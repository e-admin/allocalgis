	...
	public boolean isPresent(){
	    for (int i = 0; i < ATTEMPTS_NUMBER; i++) {
	        try{
	            ...
	            System.out.println("Saliendo false intento ["+i+"]...");
	        } 
	        catch (ProviderException ex)
	        {
	            System.out.println("Saliendo false por el ProviderException ["+i+"]...");   
	        }
	        catch (Exception ex)
	        {
	            System.out.println("Saliendo false por el Exception ["+i+"]...");  
	        }
	    }
	    return false;
 	}
