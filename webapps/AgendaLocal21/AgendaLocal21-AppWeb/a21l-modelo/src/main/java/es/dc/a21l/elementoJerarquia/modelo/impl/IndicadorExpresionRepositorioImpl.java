...
public class IndicadorExpresionRepositorioImpl extends RepositorioBaseImpl<IndicadorExpresion> implements IndicadorExpresionRepositorio {
	private static final String DELETE_POR_INDICADOR="delete from IndicadorExpresion ie where ie.indicador.id = :idIndicador";
	private static final String SELECT_POR_INDICADOR="select ie from IndicadorExpresion ie where ie.indicador.id = :idIndicador";
	...
	public List<IndicadorExpresion> cargaPorIdIndicador(Long idIndicador) {
