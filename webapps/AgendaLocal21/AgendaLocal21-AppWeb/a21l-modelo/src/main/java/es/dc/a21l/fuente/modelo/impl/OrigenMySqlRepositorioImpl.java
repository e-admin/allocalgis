...
public class OrigenMySqlRepositorioImpl extends RepositorioBaseImpl<Fuente> implements OrigenMysqlRepositorio {
	private static final Logger log = LoggerFactory.getLogger(OrigenMySqlRepositorioImpl.class);
	private static final String DRIVER_MYSQL = "com.mysql.jdbc.Driver"; 
	private static final String CADENA_BD_MYSQL="jdbc:mysql://";
	...
	public EncapsuladorListSW<TablaFuenteDatosDto> listarTablasFuenteExterna(Fuente fuente) {
		...
		if(!cadenaConexion.contains(CADENA_BD_MYSQL)){
			cadenaConexion=CADENA_BD_MYSQL.concat(cadenaConexion);
		}
