					...
					<thead>
						<tr>
							<td id="tuplaCategoria0" class="cat">
								<a onclick="mostrarOcultarArbore('idcategoriapadre-0_tr', 'idcategoria0_img',true, false, false);">
...
<script type="text/javascript">
	...
	$('#btnCrearCategoria').click(function() {
		if ( idCategoria!=null ) {
			...
			document.location.href="?accion=editaCategoria&id=0";
		}
	});
...
function dibujarFilaCategoria(idTabla, idCategoriaPadre, idCategoria, nombreCategoria, margenIzq)
{
	...
	cell.style.paddingLeft = margenIzq + "px";
	cell.innerHTML = "<a " + funcionJs +"><img id='idcategoria" + idCategoria + "_img' src='images/folder_open.png' style='float: left;' /></a><a href='#' class='enlaceTablaCategoria' style='padding-left: 8px;' idcategoria='" + idCategoria +"'>" + nombreCategoria + "</a>";
