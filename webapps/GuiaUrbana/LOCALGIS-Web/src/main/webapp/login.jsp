                ...
                <div id="boxcontrol" class="boxcontrol">
                    ...
                    <div id="contentPage">
                        <form action="j_security_check" method="post">
                            <table id="centeredTable" border="0">
                                <tr>
                                ...
                                <tr>
                                    <td align="center" valign="middle" style="padding-left: 6px;">
                                        <input type="text" class="inputTextField" name="j_username"/>
                                    </td>
                                    <td align="center" valign="middle" style="padding-left: 2px;">
                                        <input type="password" class="inputTextField" name="j_password" onkeypress="checkReturn(event);" />
                                    </td>
                                    <td valign="middle">
