...
/**
 * Class: OpenLayers.PopupLocalgis
 *
 ...
 * Example:
 * (code)
 * popup = new OpenLayers.PopupLocalgis("chicken", 
 ...
 * (end)
 */
OpenLayers.PopupLocalgis = OpenLayers.Class(OpenLayers.Popup, {
    ...
    */
    ...
    destroy: function() {
        if (this.map != null) {
            //Borramos todas las marcas
            this.map.markersAuxiliarLayer.clearMarkers();
...
//            this.contentDiv.style.height = this.size.h + "px";
    ...
    */
    ...
    CLASS_NAME: "OpenLayers.PopupLocalgis"
});
