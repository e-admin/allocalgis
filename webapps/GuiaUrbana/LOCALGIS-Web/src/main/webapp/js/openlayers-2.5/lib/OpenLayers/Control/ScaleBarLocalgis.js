...
OpenLayers.Control.ScaleBarLocalgis  = 
  OpenLayers.Class(OpenLayers.Control, {
    ...
    update: function() {
        ...
        this.labelSpan.innerHTML = "<span>Escala 1: " + Math.round((this.map.baseLayer.getResolution() * OpenLayers.INCHES_PER_UNIT[this.map.baseLayer.units] * OpenLayers.DOTS_PER_INCH)) +"</span>";
