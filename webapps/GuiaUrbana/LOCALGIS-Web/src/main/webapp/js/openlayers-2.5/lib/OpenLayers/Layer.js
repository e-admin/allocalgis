...
OpenLayers.Layer = OpenLayers.Class({
  ...
  /********************************************************/
    ...
    /*setZIndex: function (zIndex) {
    	alert(this.div.style.zIndex + " " +setZIndex);
    ...
    setZIndex: function (zIndex) {
    	try{
    	if(!zIndex)  this.div.style.zIndex =  parseInt(this.div.style.zIndex) + 5;
    	else  this.div.style.zIndex = parseInt(zIndex);
    	}
    	catch(e){}
    	//alert(zIndex);
    ...
    setZIndexAddLayer: function (zIndex) {
    	try{
    		this.div.style.zIndex = parseInt(zIndex);
    	}
    	catch(e){}
    	//alert(zIndex);
