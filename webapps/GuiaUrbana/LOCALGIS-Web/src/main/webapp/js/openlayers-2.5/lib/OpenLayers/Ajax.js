 ...
 *     call request.abort().
 */
 OpenLayers.loadURLLocalgis = function(uri, params, caller,
                                  onComplete, onFailure) {
	//OpenLayers.ProxyHost="proxy.do?";
    uri = "proxy.do?requestWms=wms&urlValor="+ escape(uri);
...
OpenLayers.loadURL = function(uri, params, caller,
    ...
    if (OpenLayers.ProxyHost && OpenLayers.String.startsWith(uri, "http")) {
        uri = OpenLayers.ProxyHost + escape(uri)+params;
    }
...
OpenLayers.loadURL2 = function(uri, params, caller,
                                  onComplete, onFailure) {
