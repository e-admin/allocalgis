...
<h1 align="center">El certificado proporcionado no es válido</h1>
<h2 align="center"><bean:write name="resultado" /></h2>
<%--
<div style="margin-top:1em;text-align:center;">
	<img style="" src="${pageContext.request.contextPath}/img/arrow.gif" alt="Arrow" />
	<html:link style="font-weight:bold;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:12px;"
		href="index.jsp" title="Intentarlo de nuevo">Intentarlo de nuevo</html:link>
</div>
--%>
