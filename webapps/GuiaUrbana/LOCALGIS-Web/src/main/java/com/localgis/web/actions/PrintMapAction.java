...
public class PrintMapAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
      ...
      //Conversion de coordenadas
        ...
        String escudoEntidad = "../img/escudos/" + localgisMap.getMapidentidad() + ".png";
        ...
        String overlay = formBean.getOverlay();
        if (overlay!=null)
            {
        	String decoded = URLDecoder.decode(overlay);
                decoded=decoded.replaceAll("\n", "\\n");
        	request.setAttribute("overlay", decoded);
        	log.debug("Overlay:"+decoded);
            }
