...
public class Configuration {
    ...
    public static final double DOTS_PER_INCH = 96;
    ...
    public static final String MAPSERVER_CONFIG_FILE_DIRECTORY = "/apps/localgis";
     ...
     */
    public static final String PROPERTY_JDBC_ENVIRONMENT = "jdbc.environment";
    ...
    public static final String PROPERTY_MAPSERVER_URL_SERVER_INTERNAL = "mapserver.url.server.internal";
    ...
    public static final String PROPERTY_MAPSERVER_COMPATIBILITY="mapserver.compatibility";
    
    /**
     * Propiedades de configuracion de los sistemas de proyeccion
     */
    public static final String PROPERTY_DISPLAYPROJECTION = "displayprojection";
    ...
    public static final String PROPERTY_COMUNIDAD_BBOX_EPSG_CODE = "comunidad.bbox.epsgCode";
    public static final String PROPERTY_COMUNIDAD_MINX = "comunidad.minX";
    public static final String PROPERTY_COMUNIDAD_MINY = "comunidad.minY";
    public static final String PROPERTY_COMUNIDAD_MAXX = "comunidad.maxX";
    public static final String PROPERTY_COMUNIDAD_MAXY = "comunidad.maxY";
     ...
     *             Si no se encuentra la propiedad
     */
    public static String getPropertyStringWithFilter(String property){
    	String value = "";
    	try{
	    	if (properties == null) {
	        	logger.error("No se ha iniciado correctamente la configuracion");
	        ...
	        if(value == null){
	        	if (!property.equals("jdbc.environment"))
	        		logger.error("No se ha encontrado el parametro de configuracion: "+property);
	            throw new LocalgisConfigurationException("No se ha encontrado el parametro de configuracion: "+property+" en el fichero de configuracion");
	        }
        }
        catch(LocalgisConfigurationException ex){
        	if (!property.equals("jdbc.environment"))
        		logger.error("No se ha encontrado el parametro de configuracion: " + property + " - " + ex);
        	value = "";
        }
        return value;
    }
