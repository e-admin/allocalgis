...
/**
 * DAO para manejar los números de policia de la base de datos de Geopista
 * 
 * @author albegarcia
 * 
 */
public interface GeopistaNumeroPoliciaDAO extends Dao {
    ...
    /**
     * Método que devuelve un numero de policia a partir de su id
     * 
     * @param id
     *            Identificador del número de policía
     * @return Número de policia de Geopista
