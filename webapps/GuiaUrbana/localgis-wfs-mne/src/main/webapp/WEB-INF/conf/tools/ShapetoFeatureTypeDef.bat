...
rem java -classpath .;..\..\classes;..\..\lib\log4j-1.2.9.jar;..\..\lib\deegree2.jar org.deegree.tools.datastore.DBSchemaToDatastoreConf -driver SHAPE -tables ..\..\data\utah\vector\SGID500_Contours500Ft -output ..\..\conf\wms\featuretypes\SGID500_Contours500Ft_shp.xsd
...
rem java -classpath .;..\..\classes;..\..\lib\log4j-1.2.9.jar;..\..\lib\deegree2.jar org.deegree.tools.datastore.DBSchemaToDatastoreConf -driver SHAPE -tables ..\..\data\utah\vector\SGID024_Springs -output ..\..\conf\wms\featuretypes\SGID024_Springs_shp.xsd
rem java -classpath .;..\..\classes;..\..\lib\log4j-1.2.9.jar;..\..\lib\deegree2.jar org.deegree.tools.datastore.DBSchemaToDatastoreConf -driver SHAPE -tables ..\..\data\utah\vector\SGID100_RailroadsDLG100 -output ..\..\conf\wms\featuretypes\SGID100_RailroadsDLG100_shp.xsd
