...
<title>AL LocalGIS WMS Manager_Error</title>
                ...
                <div id="boxcontrol" class="boxcontrol">
                    ...
                    <div id="contentPage">
                        <table id="centeredTable">
                            <tr>
                                <td align="center">
                                    <span class="errorMessage">El tiempo máximo de espera se ha superado. Intente volver a entrar a la aplicación.</span>
                                </td>
                            </tr>
                        </table>
                    </div>                    
