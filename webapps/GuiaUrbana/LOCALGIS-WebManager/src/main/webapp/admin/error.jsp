...
<span style="color:red;text-align:center;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:14px;"><html:messages id="msg" property="error" message="true"><bean:write name="msg"/></html:messages><span>
