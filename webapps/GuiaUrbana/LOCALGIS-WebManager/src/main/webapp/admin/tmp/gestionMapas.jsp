...
<div id="bannerSelect" onclick="goHome()">
    ...
    <bean:parameter id="type" name="type"/>
		...
		<tr>
			...
			<td><html:img styleClass="imageButton" alt="salir" onclick="document.location.href='./logoff.do'" src="../img/btn_cerrar_sesion.gif" alt="Cerrar Sesión" /></td>
		</tr>		
	</table>
					...
					<tr>
					   ...
					   <td>
					       <table border="0" cellpadding="0" cellspacing="0" style="margin-left:auto;margin-right: auto;text-align:center;width: 235px">
					           <tr>
					               <td align="left">
					                   <html:img styleClass="imageButton" alt="publicar" styleId="republishImage" border="0" src="../img/btn_republicar.gif" alt="Republicar"  onclick="republishMaps(false,false);" />
					               </td>
					               <td align="right">
					                   <html:img styleClass="imageButton" alt="default" styleId="default" border="0" src="../img/default.gif" alt="Default"  onclick="setDefault();" />
					               </td>
					                  <td align="right">
					                   <html:img styleClass="imageButton" alt="republicar" styleId="republishImage" border="0" src="../img/btn_info.gif" alt="Info Mapa"  onclick="infoMapa();" />
					               </td>
					           </tr>
					           ...
					           <tr>
					            <td colspan="2" align="center">
					           	...
					           	<tr>
					               <td align="left">
					                   <html:img styleClass="imageButton" alt="republicar" styleId="republishImage" border="0" src="../img/btn_publicar_entidades.gif" alt="Republicar Todos"  onclick="republishMaps(true,false);" />
					               </td>
					               <td align="right">
					                   <html:img styleClass="imageButton" alt="republicar" styleId="republishImage" border="0" src="../img/btn_despublicar_entidades.gif" alt="DesPpublicar Todos"  onclick="republishMaps(true,true);" />
					               </td>
					           </tr>
					           </logic:present>
