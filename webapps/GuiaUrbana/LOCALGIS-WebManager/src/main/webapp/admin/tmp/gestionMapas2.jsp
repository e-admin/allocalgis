...
<!--
       ...
       function republishMaps() {
           ...
           if (mapsToRepublish == '') {
               ...
               JMap.republishMaps(mapsToRepublish,type,republishMapsReplyServer);             
               var image = document.getElementById('republishImage');
					...
					<tr>
					   ...
					   <td>
					       <table border="0" cellpadding="0" cellspacing="0" style="margin-left:auto;margin-right: auto;text-align:center;width: 235px">
					           <tr>
					               <td align="left">
					                   <html:img styleClass="imageButton" alt="republicar" styleId="republishImage" border="0" src="../img/btn_republicar.gif" alt="Republicar"  onclick="republishMaps();" />
					               </td>
					               <td align="right">
