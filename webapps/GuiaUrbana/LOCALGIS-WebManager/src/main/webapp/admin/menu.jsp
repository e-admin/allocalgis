...
<div id="wrap">
	...
	<bean:define id="list" value="listLayers" />
		<table>
			<tr>
				<td>
				<h1>Menú Principal (<bean:write name="nombreEntidad"/>)</h1>
				</td>
				<td align="right" style="width: 50em"></td>
				<td><html:img styleClass="imageButton" onclick="document.location.href='./logoff.do'"
					src="../img/btn_cerrar_sesion.gif" alt="Cerrar Sesión" /></td>
			</tr>
			<tr>
		...
		<table
			...
			<tr style="height: 3.5em;">
				...
				<td><html:link
					style="text-align:left;font-weight:bold;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:12px;"
					action="/admin/seleccionTipoMapas?gestion=mapas" title="Gestión Mapas">Gestión de Mapas</html:link>
				</td>
			</tr>
			<tr style="height: 3.5em;">
				<td><img src="../img/arrow.gif" alt="Arrow" /></td>
				<td><html:link
					style="font-weight:bold;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:12px;"
					action="/admin/seleccionTipoMapas?gestion=capas" paramId="parameter" paramName="list"  title="Gestión de capas">Gestión de Capas</html:link>
				</td>
			</tr>
			<tr style="height: 3.5em;">
				<td><img src="../img/arrow.gif" alt="Arrow" /></td>
				<td><html:link
					style="font-weight:bold;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:12px;"
					action="/admin/gestionEstilos" title="Gestión de Diseño">Gestión de Diseño</html:link>
				</td>
			</tr>			
			<tr>
				<td style="height: 1.5em;"></td>
