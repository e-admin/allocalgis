 ...
 */
package com.localgis.web.wm.dnie.filters;
...
public class DNIeFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
	     ...
	     Integer httpPort = (Integer) session.getAttribute(CertificateAuthManager.HTTP_CONNECTION_PORT);
     	 ...
     	 String finalURL = baseURL + "/localgis-wmsmanager/admin/";
...
//						httpServletRequest.getSession().setAttribute(LOGIN_ATTRIBUTE,datosCert.getCertificado().getNIFResponsable());
			        	...
			        	finalURL = baseURL + "/localgis-wmsmanager/admin/inicio.do"; //adquirida al pulsar el botón DNIe o al entra en /private (filtro previo)
			        	if(idEntidad>0){
			        		//httpServletRequest.getSession().setAttribute("entidadId", idEntidad);  
			        	...
			        	//	request.getRequestDispatcher("/private/selectMap.do").forward(request, response);
			        		finalURL = baseURL + "/localgis-wmsmanager/admin/menu.jsp";//?entidadId=" + idEntidad;
		                }
				...
				log.error(e);
				finalURL = baseURL + "/localgis-wmsmanager/error500.jsp";
