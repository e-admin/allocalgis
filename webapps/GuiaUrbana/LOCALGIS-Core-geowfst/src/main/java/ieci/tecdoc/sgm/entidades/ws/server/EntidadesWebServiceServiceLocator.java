...
public class EntidadesWebServiceServiceLocator extends org.apache.axis.client.Service implements ieci.tecdoc.sgm.entidades.ws.server.EntidadesWebServiceService {
    ...
    private java.lang.String EntidadesWebService_address = "http://192.168.1.60:8080/SIGEM_EntidadesWS/services/EntidadesWebService";
    ...
    public ieci.tecdoc.sgm.entidades.ws.server.EntidadesWebService getEntidadesWebService() throws javax.xml.rpc.ServiceException {
    ...
    public ieci.tecdoc.sgm.entidades.ws.server.EntidadesWebService getEntidadesWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ieci.tecdoc.sgm.entidades.ws.server.EntidadesWebServiceSoapBindingStub _stub = new ieci.tecdoc.sgm.entidades.ws.server.EntidadesWebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ieci.tecdoc.sgm.entidades.ws.server.EntidadesWebService.class.isAssignableFrom(serviceEndpointInterface)) {
                ieci.tecdoc.sgm.entidades.ws.server.EntidadesWebServiceSoapBindingStub _stub = new ieci.tecdoc.sgm.entidades.ws.server.EntidadesWebServiceSoapBindingStub(new java.net.URL(EntidadesWebService_address), this);
                _stub.setPortName(getEntidadesWebServiceWSDDServiceName());
                return _stub;
            }
        }
