...
public class EntidadesWebServiceSoapBindingStub extends org.apache.axis.client.Stub implements ieci.tecdoc.sgm.entidades.ws.server.EntidadesWebService {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://server.ws.entidades.sgm.tecdoc.ieci", "poCriterio"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://server.ws.entidades.sgm.tecdoc.ieci", "CriterioBusquedaEntidades"), ieci.tecdoc.sgm.entidades.ws.server.CriterioBusquedaEntidades.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://server.ws.entidades.sgm.tecdoc.ieci", "Entidades"));
        oper.setReturnClass(ieci.tecdoc.sgm.entidades.ws.server.Entidades.class);
        ...
        oper.setReturnClass(ieci.tecdoc.sgm.entidades.ws.server.RetornoCadena.class);
    ...
    public EntidadesWebServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = ieci.tecdoc.sgm.entidades.ws.server.Entidad[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = ieci.tecdoc.sgm.entidades.ws.server.CriterioBusquedaEntidades.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = ieci.tecdoc.sgm.entidades.ws.server.Entidades.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = ieci.tecdoc.sgm.entidades.ws.server.RetornoCadena.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {poEntidad});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (ieci.tecdoc.sgm.entidades.ws.server.Entidad) _resp;
            } catch (java.lang.Exception _exception) {
                return (ieci.tecdoc.sgm.entidades.ws.server.Entidad) org.apache.axis.utils.JavaUtils.convert(_resp, ieci.tecdoc.sgm.entidades.ws.server.Entidad.class);
            }
        }
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {poCriterio});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (ieci.tecdoc.sgm.entidades.ws.server.Entidades) _resp;
            } catch (java.lang.Exception _exception) {
                return (ieci.tecdoc.sgm.entidades.ws.server.Entidades) org.apache.axis.utils.JavaUtils.convert(_resp, ieci.tecdoc.sgm.entidades.ws.server.Entidades.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (ieci.tecdoc.sgm.entidades.ws.server.RetornoCadena) _resp;
            } catch (java.lang.Exception _exception) {
                return (ieci.tecdoc.sgm.entidades.ws.server.RetornoCadena) org.apache.axis.utils.JavaUtils.convert(_resp, ieci.tecdoc.sgm.entidades.ws.server.RetornoCadena.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
