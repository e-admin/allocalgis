...
public class TiposConectores  extends ieci.tecdoc.sgm.core.services.dto.RetornoServicio  implements java.io.Serializable {
    private ieci.tecdoc.sgm.catalogo.ws.server.TipoConector[] tiposConectores;
    ...
    public TiposConectores(
           ...
           ieci.tecdoc.sgm.catalogo.ws.server.TipoConector[] tiposConectores) {
        super(
            errorCode,
            returnCode);
     ...
     */
    public ieci.tecdoc.sgm.catalogo.ws.server.TipoConector[] getTiposConectores() {
        return tiposConectores;
    }
     ...
     */
    public void setTiposConectores(ieci.tecdoc.sgm.catalogo.ws.server.TipoConector[] tiposConectores) {
        this.tiposConectores = tiposConectores;
    }
        ...
        _equals = super.equals(obj) && 
            ((this.tiposConectores==null && other.getTiposConectores()==null) || 
             (this.tiposConectores!=null &&
              java.util.Arrays.equals(this.tiposConectores, other.getTiposConectores())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getTiposConectores() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getTiposConectores());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getTiposConectores(), i);
                if (obj != null &&
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://server.ws.catalogo.sgm.tecdoc.ieci", "TipoConector"));
