...
public class OrganosDestinatarios  extends ieci.tecdoc.sgm.core.services.dto.RetornoServicio  implements java.io.Serializable {
    private ieci.tecdoc.sgm.catalogo.ws.server.OrganoDestinatario[] organosDestinatarios;
    ...
    public OrganosDestinatarios(
           ...
           ieci.tecdoc.sgm.catalogo.ws.server.OrganoDestinatario[] organosDestinatarios) {
        super(
            errorCode,
            returnCode);
     ...
     */
    public ieci.tecdoc.sgm.catalogo.ws.server.OrganoDestinatario[] getOrganosDestinatarios() {
        return organosDestinatarios;
    }
     ...
     */
    public void setOrganosDestinatarios(ieci.tecdoc.sgm.catalogo.ws.server.OrganoDestinatario[] organosDestinatarios) {
        this.organosDestinatarios = organosDestinatarios;
    }
