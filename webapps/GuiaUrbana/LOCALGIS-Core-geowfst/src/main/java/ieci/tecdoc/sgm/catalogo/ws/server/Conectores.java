...
public class Conectores  extends ieci.tecdoc.sgm.core.services.dto.RetornoServicio  implements java.io.Serializable {
    private ieci.tecdoc.sgm.catalogo.ws.server.Conector[] conectores;
    ...
    public Conectores(
           ...
           ieci.tecdoc.sgm.catalogo.ws.server.Conector[] conectores) {
        super(
            errorCode,
            returnCode);
     ...
     * @return conectores
     */
    public ieci.tecdoc.sgm.catalogo.ws.server.Conector[] getConectores() {
        return conectores;
    }
     ...
     * @param conectores
     */
    public void setConectores(ieci.tecdoc.sgm.catalogo.ws.server.Conector[] conectores) {
        this.conectores = conectores;
    }
