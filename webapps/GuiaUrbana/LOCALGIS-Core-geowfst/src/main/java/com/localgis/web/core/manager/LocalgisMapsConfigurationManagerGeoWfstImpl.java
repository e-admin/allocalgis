/**
 * LocalgisMapsConfigurationManagerGeoWfstImpl.java
 ...
 *
 */
public class LocalgisMapsConfigurationManagerGeoWfstImpl implements LocalgisMapsConfigurationManagerGeoWfst {

    /**
     * Logger para las trazas
     */
    private static Logger logger = Logger.getLogger(LocalgisMapsConfigurationManagerGeoWfstImpl.class);
     ...
     */
    private LocalgisManagerBuilderGeoWfst localgisManagerBuilderGeoWfst;
     ...
     */
    public LocalgisMapsConfigurationManagerGeoWfstImpl(DaoManager daoManager, WMSConfigurator wmsConfigurator, LocalgisManagerBuilderGeoWfst localgisManagerBuilderGeoWfst) {
        ...
        this.localgisManagerBuilderGeoWfst = localgisManagerBuilderGeoWfst;
    }
    ...
    public List getAvailableMaps(Integer idEntidad) throws LocalgisInvalidParameterException, LocalgisDBException {
        ...
        try {
            return geopistaMapDAO.selectMapsByIdEntidad(idEntidad, localgisManagerBuilderGeoWfst.getDefaultLocale());
        } catch (DaoException e) {
    ...
    public GeopistaMap getAvailableMap(Integer idEntidad,Integer idMap) throws LocalgisInvalidParameterException, LocalgisDBException {
        ...
        try {
            return geopistaMapDAO.selectMapById(idEntidad,idMap, localgisManagerBuilderGeoWfst.getDefaultLocale());
        } catch (DaoException e) {
    ...
    public List getPublishedMaps(Integer idEntidad) throws LocalgisInvalidParameterException, LocalgisDBException {
        ...
        try {
            return localgisMapDAO.selectMapsByIdEntidad(idEntidad, localgisManagerBuilderGeoWfst.getDefaultLocale());        
        } catch (DaoException e) {
    ...
    public List getPublishedMaps(Integer idEntidad, Boolean mapasPublicos) throws LocalgisInvalidParameterException, LocalgisDBException {
        ...
        try {
            return localgisMapDAO.selectMapsByIdEntidad(idEntidad, mapasPublicos, localgisManagerBuilderGeoWfst.getDefaultLocale());        
        } catch (DaoException e) {
        ...
        try {
            ...
            if (mapsToRemove != null) {
                for (int i = 0; i < mapsToRemove.length; i++) {
                    ...
                    localgisMapDAO.deleteByIdMapAndPublicMap(mapToRemove.getMapid(), publicMaps);
                }
            }
            if (mapsToPublish != null) {
                for (int i = 0; i < mapsToPublish.length; i++) {                
                    GeopistaMap geopistaMapToPublish = geopistaMapDAO.selectMapById(geopistaEntidadSupramunicipal.getIdEntidad(), mapsToPublish[i].getIdMap(), localgisManagerBuilderGeoWfst.getDefaultLocale());
            ...
            if (mapsToRepublish != null) {
                ...
                for (int i = 0; i < mapsToRepublish.length; i++) {
                    ...
                    mapToRepublish = localgisMapDAO.selectMapById(mapToRepublish.getMapid(), localgisManagerBuilderGeoWfst.getDefaultLocale());
                    ...
                    GeopistaMap geopistaMapToRepublish = geopistaMapDAO.selectMapById(geopistaEntidadSupramunicipal.getIdEntidad(), mapToRepublish.getMapidgeopista(), localgisManagerBuilderGeoWfst.getDefaultLocale());
     ...
     */
    public void addMapToWMSServer(GeopistaMap geopistaMap, Integer idEntidad, Boolean publicMap) throws LocalgisConfigurationException, LocalgisInvalidParameterException, LocalgisDBException, LocalgisWMSException, NoResourceAvailableException {
        GeopistaMap [] mapsToPublish = new GeopistaMap[1];
        mapsToPublish[0] = geopistaMap;
        publishAndRemoveMapsFromWMSServer(mapsToPublish, null, null, idEntidad, publicMap, geopistaMap.getIdMap());
    }
    ...
    public LocalgisMap getDefaultMap(Integer idEntidad, Boolean mapPublic) throws LocalgisInvalidParameterException, LocalgisDBException {
        ...
        try {
            return localgisMapDAO.getDefaltMap(mapPublic, idEntidad, localgisManagerBuilderGeoWfst.getDefaultLocale());
        } catch (DaoException e) {
     ...
     */
    private void insertLayer(GeopistaLayer geopistaLayer, Integer idMap, Integer idEntidad, Collection<Integer> idsMunicipios, Boolean publicMap, String srid) throws LocalgisConfigurationException, NoResourceAvailableException {
        /*
        ...
        Integer idStyle = localgisStyleDAO.insert(localgisStyle);
