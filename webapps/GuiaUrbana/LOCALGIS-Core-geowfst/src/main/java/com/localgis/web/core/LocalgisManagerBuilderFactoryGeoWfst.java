/**
 * LocalgisManagerBuilderFactoryGeoWfst.java
 ...
 *
 */
public class LocalgisManagerBuilderFactoryGeoWfst {

    /**
     * Logger para las trazas
     */
    private static Logger logger = Logger.getLogger(LocalgisManagerBuilderFactoryGeoWfst.class);

    /**
     * Fichero de configuracion de framework de persistencia
     */
    private static final String RESOURCE_DAO_XML = "com/localgis/web/core/dao/daoGeoWfst.xml";
     ...
     */
    public static LocalgisManagerBuilderGeoWfst createLocalgisManagerBuilder(String locale) throws LocalgisConfigurationException, LocalgisInitiationException {
        try {
            ...
            return new LocalgisManagerBuilderGeoWfst(daoManager, wmConfigurator, localeSelected, availableLocales);
     ...
     */
    public static LocalgisManagerBuilderGeoWfst createLocalgisManagerBuilder() throws LocalgisConfigurationException, LocalgisInitiationException {
        return LocalgisManagerBuilderFactoryGeoWfst.createLocalgisManagerBuilder(null);
    }
