...
public class ObtenerListaCapasResponse  implements java.io.Serializable {
    private com.localgis.model.ot.CapaOT[] out;

    public ObtenerListaCapasResponse() {
    }

    public ObtenerListaCapasResponse(
           com.localgis.model.ot.CapaOT[] out) {
           this.out = out;
    }
     ...
     * @return out
     */
    public com.localgis.model.ot.CapaOT[] getOut() {
        return out;
    }
     ...
     * @param out
     */
    public void setOut(com.localgis.model.ot.CapaOT[] out) {
        this.out = out;
    }
    ...
    static {
        ...
        elemField.setItemQName(new javax.xml.namespace.QName("http://ot.model.localgis.com", "CapaOT"));
