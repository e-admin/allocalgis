...
OpenLayers.Control.ToolbarWfstLocalgis  = 
  OpenLayers.Class(OpenLayers.Control.PanelLocalgis, {
	 
	selectFeature: null,
	drawFeaturePolygon: null,	    
     ...
     */
    initialize: function(options,layerWfstModification,layersWfsSelection,layerWfstModificationEvents,layerWfstSelectionEvents,layersWfstDrawFeature) {
        ...
        if(layersWfstDrawFeature == "")
        	this.drawFeature = new OpenLayers.Control.DrawFeaturePolygonLocalgis(layerWfstModification);
        else if(layersWfstDrawFeature == "")
        	this.drawFeature = new OpenLayers.Control.DrawFeaturePathLocalgis(layerWfstModification);
        else
        	this.drawFeature = new OpenLayers.Control.DrawFeaturePointLocalgis(layerWfstModification);
   ...
   CLASS_NAME: "OpenLayers.Control.ToolbarWfstLocalgis"
});                               
