 ...
 *
 * Class: OpenLayers.Control.OverviewMapLocalgis
 ...
 * <OpenLayers.Control.OverviewMapLocalgis> constructor.
 *
 * Inerits from:
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.OverviewMapLocalgis = OpenLayers.Class(OpenLayers.Control, {

    /**
     * Property: id
     * {String} For div.id
     */
    id:  "OverviewMapLocalgis",
    ...
    /**
     * Constructor: OpenLayers.Control.OverviewMapLocalgis
    ...
    destroy: function() {
        ...
        if (this.maximizeDiv) {
            OpenLayers.EventLocalgis.stopObservingElement(this.maximizeDiv);
            this.div.removeChild(this.maximizeDiv);
            this.maximizeDiv = null;
        }
        
        if (this.minimizeDiv) {
            OpenLayers.EventLocalgis.stopObservingElement(this.minimizeDiv);
    ...
    draw: function() {
        ...
        // should slip through.
        this.elementEvents = new OpenLayers.EventsLocalgis(this, this.element);
        this.elementEvents.register('mousedown', this, function(e) {
            OpenLayers.EventLocalgis.stop(e);
        });
        ...
        this.rectEvents = new OpenLayers.EventsLocalgis(this, this.extentRectangle,
                                                null, true);
        ...
        this.mapDivEvents = new OpenLayers.EventsLocalgis(this, this.mapDiv);
        ...
        if(!this.outsideViewport) {
            ...
            // maximize button div
            var img = imgLocation + 'overview-map-maximize-grey.gif';
            ...
            OpenLayers.EventLocalgis.observe(this.maximizeDiv, 'click', 
            ...
            // minimize button div
            var img = imgLocation + 'overview-map-minimize-grey.gif';
            ...
            OpenLayers.EventLocalgis.observe(this.minimizeDiv, 'click', 
            ...
            for (var i = 0; i < eventsToStop.length; i++) {
                ...
                OpenLayers.EventLocalgis.observe(this.maximizeDiv, 
                                         eventsToStop[i], 
                                         OpenLayers.EventLocalgis.stop);

                OpenLayers.EventLocalgis.observe(this.minimizeDiv,
                                         eventsToStop[i], 
                                         OpenLayers.EventLocalgis.stop);
            }
    ...
    rectMouseDown: function (evt) {
        if(!OpenLayers.EventLocalgis.isLeftClick(evt)) return;
        this.rectDragStart = evt.xy.clone();
        this.performedRectDrag = false;
        OpenLayers.EventLocalgis.stop(evt);
    },
    ...
    CLASS_NAME: 'OpenLayers.Control.OverviewMapLocalgis'
});
