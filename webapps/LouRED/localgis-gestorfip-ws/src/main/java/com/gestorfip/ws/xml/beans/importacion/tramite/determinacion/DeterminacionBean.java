...
public class DeterminacionBean implements Serializable {
	...
	private String unidad_codigoTramite;
	...
	public String getUnidad_codigoTramite() {
		return unidad_codigoTramite;
	}

	public void setUnidad_codigoTramite(String unidadCodigoTramite) {
		unidad_codigoTramite = unidadCodigoTramite;
	}
