...
public class Caso_RegimenBean implements Serializable {
	...
	private String valorreferencia_codigoTramite;
	private String determinacionregimen_determinacion;
	private String determinacionregimen_codigoTramite;
	...
	public String getValorreferencia_codigoTramite() {
		return valorreferencia_codigoTramite;
	}

	public void setValorreferencia_codigoTramite(String valorreferenciaCodigoTramite) {
		valorreferencia_codigoTramite = valorreferenciaCodigoTramite;
	}

	public String getDeterminacionregimen_codigoTramite() {
		return determinacionregimen_codigoTramite;
	}

	public void setDeterminacionregimen_codigoTramite(
			String determinacionregimenCodigoTramite) {
		determinacionregimen_codigoTramite = determinacionregimenCodigoTramite;
	}
