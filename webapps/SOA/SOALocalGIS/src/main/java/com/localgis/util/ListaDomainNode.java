 ...
 * Time: 16:20:43
 */
public class ListaDomainNode implements Cloneable{
    //private Logger logger = Logger.getLogger(ListaDomainNode.class);
    ...
    public void restructurar()
    {
        ...
        for (Enumeration e=hDom.elements();e.hasMoreElements();)
        {
            ...
            else
            {
                ...
                if (nodePadre==null)
                    //logger.warn("El nodo padre no se encuentra en la lista: "+nodeAux.getIdParent()+
                    //          " posible inconsistencia de datos");
                	System.out.println("El nodo padre no se encuentra en la lista: "+nodeAux.getIdParent()+
                                      " posible inconsistencia de datos");
                else
