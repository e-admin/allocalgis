...
import com.localgis.model.dao.postgis.localweb.PostGISLocalWebDAOWS;
...
public class PostGISDAOFactoryWS extends DAOFactoryWS
{
	...
	public ILocalWebDAOWS getLocalWebDAO() throws NamingException {
		
		return new PostGISLocalWebDAOWS();
	}
