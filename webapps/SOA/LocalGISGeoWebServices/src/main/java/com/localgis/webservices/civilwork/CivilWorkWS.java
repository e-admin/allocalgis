...
import com.localgis.webservices.civilwork.ln.LocalGISPlanesObraLN;
...
public class CivilWorkWS {
	...
	public String addPlanesObra(String userName,String password,LocalGISPlanesObra planObra, Integer idMunicipio) throws ACException, NamingException{
		UserValidationLN userValidationLN = new UserValidationLN();
		userValidationLN.getActiveAndValidatedUserId(userName, password);
		Integer userId = userValidationLN.getUserId(userName);
		LocalGISPlanesObraLN planesObraLN = new LocalGISPlanesObraLN();
		planesObraLN.addPlanesObra(planObra, userId);
		return "";
	}
		
	public String deletePlanesObra(String userName,String password,Integer idPlanObra, Integer idMunicipio) throws ACException, NamingException{
		UserValidationLN userValidationLN = new UserValidationLN();
		userValidationLN.getActiveAndValidatedUserId(userName, password);
		Integer userId = userValidationLN.getUserId(userName);
		LocalGISPlanesObraLN planesObraLN = new LocalGISPlanesObraLN();
		planesObraLN.removePlanesObra(idPlanObra, userId);
		return "";
	}

	public String modifyPlanesObra(String userName,String password,LocalGISPlanesObra planObra,Integer idMunicipio) throws ACException, NamingException{
		UserValidationLN userValidationLN = new UserValidationLN();
		userValidationLN.getActiveAndValidatedUserId(userName, password);
		Integer userId = userValidationLN.getUserId(userName);
		LocalGISPlanesObraLN planesObraLN = new LocalGISPlanesObraLN();
		planesObraLN.setPlanesObra(planObra, userId);
		return "";
	}

	public LocalGISPlanesObra getPlanesObra(String userName,String password,Integer idPlanObra,Integer idMunicipio, Integer idEntidad) throws ACException, NamingException{
		UserValidationLN userValidationLN = new UserValidationLN();
		userValidationLN.getActiveAndValidatedUserId(userName, password);
		Integer userId = userValidationLN.getUserId(userName);
		LocalGISPlanesObraLN planesObraLN = new LocalGISPlanesObraLN();
		return planesObraLN.getPlanesObra(idPlanObra, true, idMunicipio, userId, idEntidad);
	}


	public LocalGISPlanesObra[] getPlanesObraList(String userName,String password, String description, Calendar fromStart, Calendar toStart,Calendar fromAprobacion,
			Calendar toAprobacion, Integer startElement, Integer range, Integer idMunicipio,
			OrderByColumn[] orderByColumns, LayerFeatureBean[] features, 
		...
		ArrayList<LayerFeatureBean> layers = new ArrayList<LayerFeatureBean>(Arrays.asList(features));
		ArrayList<OrderByColumn> columns = new ArrayList<OrderByColumn>(Arrays.asList(orderByColumns));
		ArrayList<LocalGISPlanesObra> planesObra = planesObraLN.getPlanesObraList(description, fromStart, toStart, fromAprobacion, 
				toAprobacion, startElement, range, idMunicipio, userId, columns, layers, plan, anios, nombre, paraje, presupuestoEstimado, 
				presupuestoDefinitivo, existeProyecto, infraestructura, obraNueva,
		...
		return planesObra.toArray(new LocalGISPlanesObra[(planesObra.size())]);
	}
	public LocalGISPlanesObra[] getCompletePlanesObraList(String userName,String password,Integer idMunicipio, Integer idEntidad) throws ACException, NamingException{
		return getPlanesObraList(userName, password, null, null, null, null, null, null, null, idMunicipio, new OrderByColumn[0],  
				new LayerFeatureBean[0], null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 
				null, null, null, null, null, null,	null, null, null, null, null, null, null, null, null, null, null, null, null, null, 
				null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, idEntidad);

	}

	public LocalGISPlanesObra[] getCompleteFilteredPlanesObraList(String userName,String password,Integer startElement,Integer range,Integer idMunicipio, Integer idEntidad) throws ACException, NamingException{
		return getPlanesObraList(userName, password, null, null, null, null, null, startElement, range, idMunicipio, new OrderByColumn[0], 
				new LayerFeatureBean[0], null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 
				null, null, null, null, null, null,	null, null, null, null, null, null, null, null, null, null, null, null, null, null, 
				null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, idEntidad);
	}
	
	public int getNumPlanesObra(String userName, String password, 
			String description, Calendar fromStart, Calendar toStart,
			Integer startElement, Integer idMunicipio, LayerFeatureBean[] features, 
		...
		LocalGISPlanesObraLN planesObraLN = new LocalGISPlanesObraLN();
		ArrayList<LayerFeatureBean> layers = new ArrayList<LayerFeatureBean>(Arrays.asList(features));
		return planesObraLN.getNumPlanesObra(description, fromStart, toStart, startElement, idMunicipio, userId, layers, fromAprobacion, toAprobacion, 
	...
	public int getNumCompletePlanesObraList(String userName,String password,Integer idMunicipio, Integer idEntidad) throws ACException, NamingException{

		return getNumPlanesObra(userName, password, null, null, null, null, idMunicipio, new LayerFeatureBean[0], null, null, null, 
				null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,null, null, null, 
				null, null, null, null, null, null, null, null, null, null, null, null,  null, null, null, null, null, null,
				null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, idEntidad);
	}

		
	public LocalGISPlanesObra[] getPlanesObraListByConditions(String userName,String password,FinderPlanesObraConditions conditions) throws ACException, NamingException{
		
		return getPlanesObraList(userName, password, conditions.getDescription(), conditions.getFrom(), conditions.getTo(), conditions.getFromFechaAprobacion(), 
				conditions.getToFechaAprobacion(), conditions.getStartElement(), conditions.getRange(), conditions.getIdMunicipio(), 
				getOrderByColumn(conditions.getOrderByColumns()), getLayerFeatureBean(conditions.getFeatures()), 
				conditions.getPlan(), conditions.getAnios(), conditions.getNombre(), conditions.getParaje(), conditions.getPresupuestoEstimado(), 
				conditions.getPresupuestoDefinitivo(), conditions.getExisteProyecto(), conditions.getInfraestructura(), conditions.getObraNueva(), conditions.getEstudioAmbiental(), 
				conditions.getDatosEIEL(), conditions.getPermisos(), conditions.getPersonaContacto(), conditions.getTelefonoContacto(), conditions.getDocumentosAdjuntos(), 
				conditions.getServiciosAfectados(), conditions.getDestinatario(), 
				conditions.getRecibi(), conditions.getFromFechaRecibi(), conditions.getToFechaRecibi(), conditions.getSupervision(), conditions.getDirectorProyecto(),
				conditions.getAutorProyecto(), conditions.getDirectorObra(), conditions.getEmpresaAdjudicataria(), conditions.getToFechaResolucion(), conditions.getFromFechaResolucion(),
				conditions.getPresupuestoAdjudicacion(), conditions.getCoordinadorSegSalud(), conditions.getToActaReplanteo(), conditions.getFromActaReplanteo(), 
				conditions.getToFechaComienzo(), conditions.getFromFechaComienzo(), conditions.getToFechaFinalizacion(), conditions.getFromFechaFinalizacion(), conditions.getToProrrogas(), 
				conditions.getFromProrrogas(), conditions.getToActaRecepcion(), conditions.getFromActaRecepcion(), conditions.getCertificacionFinal(), 
				conditions.getToResolucionCertificacion(), conditions.getFromResolucionCertificacion(), conditions.getToInformacionCambiosEIEL(), conditions.getFromInformacionCambiosEIEL(), 
				conditions.getToReformados(), conditions.getFromReformados(), conditions.getLiquidacion(), conditions.getToFechaLiquidacion(), conditions.getFromFechaLiquidacion(), 
				conditions.getDetalles(), conditions.getToFechaSolicitud(), conditions.getFromFechaSolicitud(), 
				conditions.getToFechaAprobacionPrincipado(), conditions.getFromFechaAprobacionPrincipado(), conditions.getIdEntidad());
	}
	public int getNumPlanesObraListByConditions(String userName,String password,FinderPlanesObraConditions conditions) throws ACException, NamingException{
		return getNumPlanesObra(userName, password, conditions.getDescription(), conditions.getFrom(), conditions.getTo(), conditions.getStartElement(), 
				conditions.getIdMunicipio(), getLayerFeatureBean(conditions.getFeatures()), conditions.getFromFechaAprobacion(), conditions.getToFechaAprobacion(), 
				conditions.getPlan(), conditions.getAnios(), conditions.getNombre(), conditions.getParaje(), conditions.getPresupuestoEstimado(), 
				conditions.getPresupuestoDefinitivo(), conditions.getExisteProyecto(), conditions.getInfraestructura(), conditions.getObraNueva(), conditions.getEstudioAmbiental(), 
				conditions.getDatosEIEL(), conditions.getPermisos(), conditions.getPersonaContacto(), conditions.getTelefonoContacto(), conditions.getDocumentosAdjuntos(), 
				conditions.getServiciosAfectados(), conditions.getDestinatario(), 
