...
set SETTINGS=..\..\settings\settings_localgis3_unsigned.xml
GOTO CONTINUE
...
set ID_REPOSITORY_MAVEN=LocalGISIII
...
FOR /F "tokens=1,2,3,* delims=[]=," %%A IN ('SET ARRAY[') DO ( 
	...
	echo call mvn -s settings_lcg3_batch_deploy.xml %TIPO_DEPLOY% -DartifactId=%%C -Dversion=%%D -Dfile=%%C-%%D.jar -DpomFile=%%C-%%D.pom -Dpackaging=jar -DrepositoryId=LocalGISIII -Durl=%%URL%% >>%PATH_LIB_EXTERNAL%		
...
echo call mvn -s settings_lcg3_batch_deploy.xml %TIPO_DEPLOY% -DartifactId=axis2 -Dversion=1.5.3 -Dfile=axis2-1.5.3.jar -DpomFile=axis2-1.5.3.pom -Dpackaging=jar -DrepositoryId=LocalGISIII -Durl=%%URL%% >>%PATH_LIB_EXTERNAL%	
...
echo call mvn -s settings_lcg3_batch_deploy.xml %TIPO_DEPLOY% -DartifactId=axis2 -Dversion=1.4 -Dfile=./axis.axis.1.4/axis-1.4.jar -DpomFile=./axis.axis.1.4/axis-1.4.pom -Dpackaging=jar -DrepositoryId=LocalGISIII -Durl=%%URL%% >>%PATH_LIB_EXTERNAL%	
...
echo echo Desplegando : axis-1.4.jar >>%PATH_LIB_EXTERNAL%
echo call mvn -s settings_lcg3_batch_deploy.xml %TIPO_DEPLOY% -DartifactId=axis2 -Dversion=1.4 -Dfile=./org.apache.axis.axis.1.4/axis-1.4.jar -DpomFile=./org.apache.axis.axis.1.4/axis-1.4.pom -Dpackaging=jar -DrepositoryId=LocalGISIII -Durl=%%URL%% >>%PATH_LIB_EXTERNAL%
