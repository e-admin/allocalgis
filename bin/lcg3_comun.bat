...
IF "%1"=="" GOTO SIGNDEFAULT
IF "%1"=="clean" GOTO CLEAN
IF "%1"=="sign" GOTO SIGN
IF "%1"=="signext" GOTO SIGNEXT
IF "%1"=="nosignext" GOTO NOSIGNEXT
IF "%1"=="nosign" GOTO NOSIGN
IF "%1"=="addlicense_gpl" GOTO ADDLICENSE_GPL
IF "%1"=="removelicense_gpl" GOTO REMOVELICENSE_GPL
IF "%1"=="addlicense_eupl" GOTO ADDLICENSE_EUPL
IF "%1"=="removelicense_eupl" GOTO REMOVELICENSE_EUPL
IF "%1"=="check" GOTO CHECK
IF "%1"=="removeoldlicense" GOTO REMOVEOLD
...
echo Licencias
echo -------------
echo Usage lcg_compile/lcg_deploy check lcg_const
echo Usage lcg_compile/lcg_deploy removeoldlicense lcg_const  (Borra la licencia antigua de LocalGIS)
echo Usage lcg_compile/lcg_deploy removelicense_gpl lcg_const (Borra la licencia de MINETUR GPL)
echo Usage lcg_compile/lcg_deploy addlicense_gpl lcg_const (Fija la licencia de MINETUR GPL)
echo Usage lcg_compile/lcg_deploy removelicense_eupl lcg_const (Borra la licencia de MINETUR EUPL)
echo Usage lcg_compile/lcg_deploy addlicense_eupl lcg_const (Fija la licencia de MINETUR EUPL)
echo --------
echo Usage lcg_clean lcg_const
GOTO END
...
:ADDLICENSE_GPL
SET OPTIONS=license:format -Dmaven.clean.failOnError=false --strict-checksums
set TIPO_COMPILACION_DEFAULT=
set OPTIONS_SIGN=-Djarsigner.skip=false
set SETTINGS=settings\settings_lcg3.xml
set REPOSITORY_MAVEN=%MAVEN_NO_SIGN_REPO%
set DATOS_DEPLOY=-DaltDeploymentRepository=LocalGISIII::default::%REPOSITORY_MAVEN%
set PROFILE=-P manage_minetur_gpl_license
GOTO CONTINUE

:REMOVELICENSE_GPL
SET OPTIONS=license:remove -Dmaven.clean.failOnError=false --strict-checksums
set TIPO_COMPILACION_DEFAULT=
set OPTIONS_SIGN=-Djarsigner.skip=false
set SETTINGS=settings\settings_lcg3.xml
set REPOSITORY_MAVEN=%MAVEN_NO_SIGN_REPO%
...
:ADDLICENSE_EUPL
SET OPTIONS=license:format_eupl -Dmaven.clean.failOnError=false --strict-checksums
set TIPO_COMPILACION_DEFAULT=
set OPTIONS_SIGN=-Djarsigner.skip=false
set SETTINGS=settings\settings_lcg3.xml
set REPOSITORY_MAVEN=%MAVEN_SIGN_REPO%
set DATOS_DEPLOY=-DaltDeploymentRepository=LocalGISIII::default::%REPOSITORY_MAVEN%
set PROFILE=-P manage_minetur_eupl_license
GOTO CONTINUE
...
:CHECK
SET OPTIONS=license:check -Dmaven.clean.failOnError=false --strict-checksums
set TIPO_COMPILACION_DEFAULT=
set OPTIONS_SIGN=-Djarsigner.skip=false
set SETTINGS=settings\settings_lcg3.xml
set REPOSITORY_MAVEN=%MAVEN_SIGN_REPO%
set DATOS_DEPLOY=-DaltDeploymentRepository=LocalGISIII::default::%REPOSITORY_MAVEN%
set PROFILE=-P manage_geopista_license
GOTO CONTINUE
...
echo. >>%PATH_LIB_LOCALGIS%		
echo GOTO OK >>%PATH_LIB_LOCALGIS%		
echo :ERROR >>%PATH_LIB_LOCALGIS%		
echo echo Error al realizar el despliegue >>%PATH_LIB_LOCALGIS%		
echo GOTO END >>%PATH_LIB_LOCALGIS%		
echo :OK >>%PATH_LIB_LOCALGIS%		
echo echo Despliegue finalizado >>%PATH_LIB_LOCALGIS%		
echo :END >>%PATH_LIB_LOCALGIS%		
