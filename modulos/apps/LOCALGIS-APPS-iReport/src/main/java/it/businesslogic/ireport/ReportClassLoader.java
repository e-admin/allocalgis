...
//		}
//		
//		ByteArrayOutputStream resourcesBaos = new ByteArrayOutputStream();
//		
//		try {
//			byte[] buffer = new byte[2048];
//			int numBytes = resourceInputStream.read(buffer, 0, 2048);
//			while (numBytes != -1){
//				resourcesBaos.write(buffer, 0, numBytes);
//				numBytes = resourceInputStream.read(buffer, 0, 2048);
//			}
//
//			return resourcesBaos.toByteArray();
//		} catch (IOException e){
//			return null;
//		}
//		
...
//		
//		try {
//			Enumeration resources = this.getSystemResources(name);
//			return resources;
//		}
//		catch (IOException e){
//			return null;
