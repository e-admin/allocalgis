/**
 * GeopistaGeneradorListadosUnionesTablas.java
...
//          objetoUniones2.setCampos("domainnodes.parentdomain=domains.id");
        ...
        //Primer Paso recuperar Datos del BlackBoard Panel 1 y poner:
          ...
          baseDatos.setAttribute("connInfo","jdbc:postgresql://" + aplicacion.getString(UserPreferenceConstants.LOCALGIS_SERVER_HOST) + ":5432/geopista");
