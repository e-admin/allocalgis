/**
 * PlaneamientoUrbanoEIELTableModel.java
...
public class PlaneamientoUrbanoEIELTableModel  extends EIELTableModel {
    ...
    public PlaneamientoUrbanoEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 0: 
        //	return ((PlaneamientoUrbanoEIEL)lstElementos.get(row)).getCodINEProvincia();
        case 1: 
        	return ((PlaneamientoUrbanoEIEL)lstElementos.get(row)).getCodINEMunicipio();
        case 2: 
            return ((PlaneamientoUrbanoEIEL)lstElementos.get(row)).getTipo();
        default: 
            return null;
