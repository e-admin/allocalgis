...
/* CONSTRUCTORES */    
    ...
    public PuntosVertidoDialog(PuntosVertidoEIEL elemento, boolean isEditable){
        ...
        EdicionUtils.enablePanel(getPuntosVertidoNucleosPanel(), true);
        getPuntosVertidoNucleosPanel().getJTableListaNucleos().setEnabled(true);
        if(elemento!=null){
        	EdicionUtils.enablePanel(getPuntosVertidoPanel().getJPanelDatosIdentificacion(), false);
        	EdicionUtils.enablePanel(getPuntosVertidoNucleosPanel().getJPanelIdentPuntosVertido(), false);
        }
        
        
        
        getPuntosVertidoPanel().getJTextFieldClave().setEnabled(false);
        getPuntosVertidoPanel().getJComboBoxProvincia().setEnabled(true);
        getPuntosVertidoPanel().getJComboBoxMunicipio().setEnabled(true);
