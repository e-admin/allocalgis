/**
 * InstalacionesDeportivasEIELTableModel.java
...
public class InstalacionesDeportivasEIELTableModel  extends EIELTableModel {
    ...
    public InstalacionesDeportivasEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 1: 
        //    return ((InstalacionesDeportivasEIEL)lstElementos.get(row)).getCodINEProvincia();
        case 2: 
