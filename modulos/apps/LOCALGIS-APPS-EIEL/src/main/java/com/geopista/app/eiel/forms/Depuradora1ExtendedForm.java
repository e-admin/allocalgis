...
public class Depuradora1ExtendedForm implements FeatureExtendedForm
{
    
    public Depuradora1ExtendedForm()
    {
    ...
    public void initialize(FeatureDialogHome fd)
    {
        ...
        {  
            ...
            Identificadores.put ("ID_Depuradora1", ID);  
            
            EdicionOperations operations = new EdicionOperations();
            Identificadores.put("depuradora1", operations.getDepuradora1EIEL(ID));
