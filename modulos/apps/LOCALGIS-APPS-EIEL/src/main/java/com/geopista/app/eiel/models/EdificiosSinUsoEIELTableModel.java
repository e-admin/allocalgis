/**
 * EdificiosSinUsoEIELTableModel.java
...
public class EdificiosSinUsoEIELTableModel  extends EIELTableModel {
    ...
    public EdificiosSinUsoEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 1: 
        //	return ((EdificiosSinUsoEIEL)lstElementos.get(row)).getCodINEProvincia();
        case 2: 
