/**
 * RecogidaBasurasPanelExtendedForm.java
    ...
    public void execute() throws Exception 
    {
    	if (recogidabasurasPanel != null) {
    		if (recogidabasurasPanel.datosMinimosYCorrectos()){
    			...
    			InitEIEL.clienteLocalGISEIEL.insertarElemento(recogidabasurasPanel.getRecogidaBasuras(recogidaBasura), idLayer, ConstantesLocalGISEIEL.RECOGIDA_BASURAS);
