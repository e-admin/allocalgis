/**
 * CabildoConsejoVersionadoCompletoEIELTableModel.java
...
public class CabildoConsejoVersionadoCompletoEIELTableModel  extends DefaultTableModel {
    ...
    public CabildoConsejoVersionadoCompletoEIELTableModel() {        
    ...
    public CabildoConsejoEIEL getValueAt(int row) {
    	...
    	Object[] fila = (Object[]) lstElementos.get(row);
    	CabildoConsejoEIEL obj = new CabildoConsejoEIEL();
		...
		obj.setCodIsla((String) fila[5]); 
		obj.setDenominacion((String) fila[6]);
		obj.setBloqueado((String) fila[7]);
