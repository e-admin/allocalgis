...
public abstract class NucleosEIELTableModel extends DefaultTableModel{
	...
	/**
	 * Gestionamos tambien que puede ser de otro municipio
	 * @param codMunicipio
	 * @param codentidad
	 * @param codnucleo
	 * @return
	 */
	public String getNombreNucleoExtended(String codMunicipio,String codentidad,String codnucleo){
