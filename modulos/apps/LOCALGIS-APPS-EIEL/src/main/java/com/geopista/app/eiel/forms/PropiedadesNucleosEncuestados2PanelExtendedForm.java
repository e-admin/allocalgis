/**
 * PropiedadesNucleosEncuestados2PanelExtendedForm.java
    ...
    public void execute() throws Exception 
    {
    	if (encuestados2panel != null) {
    		if (encuestados2panel.datosMinimosYCorrectos()){
    			...
    			InitEIEL.clienteLocalGISEIEL.insertarElemento(encuestados2panel.getEncuestados2(encuestado2), idLayer, ConstantesLocalGISEIEL.ENCUESTADOS2);
