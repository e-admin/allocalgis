/**
 * TramosConduccionEIELTableModel.java
...
public class TramosConduccionEIELTableModel  extends EIELTableModel {
    ...
    public TramosConduccionEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 1: 
        //    return ((TramosConduccionEIEL)lstElementos.get(row)).getCodINEProvincia();
        case 2: 
