...
public class EdificiosSinUsoPanel extends InventarioPanel implements FeatureExtendedPanel
{
    ...
    private ComboBoxEstructuras jComboBoxUsoAnt = null;
    private JTextField jTextFieldObservacion = null;
    private JTextField jTextFieldInst_P = null;
    ...
    private JLabel jLabelUsoAnt = null;    
     ...
     * 
     */
    public EdificiosSinUsoPanel()
    {
        super();
        initialize();
    }
    
    public EdificiosSinUsoPanel(EdificiosSinUsoEIEL pers)
    {
        super();
        initialize();
        loadData (pers);
    ...
    public void loadData(EdificiosSinUsoEIEL elemento)
    {
        if (elemento!=null)
        {
            ...
            if (elemento.getUsoAnterior() != null){            	
            	jComboBoxUsoAnt.setSelectedPatron(elemento.getUsoAnterior());
            }
            else{
            	jComboBoxUsoAnt.setSelectedIndex(0);
            } 
            ...
            if (elemento.getInst_pertenece() != null){            	
            	jTextFieldInst_P.setText(elemento.getInst_pertenece());
            }
            else{
        	...
        	jTextFieldClave.setText(ConstantesLocalGISEIEL.EDIFICIOSSINUSO_CLAVE);
    ...
    public void loadData()
    {
    	...
    	Object object = AppContext.getApplicationContext().getBlackboard().get("edificiossinuso_panel");    	
    	if (object != null && object instanceof EdificiosSinUsoEIEL){    		
    		EdificiosSinUsoEIEL elemento = (EdificiosSinUsoEIEL)object;
            //Datos identificacion   
        	if (elemento.getClave() != null){
        		jTextFieldClave.setText(elemento.getClave());
        	}
    ...
    public EdificiosSinUsoEIEL getEdificiosSinUso (EdificiosSinUsoEIEL elemento)
    {
        ...
        if (okPressed)
        {
            if(elemento==null)
            {
            	elemento = new EdificiosSinUsoEIEL();
            }
            ...
            if (jComboBoxUsoAnt.getSelectedPatron()!=null)
            	elemento.setUsoAnterior((String) jComboBoxUsoAnt.getSelectedPatron());
            else elemento.setUsoAnterior("");
            ...
            if (jTextFieldInst_P.getText()!=null){
            	elemento.setInst_pertenece(jTextFieldInst_P.getText());
            }
    ...
    {      
        ...
        this.setName(I18N.get("LocalGISEIEL","localgiseiel.edificiossinuso.panel.title"));
        
        this.setLayout(new GridBagLayout());
        this.setSize(EdificiosSinUsoDialog.DIM_X,EdificiosSinUsoDialog.DIM_Y);
...
//		     	jComboBoxEntidad.setEditable(true);
    ...
    private ComboBoxEstructuras getJComboBoxUsoAnt()
    { 
        if (jComboBoxUsoAnt == null)
        {
            Estructuras.cargarEstructura("eiel_uso_anterior");
            jComboBoxUsoAnt = new ComboBoxEstructuras(Estructuras.getListaTipos(),
                    null, aplicacion.getString(UserPreferenceConstants.DEFAULT_LOCALE_KEY,"es_ES"), false);
        
            jComboBoxUsoAnt.setPreferredSize(new Dimension(100, 20));
        }
        return jComboBoxUsoAnt;        
    }
    ...
    public EdificiosSinUsoPanel(GridBagLayout layout)
    {
        super(layout);
        initialize();
    }
    ...
    private JPanel getJPanelDatosInformacion()
    {
        ...
        {   
        	...
        	jLabelUsoAnt = new JLabel("", JLabel.CENTER);
        	jLabelUsoAnt.setText(I18N.get("LocalGISEIEL", "localgiseiel.panels.label.usoAnt"));
           ...
           jPanelInformacion.add(jLabelTitular,
            ...
            jPanelInformacion.add(jLabelUsoAnt,
                    new GridBagConstraints(2, 4, 1, 1, 0.1, 0.1,
                            GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            
            jPanelInformacion.add(getJComboBoxUsoAnt(), 
            ...
            jPanelInformacion.add(jLabelInst_P,
                    new GridBagConstraints(2, 5, 1, 1, 0.1, 0.1,
                            GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            
            jPanelInformacion.add(getjTextFieldInst_P(), 
	...
	public void loadDataIdentificacion(){
		...
		if (obj != null && obj instanceof FeatureDialog){
			...
			Feature feature = featureDialog.get_fieldPanel().getModifiedFeature();
	        	...
	        	if (feature.getAttribute(esquema.getAttributeByColumn("orden_su"))!=null){
	        		orden_su=(feature.getAttribute(esquema.getAttributeByColumn("orden_su"))).toString();
	        	}
	        	
	        	EdicionOperations operations = new EdicionOperations();
	        	loadData(operations.getPanelEdificiosSinUsoIEL(clave, codprov, codmunic, entidad, nucleo, orden_su));
	        	
	        	loadDataIdentificacion(clave, codprov, codmunic, entidad, nucleo, orden_su);       	
			}
		}
	...
	public void loadDataIdentificacion(String clave, String codprov,
			String codmunic, String entidad, String nucleo, String orden_su) {
        ...
        if (orden_su != null){
    		jTextFieldOrden.setText(orden_su);
    	}
    	else{
    		jTextFieldOrden.setText("");
    	}
