/**
 * ServiciosAbastecimientosEIELTableModel.java
...
public class ServiciosAbastecimientosEIELTableModel  extends EIELTableModel {
    ...
    public ServiciosAbastecimientosEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 0: 
        //    return ((ServiciosAbastecimientosEIEL)lstElementos.get(row)).getCodINEProvincia();
        case 1: 
