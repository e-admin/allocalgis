/**
 * UsosCentrosCulturalesCompletoEIELTableModel.java
...
public class UsosCentrosCulturalesCompletoEIELTableModel  extends DefaultTableModel {
    ...
    public UsosCentrosCulturalesCompletoEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        case 1: 
            return ((UsosCentrosCulturales) lstElementos.get(row)).getSuperficieUso() != null ? ((UsosCentrosCulturales) lstElementos
                    .get(row)).getSuperficieUso().toString()
                    : "";
        case 2: 
            return ((UsosCentrosCulturales)lstElementos.get(row)).getFechaUso() != null ? ((UsosCentrosCulturales) lstElementos
                    .get(row)).getFechaUso().toString()
                    : "";
        case 3: 
            return ((UsosCentrosCulturales)lstElementos.get(row)).getObservacionesUso();
        case 4: 
