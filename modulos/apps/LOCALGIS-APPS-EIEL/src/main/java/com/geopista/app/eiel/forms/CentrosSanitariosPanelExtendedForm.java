/**
 * CentrosSanitariosPanelExtendedForm.java
    ...
    public void execute() throws Exception 
    {
    	if (centrosSanitariosPanel != null) {
    		if (centrosSanitariosPanel.datosMinimosYCorrectos()){
    			...
    			InitEIEL.clienteLocalGISEIEL.insertarElemento(centrosSanitariosPanel.getCentrosSanitarios(centroSanitario), idLayer, ConstantesLocalGISEIEL.CENTROS_SANITARIOS);
