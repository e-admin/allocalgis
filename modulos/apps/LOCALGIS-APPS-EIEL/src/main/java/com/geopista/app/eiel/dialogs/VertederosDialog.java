...
public class VertederosDialog extends JDialog
{
    ...
    public VertederosDialog(VertederosEIEL elemento, boolean isEditable)
    {
        ...
        EdicionUtils.enablePanel(getVertederosPanel(), true);
             
        getVertederosNucleosPanel().getJTableListaNucleos().setEnabled(true);
        
        
        getVertederosPanel().getjTextFieldClave().setEnabled(false);
        getVertederosPanel().getJComboBoxProvincia().setEnabled(true);
        getVertederosPanel().getJComboBoxMunicipio().setEnabled(true);
        if (!isEditable){
    ...
    private JTabbedPane getTabbedPane() {
		if (this.tabbedPane == null){
			...
			scroll.setViewportView(getVertederosNucleosPanel());
    ...
    private void onTabbedPageChange(ChangeEvent e) {
        ...
        if (sel == 1){
        	this.getVertederosNucleosPanel().tabbedChanged(getVertederosPanel().getVertederosData());
        }
	}
	...
	public VertederoNucleosPanel getVertederosNucleosPanel(){
