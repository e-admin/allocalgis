/**
 * CasasConsistorialesVersionadoCompletoEIELTableModel.java
...
public class CasasConsistorialesVersionadoCompletoEIELTableModel  extends DefaultTableModel {
    ...
    public CasasConsistorialesVersionadoCompletoEIELTableModel() {        
    ...
    public CasasConsistorialesEIEL getValueAt(int row) {
    	...
    	Object[] fila = (Object[]) lstElementos.get(row);
    	CasasConsistorialesEIEL obj = new CasasConsistorialesEIEL();
		...
		obj.setTenencia((String) fila[13]); 
