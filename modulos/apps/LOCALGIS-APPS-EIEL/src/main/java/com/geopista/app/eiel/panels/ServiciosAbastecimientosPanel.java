/**
 * ServiciosAbastecimientosPanel.java
...
//	            			System.out.println("PASO1");
    ...
    private JTextField getjTextFieldConsumoIn(){
    	if (jTextFieldConsumoIn == null){
    		...
    		jTextFieldConsumoIn.setEnabled(false);
    		jTextFieldConsumoIn.setEditable(false);
    	}
    ...
    private JTextField getjTextFieldConsumoVe(){
    	if (jTextFieldConsumoVe == null){
    		...
    		jTextFieldConsumoVe.setEnabled(false);
    		jTextFieldConsumoVe.setEditable(false);
    	}
