/**
 * CentrosEnsenianzaEIELTableModel.java
...
public class CentrosEnsenianzaEIELTableModel  extends EIELTableModel {
    ...
    public CentrosEnsenianzaEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 1: 
        //    return ((CentrosEnsenianzaEIEL)lstElementos.get(row)).getCodINEProvincia();
        case 2: 
