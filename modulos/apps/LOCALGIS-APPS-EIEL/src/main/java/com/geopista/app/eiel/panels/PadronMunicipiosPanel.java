...
public class PadronMunicipiosPanel extends JPanel implements FeatureExtendedPanel
{
     ...
     * 
     */
    public PadronMunicipiosPanel()
    {
        super();
        initialize();
    }
    
    public PadronMunicipiosPanel(PadronMunicipiosEIEL pers)
    {
        super();
        initialize();
        loadData (pers);
    ...
    public void loadData(PadronMunicipiosEIEL elemento)
    {
        if (elemento!=null)
        {
    ...
    public void loadData()
    {
    	...
    	Object object = AppContext.getApplicationContext().getBlackboard().get("padronmunicipios_panel");    	
    	if (object != null && object instanceof PadronMunicipiosEIEL){    		
    		PadronMunicipiosEIEL elemento = (PadronMunicipiosEIEL)object;
            //Datos identificacion        	            
    		if (elemento.getCodINEProvincia() != null) {
				jComboBoxProvincia
						.setSelectedIndex(provinciaIndexSeleccionar(elemento
    ...
    public PadronMunicipiosEIEL getPadronMunicipios (PadronMunicipiosEIEL elemento)
    {
        ...
        if (okPressed)
        {
            if(elemento==null)
            {
            	elemento = new PadronMunicipiosEIEL();
            }
    ...
    {      
        ...
        this.setName(I18N.get("LocalGISEIEL","localgiseiel.padronmunicipios.panel.title"));
        
        this.setLayout(new GridBagLayout());
        this.setSize(PadronMunicipiosDialog.DIM_X,PadronMunicipiosDialog.DIM_Y);
    ...
    private JTextField getjTextFieldFecha_a1()
    {
        ...
        {
            jTextFieldFecha_a1 = new TextField(4);
            jTextFieldFecha_a1.addCaretListener(new CaretListener()
            {
                public void caretUpdate(CaretEvent evt)
                {
                    EdicionUtils.chequeaLongYCharCampoEdit(jTextFieldFecha_a1, 4, aplicacion.getMainFrame());
                }
            });
        }
    ...
    private JTextField getjTextFieldFecha_a2()
    {
        ...
        {
            jTextFieldFecha_a2 = new TextField(4);
            jTextFieldFecha_a2.addCaretListener(new CaretListener()
            {
                public void caretUpdate(CaretEvent evt)
                {
                    EdicionUtils.chequeaLongYCharCampoEdit(jTextFieldFecha_a2, 4, aplicacion.getMainFrame());
                }
            });
        }
    ...
    public PadronMunicipiosPanel(GridBagLayout layout)
    {
        super(layout);
        initialize();
    }
	...
	public void loadDataIdentificacion(){
		...
		if (obj != null && obj instanceof FeatureDialog){
			...
			Feature feature = featureDialog.get_fieldPanel().getModifiedFeature();
	        	...
	        	loadData(operations.getPanelPadronMunicipiosEIEL(codprov, codmunic));
