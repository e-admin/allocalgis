/**
 * InstalacionesDeportivasVersionadoCompletoEIELTableModel.java
...
public class InstalacionesDeportivasVersionadoCompletoEIELTableModel extends DefaultTableModel {
    ...
    public InstalacionesDeportivasVersionadoCompletoEIELTableModel() {
    ...
    public InstalacionesDeportivasEIEL getValueAt(int row) {
    	...
    	Object[] fila = (Object[]) lstElementos.get(row);
    	InstalacionesDeportivasEIEL obj = new InstalacionesDeportivasEIEL();
		...
		obj.setOrdenIdDeportes((String) fila[9]);
		...
		obj.setInst_P((String) fila[25]);
		obj.setListaTipos( (ArrayList) fila[26]);
