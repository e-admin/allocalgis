/**
 * EntidadesSingularesVersionadoCompletoEIELTableModel.java
...
public class EntidadesSingularesVersionadoCompletoEIELTableModel  extends DefaultTableModel {
    ...
    public EntidadesSingularesVersionadoCompletoEIELTableModel() {        
    ...
    public EntidadesSingularesEIEL getValueAt(int row) {
    	Object[] fila = (Object[]) lstElementos.get(row);
    	EntidadesSingularesEIEL obj = new EntidadesSingularesEIEL();
		...
		obj.setFechaRevision((Date) fila[8]); 
		obj.setObservaciones((String) fila[9]);
		obj.setEstadoRevision((Integer) fila[10]); 
