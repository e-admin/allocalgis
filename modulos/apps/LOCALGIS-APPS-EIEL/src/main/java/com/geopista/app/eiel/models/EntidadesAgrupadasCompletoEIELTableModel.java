/**
 * EntidadesAgrupadasCompletoEIELTableModel.java
...
public class EntidadesAgrupadasCompletoEIELTableModel extends EIELTableModel  {
    ...
    public Object getValueAt(int row, int col) {
        ...
        case 2: 
            return getNombreNucleo( ((EntidadesAgrupadasEIEL)lstElementos.get(row)).getCodEntidad(),((EntidadesAgrupadasEIEL)lstElementos.get(row)).getCodNucleo()); 
        case 3:
        ...
        case 4: 
            return getNombreNucleo( ((EntidadesAgrupadasEIEL)lstElementos.get(row)).getCodEntidad_agrupada(),((EntidadesAgrupadasEIEL)lstElementos.get(row)).getCodNucleo_agrupado()); 
        case 5: 
