...
public class DatosAlfaPanel extends javax.swing.JPanel {
    /**
	 * 
	 */
	...
	Logger logger= Logger.getLogger(DatosAlfaPanel.class);
     ...
     * @param locale
     */
    public DatosAlfaPanel( String locale, boolean showVersiones, boolean showSeleccionar) {
        this.locale= locale;
     ...
     * @param locale
     */
    public DatosAlfaPanel( String locale) {
