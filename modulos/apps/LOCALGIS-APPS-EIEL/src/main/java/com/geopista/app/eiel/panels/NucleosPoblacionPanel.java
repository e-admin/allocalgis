...
public class NucleosPoblacionPanel extends JPanel implements FeatureExtendedPanel
{
     ...
     * 
     */
    public NucleosPoblacionPanel()
    {
        super();
        initialize();
    }
    
    public NucleosPoblacionPanel(NucleosPoblacionEIEL pers)
    {
        super();
        initialize();
        loadData (pers);
    ...
    public void loadData(NucleosPoblacionEIEL elemento)
    {
        if (elemento!=null)
        {
            ...
            if (elemento.getEstadoActualizacion()!= null){
                jComboBoxEstado.setSelectedPatron(elemento.getEstadoActualizacion().toString());
            }
            else{
    ...
    public void loadData()
    {
    	...
    	Object object = AppContext.getApplicationContext().getBlackboard().get("nucleospoblacion_panel");    	
    	if (object != null && object instanceof NucleosPoblacionEIEL){    		
    		NucleosPoblacionEIEL elemento = (NucleosPoblacionEIEL)object;
    		//Datos identificacion        	            
    		if (elemento.getCodINEProvincia() != null) {
    ...
    public NucleosPoblacionEIEL getNucleosPoblacion (NucleosPoblacionEIEL elemento)
    {
        ...
        if (okPressed)
        {
            if(elemento==null)
            {
            	elemento = new NucleosPoblacionEIEL();
            }
            ...
            if (jComboBoxEstado.getSelectedPatron()!=null)
                elemento.setEstadoActualizacion(Integer.parseInt(jComboBoxEstado.getSelectedPatron()));         
    ...
    {      
        ...
        this.setName(I18N.get("LocalGISEIEL","localgiseiel.nucelospoblacion.panel.title"));
        
        this.setLayout(new GridBagLayout());
        this.setSize(NucleosPoblacionDialog.DIM_X,NucleosPoblacionDialog.DIM_Y);
...
//	            			System.out.println("PASO1");
    ...
    public NucleosPoblacionPanel(GridBagLayout layout)
    {
        super(layout);
        initialize();
    }
	...
	public void loadDataIdentificacion(){
		...
		if (obj != null && obj instanceof FeatureDialog){
			...
			Feature feature = featureDialog.get_fieldPanel().getModifiedFeature();
	        	...
	        	loadData(operations.getPanelNucleosPoblacionEIEL(codprov, codmunic, entidad, nucleo));
