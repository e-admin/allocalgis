/**
 * NucleosCaptacionEIELTableModel.java
...
public class NucleosCaptacionEIELTableModel  extends NucleosEIELTableModel {
    ...
    public Object getValueAt(int row, int col) {
        ...
        case 2: 
            //return getNombreNucleo( ((NucleoCaptacion)lstElementos.get(row)).getCodEntNucleo(),((NucleoCaptacion)lstElementos.get(row)).getCodPoblNucleo());
            return getNombreNucleoExtended( ((NucleoCaptacion)lstElementos.get(row)).getCodMunicNucleo(),((NucleoCaptacion)lstElementos.get(row)).getCodEntNucleo(),((NucleoCaptacion)lstElementos.get(row)).getCodPoblNucleo());
