/**
 * Encuestados2EIELTableModel.java
...
public class Encuestados2EIELTableModel  extends EIELTableModel {
    ...
    public Encuestados2EIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 1: 
        //    return ((Encuestados2EIEL)lstElementos.get(row)).getCodINEProvincia();
        case 1: 
        ...
        case 4: 
            return ((Encuestados2EIEL)lstElementos.get(row)).getDisponibilidadCaudal();
        default: 
            return null;
