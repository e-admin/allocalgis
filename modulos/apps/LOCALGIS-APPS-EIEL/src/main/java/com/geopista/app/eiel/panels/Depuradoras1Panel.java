...
public class Depuradoras1Panel extends InventarioPanel implements FeatureExtendedPanel
{
    ...
    public void loadData()
    {
    	...
    	if (object != null && object instanceof Depuradora1EIEL){    		
        	...
        	//Inicializo a no existe los dominios
    		jComboBoxTratPr1.setSelectedPatron("NO");
    		jComboBoxTratPr2.setSelectedPatron("NO");
    		jComboBoxTratPr3.setSelectedPatron("NO");
    		jComboBoxTratAv1.setSelectedPatron("NO");
    		jComboBoxTratAv2.setSelectedPatron("NO");
    		jComboBoxTratAv3.setSelectedPatron("NO");
    		jComboBoxTratSc1.setSelectedPatron("NO");
    		jComboBoxTratSc2.setSelectedPatron("NO");
    		jComboBoxTratSc3.setSelectedPatron("NO");
    		jComboBoxTratLd1.setSelectedPatron("NO");
    		jComboBoxTratLd2.setSelectedPatron("NO");
    		jComboBoxTratLd3.setSelectedPatron("NO");
    		jComboBoxProcCm1.setSelectedPatron("NO");
    		jComboBoxProcCm2.setSelectedPatron("NO");
    		jComboBoxProcCm3.setSelectedPatron("NO");
        }
    }
