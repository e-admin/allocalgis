...
public class DepositosDialog extends JDialog{
	...
	public DepositosDialog(DepositosEIEL elemento, boolean isEditable){
        ...
        if (getDepositosPanel().getJComboBoxEpigInventario().isEnabled())    	
        	...
        	EdicionUtils.enablePanel(getDepositosPanel(), isEditable);
          	EdicionUtils.enablePanel(getDepositosNucleosPanel(), true);
          	getDepositosNucleosPanel().getJTableListaNucleos().setEnabled(true);
        ...
        if(elemento!=null){
        	...
        	EdicionUtils.enablePanel(getDepositosNucleosPanel().getJPanelIdentDepositos(), false);
        }
        ...
        getDepositosPanel().getJComboBoxProvincia().setEnabled(true);
        getDepositosPanel().getJComboBoxMunicipio().setEnabled(true);
