/**
 * PropiedadesNucleosEncuestados1PanelExtendedForm.java
    ...
    public void execute() throws Exception 
    {
    	if (encuestados1Panel != null) {
    		if (encuestados1Panel.datosMinimosYCorrectos()){
    			...
    			InitEIEL.clienteLocalGISEIEL.insertarElemento(encuestados1Panel.getEncuestados1(encuestado1), idLayer, ConstantesLocalGISEIEL.ENCUESTADOS1);
