/**
 * CentrosAsistencialesPanel.java
...
public class CentrosAsistencialesPanel extends InventarioPanel implements FeatureExtendedPanel
{
	...
	private JLabel jLabelPlazas = null;
	private JLabel jLabelSCubi = null;
	...
	private JTextField jTextFieldPlazas = null;
	private JTextField jTextFieldSCubi = null;
    ...
    public CentrosAsistencialesPanel(){
        super();
        initialize();
    }
  
    public CentrosAsistencialesPanel(CentrosAsistencialesEIEL dato){
        super();
        initialize();
        loadData (dato);
    }
    
    public void loadData(CentrosAsistencialesEIEL elemento){
        if (elemento!=null){
            ...
            if (elemento.getOrdenAsistencial() != null){
        		jTextFieldOrden.setText(elemento.getOrdenAsistencial().toString());
        	}
        	else{
            ...
            if (elemento.getPlazas() != null){
        		jTextFieldPlazas.setText(elemento.getPlazas().toString());
        	}
        	else{
        		jTextFieldPlazas.setText("");
        	}
            if (elemento.getSuperficieCubierta() != null){
        		jTextFieldSCubi.setText(elemento.getSuperficieCubierta().toString());
        	}
        	else{
        		jTextFieldSCubi.setText("");
        	}
        	...
        	jTextFieldClave.setText(ConstantesLocalGISEIEL.CENTROSASISTENCIALES_CLAVE);
    ...
    public void loadData(){
    	...
    	Object object = AppContext.getApplicationContext().getBlackboard().get("centrosasistenciales_panel");    	
    	if (object != null && object instanceof CentrosAsistencialesEIEL){    		
    		CentrosAsistencialesEIEL elemento = (CentrosAsistencialesEIEL)object;
    ...
    public CentrosAsistencialesEIEL getCentrosAsistenciales (CentrosAsistencialesEIEL elemento){
        if (okPressed){
            if(elemento==null){
            	elemento = new CentrosAsistencialesEIEL();
            }
            ...
            elemento.setOrdenAsistencial(jTextFieldOrden.getText());
            elemento.setIdMunicipio(Integer.parseInt(ConstantesLocalGISEIEL.idMunicipio));
            /* JTEXT - Integer */
            if (jTextFieldPlazas.getText()!=null && !jTextFieldPlazas.getText().equals("")){
            	elemento.setPlazas(new Integer(jTextFieldPlazas.getText()));
            } else if (jTextFieldPlazas.getText().equals("")){
            	elemento.setPlazas(new Integer(0));
            }
            if (jTextFieldSCubi.getText()!=null && !jTextFieldSCubi.getText().equals("")){
            	elemento.setSuperficieCubierta(new Integer(jTextFieldSCubi.getText()));
            } else if (jTextFieldSCubi.getText().equals("")){
            ...
            if (jTextFieldFechaInst.getDate()!=null && !jTextFieldFechaInst.getDate().toString().equals("")){
            	...
            	elemento.setFechaIstalacion(new Date(fecha.getYear(),fecha.getMonth(), fecha.getDate()));
            } else{
            	elemento.setFechaIstalacion(null);
            }
    ...
    private void initialize(){      
        ...
        this.setName(I18N.get("LocalGISEIEL","localgiseiel.centrosasistenciales.panel.title"));
        
        this.setLayout(new GridBagLayout());
        this.setSize(CentrosAsistencialesDialog.DIM_X,CentrosAsistencialesDialog.DIM_Y);
...
//		     	jComboBoxEntidad.setEditable(true);
    ...
    private JTextField getjTextFieldPlazas(){
    	if (jTextFieldPlazas == null){
    		jTextFieldPlazas = new TextField(10);
    		jTextFieldPlazas.addCaretListener(new CaretListener(){
    			public void caretUpdate(CaretEvent evt){
    				EdicionUtils.chequeaLongYCharCampoEdit(jTextFieldPlazas,10, aplicacion.getMainFrame());
    			}
    		});
    	}
    ...
    private JTextField getjTextFieldSCubi(){
    	if (jTextFieldSCubi == null){
    		jTextFieldSCubi = new TextField(10);
    		jTextFieldSCubi.addCaretListener(new CaretListener(){
    			public void caretUpdate(CaretEvent evt){
    				EdicionUtils.chequeaLongYCharCampoEdit(jTextFieldSCubi,10, aplicacion.getMainFrame());
    			}
    		});
    	}
    	return jTextFieldSCubi;
    }
    ...
    public CentrosAsistencialesPanel(GridBagLayout layout){
        super(layout);
        initialize();
    }
    ...
    private JPanel getJPanelDatosInformacion(){
        if (jPanelInformacion == null){   
            ...
            jLabelPlazas = new JLabel("", JLabel.CENTER); 
            jLabelPlazas.setText(I18N.get("LocalGISEIEL", "localgiseiel.panels.label.plazas"));
            jLabelSCubi = new JLabel("", JLabel.CENTER); 
            jLabelSCubi.setText(I18N.get("LocalGISEIEL", "localgiseiel.panels.label.s_cubierta_id"));
            ...
            jLabelEst.setText(I18N.get("LocalGISEIEL", "localgiseiel.panels.label.estado_id"));
            ...
            jPanelInformacion.add(getJComboBoxGestor(), 
                    new GridBagConstraints(3, 1, 1, 1, 0.1, 0.1,
                            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            jPanelInformacion.add(jLabelPlazas,
                    new GridBagConstraints(0, 2, 1, 1, 0.1, 0.1,
                            GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            jPanelInformacion.add(getjTextFieldPlazas(), 
                    new GridBagConstraints(1, 2, 1, 1, 0.1, 0.1,
                            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            jPanelInformacion.add(jLabelSCubi,
                    new GridBagConstraints(2, 2, 1, 1, 0.1, 0.1,
                            GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            jPanelInformacion.add(getjTextFieldSCubi(), 
                    new GridBagConstraints(3, 2, 1, 1, 0.1, 0.1,
                            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
	...
	public void loadDataIdentificacion(){
		...
		if (obj != null && obj instanceof FeatureDialog){
        	...
        	if (feature.getAttribute(esquema.getAttributeByColumn("orden_as"))!=null){
        		orden_as=(feature.getAttribute(esquema.getAttributeByColumn("orden_as"))).toString();
        	}
        	
        	EdicionOperations operations = new EdicionOperations();
        	loadData(operations.getPanelCentrosAsistencialesEIEL(clave, codprov, codmunic, entidad, nucleo, orden_as));
        	
        	loadDataIdentificacion(clave, codprov, codmunic, entidad, nucleo, orden_as);
		}
		
	}

	public void loadDataIdentificacion(String clave, String codprov,
			String codmunic, String entidad, String nucleo, String orden_as) {
        ...
        if (orden_as != null){
    		jTextFieldOrden.setText(orden_as);
    	}
    	else{
    		jTextFieldOrden.setText("");
    	}
