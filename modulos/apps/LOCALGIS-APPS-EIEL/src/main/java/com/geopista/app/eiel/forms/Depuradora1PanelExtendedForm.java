/**
 * Depuradora1PanelExtendedForm.java
    ...
    public void execute() throws Exception 
    {
    	if (depuradorasPanel != null) {
    		if (depuradorasPanel.datosMinimosYCorrectos()){
    			...
    			InitEIEL.clienteLocalGISEIEL.insertarElemento(depuradorasPanel.getDepuradora1(depuradora1), idLayer, ConstantesLocalGISEIEL.DEPURADORAS1);
