/**
 * CentrosCulturalesPanelExtendedForm.java
    ...
    public void execute() throws Exception 
    {
    	if (centrosCulturalesPanel != null) {
    		if (centrosCulturalesPanel.datosMinimosYCorrectos()){
    			...
    			InitEIEL.clienteLocalGISEIEL.insertarElemento(centrosCulturalesPanel.getCentroCultural(centros), idLayer, ConstantesLocalGISEIEL.CENTROS_CULTURALES);
