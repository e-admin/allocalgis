/**
 * ServiciosRecogidaBasurasPanel.java
...
public class ServiciosRecogidaBasurasPanel extends JPanel implements FeatureExtendedPanel
{
    ...
    private JTextField jTextFieldPobResA = null;
    private JTextField jTextFieldPobEsA = null;
    private ComboBoxEstructuras jComboBoxServ = null;
    private JTextField jTextFieldPlantll = null;
    private JTextField jTextFieldObservacion = null;
    
    private JLabel jLabelVivien = null;
    private JLabel jLabelPobResA = null;
    private JLabel jLabelPobEsA = null;
    private JLabel jLabelServ = null;
    private JLabel jLabelPlantll = null;
     ...
     * 
     */
    public ServiciosRecogidaBasurasPanel()
    {
        super();
        initialize();
    }
    
    public ServiciosRecogidaBasurasPanel(ServiciosRecogidaBasuraEIEL pers)
    {
        super();
        initialize();
        loadData (pers);
    ...
    public void loadData(ServiciosRecogidaBasuraEIEL elemento)
    {
        if (elemento!=null)
        {
           ...
           if (elemento.getVivSinServicio() != null){            	
            	jTextFieldVivien.setText(elemento.getVivSinServicio().toString());
            }
            else{
            	jTextFieldVivien.setText("");
            } 
            
           if (elemento.getPoblResSinServicio() != null){            	
           	jTextFieldPobResA.setText(elemento.getPoblResSinServicio().toString());
           }
           else{
        	   jTextFieldPobResA.setText("");
           } 
           
            if (elemento.getPoblEstSinServicio()!= null){            	
            	jTextFieldPobEsA.setText(elemento.getPoblEstSinServicio().toString());
            }
            else{
            	jTextFieldPobEsA.setText("");
            } 
            
            if (elemento.getServLimpCalles()!= null){            	
            	jComboBoxServ.setSelectedPatron(elemento.getServLimpCalles());
            }
            else{
                jComboBoxServ.setSelectedIndex(0);
            }            
            
            if (elemento.getPlantilla() != null){            	
            	jTextFieldPlantll.setText(elemento.getPlantilla().toString());
            }
            else{
            	jTextFieldPlantll.setText("");
            }
    ...
    {
    	Object object = AppContext.getApplicationContext().getBlackboard().get("serviciosrecogidabasura_panel");    	
    	if (object != null && object instanceof ServiciosRecogidaBasuraEIEL){    		
    		ServiciosRecogidaBasuraEIEL elemento = (ServiciosRecogidaBasuraEIEL)object;
            //Datos identificacion   
    		if (elemento.getCodINEProvincia() != null) {
    ...
    public ServiciosRecogidaBasuraEIEL getServiciosRecogidaBasuras (ServiciosRecogidaBasuraEIEL elemento)
    {
        ...
        if (okPressed)
        {
            if(elemento==null)
            {
            	elemento = new ServiciosRecogidaBasuraEIEL();
            }
            ...
            if (jTextFieldVivien.getText()!=null && !jTextFieldVivien.getText().equals("")){
            	elemento.setVivSinServicio(new Integer(jTextFieldVivien.getText()));
            }
            else{
            	elemento.setVivSinServicio(null);
            }
            
            if (jTextFieldPobResA.getText()!=null && !jTextFieldPobResA.getText().equals("")){
            	elemento.setPoblResSinServicio(new Integer(jTextFieldPobResA.getText()));
            }
            else{
            	elemento.setPoblResSinServicio(null);
            }
            
            if (jTextFieldPobEsA.getText()!=null && !jTextFieldPobEsA.getText().equals("")){
            	elemento.setPoblEstSinServicio(new Integer(jTextFieldPobEsA.getText()));
            }
            else{
            	elemento.setPoblEstSinServicio(null);
            }            
            
            if (jComboBoxServ.getSelectedPatron()!=null)
                elemento.setServLimpCalles((String)jComboBoxServ.getSelectedPatron());
            else elemento.setServLimpCalles("");
            
            if (jTextFieldPlantll.getText()!=null && !jTextFieldPlantll.getText().equals("")){
            	elemento.setPlantilla(new Integer(jTextFieldPlantll.getText()));
            }
            else{
            	elemento.setPlantilla(null);
            }
    ...
    {      
        ...
        this.setName(I18N.get("LocalGISEIEL","localgiseiel.serviciosrecogidabasura.panel.title"));
        
        this.setLayout(new GridBagLayout());
        this.setSize(ServiciosRecogidaBasurasDialog.DIM_X,ServiciosRecogidaBasurasDialog.DIM_Y);
...
//		     	jComboBoxEntidad.setEditable(true);
    ...
    private JTextField getjTextFieldPobResA()
    {
    	if (jTextFieldPobResA == null)
    	{
    		jTextFieldPobResA = new TextField(10);
    		jTextFieldPobResA.addCaretListener(new CaretListener()
    		{
    			public void caretUpdate(CaretEvent evt)
    			{
    				EdicionUtils.chequeaLongYCharCampoEdit(jTextFieldPobResA, 10, aplicacion.getMainFrame());
    			}
    		});
    	}
    	return jTextFieldPobResA;
    }
    
    
    private JTextField getjTextFieldPobEsA()
    {
    	if (jTextFieldPobEsA == null)
    	{
    		jTextFieldPobEsA = new TextField(10);
    		jTextFieldPobEsA.addCaretListener(new CaretListener()
    		{
    			public void caretUpdate(CaretEvent evt)
    			{
    				EdicionUtils.chequeaLongYCharCampoEdit(jTextFieldPobEsA, 10, aplicacion.getMainFrame());
    			}
    		});
    	}
    	return jTextFieldPobEsA;
    }
    
    private ComboBoxEstructuras getJComboBoxServ()
    { 
        if (jComboBoxServ == null)
        {
            Estructuras.cargarEstructura("eiel_Servicio de limpieza de calles");
            jComboBoxServ = new ComboBoxEstructuras(Estructuras.getListaTipos(),
                    null, aplicacion.getString(UserPreferenceConstants.DEFAULT_LOCALE_KEY,"es_ES"), false);
        
            jComboBoxServ.setPreferredSize(new Dimension(100, 20));
        }
        return jComboBoxServ;        
    }
    
    private JTextField getjTextFieldPlantll()
    {
    	if (jTextFieldPlantll == null)
    	{
    		jTextFieldPlantll = new TextField(10);
    		jTextFieldPlantll.addCaretListener(new CaretListener()
    		{
    			public void caretUpdate(CaretEvent evt)
    			{
    				EdicionUtils.chequeaLongYCharCampoEdit(jTextFieldPlantll, 10, aplicacion.getMainFrame());
    			}
    		});
    	}
    	return jTextFieldPlantll;
    }
    ...
    public ServiciosRecogidaBasurasPanel(GridBagLayout layout)
    {
        super(layout);
        initialize();
    }
    ...
    private JPanel getJPanelDatosInformacion()
    {
        ...
        {   
        	...
        	jLabelVivien.setText(I18N.get("LocalGISEIEL", "localgiseiel.panels.label.viviend")); 
            
        	jLabelPobResA = new JLabel("", JLabel.CENTER);
        	jLabelPobResA.setText(I18N.get("LocalGISEIEL", "localgiseiel.panels.label.poblR"));
        	
        	jLabelPobEsA = new JLabel("", JLabel.CENTER); 
        	jLabelPobEsA.setText(I18N.get("LocalGISEIEL", "localgiseiel.panels.label.poblE")); 

        	jLabelServ = new JLabel("", JLabel.CENTER);
        	jLabelServ.setText(I18N.get("LocalGISEIEL", "localgiseiel.panels.label.serv"));
            
        	jLabelPlantll = new JLabel("", JLabel.CENTER);
        	jLabelPlantll.setText(I18N.get("LocalGISEIEL", "localgiseiel.panels.label.plantll"));
            ...
            jPanelInformacion.add(jLabelPobResA,
                    new GridBagConstraints(2, 0, 1, 1, 0.1, 0.1,
                            GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            
            jPanelInformacion.add(getjTextFieldPobResA(), 
                    new GridBagConstraints(3, 0, 1, 1, 0.1, 0.1,
                            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            
            jPanelInformacion.add(jLabelPobEsA,
                    new GridBagConstraints(0, 1, 1, 1, 0.1, 0.1,
                            GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            
            jPanelInformacion.add(getjTextFieldPobEsA(), 
                    new GridBagConstraints(1, 1, 1, 1, 0.1, 0.1,
                            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            
            jPanelInformacion.add(jLabelServ,
                    new GridBagConstraints(2, 1, 1, 1, 0.1, 0.1,
                            GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 5, 0));
            
            jPanelInformacion.add(getJComboBoxServ(), 
                    new GridBagConstraints(3, 1, 1, 1, 0.1, 0.1,
                            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            
            jPanelInformacion.add(jLabelPlantll,
                    new GridBagConstraints(0, 2, 1, 1, 0.1, 0.1,
                            GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            
            jPanelInformacion.add(getjTextFieldPlantll(), 
	...
	public void loadDataIdentificacion(){
		...
		if (obj != null && obj instanceof FeatureDialog){
			...
			Feature feature = featureDialog.get_fieldPanel().getModifiedFeature();
	        	...
	        	loadData(operations.getPanelServiciosRecogidaBasuraEIEL(codprov, codmunic, entidad, nucleo));
