/**
 * ParquesJardinesPanelExtendedForm.java
    ...
    public void execute() throws Exception 
    {
    	if (parquesjardinesPanel != null) {
    		if (parquesjardinesPanel.datosMinimosYCorrectos()){
    			...
    			InitEIEL.clienteLocalGISEIEL.insertarElemento(parquesjardinesPanel.getParquesJardines(parqueJardin), idLayer, ConstantesLocalGISEIEL.PARQUES_JARDINES);
