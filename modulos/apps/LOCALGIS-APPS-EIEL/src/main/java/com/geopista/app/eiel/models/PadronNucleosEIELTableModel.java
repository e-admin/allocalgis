/**
 * PadronNucleosEIELTableModel.java
...
public class PadronNucleosEIELTableModel  extends EIELTableModel {
    ...
    public PadronNucleosEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 0: 
        //	return ((PadronNucleosEIEL)lstElementos.get(row)).getCodINEProvincia();
        case 1: 
