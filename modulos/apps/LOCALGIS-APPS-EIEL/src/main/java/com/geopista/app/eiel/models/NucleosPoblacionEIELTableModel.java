/**
 * NucleosPoblacionEIELTableModel.java
...
public class NucleosPoblacionEIELTableModel  extends EIELTableModel {
    ...
    public NucleosPoblacionEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 0: 
        //    return ((NucleosPoblacionEIEL)lstElementos.get(row)).getCodINEProvincia();
        case 1: 
        ...
        case 2: 
            return getNombreNucleo( ((NucleosPoblacionEIEL)lstElementos.get(row)).getCodINEEntidad(),((NucleosPoblacionEIEL)lstElementos.get(row)).getCodINEPoblamiento());
        case 3: 
