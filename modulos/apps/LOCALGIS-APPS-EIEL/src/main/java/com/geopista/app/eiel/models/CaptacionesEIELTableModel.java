/**
 * CaptacionesEIELTableModel.java
...
public class CaptacionesEIELTableModel  extends EIELTableModel {
    ...
    public CaptacionesEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 2: 
        //    return ((CaptacionesEIEL)lstElementos.get(row)).getCodINEProvincia();
        case 2: 
