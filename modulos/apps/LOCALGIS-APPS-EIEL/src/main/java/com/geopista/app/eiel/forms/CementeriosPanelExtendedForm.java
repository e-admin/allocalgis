/**
 * CementeriosPanelExtendedForm.java
    ...
    public void execute() throws Exception 
    {
    	if (cementeriosPanel != null) {
    		if (cementeriosPanel.datosMinimosYCorrectos()){
    			...
    			InitEIEL.clienteLocalGISEIEL.insertarElemento(cementeriosPanel.getCementerios(cementerios), idLayer, ConstantesLocalGISEIEL.CEMENTERIOS);
