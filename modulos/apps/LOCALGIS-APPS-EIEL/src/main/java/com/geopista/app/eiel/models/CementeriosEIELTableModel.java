/**
 * CementeriosEIELTableModel.java
...
public class CementeriosEIELTableModel  extends EIELTableModel {
    ...
    public CementeriosEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 1: 
        //    return ((CementeriosEIEL)lstElementos.get(row)).getCodINEProvincia();
        case 2: 
