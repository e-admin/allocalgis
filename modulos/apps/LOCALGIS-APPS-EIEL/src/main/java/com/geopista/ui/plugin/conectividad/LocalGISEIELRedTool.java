...
public abstract class LocalGISEIELRedTool extends DragTool {
    ...
    protected void gestureFinished() throws NoninvertibleTransformException {
        ...
        //Revisamos aquellas capas que pueden tener informacion de redes
        ...
        try {
			...
			if (nodoSeleccionado!=null){
				listaNodosByName=InitEIEL.clienteLocalGISEIEL.getNodosEIELByName(nodoSeleccionado, ConstantesLocalGISEIEL.Locale);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
            ...
            if (layer instanceof GeopistaLayer){
               ...
               if (nodoSeleccionado!=null){
            	   if (listaNodosByName==null || listaNodosByName.get(idLayer)==null){
            		   ...
            		   LCGNodoEIEL nodoEIEL=(LCGNodoEIEL)listaNodosByName.get(idLayer);
            		   if (!nodoEIEL.isConectividad()){
            			   //Solo trabajamos con capas que tengan actividad que son conectables.
            			   continue;
            		   }
        ...
        if (!algunaCapasSeleccionada)
        	getPanel().getContext().setStatusMessage("No hay seleccionada ninguna feature conectable");
    ...
    protected LocalGISEIELRedTool(String rendererID) {
