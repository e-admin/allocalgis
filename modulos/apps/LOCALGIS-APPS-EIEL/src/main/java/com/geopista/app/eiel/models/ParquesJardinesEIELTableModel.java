/**
 * ParquesJardinesEIELTableModel.java
...
public class ParquesJardinesEIELTableModel  extends EIELTableModel {
    ...
    public ParquesJardinesEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 1: 
        //    return ((ParquesJardinesEIEL)lstElementos.get(row)).getCodINEProvincia();
        case 2: 
