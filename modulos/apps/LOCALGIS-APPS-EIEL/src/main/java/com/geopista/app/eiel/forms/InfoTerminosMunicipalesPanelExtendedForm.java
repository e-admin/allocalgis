/**
 * InfoTerminosMunicipalesPanelExtendedForm.java
    ...
    public void execute() throws Exception 
    {
    	if (infoTerminosMunicipalesPanel != null) {
    		if (infoTerminosMunicipalesPanel.datosMinimosYCorrectos()){
    			...
    			InitEIEL.clienteLocalGISEIEL.insertarElemento(infoTerminosMunicipalesPanel.getInfoTerminosMunicipales(infoTerminoMunicipal), idLayer, ConstantesLocalGISEIEL.NUCLEO_ENCT_7);
