/**
 * TratamientosPotabilizacionEIELTableModel.java
...
public class TratamientosPotabilizacionEIELTableModel  extends EIELTableModel {
    ...
    public TratamientosPotabilizacionEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 1: 
        //    return ((TratamientosPotabilizacionEIEL)lstElementos.get(row)).getCodINEProvincia();
        case 2: 
        ...
        case 4: 
            return ((TratamientosPotabilizacionEIEL)lstElementos.get(row)).getTipo();
        default: 
            return null;
