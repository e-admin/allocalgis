/**
 * OtrosServMunicipalesEIELTableModel.java
...
public class OtrosServMunicipalesEIELTableModel  extends EIELTableModel {
    ...
    public OtrosServMunicipalesEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 1: 
        //	return ((OtrosServMunicipalesEIEL)lstElementos.get(row)).getCodINEProvincia();
        case 1: 
        ...
        case 2: 
            return ((OtrosServMunicipalesEIEL)lstElementos.get(row)).getSwInfGeneral();
        default: 
            return null;
