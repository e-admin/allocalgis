/**
 * RecogidaBasurasEIELTableModel.java
...
public class RecogidaBasurasEIELTableModel  extends EIELTableModel {
    ...
    public RecogidaBasurasEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 1: 
        //	return ((RecogidaBasurasEIEL)lstElementos.get(row)).getCodINEProvincia();
        case 2: 
        	return ((RecogidaBasurasEIEL)lstElementos.get(row)).getCodINEMunicipio();
        case 3: 
        ...
        case 5:
            return ((RecogidaBasurasEIEL)lstElementos.get(row)).getTipo();
        default: 
            return null;
