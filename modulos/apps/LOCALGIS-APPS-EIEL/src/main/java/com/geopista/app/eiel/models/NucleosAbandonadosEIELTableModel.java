/**
 * NucleosAbandonadosEIELTableModel.java
...
public class NucleosAbandonadosEIELTableModel  extends EIELTableModel {
    ...
    public NucleosAbandonadosEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 0: 
        //    return ((NucleosAbandonadosEIEL)lstElementos.get(row)).getCodINEProvincia();
        case 1: 
        ...
        case 4: 
            return ((NucleosAbandonadosEIEL)lstElementos.get(row)).getTitularidad();
        default: 
            return null;
