...
import com.geopista.app.eiel.models.NucleosEmisariosEIELTableModel;
...
public class EmisariosNucleosPanel extends JPanel implements FeatureExtendedPanel {
	...
	private JPanel jPanelIdentEmisarios = null;
    ...
    public JTable getJTableListaNucleos()
    {
    	if (jTableListaNucleos  == null)
    	{
    		...
    		tableListaNucleosModel  = new NucleosEmisariosEIELTableModel();
    		...
    		((NucleosEmisariosEIELTableModel)((TableSorted)getJTableListaNucleos().getModel()).getTableModel()).setData(lstNucleos);
    ...
    private void loadSelectedItem(){
    	...
    	Object selectedItem = ((NucleosEmisariosEIELTableModel)((TableSorted)getJTableListaNucleos().getModel()).getTableModel()).getValueAt(selectedRow);
    	
    	if (selectedItem != null && selectedItem instanceof NucleoEmisario){
    		
    		loadNucleoEmisario((NucleoEmisario)selectedItem);
    	}    	
    }
    
    private void loadNucleoEmisario(NucleoEmisario nucleoEmisario){
    	
    	 if (nucleoEmisario.getCodProvNucleo()!=null){
         	jComboBoxProvinciaNucleo.setSelectedIndex(
         		provinciaIndexSeleccionar(nucleoEmisario.getCodProvNucleo())
         			);
         }
         else{
         ...
         if (nucleoEmisario.getCodMunicNucleo() != null){
         	jComboBoxMunicipioNucleo.setSelectedIndex(
         			municipioIndexSeleccionar(nucleoEmisario.getCodMunicNucleo())
         	);
         ...
         if (nucleoEmisario.getCodEntNucleo() != null){
         	jComboBoxEntidad.setSelectedIndex(
         			entidadesSingularesIndexSeleccionar(nucleoEmisario.getCodEntNucleo())
         	);
         }
         else{
         ...
         if (nucleoEmisario.getCodPoblNucleo() != null){
         	jComboBoxNucleo.setSelectedIndex(
         			nucleoPoblacionIndexSeleccionar(nucleoEmisario.getCodPoblNucleo())
         			);
        ...
        if (nucleoEmisario.getObservaciones() != null){
    		jTextFieldObserv.setText(nucleoEmisario.getObservaciones());
    	}
    	else{
    		jTextFieldObserv.setText("");
    	}
       
        if (nucleoEmisario.getFechaRevision() != null && nucleoEmisario.getFechaRevision().equals( new java.util.Date()) ){
    		jTextFieldFechaRevision.setText(nucleoEmisario.getFechaRevision().toString());
    	}
    	else{
       ...
       if (nucleoEmisario.getEstadoRevision() != null){
       	jComboBoxEstadoRevision.setSelectedPatron(nucleoEmisario.getEstadoRevision().toString());
   	}
   	else{
    ...
    private void annadirNucleo(){
    	...
    	if(!datosMinimosYCorrectos())
    	{
    		...
    		operations.saveNucleoEmisario(getNucleoEmisario());
        	enter();
    	}
    	
    }
    
    private void eliminarNucleoEmisario(){
    	...
    	if (selectedItem != null && selectedItem instanceof NucleoEmisario){
    		...
    		EdicionOperations operations = new EdicionOperations();
    		operations.deleteNucleoEmisario((NucleoEmisario)selectedItem);
    		reset();
    		enter();
    	}  
    }
    ...
    private NucleoEmisario getNucleoEmisario(){
    	
    	NucleoEmisario nucleoEmisario = new NucleoEmisario();
    	
    	nucleoEmisario.setCodProvEmisario((String) jComboBoxProvinciaEmisario.getSelectedItem());
    	nucleoEmisario.setCodMunicEmisario((String) jComboBoxMunicipioEmisario.getSelectedItem());
        
        if (jTextFieldClave.getText()!=null){
        	nucleoEmisario.setClaveEmisario(jTextFieldClave.getText());
        }
        
        if (jTextFieldCodOrden.getText()!=null){
        	nucleoEmisario.setCodTramoEmisario(jTextFieldCodOrden.getText());
        }
        
        nucleoEmisario.setCodProvNucleo(((Provincia) jComboBoxProvinciaNucleo.getSelectedItem()).getIdProvincia());
        nucleoEmisario.setCodMunicNucleo(((Municipio) jComboBoxMunicipioNucleo.getSelectedItem()).getIdIne());
        nucleoEmisario.setCodEntNucleo(((EntidadesSingularesEIEL) jComboBoxEntidad.getSelectedItem()).getCodINEEntidad());
        nucleoEmisario.setCodPoblNucleo(((NucleosPoblacionEIEL) jComboBoxNucleo.getSelectedItem()).getCodINEPoblamiento()); 
        
        if (jTextFieldObserv.getText()!=null){
        	nucleoEmisario.setObservaciones(jTextFieldObserv.getText());
        }
        ...
        if (jTextFieldFechaRevision.getText()!=null && !jTextFieldFechaRevision.getText().equals("")){
        	...
        	nucleoEmisario.setFechaRevision(new Date(fecha.getYear(),fecha.getMonth(), fecha.getDate()));

        }  
        else{
        	nucleoEmisario.setFechaRevision(null);
        }
        
        if (jComboBoxEstadoRevision.getSelectedPatron()!=null) 
        	nucleoEmisario.setEstadoRevision(Integer.parseInt(jComboBoxEstadoRevision.getSelectedPatron()));
        
    	
    	return nucleoEmisario;
    }
    ...
    public JPanel getJPanelIdentEmisario()
    {
        if (jPanelIdentEmisarios == null)
        {   
            ...
            jPanelIdentEmisarios = new JPanel(new GridBagLayout());
            jPanelIdentEmisarios.setBorder(BorderFactory.createTitledBorder
            ...
            jPanelIdentEmisarios.add(jLabelClave,
                    new GridBagConstraints(0, 0, 1, 1, 0.1, 0.1,
                            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            
            jPanelIdentEmisarios.add(getJTextFieldClave(), 
                    new GridBagConstraints(1, 0, 1, 1, 0.1, 0.1,
                            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            
            jPanelIdentEmisarios.add(jLabelCodProvEmisario, 
                    new GridBagConstraints(2, 0, 1, 1, 0.1, 0.1,
                            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            
            
            jPanelIdentEmisarios.add(getJComboBoxProvinciaEmisario(), 
                    new GridBagConstraints(3, 0, 1, 1, 0.1, 0.1,
                            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            
            jPanelIdentEmisarios.add(jLabelCodMunicEmisario, 
                    new GridBagConstraints(0, 1, 1, 1, 0.1, 0.1,
                            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            
            
            jPanelIdentEmisarios.add(getJComboBoxMunicipioEmisario(), 
                    new GridBagConstraints(1, 1, 1, 1, 0.1, 0.1,
                            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            
            jPanelIdentEmisarios.add(jLabelCodOrden, 
                    new GridBagConstraints(2, 1, 1, 1, 0.1, 0.1,
                            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                            new Insets(5, 5, 5, 5), 0, 0));
            
            
            jPanelIdentEmisarios.add(getJTextFieldOrden(), 
        	...
        	jComboBoxProvinciaEmisario.addActionListener(new ActionListener()
            {
            	...
            	{   
            		...
            		else
            		{
            			...
            			/*EdicionUtils.cargarLista(getJComboBoxMunicipioEmisario(), 
            					oper.obtenerIdMunicipios((String)jComboBoxProvinciaEmisario.getSelectedItem()));*/
            			//getJComboBoxMunicipioEmisario().setEnabled(true);
            		}
...
//        	jComboBoxEntidad.setEditable(true);
    ...
    private void jbInit() throws Exception
    {
        ...
        this.setSize(EmisariosNucleosPanel.DIM_X,EmisariosNucleosPanel.DIM_Y);
    ...
    public void enter()
    {
        ...
        EdicionOperations operations = new EdicionOperations();
        if (emisario != null){
    		lstNucleos = operations.getLstNucleosEmisario(
    				emisario.getClave(), 
        	...
        	lstNucleos = operations.getLstNucleosEmisario(idEmisario);
        ...
        ((NucleosEmisariosEIELTableModel)((TableSorted)getJTableListaNucleos().getModel()).getTableModel()).fireTableDataChanged();
    ...
    public void loadDataIdentificacion(String clave, String codprov,
			String codmunic, String tramo_em) {
        ...
        if (tramo_em != null){
    		jTextFieldCodOrden.setText(tramo_em);
    	}
    	else{
    		jTextFieldCodOrden.setText("");
    	}
