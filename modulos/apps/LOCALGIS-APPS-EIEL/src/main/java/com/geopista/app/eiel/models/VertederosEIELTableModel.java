...
public class VertederosEIELTableModel  extends EIELTableModel {
    ...
    public VertederosEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 1: 
        //	return ((VertederosEIEL)lstElementos.get(row)).getCodINEProvincia();
        case 2: 
        ...
        case 4:
            return ((VertederosEIEL)lstElementos.get(row)).getTipo();
        default: 
            return null;
