/**
 * Depuradora1EIELTableModel.java
...
public class Depuradora1EIELTableModel  extends EIELTableModel {
    ...
    public Depuradora1EIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        //case 1: 
        //    return ((Depuradora1EIEL)lstElementos.get(row)).getCodINEProvincia();
        case 2: 
