...
public class CarreterasEIELTableModel  extends EIELTableModel {
    ...
    public CarreterasEIELTableModel() {        
    ...
    public Object getValueAt(int row, int col) {
        ...
        case 1: 
        	return ((TramosCarreterasEIEL)lstElementos.get(row)).getCodINEProvincia();      
        case 2:
        	return ((TramosCarreterasEIEL)lstElementos.get(row)).getCodCarretera();
        case 3: 
