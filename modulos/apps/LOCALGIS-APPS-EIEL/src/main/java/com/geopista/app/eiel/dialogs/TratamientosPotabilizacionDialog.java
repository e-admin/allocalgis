/**
 * TratamientosPotabilizacionDialog.java
...
/* CONSTRUCTORES */    
    ...
    public TratamientosPotabilizacionDialog(TratamientosPotabilizacionEIEL elemento, boolean isEditable){
        ...
        EdicionUtils.enablePanel(getTratamientosPotabilizacionNucleosPanel(), true);
        ...
        if(elemento!=null){
        	EdicionUtils.enablePanel(getTratamientosPotabilizacionPanel().getJPanelDatosIdentificacion(), false);
        	EdicionUtils.enablePanel(getTratamientosPotabilizacionNucleosPanel().getJPanelIdentTratamientosPotabilizacion(), false);
        }
        ...
        getTratamientosPotabilizacionPanel().getJComboBoxProvincia().setEnabled(true);
        getTratamientosPotabilizacionPanel().getJComboBoxMunicipio().setEnabled(true);
