/**
 * EdificiosSinUsoPanelExtendedForm.java
    ...
    public void execute() throws Exception 
    {
    	if (edificiosSinUsoPanel != null) {
    		if (edificiosSinUsoPanel.datosMinimosYCorrectos()){
    			...
    			InitEIEL.clienteLocalGISEIEL.insertarElemento(edificiosSinUsoPanel.getEdificiosSinUso(edificioSinUso), idLayer, ConstantesLocalGISEIEL.EDIFICIOS_SIN_USO);
