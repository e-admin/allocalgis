...
public class TramosConduccionDialog extends JDialog
{
    ...
    public TramosConduccionDialog(TramosConduccionEIEL elemento, boolean isEditable)
    {
        ...
        initialize(I18N.get("LocalGISEIEL", "localgiseiel.dialog.titulo.cn"));       
        this.isEditable = isEditable;
        getTramosConduccionPanel().loadData (elemento);
        EdicionUtils.enablePanel(getTramosConduccionPanel(), isEditable);
        EdicionUtils.enablePanel(getTramosConduccionNucleosPanel(), true);
        ...
        if(elemento!=null){
        	EdicionUtils.enablePanel(getTramosConduccionPanel().getJPanelDatosIdentificacion(), false);
        	EdicionUtils.enablePanel(getTramosConduccionNucleosPanel().getJPanelIdentTramosConduccion(), false);
        }
        ...
        getTramosConduccionPanel().getJComboBoxProvincia().setEnabled(true);
        getTramosConduccionPanel().getJComboBoxMunicipio().setEnabled(true);
