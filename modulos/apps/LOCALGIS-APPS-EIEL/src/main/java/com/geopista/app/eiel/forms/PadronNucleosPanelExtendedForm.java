/**
 * PadronNucleosPanelExtendedForm.java
    ...
    public void execute() throws Exception 
    {
    	if (padronNucleosPanel != null) {
    		if (padronNucleosPanel.datosMinimosYCorrectos()){
    			...
    			InitEIEL.clienteLocalGISEIEL.insertarElemento(padronNucleosPanel.getPadronNucleos(padronNucleo), idLayer, ConstantesLocalGISEIEL.PADRON_NUCLEOS);
