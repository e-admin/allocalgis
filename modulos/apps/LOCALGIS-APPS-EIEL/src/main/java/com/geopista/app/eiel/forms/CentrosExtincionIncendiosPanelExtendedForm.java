/**
 * CentrosExtincionIncendiosPanelExtendedForm.java
    ...
    public void execute() throws Exception 
    {
    	if (incendiosProteccionPanel != null) {
    		if (incendiosProteccionPanel.datosMinimosYCorrectos()){
    			...
    			InitEIEL.clienteLocalGISEIEL.insertarElemento(incendiosProteccionPanel.getIncendiosProteccion(centroIncendios), idLayer, ConstantesLocalGISEIEL.INCENDIOS_PROTECCION);
