 ...
 *
 */
public class NewMunicipio extends LoggerHttpServlet {
    

	private static final long serialVersionUID = 7154488014521925686L;
	private org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(NewMunicipio.class);
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Municipio municipio= (Municipio) Unmarshaller.unmarshal(Municipio.class, new StringReader(
                    request.getParameter(EnviarSeguro.mensajeXML)));
            Marshaller.marshal(municipio, new OutputStreamWriter(System.out));
            resultado = COperacionesAdministrador.ejecutarNewMunicipio(municipio);
