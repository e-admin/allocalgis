...
public class Const {
    ...
    public static final int ACTION_GET_ATTACHED_DOCUMENTS_SIN_FEATURE=31;
    public static final int ACTION_DETACH_DOCUMENT_SIN_FEATURE=32;
    public static final int ACTION_ATTACH_BYTESTREAM_SIN_FEATURE=33;
    public static final int ACTION_ATTACH_DOCUMENT_SIN_FEATURE=34;
