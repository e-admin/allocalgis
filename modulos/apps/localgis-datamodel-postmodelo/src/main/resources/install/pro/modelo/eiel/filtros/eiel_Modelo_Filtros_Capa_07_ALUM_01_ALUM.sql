...
insert into lcg_nodos_capas_campos (clave_capa, clave_grupo, campo_bd, tag_traduccion,tipo_bd, dominio, metodo)
	values ('ALUM','Info.ALUM','reductor_flujo_inicio','localgiseiel.tabla.luminaria.columna.reductor_flujo_inicio',4,'eiel_Reductor de flujo en la instalación','reductor_flujo_inicio');	

	insert into lcg_nodos_capas_campos (clave_capa, clave_grupo, campo_bd, tag_traduccion,tipo_bd, dominio, metodo)
	values ('ALUM','Info.ALUM','reductor_flujo','localgiseiel.tabla.luminaria.columna.reductor_flujo',4,'eiel_Reductor de flujo en la luminaria','reductor_flujo');	
