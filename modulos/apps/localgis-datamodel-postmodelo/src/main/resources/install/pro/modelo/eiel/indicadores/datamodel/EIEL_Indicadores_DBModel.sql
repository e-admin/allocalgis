DROP TABLE IF EXISTS eiel_indicadores_m_indicadores;
DROP TABLE IF EXISTS eiel_indicadores_m_categorias;

DROP TABLE IF EXISTS eiel_indicadores_d_poblacion;
DROP TABLE IF EXISTS eiel_indicadores_d_viviendas;
DROP TABLE IF EXISTS eiel_indicadores_d_planeam;
DROP TABLE IF EXISTS eiel_indicadores_t_captaciones_aux;
DROP TABLE IF EXISTS eiel_indicadores_d_captaciones;
DROP TABLE IF EXISTS eiel_indicadores_d_potabilizacion;
DROP TABLE IF EXISTS eiel_indicadores_d_depositos;

DROP TABLE IF EXISTS eiel_indicadores_d_rsaneam;
DROP TABLE IF EXISTS eiel_indicadores_t_rsaneam_aux;

DROP TABLE IF EXISTS eiel_indicadores_d_rdistribucion;
DROP TABLE IF EXISTS eiel_indicadores_t_rdistribucion_aux;
DROP TABLE IF EXISTS eiel_indicadores_d_vertidos;


DROP TABLE IF EXISTS eiel_indicadores_d_accesibilidad;
DROP TABLE IF EXISTS eiel_indicadores_d_pavimentacion;
DROP TABLE IF EXISTS eiel_indicadores_d_alumbrado;
DROP TABLE IF EXISTS eiel_indicadores_d_comunicaciones;
DROP TABLE IF EXISTS eiel_indicadores_d_comunicaciones_aux;
DROP TABLE IF EXISTS eiel_indicadores_d_suministros;

DROP TABLE IF EXISTS eiel_indicadores_d_centrosen;
DROP TABLE IF EXISTS eiel_indicadores_d_ideporte;
DROP TABLE IF EXISTS eiel_indicadores_d_ccultura;
DROP TABLE IF EXISTS eiel_indicadores_d_zverde;
DROP TABLE IF EXISTS eiel_indicadores_d_csanitario;
DROP TABLE IF EXISTS eiel_indicadores_d_servotros;
DROP TABLE IF EXISTS eiel_indicadores_d_casistencial;

DROP TABLE IF EXISTS eiel_indicadores_d_rblimpieza;
drop table IF EXISTS eiel_indicadores_t_rblimpieza_aux;
DROP TABLE IF EXISTS eiel_indicadores_d_tratamresiduos;

DROP TABLE IF EXISTS eiel_indicadores_d_rsaneam_aux;
