...
delete from iusergroupuser where userid=(select id from iuseruserhdr where name ilike '%EIEL001_VAL%');

delete from iusercnt where userid=(select id from iuseruserhdr where name ilike '%EIEL001_VAL%');

-- Borramos al usuario
delete from iuseruserhdr where name ilike '%EIEL001_VAL%';
