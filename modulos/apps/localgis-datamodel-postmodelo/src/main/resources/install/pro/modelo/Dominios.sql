...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Disponibilidad de agua',((select idacl FROM acl WHERE name='EIEL')),5);  
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  		...
  		---Inserta dominio hijos
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'IN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'SF',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Cisterna',(select idacl FROM acl WHERE name='EIEL'),5);  
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  		...
  		---Inserta dominio hijos
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'MC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'OT',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'RO',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'RU',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Sequía');
  			...
  			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'SE',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Restricciones de agua',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'RF',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'RM',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'RT',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
------  			
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Accesibilidad del núcleo de población',(select idacl FROM acl WHERE name='EIEL'),5);  
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  		...
  		---Inserta dominio hijos
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'IT',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Titularidad de cementerio',(select idacl FROM acl WHERE name='EIEL'),5);  
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CR',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'MU',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PV',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Estado del acceso',(select idacl FROM acl WHERE name='EIEL'),5);  
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  		...
  		---Inserta dominio hijos
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'B',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'E',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'M',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'R',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Capilla',(select idacl FROM acl WHERE name='EIEL'),5);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
		  				values(nextval('seq_domainnodes'),currval('seq_domains'),'EC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
		  				values(nextval('seq_domainnodes'),currval('seq_domains'),'MO',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Titularidad Núcleo Abandonado',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CH',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'OP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Agua en Núcleo Abandonado',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Distribución domiciliaria');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AD',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Fuente Pública');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'FP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Pozos individuales');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PZ',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Acceso a Núcleo Abandonado',(select idacl FROM acl WHERE name='EIEL'),5);  
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  		...
  		---Inserta dominio hijos
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'RG',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'VE',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
 ...
 insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Causa de Abandono',(select idacl FROM acl WHERE name='EIEL'),5);  
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  		...
  		---Inserta dominio hijos
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'EM',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'EX',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Titularidad_General_equip',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CO',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'EP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'MA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PR',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Tipo de vertedero',(select idacl FROM acl WHERE name='EIEL'),5);  
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'EST',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'ICA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'ISA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'OTR',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PCE',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PLV',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PTC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PTI',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'VCC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'VCS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'VIN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Situación de la actividad de la instalación',(select idacl FROM acl WHERE name='EIEL'),5);  
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  		...
  		---Inserta dominio hijos
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AB',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'EN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'SG',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Titular del vertedero',(select idacl FROM acl WHERE name='EIEL'),5);  
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CON',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	--MCC
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'MCC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	--MCD
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'MCD',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	--MUC
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'MUC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	--MUD
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'MUD',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	--OTS
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(nextval('seq_dictionary'),'es_ES','Otros');
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ga_ES','Otros');
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'va_ES','Otros');
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'OTS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Categoria del vertedero',(select idacl FROM acl WHERE name='EIEL'),5);  
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  		...
  		---Inserta dominio hijos
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'VMN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'VRN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'VRP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Tipos de saneamiento autónomo',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Fosa Séptica');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'FS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Pozo Negro');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Tipo de parque',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Áreas de la naturaleza');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Jardines');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'JA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PI',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Parque urbano');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PU',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Zonas recreativas naturales');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'ZR',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Titularidad Enseñanza',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CE',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CL',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'UP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'UV',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Ámbitos de Centros de enseñanza',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'A',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'C',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'L',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
-----
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Titularidad del Centro de Protección Civil',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'XR',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Tipo de Centro de Protección Civil',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'BO',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_tipo_red_interior',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'MX',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PL',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'RE',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Sistema de impulsión',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'GR',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'IM',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_precision_dig',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'DC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'GP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'OF',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Proyecto');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PY',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Escaneado');
  	...
  	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'SC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_diametro_abast',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'16',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'20',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'25',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'32',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'40',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'50',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'63',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'75',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'90',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'110',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'125',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'140',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'160',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'180',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'200',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'250',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'315',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'400',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'450',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'500',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'630',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'710',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'800',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'900',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'1000',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'1200',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_diametro_sanea',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'100',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'150',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'300',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'350',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'600',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'700',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'1400',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'1600',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'1800',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Estado de revisión',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'0',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_material',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'FC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'FU',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'HO',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PE',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Ubicación del tratamiento de potabilización',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CD',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'DE',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'RD',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AU',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AL',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'DI',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'ME',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'QU',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Método de desinfección',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CG',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'HP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'NF',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'OS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'OZ',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'UF',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Ultravioleta');
  	...
  	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  			values(nextval('seq_domainnodes'),currval('seq_domains'),'UL',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);	
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Clave Abast AR',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'BR',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'HI',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'VA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Clave Saneam PR',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'SP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'SU',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
-----	
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Tipo de uso CA',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Uso extraordinario');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'UE',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Uso ordinario');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'UO',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Tipo de Captación',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AM',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'EB',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'GA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'MT',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PO',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PX',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'RI',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Sondeo');		
  	...
  	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'SO',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Sist. de depuración, Procesos complementarios',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Desodorización');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'DS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Ubicacion Deposito',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'EL',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'ES',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Contador DE',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'SA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Señaliza',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'H',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'N',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'V',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_dimensiona',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'BD',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'MD',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Firme Tramos C',(select idacl FROM acl WHERE name='EIEL'),5);
  ...
  insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(nextval('seq_dictionary'),'es_ES','Material del firme');
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'HR',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'MB',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'RA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'TI',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
  	...
  	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'ZE',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Tipo Red Viaria',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Travesías');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'TR',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Figuras de Planeamiento',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'D.C',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'D.S',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'N.M',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'N.P',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'P.E',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'P.G',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'P.S',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Estado de tramitación de la Figura de Planeamiento',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AI',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'ER',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Titularidad Centro Sanitario',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CAU',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'DIP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'FAS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'MAT',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'MUN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'OAC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'OEP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PCR',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PIG',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PNB',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PRB',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'TSS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Tipo Centro Sanitario',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Ambulatorio, Centro de especialidades o policlínicas sin internamiento');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AMB',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Centro de Salud');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CDS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Consultoria Local');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CLO',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Centros de Urgencia y Casas de Socorro');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CUR',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Hospital General');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'HGS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Hospital maternal e infantil');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'HIN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Hospital geriátrico y larga estancia');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'HLE',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Hospital otras especialidades');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'HOE',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Hospital psiquiátrico');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'HPS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Hospital quirúrgico');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'HQU',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Gestor Centro Sanitario',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CAS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'INS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'OPB',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'SAS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(nextval('seq_dictionary'),'es_ES','Abandonada o sin uso');
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Explotación incorrecta');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'EI',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Falta de elementos');
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'FE',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Falta de mantenimiento');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'FM',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Infradimensionamiento');
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'IF',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'VI',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_niveles_centros_ensenianza',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'BAC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'ESO',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'ESP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'FP1',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'FP2',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'INF',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PRI',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'UN1',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'UN2',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'UN3',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Tipo de recogida selectiva de basura',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'OG',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'RN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_tipo_luminaria',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'FA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_tipo_lampara',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Fluorescente');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'FL',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Halogenuros metálicos');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'HA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Mezcla');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'MZ',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_sist_eficiencia_pl',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Doble nivel');
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'DNL',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Reactancia electrónica con reductor de flujo');
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'RER',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(nextval('seq_dictionary'),'es_ES','Antiguas escuelas');
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Antiguas escuelas');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AE',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null); 
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Casa Consistorial');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AY',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Otros edificios de usos administrativos');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'UA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'VM',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Tipo de Edificio',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'FT',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'IG',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'LV',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Tipo de Centro Asistencial',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Centro de rehabilitación toxicómanos abierto');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CT',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Guarderías infantiles(no los parvularios ni docentes preescolares)');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'GI',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Tipo Centro Cultural',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AR',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);	
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'BI',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'KI',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'LU',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'MS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'TC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Tipo de instalaciones deportivas',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  			values(nextval('seq_domainnodes'),currval('seq_domains'),'CP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);	
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Escuela de vela');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'EV',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);	
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'FR',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);	
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PD',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);	
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);	
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PT',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);	
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'SK',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);	
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'TJ',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);	
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Zona del punto de vertido',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'ZM',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);		
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'ZN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);		
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'ZS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);		
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Tipo Deporte',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AT',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);		
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'BB',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);		
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'BC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);		
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'BM',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);		
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'BV',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);		
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'FB',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);		
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'GF',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);		
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Judo/Kárate');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'JU',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);		
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Natación');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'NA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);		
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Tenis');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'TE',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);		
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Tiro al plato');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'TP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);		
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Lonja/Mercado/Feria',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'LO',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);	
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Sist. de depuración, Tratamientos avanzados',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'UN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'UT',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Sist. de depuración, Tratamientos de fangos o lodos',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'DA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'DN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'TT',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Sist. de depuración, Tratamiento primario',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'DG',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'FQ',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'LN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Sist. de depuración, Tratamiento secundario',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Contadores biológicos rotativos');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CB',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Filtro verde');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'FV',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Infiltración rápida');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'IR',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Sistema de lagunaje');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'LA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Lechos bacterianos');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'LB',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Lechos de turba');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'LT',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Zanjas, lechoso pozos filtrantes');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'ZF',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
-------
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Usos Casas Consistoriales',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'BA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CI',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'OA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domains (ID, NAME,idacl,ID_CATEGORY)values(nextval('seq_domains'),'eiel_Tipos de usos de los Centros culturales',(select idacl FROM acl WHERE name='EIEL'),5);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Auditorio');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'AO',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Cívico Social (Comprende el lugar de reuniones de las Asociaciones de Vecinos, Círculos, Ateneos,etc)');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'CV',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Educativo(Se refiere a las enseñanzas no oficiales como Escuela de música(no homologada), enseñanza de idiomas, fotografía, pintura, etc)');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'ED',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Kiosco de música');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'KM',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
	...
	insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ca_ES','Plaza de toros');
		...
		insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'PS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
				...
				insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
							values(nextval('seq_domainnodes'),currval('seq_domains'),'P2',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
				...
				insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
						values(nextval('seq_domainnodes'),currval('seq_domains'),'DSA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
	  	values(nextval('seq_domainnodes'),currval('seq_domains'),'SA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
				...
				insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
						values(nextval('seq_domainnodes'),currval('seq_domains'),'D1',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
				...
				insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
						values(nextval('seq_domainnodes'),currval('seq_domains'),'D2',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
				...
				--insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
		 		--		values(nextval('seq_domainnodes'),currval('seq_domains'),'PVE',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
				...
				insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
						values(nextval('seq_domainnodes'),currval('seq_domains'),'SN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
				...
				insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
							values(nextval('seq_domainnodes'),currval('seq_domains'),'DSS',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'EQ',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			--	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
			--				values(nextval('seq_domainnodes'),currval('seq_domains'),'CCU',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
				...
				insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
				 			values(nextval('seq_domainnodes'),currval('seq_domains'),'CU',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
		...
		--		insert into DICTIONARY (ID_VOCABLO,LOCALE,TRADUCCION)values(currval('seq_dictionary'),'ga_ES','Centros de enseñanza (niveles)');
			...
			--	insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
			--	 			values(nextval('seq_domainnodes'),currval('seq_domains'),'ENN',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
				...
				insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
				 			values(nextval('seq_domainnodes'),currval('seq_domains'),'ID',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
				...
				--insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
				 --			values(nextval('seq_domainnodes'),currval('seq_domains'),'IDD',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
				...
				insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
				 				values(nextval('seq_domainnodes'),currval('seq_domains'),'TA',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);	
...
insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'RC',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
  				values(nextval('seq_domainnodes'),currval('seq_domains'),'VT',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
	  				values(nextval('seq_domainnodes'),currval('seq_domains'),'NP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
						values(nextval('seq_domainnodes'),currval('seq_domains'),'SR',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
					values(nextval('seq_domainnodes'),currval('seq_domains'),'N7',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
				  	values(nextval('seq_domainnodes'),currval('seq_domains'),'RB',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
					values(nextval('seq_domainnodes'),currval('seq_domains'),'P1',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
			values(nextval('seq_domainnodes'),currval('seq_domains'),'MP',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
							 				values(nextval('seq_domainnodes'),currval('seq_domains'),'PM',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
			...
			insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
					values(nextval('seq_domainnodes'),currval('seq_domains'),'A6',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
...
insert into domainnodes (id,id_domain, pattern,  ID_DESCRIPTION, "type",permissionlevel, parentdomain,id_municipio)
			values(nextval('seq_domainnodes'),currval('seq_domains'),'ALUM',currval('seq_dictionary'),7,null,(select currval('seq_domainnodes') from seq_domainnodes),null);
