...
DROP TABLE IF EXISTS lcg_nodos_capas_traducciones;
DROP TABLE IF EXISTS lcg_nodos_capas_campos;
DROP TABLE IF EXISTS lcg_nodos_app;
DROP TABLE IF EXISTS lcg_nodos_capas;
DROP TABLE IF EXISTS lcg_nodos_capas_grupos;
