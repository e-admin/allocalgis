...
-- Tramos de conducción (Informes=Conduccion)
insert into lcg_nodos_capas  (clave, categoria,nodo, tag_traduccion, tabla,nombre_filtro,bean,conectividad)
...
insert into lcg_nodos_capas  (clave, categoria,nodo, tag_traduccion, tabla,nombre_filtro,bean,layer,conectividad)
	values ('EM','SA','EM','eiel.EM','eiel_t_saneam_tem','filtro_em','com.geopista.app.eiel.beans.EmisariosEIEL','TEM',true);
--Colectores
insert into lcg_nodos_capas  (clave, categoria,nodo, tag_traduccion, tabla,nombre_filtro,bean,layer,conectividad)
	values ('CL','SA','CL','eiel.CL','eiel_t_saneam_tcl','filtro_cl','com.geopista.app.eiel.beans.ColectorEIEL','TCL',true);
--Red de Ramales
insert into lcg_nodos_capas  (clave, categoria,nodo, tag_traduccion, tabla,nombre_filtro,bean,layer,conectividad)
	values ('RS','SA','RS','eiel.RS','eiel_c_saneam_rs','filtro_rs','com.geopista.app.eiel.beans.RedDeRamalesEIEL','RS',true);
--Elementos Puntuales
insert into lcg_nodos_capas  (clave, categoria,nodo, tag_traduccion, tabla,nombre_filtro,bean,layer,conectividad)
...
insert into lcg_nodos_app  ( app, clave_capa) values ('EIEL','RS');
...
insert into lcg_nodos_capas_grupos values ('Ident.RS',1,'eiel.Identificacion',null);
insert into lcg_nodos_capas_grupos values ('Info.RS',2,'eiel.Informacion',null);
insert into lcg_nodos_capas_grupos values ('Esta.RS',3,'eiel.Estado',null);
