...
public class SSOAuthManagerOpenAM {
	...
	/**
	 * Gestion de la autenticaciÃ³n con SSO
	 * 
	 */
        ...
        try {                   
            ...
            String url = AppContext.getApplicationContext().getString(
                ...
                if (login!=null) {
	                ...
	                //Fijamos una contraseña para enviar los datos ya que no sabemos dicha contraseña
	                ...
	                if (passwordManager.verificacionContraseña(profile,true)){
	                    logger.info("ssoAuthManager() - INFO: Entra en contraseÃ±a verificada");
	                    ...
	                    logger.info("ssoAuthManager() - INFO: Entra en contraseÃ±a verificada "+login);
	                }
	                else{                     
