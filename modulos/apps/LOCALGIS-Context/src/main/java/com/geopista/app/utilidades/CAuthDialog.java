...
public class CAuthDialog extends javax.swing.JDialog {
    ...
    private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(CAuthDialog.class);
    ...
    public CAuthDialog(java.awt.Frame parent, boolean modal,
       ...
       // dial = new LoginDialog(parent,idApp);
        ...
        logger.info("Mostrando pantalla de autenticacion");
    }
		    	...
		    	if (segPassword.isBloqueado()){
		    		...
		    		if (!idApp.equals(AppConstants.idApp)){
		    			if (segPassword.isCaducado()){
				            ...
				            lanzarAdministracion(literales.getString("CAuthDialog.descripcion.contraseniaCaducada"), true);
		    			}    			
		    			else{
		    				if (segPassword.isAviso()){
		    					...
		    					if (dias == 0){
		    						...
		    						mensaje = literales.getString("CAuthDialog.descripcion.cambioContrasenia");
		    					}
		    					else{
		    						...
		    						mensaje = literales.getString("CAuthDialog.descripcion1.cambioContrasenia")+" "+dias+" "+literales.getString("CAuthDialog.descripcion2.cambioContrasenia");
		    					}           
		    		            JDialog dialog = optionPane.createDialog(literales.getString("CAuthDialog.title.cambioContrasenia"));
		    		            dialog.setVisible(true);
		    		            
		    		            lanzarAdministracion(mensaje, false);
		        			}
		    			}
			        }
		    	}
...
//			intentos++;
            ...
            }else
            {
                ...
                parent.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                com.geopista.security.SecurityManager.login(dial.getLogin(), dial.getPassword(),idApp);
                autenticado=true;
                //el usuario ya está autenticado en el sistema vamos a
                //guardarlo como una constante:
...
//            }
        ...
        {        
            try
            {
                ...
                if (e.getMessage().equals("El usuario ya ha hecho login con anterioridad")){
                	com.geopista.security.SecurityManager.setIdSesion(null);
                }
            }catch(Exception ex)
            {
    ...
    public void lanzarAdministracion(String mensaje, Boolean caducada){
		...
		.showOptionDialog(this, mensaje+"\n"+literales.getString("CAuthDialog.descripcion.irAdministracion"), literales.getString("CAuthDialog.title.irAdministracion"),
