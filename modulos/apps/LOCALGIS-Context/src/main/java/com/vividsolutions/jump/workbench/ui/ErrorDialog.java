...
public class ErrorDialog extends JOptionPane {
    ...
    private static final String SHOW_DETAILS = aplicacion.getI18nString("ErrorDialog.showDetails");
    private static final String HIDE_DETAILS = aplicacion.getI18nString("ErrorDialog.hideDetails");
    private static final String BUGZILLA_DETAILS = aplicacion.getI18nString("ErrorDialog.errorSend");
    ...
    private ErrorDialog(int messageType) {
    ...
    private void addErrorAction(final JDialog dialog,final JButton errorButton) {
    ...
    public JDialog createDialog(Component parentComponent, String title) {
        ...
        if (messageType==ERROR_MESSAGE)
        	setOptions(new Object[] { okButton, detailButton, errorButton });
        else 
        ...
        addErrorAction(dialog, errorButton);
    ...
    public static void show(Component parentComponent, String title,
            String message, String details,int longitud) {
            ErrorDialog dialog = new ErrorDialog();
            dialog.setMessage(StringUtil.split(message, longitud));
            dialog.setDetails(details);
            dialog.createDialog(parentComponent, title).setVisible(true);
        }
    
    public static void show(Component parentComponent, int messageType, String title,
        String message, String details) {
        ErrorDialog dialog = new ErrorDialog(messageType);
        dialog.setMessage(StringUtil.split(message, 80));
        dialog.setDetails(details);
        dialog.createDialog(parentComponent, title).setVisible(true);
