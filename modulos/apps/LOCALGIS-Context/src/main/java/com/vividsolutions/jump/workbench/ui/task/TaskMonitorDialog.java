...
public class TaskMonitorDialog extends JDialog implements TaskMonitor,ITaskMonitor {
	...
	private CancelListener cancelerListener;
	private JDialog parentDialog;

    public TaskMonitorDialog(Frame frame, ErrorHandler errorHandler) {
        this(frame, errorHandler, true);
    }
    public TaskMonitorDialog() {
    }

    public void setTitle(String title) {
    	super.setTitle(aplicacion.getI18nString(title));
    }
    
    public void setTextTitle(String textTitle) {
    	super.setTitle(textTitle);
    }

    public TaskMonitorDialog(Frame frame, ErrorHandler errorHandler, boolean modal) {
        super(frame, aplicacion.getI18nString("TaskMonitorDialog.Busy"), modal);
    ...
    private void jbInit() throws Exception {
        ...
        cancelButton.setText(aplicacion.getI18nString("TaskMonitorDialog.Cancel"));
    ...
    void cancelButton_actionPerformed(ActionEvent e) {
        ...
        cancelled = true;
        if (cancelerListener!=null)
        	cancelerListener.doCancel();
    }
	...
	public void addCancelListener(CancelListener cancelListener) {
		this.cancelerListener=cancelListener;
