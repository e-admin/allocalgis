...
public class FileImportSelectPanel extends JPanel 
{
    ...
    public JPanel getJPanelImportInformation()
    {
        if (jPanelImportInformation == null)
        {
            ...
            jLabelFicheroImportar.setText(I18N.get("Importacion","importar.general.panelimportacion.fichero"));
           
            jLabelDatosImportar = new JLabel("", JLabel.LEFT);
            jLabelDatosImportar.setText(I18N.get("Importacion","importar.general.panelimportacion.datos"));
            ...
            jLabelSeleccionFichero.setText(I18N.get("Importacion","importar.general.panelimportacion.seleccionar"));
            jPanelImportInformation = new JPanel(new GridBagLayout());
            jPanelImportInformation.setBorder(BorderFactory.createTitledBorder(
                    I18N.get("Importacion","importar.general.panelimportacion.informacion")));
    ...
    public JPanel getJPanelFileInformation()
    {
        ...
        {           
            ...
            jPanelFileInformation.setBorder(BorderFactory.createTitledBorder(
                    I18N.get("Importacion","importar.general.panelimportacion.infofich")));
