...
{
	private static Logger logger = Logger.getLogger(UtilImportacion.class);

    public static Icon iconoFlechaDerecha;
    public static Icon iconoFlechaIzquierda;
    public static Icon iconoDelete;
    public static Icon iconoAnadir;
    ...
    {
        ClassLoader cl= (new UtilImportacion()).getClass().getClassLoader();
        iconoFlechaDerecha = new javax.swing.ImageIcon(cl.getResource("com/geopista/app/catastro/intercambio/importacion/images/flecha_derecha.gif"));
        iconoFlechaIzquierda =  new javax.swing.ImageIcon(cl.getResource("com/geopista/app/catastro/intercambio/importacion/images/flecha_izquierda.gif"));
        iconoDelete =  new javax.swing.ImageIcon(cl.getResource("com/geopista/app/catastro/intercambio/importacion/images/delete.gif"));
        iconoAnadir =  new javax.swing.ImageIcon(cl.getResource("com/geopista/app/catastro/intercambio/importacion/images/add.gif"));
    }
