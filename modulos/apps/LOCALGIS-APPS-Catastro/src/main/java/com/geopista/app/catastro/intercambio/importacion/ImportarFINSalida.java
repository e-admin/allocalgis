...
public class ImportarFINSalida extends JPanel implements WizardPanel
{
    ...
    {        
        ...
        UserPreferenceStore.getUserPreference(ImportarUtils.LAST_IMPORT_DIRECTORY, fc.getCurrentDirectory().getAbsolutePath(),false);
                    ...
                    new Thread(new Runnable()
                        ...
                        {                            
                            try
                            {
                                ...
                                mensajeValidacion = ImportarUtilsCatastro.validateLowSAXdocumentWithXSD(fc.getSelectedFile().getPath(), TIPO_FICHERO);
