/**
 * RepartoCatastroServerXMLHandler.java
...
public class RepartoCatastroServerXMLHandler extends DefaultHandler 
{  
    ...
    private ExpedienteCatastroServerXMLHandler handlerExpediente = null;  
    private ElementoRepartoCatastroServerXMLHandler handlerElementoReparto = null; 
    ...
    public RepartoCatastroServerXMLHandler (XMLReader parser, DefaultHandler handlerToReturn, 
    ...
    throws SAXException 
    {
        ...
        if (((existeCspr && existeCcc) || existeNoec)){
        	...
        	if (localName.equals("lerep") ){
        		...
        		handlerElementoReparto = new ElementoRepartoCatastroServerXMLHandler(parser, this, lstLocales, localName);
        		...
        		elemento = new ElementoReparto();
        		handlerElementoReparto = new ElementoRepartoCatastroServerXMLHandler(parser, this, lstBienes, localName);
        		parser.setContentHandler(handlerElementoReparto);
        		elemento.setExpediente(exp);
