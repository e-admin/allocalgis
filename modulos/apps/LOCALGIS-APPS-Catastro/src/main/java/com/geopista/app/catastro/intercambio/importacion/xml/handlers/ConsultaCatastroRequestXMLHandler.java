/**
 * ConsultaCatastroRequestXMLHandler.java
...
import com.geopista.app.catastro.model.intercambio.importacion.xml.contents.UnidadDatosRetornoXMLHandler;
 ...
 *
 */
public class ConsultaCatastroRequestXMLHandler extends DefaultHandler 
{   
    //Lista de instancias
    ...
    private UnidadDatosRetornoXMLHandler handlerUnidadDatosRetorno;
    ...
    public ConsultaCatastroRequestXMLHandler (XMLReader parser, ArrayList v, TaskMonitorDialog progressDialog)
    {
        this.parser = parser;
        this.instancias = v;
    ...
    {  
        ...
        if (localName.equals("err")||localName.equals("uderr"))
        {
            ...
            handlerUnidadDatosRetorno = new UnidadDatosRetornoXMLHandler( parser, progressDialog, true);
