/**
 * PanelInformacionNotarialCrearExp.java
...
public class PanelInformacionNotarialCrearExp extends JPanel implements IMultilingue {
    ...
    private void chequeaAnnoExpedienteOrigen(final JTextComponent comp)
    {
        ...
        if(!numAnno.equals(""))
        {
            ...
            if(numAnno.length()>4 )
            {
                UtilRegistroExp.retrocedeCaracter(comp,4);
            }
    ...
    * */
    ...
    public boolean recopilaDatosPanel(Hashtable hashDatos)
    {
    	if (validateFields()){
    		...
    		if(!codigoProvinciaJTfield.getText().equals("") && 
        	    ...
        	    {
        	            hashDatos.put(ConstantesCatastro.expedienteCodProvinciaNotaria, codigoProvinciaJTfield.getText());
        	            hashDatos.put(ConstantesCatastro.expedienteCodPoblacionNotaria, codigoPoblacionJTfield.getText());
        	            hashDatos.put(ConstantesCatastro.expedienteCodNotaria, codigoNotariaJTfield.getText());
        	            hashDatos.put(ConstantesCatastro.expedienteAnnoProtocoloNotarial, annoJTfield.getText());
        	            hashDatos.put(ConstantesCatastro.expedienteProtocoloNotarial, protocoloJTfield.getText());
    		...
    		JOptionPane.showMessageDialog(this, I18N.get("RegistroExpedientes",
    		"Catastro.RegistroExpedientes.PanelInformacionNotarial.msg1"));
    	}
    	return false;
    }
    ...
    {
        codigoProvinciaJTfield.setText((String)hashDatos.get(ConstantesCatastro.expedienteCodProvinciaNotaria));
        codigoPoblacionJTfield.setText((String)hashDatos.get(ConstantesCatastro.expedienteCodPoblacionNotaria));
        codigoNotariaJTfield.setText((String)hashDatos.get(ConstantesCatastro.expedienteCodNotaria));
        annoJTfield.setText((String)hashDatos.get(ConstantesCatastro.expedienteAnnoProtocoloNotarial));
        protocoloJTfield.setText((String)hashDatos.get(ConstantesCatastro.expedienteProtocoloNotarial));
    }
    
    private boolean validateFields(){
    	if(codigoProvinciaJTfield.getText()!=null&&
    			codigoPoblacionJTfield.getText()!=null&&
    			codigoNotariaJTfield.getText()!=null && 
    			annoJTfield.getText()!=null &&
    			protocoloJTfield.getText() != null){
    		if((codigoProvinciaJTfield.getText().equals("")&&
    				codigoPoblacionJTfield.getText().equals("")&&
    				codigoNotariaJTfield.getText().equals("") &&
    				annoJTfield.getText().equals("") &&
    				protocoloJTfield.getText().equals(""))||
    				(!codigoProvinciaJTfield.getText().equals("")&&
    	    				!codigoPoblacionJTfield.getText().equals("")&&
    	    				!codigoNotariaJTfield.getText().equals("") &&
    	    				!annoJTfield.getText().equals("") &&
    	    				!protocoloJTfield.getText().equals("")))
    	...
    	else if (codigoProvinciaJTfield.getText()==null&&
    			codigoPoblacionJTfield.getText()==null&&
    			codigoNotariaJTfield.getText()==null &&
    			annoJTfield.getText() == null &&
    			protocoloJTfield.getText() == null)
