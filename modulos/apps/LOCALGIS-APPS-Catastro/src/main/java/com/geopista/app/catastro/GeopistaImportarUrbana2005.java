/**
 * GeopistaImportarUrbana2005.java
...
public class GeopistaImportarUrbana2005 extends JPanel implements WizardPanel
{   
    ...
    public static byte[] inicioRegistro = new byte[]{0x35, 0x30};
    
    public static byte[] inicioCola = new byte[]{0x39, 0x30};
    
    public GeopistaImportarUrbana2005()
    {
    ...
    {
        setName(aplicacion
                .getI18nString("importar.asistente.urbana.2005.titulo1"));
        this.setLayout(null);
        ...
        cmbTipoFichero.addItem(aplicacion.getI18nString("importar.asistente.urbana.tipocmb.padron"));
    ...
    public void enteredFromLeft(Map dataMap)
    {
        ...
        GeopistaPermission geopistaPerm = new GeopistaPermission("Geopista.Importar.Padron.Urbana.2005");
