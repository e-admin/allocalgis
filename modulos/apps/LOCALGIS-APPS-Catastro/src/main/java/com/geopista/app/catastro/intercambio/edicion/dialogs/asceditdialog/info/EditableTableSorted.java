 ...
 * Time: 19:14:20
 */
public class EditableTableSorted  extends AbstractTableModel {
        ...
        public EditableTableSorted() {
            this.mouseListener = new MouseHandler();
            this.tableModelListener = new TableModelHandler();
        }

        public EditableTableSorted(TableModel tableModel) {
            this();
            setTableModel(tableModel);
        }


		public EditableTableSorted(TableModel tableModel, JTableHeader tableHeader) {
            this();
        ...
        private class TableModelHandler implements TableModelListener {
            public void tableChanged(TableModelEvent e) {
                ...
                if (e.getFirstRow() == e.getLastRow()
                    ...
                    fireTableChanged(new TableModelEvent(EditableTableSorted.this,
                                                         viewIndex, viewIndex,
                                                         column, e.getType()));
                    return;
                }
