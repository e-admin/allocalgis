...
//                    jComboBoxTramo.getSelectedItem().toString():"");
    ...
    private JPanel getJPanelDatosLocalizacion()
    {
        if (jPanelDatosLocalizacion == null)
        {
            ...
            jPanelDatosLocalizacion.add(jLabelDireccion, new GridBagConstraints(3, 2, 6, 1, 0.1,0.1, GridBagConstraints.CENTER,GridBagConstraints.HORIZONTAL, new Insets (0,5,0,5), 0,0));
            ...
            jPanelDatosLocalizacion.add(getJTextFieldDireccion(), new GridBagConstraints(3, 3, 7, 1, 0.1,0.1, GridBagConstraints.CENTER,GridBagConstraints.HORIZONTAL, new Insets (0,5,0,5), 0,0));
     ...
     * @return javax.swing.JPanel	
     */
    public JPanel getJPanelDatosEconomicos()
    {
    ...
    private JButton getJButtonBuscarDireccion()
    {
        if (jButtonBuscar == null)
        {
            ...
            jButtonBuscar.setIcon(IconLoader.icon(InfCatatralFisicoEconomicoPanel.ICONO_BUSCAR));
    ...
    public JButton getJButtonBuscarCodigoVia()
    {
        if (jButtonBuscarCodigoVia  == null)
        {
        	jButtonBuscarCodigoVia = new JButton();
        	jButtonBuscarCodigoVia.setIcon(IconLoader.icon(InfCatatralFisicoEconomicoPanel.ICONO_BUSCAR));
        	...
        	EdicionUtils.disabledButtons(jButtonBuscarCodigoVia, "_buscarcodigovia");
        }
    ...
    private JPanel getJPanelDatosPonencia()
    {
        ...
        EdicionUtils.disabledButtons(getJButtonBuscarCodigoVia(), "_buscarcodigovia");
