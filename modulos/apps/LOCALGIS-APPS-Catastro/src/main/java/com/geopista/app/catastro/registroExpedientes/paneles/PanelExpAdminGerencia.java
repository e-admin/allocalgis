...
public class PanelExpAdminGerencia  extends JPanel implements IMultilingue {
    ...
    * */
    		...
    		if(validateFields()){
    			if (annoExpedienteGerenciaJTField.getText().length()!=0){
    				...
    				if (codigoEntidad.intValue() == -1 || (codigoEntidad.intValue() >= 900 && codigoEntidad.intValue()<=999)){
    					hashDatos.put(ConstantesCatastro.expedienteAnnoExpedienteGerencia, annoExpedienteGerenciaJTField.getText());
    					hashDatos.put(ConstantesCatastro.expedienteReferenciaExpedienteGerencia, referenciaExpedienteGerenciaJTField.getText());
    					hashDatos.put(ConstantesCatastro.expedienteCodigoEntidadRegistroDGCOrigenAlteracion, codigoEntidadRegistroDGCOrigenAltJTField.getText());
    					return true;
    				}
    				else{
    					JOptionPane.showMessageDialog(this, I18N.get("RegistroExpedientes",
    ...
    {
        annoExpedienteGerenciaJTField.setText((String)hashDatos.get(ConstantesCatastro.expedienteAnnoExpedienteGerencia));
        referenciaExpedienteGerenciaJTField.setText((String)hashDatos.get(ConstantesCatastro.expedienteReferenciaExpedienteGerencia));
        codigoEntidadRegistroDGCOrigenAltJTField.setText((String)hashDatos.get(ConstantesCatastro.expedienteCodigoEntidadRegistroDGCOrigenAlteracion));
    }
