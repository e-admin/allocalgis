/**
 * DialogoBuscarRefCatastralPorPoligonoImportarFXCC.java
...
public class DialogoBuscarRefCatastralPorPoligonoImportarFXCC extends javax.swing.JDialog
{
     ...
     */
    public DialogoBuscarRefCatastralPorPoligonoImportarFXCC(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        inicializaDialogo();
    }
                    ...
                    public void run()
                    {
                        try
                        {
                            ...
                            try
                            {
                                ...
                                referenciasCatastrales= (ArrayList)ConstantesRegExp.clienteCatastro.
