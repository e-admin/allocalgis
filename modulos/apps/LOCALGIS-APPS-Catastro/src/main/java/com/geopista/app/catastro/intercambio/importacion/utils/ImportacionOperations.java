...
{    
     ...
     */
    public void insertarDatosImagenImportadorFxcc(FincaCatastro fc, ImagenCatastro imagen) 
    throws Exception
    {
		...
		if (idFinca!=null)
		{
			...
			s = conn.prepareStatement("MCnextSecuenciaImagen");
		    r = s.executeQuery();
		    if (r.next())
		    	idImagen = new Long(r.getLong(1));
		    
		    r=null;
		    s=null;             

		    // se hace la insercion de la imagen
		    ...
		    lstValores.add(new Integer(idFinca));
		    lstTipos.add(TYPE_NUMERIC);
		    
		    lstValores.add(idImagen);
		    lstTipos.add(TYPE_NUMERIC);
    ...
    public void insertarDatosImagenesImportadorFXCC(FincaCatastro fc, ArrayList lstImagenes) 
    	    throws Exception
    	    {
    	    	if (lstImagenes != null){
    	    		...
    	    		while (itImagenes.hasNext()){
    	    			...
    	    			try
    	    			{
    	    				...
    	    				insertarDatosImagenImportadorFxcc(fc, imagen);
    	    			}
    ...
    public String obtenerParcela (String referencia_catastral) throws SQLException
    {
        ...
        Connection conn = getDBConnection();
        s = conn.prepareStatement("MCexisteFinca");
        s.setString(1,referencia_catastral);
        ...
        /*if(idFinca != null){
      	  devolverParcela = idFinca.toString();
        }
        */
        return idFinca;
    }
