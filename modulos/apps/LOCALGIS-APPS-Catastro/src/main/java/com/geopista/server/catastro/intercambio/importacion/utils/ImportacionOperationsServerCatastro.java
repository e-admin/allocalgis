/**
 * ImportacionOperationsServerCatastro.java
...
public class ImportacionOperationsServerCatastro
{    
    /**
    ...
    private static final Log logger = LogFactory.getLog(ImportacionOperationsServerCatastro.class);
     ...
     *
     */
    public ImportacionOperationsServerCatastro()
    {        
     ...
     */
    private void insertarListaDatos(ArrayList lstDatos, boolean insertarExpediente, Expediente exp) //throws DataExceptionServerCatastro
    throws Exception
    {
    ...
    {   
        ...
        catch (DataExceptionCatastro ex)
        {           
        	throw new DataExceptionCatastro(I18N.get("Importacion","importar.error.bienes"), ex);
        }        
    }
     ...
     * @throws DataExceptionCatastro
     */
    private void eliminarDatosTitulares(IdBienInmueble idBi) throws DataExceptionCatastro
    {
        try
        {            
            PreparedStatement s = null;
        ...
        {           
            throw new DataExceptionCatastro(I18N.get("Importacion","importar.error.eliminar.titulares"), ex);
        }
    ...
    throws Exception
    {
        ...
        {           
            throw new DataExceptionCatastro(I18N.get("Importacion","importar.error.personas"), ex);
        }          
    }
    ...
    throws Exception
    {
        ...
        {           
            throw new DataExceptionCatastro(I18N.get("Importacion","importar.error.suelos"), ex);
        }        
    }
    ...
    {        
        ...
        {           
            throw new DataExceptionCatastro(I18N.get("Importacion","importar.error.uc"), ex);
        }       
    ...
    throws Exception
    {
        ...
        {           
            throw new DataExceptionCatastro(I18N.get("Importacion","importar.error.construcciones"), ex);
        }       
    ...
    {       
        ...
        {           
            throw new DataExceptionCatastro(I18N.get("Importacion","importar.error.cultivos"), ex);
        }
    ...
    public void asociarDatosGraficosTemporal(long idExpediente, FincaCatastro fc, FX_CC fxcc) throws DataExceptionCatastro
    {
    	try
    	{    
    		PreparedStatement s = null;
    	...
    	{           
    		throw new DataExceptionCatastro(I18N.get("Importacion","importar.error.graficos"), ex);
    ...
    {        
    	...
    	PreparedStatement s = null;
    	ResultSet r = null;
    	String codProvincia = EdicionUtilsCatastroServer.paddingString(String.valueOf(dir.getProvinciaINE()),
    			TAM_CODPRO,'0',true);
    	
    	String codMunicipioINE = EdicionUtilsCatastroServer.paddingString(String.valueOf(dir.getMunicipioINE()),
    			TAM_CODMUNI,'0',true);
    ...
    {     
    	...
    	if (dir.getCodParaje() != null && !dir.getCodParaje().equals("") 
    		...
    		try{
    			...
    			String codProvincia = EdicionUtilsCatastroServer.paddingString(String.valueOf(dir.getProvinciaINE().trim()), 
    					2,'0', true);
    			
    			String codMunicipio = EdicionUtilsCatastroServer.paddingString(String.valueOf(dir.getMunicipioINE().trim()),
        				3,'0',true);

        		String codParaje = EdicionUtilsCatastroServer.paddingString(String.valueOf(dir.getCodParaje().trim()),
        				5,'0',true);
    ...
    {       
        ...
        {         
            ...
            String codProvincia = EdicionUtilsCatastroServer.paddingString(String.valueOf(fc.getDirParcela().getProvinciaINE()),
                    TAM_CODPRO,'0',true);
            String codMunicipio = EdicionUtilsCatastroServer.paddingString(String.valueOf(fc.getDirParcela().getCodigoMunicipioDGC()),
                    TAM_CODMUNI,'0',true);
     ...
     * @throws DataExceptionCatastro Si se produce un error de acceso a datos 
     */
     ...
     * @throws DataExceptionCatastro 
     */
    public ArrayList obtenerParcelasAfectadas(ArrayList lstParcelasImportadas) throws DataExceptionCatastro
    {    
	    ...
	    {           
	        throw new DataExceptionCatastro(I18N.get("Importacion","importar.error.fincas"), ex);
	    }
    ...
    * @throws DataExceptionCatastro
    */
    public ArrayList obtenerParcelasAfectadas() throws DataExceptionCatastro
    {        
        ArrayList lstParcelas = new ArrayList();
...
//            }
    ...
    throws Exception
    {  
    	String idEntidad= String.valueOf(AppContext.getIdEntidad());
        	...
        	if(udsa.getFxcc()!=null){
        		if(udsa.getFxcc().getDXF()!=null){
        			...
        			if(geometriaParcela!=null){
        				...
        				insertarDatosFinca(g, udsa.getFincaCatastro(), insertarExpediente, exp);
        			}
        			else{
