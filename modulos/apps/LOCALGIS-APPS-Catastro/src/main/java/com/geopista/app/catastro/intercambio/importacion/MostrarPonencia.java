                ...
                new Thread(new Runnable()
                    ...
                    public void run()
                    {
                        try
                        {
                            ...
                            String rutaImp = (String) blackboard.get(ImportarUtils.FILE_TO_IMPORT);
                            String linea;
                            ...
                            while ((len = is.read(bytes)) > 0 )
                            {
                            	...
                            	progressDialog.report(readedRows, numRegistros-2,
                                        ...
                                        if((new Boolean(blackboard.get(ImportarUtils.FILE_TXT_MULTILINE).toString()))
                                                .booleanValue())
                                            is.skip(2);
                            }
                            is.close();
