/**
 * TablaBusquedaExportacionMasiva.java
...
public class TablaBusquedaExportacionMasiva extends JPanel implements IMultilingue
{
     ...
     */
    public TablaBusquedaExportacionMasiva(String label, ArrayList expedientes, Hashtable usuarios)
    {
    	setLstExp(expedientes);
        etiqueta= label;
        inicializaTabla();
