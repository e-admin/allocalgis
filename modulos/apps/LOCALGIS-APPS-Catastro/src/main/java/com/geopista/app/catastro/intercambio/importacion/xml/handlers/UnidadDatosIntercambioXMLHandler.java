/**
 * UnidadDatosIntercambioXMLHandler.java
...
import com.geopista.app.catastro.model.intercambio.importacion.xml.handlers.ConstruccionXMLHandler;
import com.geopista.app.catastro.model.intercambio.importacion.xml.handlers.CultivoXMLHandler;
import com.geopista.app.catastro.model.intercambio.importacion.xml.handlers.FincaXMLHandler;
import com.geopista.app.catastro.model.intercambio.importacion.xml.handlers.FxccXMLHandler;
import com.geopista.app.catastro.model.intercambio.importacion.xml.handlers.RepartoXMLHandler;
import com.geopista.app.catastro.model.intercambio.importacion.xml.handlers.SueloXMLHandler;
import com.geopista.app.catastro.model.intercambio.importacion.xml.handlers.UnidadConstructivaXMLHandler;
    	...
    	if((!((Boolean)blackboard.get("cancel")).booleanValue())&&(!progressDialog.isCancelRequested())){
    		...
    		while(((Boolean) blackboard.get("newattempt")).booleanValue()){
    			...
    			try
    			{
    				...
    				ConstantesRegExp.clienteCatastro.insertarDatosSalida(actual, false, null);
