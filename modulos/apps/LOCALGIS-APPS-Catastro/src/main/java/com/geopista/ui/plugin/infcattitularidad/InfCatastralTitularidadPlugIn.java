package com.geopista.ui.plugin.infcattitularidad;
...
import com.geopista.ui.plugin.infcattitularidad.images.IconLoader;
import com.geopista.ui.plugin.infcattitularidad.plugin.InfCastatralEnableCheckFactory;
...
public class InfCatastralTitularidadPlugIn extends AbstractPlugIn{
	private boolean selectZoomToAreaAdded = false;
	private Hashtable permisos= new Hashtable();
	private ApplicationContext aplicacion;
	
	public InfCatastralTitularidadPlugIn() {
    	Locale loc=Locale.getDefault();      	 
    	ResourceBundle bundle2 = ResourceBundle.getBundle("com.geopista.ui.plugin.infcattitularidad.languages.InfCatastraTitularidadPlugIni18n",loc,this.getClass().getClassLoader());    	
        I18N.plugInsResourceBundle.put("InfCatastralTitularidadPlugIn",bundle2);
    }
	
	public Icon getIcon() {
        return IconLoader.icon("InfCatTitularidad.png");
    }
    
    public String getName(){
    	String name = I18N.get("InfCatastralTitularidadPlugIn","InfCatastralTitularidadPlugInTooltip");
    	return name;
    }
    ...
    public boolean execute(final PlugInContext context) throws Exception {
    	...
    	isPermisosConsultarInformacionCatastral = ConstantesRegExp.clienteCatastro.isPermisosConsultarInformacionCatastralTitularidad();
      	if(isPermisosConsultarInformacionCatastral.booleanValue()){
	        ...
	        progressDialog.report(I18N.get("InfCatastralTitularidadPlugIn","cargando.datos.informacion.catastral"));
	                    ...
	                    public void run()
	                    {
	                        try
	                        {
						    	...
						    	if(!coll.isEmpty()){
							    	...
							    	String title = I18N.get("InfCatastralTitularidadPlugIn","infCatastralTitularidad.panel.title");
							    	DialogoVerInfCatastralTitularidad dialogo = new DialogoVerInfCatastralTitularidad(desktop,true,
							    			listIdParcelas, DatosConfiguracion.CONVENIO_TITULARIDAD, title);
						    		...
						    		JOptionPane.showMessageDialog(aplicacion.getMainFrame(),I18N.get("InfCatastralTitularidadPlugIn","infCatastralTitularidad.seleccionar.parcela"));
						    	}
                        	}
	                        catch(Exception e)
	                        {
	        ...
	        progressDialog.setVisible(true);
      		...
      		JOptionPane.showMessageDialog(aplicacion.getMainFrame(),I18N.get("InfCatastralTitularidadPlugIn","no.permisos.ver.informacion.catastral"),"ERROR",0);
      	}
        return true;
    }
	...
	public MultiEnableCheck createEnableCheck(
    	...
    	return new MultiEnableCheck().add(checkFactory.createAtLeastConvenioTitularidadMustBeSelectedCheck());
