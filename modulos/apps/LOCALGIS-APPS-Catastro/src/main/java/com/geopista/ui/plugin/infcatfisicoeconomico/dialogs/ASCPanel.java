...
public class ASCPanel extends JPanel implements FeatureExtendedPanel {
	 ...
	 * @return javax.swing.JTable
	 */
	public JTable getJTableListaPlantas() {
				...
				new Thread(new Runnable() {
					...
					public void run() {
						try {
							...
							Java2XMLCatastroVariaciones aux2 = new Java2XMLCatastroVariaciones();
...
//			for (int i = 0; i < asc.getLstLinderos().size(); i++) {
//				LinderoCatastro lin = (LinderoCatastro) asc.getLstLinderos().get(i);
//				out.println(lin.getTipoLindero());
//				out.println(lin.getCodVia());
//				String cont = "";
//				if (lin.getSiglaVia() != null) {
//					cont = lin.getSiglaVia() + 
//					EdicionUtils.completarCadenaLonguitud(lin.getNombreVia(),25) +
//					EdicionUtils.completarConCerosIzq(String.valueOf(lin.getNumVia()),4) + 
//					lin.getLetraDuplicado();
//				}
//				out.println(cont);
//			}
