/**
 * GeopistaExpedirInformeUrbanisticoPanel.java
  ...
  geopistaEditor1.addGeopistaListener(new GeopistaListener(){
      ...
      public void selectionChanged(IAbstractSelection abtractSelection)
      {
         ...
         try {
          ...
          tipoReferencia = (String)actualFeature.getAttribute("tipo"); //El Tipo
          ...
          if (tipoReferencia.equals("U"))
            {
        	 ...
        	 txtPoligonoUrbano.setText(null);
             txtParcelaUrbano.setText(null);
             txtParcela.setText(referencia.substring(0,5));
             txtPoligonoRustico.setText(referencia.substring(5,7));
            }
    ...
    public boolean isInputValid()
    {
        ...
        if (lista.size()==1){
	        return true;
        	 ...
        	 JOptionPane.showMessageDialog(aplicacion.getMainFrame(), "Solo puede seleccionar un elemento");
        	 return false;
        }
        else
        	return false;
