/**
 * GeopistaGenerarMapaPatrimonio.java
...
public class GeopistaGenerarMapaPatrimonio  extends JPanel implements WizardPanel
{
...
//  private GeopistaEditor geopistaEditor1 = new GeopistaEditor();
  ...
  public GeopistaGenerarMapaPatrimonio ()
  {
    try
    {
      jbInit();
 ...
 //fin de la ayuda
    ...
    lblImagen.setIcon(IconLoader.icon("patrimonio.png"));
...
//    geopistaEditor1.addCursorTool("Select tool", "com.geopista.ui.cursortool.GeopistaSelectFeaturesTool");
    ...
    String rutaMapa =  aplicacion.getString("url.mapa.catastro");
      try{
