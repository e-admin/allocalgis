/**
 * GeopistaEditarDominiosPlaneamiento.java
...
public class GeopistaEditarDominiosPlaneamiento  extends JPanel implements WizardPanel{
 ...
 if(aplicacion.isLogged())
 {
	 ...
	 GeopistaPermission paso = new GeopistaPermission("Geopista.Planeamiento.Edición de dominios");
	 boolean acceso = aplicacion.checkPermission(paso,"Planeamiento");
	...
	private boolean configureApp() {
		...
		try {
            ...
            try{
                   ...
                   Constantes.Locale = UserPreferenceStore.getUserPreference(UserPreferenceConstants.DEFAULT_LOCALE_KEY,"es_ES",false);
                   try{Constantes.idMunicipio=new Integer(UserPreferenceStore.getUserPreference(UserPreferenceConstants.DEFAULT_MUNICIPALITY_ID,"0",false)).intValue();
                   }catch (Exception e){
                              JOptionPane.showMessageDialog(this, "Valor de id municipio no valido:"+e.toString()+UserPreferenceStore.getUserPreference(UserPreferenceConstants.DEFAULT_MUNICIPALITY_ID,"0",false));
                              //System.out.println("Valor de id municipio no valido:"+e.toString()+app.getUserPreference(UserPreferenceConstants.DEFAULT_MUNICIPALITY_ID,"0",false));
                              //logger.error("Valor de id municipio no valido:"+e.toString()+app.getUserPreference(UserPreferenceConstants.DEFAULT_MUNICIPALITY_ID,"0",false));
                              System.exit(-1);
                   }
