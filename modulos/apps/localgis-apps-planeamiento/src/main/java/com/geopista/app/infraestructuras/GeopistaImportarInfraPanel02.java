/**
 * GeopistaImportarInfraPanel02.java
...
public class GeopistaImportarInfraPanel02 extends JPanel implements WizardPanel
{
    ...
    public GeopistaImportarInfraPanel02()
        {
    ...
    private void jbInit() throws Exception
    {
        ...
        geopistaEditor2 = (GeopistaEditor) blackImportar.get("infraestructurasEditor");
        try
        {
            String helpHS = "ayuda.hs";
            HelpSet hs = com.geopista.app.help.HelpLoader.getHelpSet(helpHS);
            HelpBroker hb = hs.createHelpBroker();
            hb.enableHelpKey(this, "infraestructurasImportar02.htm", hs);
        ...
        nombreMapa = aplicacion.getI18nString("importar.usuario.paso3.mapa.infr");
