/**
 * GeopistaImportarPlaneamiento01Panel.java
...
public class GeopistaImportarPlaneamiento01Panel extends JPanel implements WizardPanel
{
    ...
    private void jbInit() throws Exception
    {
        ...
        try
        {
            idMunicipio = Integer.parseInt(aplicacion.getString(UserPreferenceConstants.DEFAULT_MUNICIPALITY_ID));
        } catch (Exception e)
        {
    ...
    private void btnAbrir_actionPerformed(ActionEvent e)
    {
        ...
        File currentDirectory = (File) blackImportar.get(Constantes.LAST_IMPORT_DIRECTORY);
