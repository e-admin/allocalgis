...
public class LoadCatalogo extends Load {
	...
	private static final long serialVersionUID = 1L;
        ...
        public LoadCatalogo(java.awt.Frame parent, boolean modal,
            ...
            url= aplicacion.getString(UserPreferenceConstants.LOCALGIS_SERVER_URL) + WebAppConstants.ADMINISTRACION_WEBAPP_NAME;
       ...
       protected void aceptar(){
          try{ 
        	  ...
        	  logger.error("Se ha producido un error al comprobar fichero con su esquema",saex);
