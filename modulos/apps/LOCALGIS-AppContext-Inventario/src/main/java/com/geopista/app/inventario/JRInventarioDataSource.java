...
//        	Arrays.sort(bienes.toArray(),new BienComparator());TODO :¿SE necesita ordenar?
        ...
        inventarioClient= new InventarioClient(((AppContext) AppContext.getApplicationContext()).getString(UserPreferenceConstants.LOCALGIS_SERVER_ADMCAR_SERVLET_URL) +
     ...
     */
      public Object getFieldValue(JRField field) throws JRException{
        ...
        if (field.getName().startsWith("IMG_")){
            ...
            String imagefile=AppContext.getApplicationContext().getString("ruta.base.mapas")+path_plantillas_inventario+File.separator+ConstantesLocalGISPlantillas.PATH_IMG+File.separator+nombreFichero;
            System.out.println("JRInventario:Localizacion de la imagen:"+imagefile);
            return imagefile;
        ...
        if (field.getName().startsWith("LOGO_")){
           ...
           // return Constantes.PATH_PLANTILLAS_INVENTARIO + File.separator +"img" + File.separator + AppContext.getIdMunicipio() + ".png";
            //Los logotipos de los ayuntamientos se encuentran dentro de la carpeta escudos
            //Log.info("Imagen del Logotipo del ayuntamiento:"+Constantes.PATH_PLANTILLAS_INVENTARIO + File.separator +"img" + File.separator +ConstantesLocalGISPlantillas.PATH_ESCUDOS+File.separator+ AppContext.getIdMunicipio() + ".png");
            //System.out.println("Imagen del Logotipo del ayuntamiento:"+Constantes.PATH_PLANTILLAS_INVENTARIO + File.separator +"img" + File.separator +ConstantesLocalGISPlantillas.PATH_ESCUDOS+File.separator+ AppContext.getIdMunicipio() + ".png");
            //File f=new File(Constantes.PATH_PLANTILLAS_INVENTARIO + File.separator +"img" + File.separator +ConstantesLocalGISPlantillas.PATH_ESCUDOS+File.separator+ AppContext.getIdMunicipio() + ".png");

            String imagefile=AppContext.getApplicationContext().getString("ruta.base.mapas")+path_plantillas_inventario+File.separator+ConstantesLocalGISPlantillas.PATH_IMG+File.separator+ConstantesLocalGISPlantillas.PATH_ESCUDOS+File.separator+ AppContext.getIdMunicipio() + ".png";
            System.out.println("JRInventario:Localizacion del escudo:"+imagefile);
            return imagefile;
        }
