/**
 * HistoricoAmortizacionJDialog.java
...
private static final Logger logger = Logger.getLogger(HistoricoAmortizacionJDialog.class);
	...
	private void insertarHistoricoAmortizado() {
		try {
			listaHA=inventarioClient.insertBienesAmortizables(Integer.parseInt(UserPreferenceStore.getUserPreference(Const.KEY_ANIO_AMORTIZACION,"0000",true)));
...
//		});
	...
	private void renombrarComponentes(){
        String [] anioAmort={UserPreferenceStore.getUserPreference(Const.KEY_ANIO_AMORTIZACION,"0000",true)};     	        		   
...
//									dispose();
	...
	private JFileChooser getFileChooser() {
        if (fileChooser == null) {
			...
			fileChooser.setSelectedFile(new File(File.separator+"amortizaciones"+"_"+UserPreferenceStore.getUserPreference(Const.KEY_ANIO_AMORTIZACION,"0000",false)+".xls"));
        }
