...
public class ObservacionesJPanel extends JPanel{
    ...
    public void initComponents() throws Exception{
        ...
        fechaJLabel= new InventarioLabel();
        observacionesJLabel= new InventarioLabel();

        observacionesJScrollPane= new javax.swing.JScrollPane();
        observacionesJTArea= new InventarioTextPane(999);
        observacionesJTArea.setEnabled(false);
        fechaJTField= new InventarioTextField();
     ...
     * @param bien
     */
    public void load(Collection<Observacion> observaciones){
        observacionesListaPane.setCollection(observaciones);
    ...
    /**
     * Devuelve la lista del observaciones
     * @return
     */
    public Collection<Observacion> getObservaciones(){
       return observacionesListaPane.getCollection();
    }
