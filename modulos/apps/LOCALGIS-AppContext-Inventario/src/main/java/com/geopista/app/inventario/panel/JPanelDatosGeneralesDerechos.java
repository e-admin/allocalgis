/**
 * JPanelDatosGeneralesDerechos.java
...
public class JPanelDatosGeneralesDerechos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        InventarioClient inventarioClient= new InventarioClient(aplicacion.getString(UserPreferenceConstants.LOCALGIS_SERVER_ADMCAR_SERVLET_URL) +
