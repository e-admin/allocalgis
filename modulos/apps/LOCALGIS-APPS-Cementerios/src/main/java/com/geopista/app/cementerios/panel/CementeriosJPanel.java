...
//        		ServletConstants.CEMENTERIO_SERVLET_NAME);
        ...
        cementeriosClient= new CementerioClient(aplicacion.getString(UserPreferenceConstants.LOCALGIS_SERVER_URL) + WebAppConstants.CEMENTERIOS_WEBAPP_NAME + ServletConstants.ADMINISTRADOR_CARTOGRAFIA_SERVLET_NAME +
        		ServletConstants.CEMENTERIO_SERVLET_NAME);
        ...
        try {
        	CementerioBean cementerioBean = ((CementerioBean) cementeriosClient.getCementerio(Const.ACTION_GET_CEMENTERIO, idCementerio));
			if (cementerioBean!=null)
				nombreCementerio=cementerioBean.getNombre();
			else
				logger.error("No se ha podido obtener el nombre del cementerio");
    ...
    private void abrirDialogoTarifasGPropiedad(final String operacion,String tipo) throws Exception{
        ...
        try{
        	...
        	if (operacion.equalsIgnoreCase(Constantes.OPERACION_ANNADIR)){
        		...
        		tarifa.setTipo_tarifa(Const.TARIFA_GPROPIEDAD);
    ...
    private void abrirDialogoTarifasGDifuntos(final String operacion,String tipo) throws Exception{
        ...
        try{
        	...
        	if (operacion.equalsIgnoreCase(Constantes.OPERACION_ANNADIR)){
        		...
        		TarifaBean tarifa = new TarifaBean();
        		tarifa.setTipo(tipoElemCementeriosJPanel.getSubtipoSeleccionado());
        		tarifa.setTipo_tarifa(Const.TARIFA_GDIFUNTOS);
