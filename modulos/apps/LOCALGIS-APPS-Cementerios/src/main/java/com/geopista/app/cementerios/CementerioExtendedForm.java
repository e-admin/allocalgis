 ...
 */
public class CementerioExtendedForm implements FeatureExtendedForm{
    private CementeriosJPanel inventarioPanel;

    public CementerioExtendedForm(){
    }
    ...
    public void initialize(FeatureDialogHome fd){
        ...
        inventarioPanel= new CementeriosJPanel(true);
