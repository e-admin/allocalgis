   ...
   private void initHeadersJTable(){
    ...
    private void reColorearBloqueo(){
          ...
          for (int i=0; i < tableSorted.getRowCount(); i++){
              ...
              if (cb != null && cb.getBloqueado()!=null && !cb.getBloqueado().equalsIgnoreCase(com.geopista.security.SecurityManager.getPrincipal()!=null?com.geopista.security.SecurityManager.getPrincipal().getName():UserPreferenceStore.getUserPreference(UserPreferenceConstants.DEFAULT_LOGIN_USERNAME,null,false))){
