...
public class ExhumacionJDialog extends javax.swing.JDialog {
	...
	private static final String patron = "GD-3";
...
public void setExhumacion(ExhumacionBean exhumacion) {
   ...
   private ArrayList getTarifasByServicioAndUnidad (){
	   ...
	   for (int i = 0; i < listaTarifas.size(); i++) {
		...
		//String.valueOf(getPatronExhumacion())
		if ((tarifa.getTipo_calculo().equals(patron)) && getUnidadSelected()!=null && (tarifa.getTipo_unidad() == getUnidadSelected().getTipo_unidad())){
