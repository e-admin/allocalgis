...
//    }
    ...
    private static Object getDocumentoValue(JRField field, ElemCementerioBean elem) throws Exception{
        if (field == null) return null;
        Object value= null;
        CementerioDocumentClient documentClient= new CementerioDocumentClient(((AppContext) AppContext.getApplicationContext()).getString(UserPreferenceConstants.LOCALGIS_SERVER_ADMCAR_SERVLET_URL) +
