/**
 * NotesInterventionsSearchViewPanel.java
 ...
 *
 */
public class NotesInterventionsSearchViewPanel extends JPanel{
...
//	private TextArea listaDocumentosTextArea = null;
	...
	public NotesInterventionsSearchViewPanel(LocalGISNote note){
			...
			try{
				String title = "";
				 ...
				 if (note instanceof LocalGISIntervention){
						title = I18N.get("avisospanels","localgisgestionciudad.interfaces.avisos.caducadosdialog.datosbordertitle") ;
				} else if (note instanceof LocalGISNote){
					title = I18N.get("avisospanels","localgisgestionciudad.interfaces.notes.caducadosdialog.datosbordertitle") ;
				}
				title = title + " " +  note.getId();
