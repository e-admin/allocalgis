			...
			if (aviso.getStartWarning() != null){
				try{
					this.getFechaAltaLabel().setText(campoFechaAlta
							+ ConstantesEspacioPublico.DateFormat.format(aviso.getStartWarning().getTime()));
			...
			if (aviso.getNextWarning() != null){
				try{
					this.getFechaProximoAvisoLabel().setText(campoProxFecha
							+ ConstantesEspacioPublico.DateFormat.format(aviso.getNextWarning().getTime()));
				} catch ( IllegalArgumentException e) {
					e.printStackTrace();
					this.getFechaProximoAvisoLabel().setText(campoProxFecha);
				}
