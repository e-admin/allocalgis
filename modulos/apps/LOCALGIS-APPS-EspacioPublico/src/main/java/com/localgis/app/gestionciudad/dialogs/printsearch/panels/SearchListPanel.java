...
//							UserPreferenceStore.getUserPreference(UserPreferenceConstants.DEFAULT_LOGIN_USERNAME, "", true), 
...
//							String userName = UserPreferenceStore.getUserPreference(UserPreferenceConstants.DEFAULT_LOGIN_USERNAME, "", true);
//							int idMunicipio = AppContext.getIdMunicipio();
//							if ((userName != null && !userName.equals("")) && idMunicipio > 0 ){
