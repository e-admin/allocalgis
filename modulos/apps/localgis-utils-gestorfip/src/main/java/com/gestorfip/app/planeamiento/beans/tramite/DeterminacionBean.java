...
public class DeterminacionBean {
	...
	private int madre;
	private int tramite;
	//indica si la determinacion es modificable o no
	//No sera modificable si corresponde a una determinacion del catalogo sistematizado
	// Sera modificable si corresponde a una determinacion del Planeamiento encargado
	...
	private DocumentoDeterminacionBean[] lstDocumento;
	private DocumentoDeterminacionBean[] lstDocumentoAlta;
	private DocumentoDeterminacionBean[] lstDocumentoBaja;
	...
	public DocumentoDeterminacionBean[] getLstDocumento() {
		return lstDocumento;
	}

	public void setLstDocumento(DocumentoDeterminacionBean[] lstDocumento) {
		this.lstDocumento = lstDocumento;
	}

	public DocumentoDeterminacionBean[] getLstDocumentoAlta() {
		return lstDocumentoAlta;
	}

	public void setLstDocumentoAlta(DocumentoDeterminacionBean[] lstDocumentoAlta) {
		this.lstDocumentoAlta = lstDocumentoAlta;
	}

	public DocumentoDeterminacionBean[] getLstDocumentoBaja() {
		return lstDocumentoBaja;
	}

	public void setLstDocumentoBaja(DocumentoDeterminacionBean[] lstDocumentoBaja) {
