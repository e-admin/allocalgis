 ...
 */
//$HeadURL: https://svn.wald.intevation.org/svn/deegree/base/trunk/src/org/deegree/model/filterencoding/PropertyIsCOMPOperation.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * Encapsulates the information of a <PropertyIsCOMP>-element (as defined in Filter DTD). COMP can
...
public class PropertyIsCOMPOperation extends ComparisonOperation {
    ...
    public boolean evaluate( Feature feature )
        ...
        // en cualquier caso que vaya a hacer una comparacion y el objeto sea vacio le doy boleto
        if ((value1 instanceof String) && (((String)value1).trim().equals(""))) {
        	return false;
        }
        else if ((value2 instanceof String) && (((String)value2).trim().equals(""))) {
        	return false;
        }
        ...
        if ( value1 instanceof String && value2 instanceof String ) {
            ...
            case OperationDefines.PROPERTYISGREATERTHANOREQUALTO:
                throw new FilterEvaluationException( "'" + getOperatorName()
                                                     ...
                                                     + "String values!" );
            default:
                throw new FilterEvaluationException( "Unknown comparison operation: '"
                                                     + getOperatorName() + "'!" );
            }
        }// compare Doubles
 ...
 *** empty log message ***
 ...
 Revision 1.11  2007/03/19 08:47:33  wanhoff
 Fixed Javadoc (@param, @return)
