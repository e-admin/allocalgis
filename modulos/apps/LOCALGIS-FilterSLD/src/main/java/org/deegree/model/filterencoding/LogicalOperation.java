 ...
 */
//$HeadURL: https://svn.wald.intevation.org/svn/deegree/base/trunk/src/org/deegree/model/filterencoding/LogicalOperation.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class LogicalOperation extends AbstractOperation {
     ...
     * @param arguments
     */
    public LogicalOperation( int operatorId, List  arguments ) {
        super( operatorId );
    ...
    public StringBuffer toXML() {
        ...
        for ( int i = 0; i < arguments.size(); i++ ) {
            sb.append( ((Operation) arguments.get( i )).toXML() );
        }
    ...
    public boolean evaluate( Feature feature )
        ...
        switch ( getOperatorId() ) {
            case OperationDefines.AND: {
                for ( int i = 0; i < arguments.size(); i++ ) {
                    if ( !((Operation)arguments.get( i )).evaluate( feature ) )
                        return false;
                }
                return true;
            }
            ...
            case OperationDefines.NOT: {
                return !((Operation)arguments.get( 0 )).evaluate( feature );
            }
            default: {
