 ...
 */
//$HeadURL: https://svn.wald.intevation.org/svn/deegree/base/trunk/src/org/deegree/model/filterencoding/FeatureFilter.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class FeatureFilter extends AbstractFilter {
    ...
    private ArrayList  featureIds = new ArrayList ();
