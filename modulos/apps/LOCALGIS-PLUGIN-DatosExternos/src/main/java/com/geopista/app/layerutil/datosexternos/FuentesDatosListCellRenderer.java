/**
 * FuentesDatosListCellRenderer.java
...
public class FuentesDatosListCellRenderer extends JLabel implements ListCellRenderer {
     ...
     *
     */
    public FuentesDatosListCellRenderer() {
        super();
        setOpaque(true);
    }
    /**
        ...
        boolean cellHasFocus)
    {
        ...
        if (value instanceof ExternalDataSource){
            ExternalDataSource externalDS = (ExternalDataSource)value;
            String texto = externalDS.getName(); 
            setText(texto);            
        }
