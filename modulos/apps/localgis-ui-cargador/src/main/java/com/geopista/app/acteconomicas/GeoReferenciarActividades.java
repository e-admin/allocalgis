/**
 * GeoReferenciarActividades.java
    ...
    private ArrayList geoReferenciarActividadesBD(TaskMonitorDialog progressDialog)
    {
        ...
        try
        {
                ...
                for (Iterator it=actividadeEco.iterator();it.hasNext();)
                {
                    ...
                    FeatureCollection fc=administradorCartografiaClient.getGeoRefAddress(
                    ...
                    if (fc==null|| fc.getFeatures().size()==0)
                    {
                        ...
                        fc=administradorCartografiaClient.getGeoRefAddress("%",datos.getNombreviaine(),"%",Locale.getDefault().toString());
                        if (fc==null|| fc.getFeatures().size()==0)
