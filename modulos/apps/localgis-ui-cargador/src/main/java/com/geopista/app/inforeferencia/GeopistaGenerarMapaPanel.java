...
public class GeopistaGenerarMapaPanel extends JPanel implements WizardPanel
{
...
//  private GeopistaEditor geopistaEditor1 = new GeopistaEditor();
  ...
  public GeopistaGenerarMapaPanel()
  {
    try
    {
      jbInit();
  ...
  private void jbInit() throws Exception
  {
	...
	lblOpcion.setText(aplicacion.getI18nString("previsua"));
...
//    geopistaEditor1.addCursorTool("Select tool", "com.geopista.ui.cursortool.GeopistaSelectFeaturesTool");
    ...
    String rutaMapa =  aplicacion.getString("url.mapa.inforeferencia");
      try{
