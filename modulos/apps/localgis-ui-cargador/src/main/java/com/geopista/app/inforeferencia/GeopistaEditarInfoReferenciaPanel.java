/**
 * GeopistaEditarInfoReferenciaPanel.java
...
public class GeopistaEditarInfoReferenciaPanel
{
  private ApplicationContext appcont = AppContext.getApplicationContext();
  
   public GeopistaEditarInfoReferenciaPanel()
   {
	  final String[] parametros = new String[6];

    try{

    String rutaMapa = appcont.getString("url.mapa.inforeferencia");
    parametros[0] = "-map";
