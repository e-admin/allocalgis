...
public class SQLParserOracle {
        ...
        public PreparedStatement[] newUpdateOracle(int iMunicipio,String sSQL, IACLayer schema,
            ...
            for(int i=0;i<sQueries.length;i++){
                ...
                while(matcher.find()){
                    ...
                    if (sMatch.equals("M")){
                        ...
                        if (att!=null && att.getColumn().getType()==IACLayer.TYPE_GEOMETRY)
                        {
                            try
                            {
         ...
         public PreparedStatement newSelectOracle(int iMunicipio,String sSQL, IACLayer schema,Geometry geometry, FilterNode fn)
