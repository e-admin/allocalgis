...
public class LoadSystemLayersPanel01  extends JPanel implements WizardPanel
{
  ...
  public LoadSystemLayersPanel01(String id, String nextId, PlugInContext context)
  {
    this.nextID = nextId;
    this.localId = id;
