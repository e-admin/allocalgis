/**
 * GeopistaOneLayerAttributeTab.java
 ...
 */
public class GeopistaOneLayerAttributeTab extends AttributeTab {
    public GeopistaOneLayerAttributeTab(WorkbenchContext context, TaskComponent taskFrame,
    ...
    public GeopistaOneLayerAttributeTab setLayer(Layer layer) {
    ...
    public GeopistaOneLayerAttributeTab setLayer(Collection collection ,Layer layer) {
        if (!getModel().getLayers().isEmpty()) {
            getModel().remove(getLayer());
        }
