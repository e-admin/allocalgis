							...
							if (rightValue instanceof String)
								{
									if (comp instanceof JTextComponent ){
										...
										String previousText=((String)((javax.swing.JComboBox) comp).getSelectedItem());
										if (!(rightValue).equals(previousText))
										((javax.swing.JComboBox) comp).setSelectedItem(rightValue);
									}
								}
								else
								{
									if (comp instanceof JTextComponent ){
										...
										if (!format.format(rightValue).equals( ((javax.swing.JComboBox) comp).getSelectedItem()))
											((javax.swing.JComboBox) comp).setSelectedItem(format.format(rightValue));
									}
								}
