 ...
 */
public class LockFeaturesPlugIn extends ThreadedBasePlugIn implements LayerViewPanelListener ,InternalFrameListener, LockListener
{
                ...
                public void componentShown(ComponentEvent e) {
                    ...
                    new Thread(new Runnable(){
                        public void run()
                        {
                            ...
                            {
                                /*ErrorDialog.show(aplicacion.getMainFrame(), aplicacion
                                        .getI18nString("ErrorAlDesbloquearFeatures"), aplicacion
                                        .getI18nString("ErrorAlDesbloquearFeatures"), StringUtil
                                        .stackTrace(e));*/
                            }finally
                            {
    ...
    public void updateButton()
    {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
            	...
            	if (globalContext.getActiveTaskComponent()!=null){
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
            	...
            	if (globalContext.getWorkbenchFrame()!=null)
            		frames=globalContext.getWorkbenchFrame().getInternalFrames();
            	else  if (globalContext.getWorkbenchGuiComponent()!=null)
            		frames = globalContext.getWorkbenchGuiComponent().getInternalFrames();
...

                {
                	...
                	if (globalContext.getWorkbenchGuiComponent() instanceof com.geopista.editor.GeopistaEditor){
                		((com.geopista.editor.GeopistaEditor)globalContext.getWorkbenchGuiComponent()).getLayerViewPanel().repaint();
                	}
                }
            }
        });
