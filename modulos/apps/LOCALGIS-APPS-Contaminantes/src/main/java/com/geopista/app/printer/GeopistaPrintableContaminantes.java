/**
 * GeopistaPrintableContaminantes.java
 ...
 * Time: 15:56:49
 */
public class GeopistaPrintableContaminantes extends javax.swing.JPanel implements Printable{
	private static Logger logger = Logger.getLogger(GeopistaPrintableContaminantes.class);
							...
							if ((sValor != null) && (!sValor.equals(""))) {
								...
								case FICHA_CONTAMINANTE_VERTEDERO:
									if (sDomSource.equalsIgnoreCase("DocumentacionTipoZonaArbolada")) {
										Hashtable hDomainNodes = com.geopista.app.contaminantes.Estructuras.getListaTipoZonaArbolada().getLista();
										for (Enumeration _e=hDomainNodes.elements();_e.hasMoreElements();)
										{
											...
											if (auxDomain.getPatron().equalsIgnoreCase(sValor))
												sValor = ((DomainNode)com.geopista.app.contaminantes.Estructuras.getListaTipoZonaArbolada().getDomainNode(sValor)).getTerm(com.geopista.app.contaminantes.CMainContaminantes.messages.getLocale().toString());
										}
									}
									break;
								case FICHA_CONTAMINANTE_PLANOS:
	...
	public void printObjeto(String urlXml, Object objeto, Class clase, Image plano, int tipoFicha) throws Exception
	{
		...
		ClassLoader cl =(new GeopistaPrintableContaminantes()).getClass().getClassLoader();
