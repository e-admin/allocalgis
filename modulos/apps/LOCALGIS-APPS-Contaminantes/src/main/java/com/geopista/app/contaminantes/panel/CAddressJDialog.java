...
public class CAddressJDialog extends javax.swing.JDialog {
	Logger logger = Logger.getLogger(com.geopista.app.contaminantes.panel.CAddressJDialog.class);
	...
	private void buscarJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarJButtonActionPerformed
		...
		try {
			...
			Vector referenciasCatastrales = (new OperacionesContaminantes(Constantes.url)).getSearchedAddressesByNumPolicia(hash); 
