...
public class CutSelectedRasterImageLayersPlugIn extends MacroPlugIn {
    ...
    protected final static String shortClassName = CutSelectedRasterImageLayersPlugIn.class.getName().substring(CutSelectedRasterImageLayersPlugIn.class.getName().lastIndexOf(".")+1);
