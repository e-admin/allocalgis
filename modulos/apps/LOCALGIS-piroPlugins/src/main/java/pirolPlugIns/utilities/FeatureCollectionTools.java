 ...
 *  $RCSfile: FeatureCollectionTools.java,v $
 *  $Revision: 1.1 $
 *  $Date: 2009/07/03 12:31:54 $
 *  $Source: /usr/cvslocalgis/.CVSROOT/localgisdos/core/src/pirolPlugIns/utilities/FeatureCollectionTools.java,v $s
 */
...
public class FeatureCollectionTools extends ToolToMakeYourLifeEasier {
     ...
     */
    public static Feature getFeatureFromCollection( List features, int fid ){
     ...
     *@return the mean (double because a mean of integers will very likely be a double) 
     */
    public static double getAritmeticMiddleForAttribute( List features, int attr ){
     ...
     *@return number of differnt values in the given features attributes or -1 if an error occurs
     */
    public static Set getSetOfDifferentAttributeValues( Feature[] features, int attr ){
        Feature[] featArray = features;
        int numFeats = featArray.length;
        
        HashSet differentValues = new HashSet();
        Object val;
     ...
     */
    public static void deleteFeatures( List features, PlugInContext context ){
     ...
     *@see AttributeInfo
     */
    public static PirolFeatureCollection addAttributesToFeatureCollection( FeatureCollection fc, List attributeInfos ){
    ...
    public static PirolFeatureCollection addAttributesToFeatureCollection( FeatureCollection fc, AttributeInfo[] attributeInfos ){
        ...
        for (int i=0; i<attributeInfos.length; i++){
            ...
            fs.addAttribute(attrInfo.getUniqueAttributeName(), attrInfo.attributeType);
        }
    ...
    */
     ...
     */
    public static Feature[] FeatureCollection2FeatureArray( List features ){
