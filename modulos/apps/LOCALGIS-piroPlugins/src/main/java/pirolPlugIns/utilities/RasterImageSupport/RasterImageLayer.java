...
public class RasterImageLayer extends AbstractLayerable implements ObjectContainingMetaInformation, IRasterImageLayer {
	 ...
	 */
    @Override
	public BufferedImage createImage(ILayerViewPanel layerViewPanel) {
        ...
        try {
            ...
            visibleRect = ((LayerViewPanel)viewport.getPanel()).getVisibleRect();
            ...
            if (this.visibleEnv == null || this.visibleEnv.getMinX() != newVisibleEnv.getMinX() || this.visibleEnv.getMaxX() != newVisibleEnv.getMaxX() || 
                ...
                if ( (this.origImageWidth * this.origImageHeight) < RasterImageLayer.getMaxPixelsForFastDisplayModeStatic() ){
	 ...
	 */
    @Override
	public Rectangle getDrawingRectangle( double imgWidth, double imgHeight, Envelope imageEnv, IViewport viewport ) throws NoninvertibleTransformException{
        
        Rectangle visible = ((LayerViewPanel) viewport.getPanel()).getVisibleRect();
    ...
    public int getMaxPixelsForFastDisplayMode() {
        return maxPixelsForFastDisplayMode;
    }

    public static int getMaxPixelsForFastDisplayModeStatic() {
        return maxPixelsForFastDisplayMode;
    }
