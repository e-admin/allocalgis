 ...
 *  $ID$
 *  $Revision: 1.1 $
 *  $Source: /usr/cvslocalgis/.CVSROOT/localgisdos/core/src/pirolPlugIns/dialogs/NewAttributePanel.java,v $
 *  $Log: NewAttributePanel.java,v $
...
public class NewAttributePanel extends JPanel implements ActionListener {
    ...
    protected String typeLabelText = PirolPlugInMessages.getString("type-of-new-attribute");
    protected String nameLabelText = PirolPlugInMessages.getString("name-of-new-attribute");
    protected String defValLabelText = PirolPlugInMessages.getString("default-value-for-new-attribute");
