...
public class CConstantesLicencias {

	public static final String idAppLicenciasObra="Licencias Obra";
	public static final String idAppLicenciasActividad="Licencias Actividad";
    ...
    public static final int EstadoMejoraDatos=30;
  public static final int EstadoMejoraDatosII=130;
	...
	public static int MaxLengthLocalidad = 32;
	...
	public static String Localidad = null;
