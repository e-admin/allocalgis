/**
 * ConstantesLocalGISPlantillas.java
...
public class ConstantesLocalGISPlantillas {
	...
	public static String PATH_PLANTILLAS_CUADROS_EIEL="eiel"+File.separator+"cuadros";
	public static String PATH_PLANTILLAS_CUADROS_IMG_EIEL="eiel"+File.separator+"cuadros"+File.separator+"img"+File.separator;
    public static String PATH_PLANTILLAS_EIEL="eiel";
    public static String SUREPORT_DIR="eiel"+File.separator+"subreports"+File.separator;
    public static String IMAGE_DIR="eiel"+File.separator+"img"+File.separator;
	...
	public static String DIR_PLANTILLAS="/usr/local/LocalGIS/plantillas.entidad";
	public static String RESOURCES_PATH="";
	public static String PATH_PLANTILLAS=File.separator+"plantillas"+File.separator;
