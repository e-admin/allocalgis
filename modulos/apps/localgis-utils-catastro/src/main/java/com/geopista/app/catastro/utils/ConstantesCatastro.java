 ...
 */
package com.geopista.app.catastro.utils;
...
public class ConstantesCatastro
{
    ...
    public final static String CONVENIO_CONSULTA = "CONS";
    ...
    public static String helpSetHomeID= "RegExpIntro";    
	 ...
	 public static boolean botonesGestExp[]= new boolean[9];
       ...
       public final static String expedienteTipoTramitacion = "tipoTramitacion";
       ...
       public final static String expedienteDigitoControlNifPresentador = "digitoControlNifPresentador";
