...
import es.mitc.redes.urbanismoenred.serviciosweb.v1_86.UrbrWSServiceStub;
import es.mitc.redes.urbanismoenred.serviciosweb.v1_86.UrbrWSServiceStub.FechaRefundido;
import es.mitc.redes.urbanismoenred.serviciosweb.v1_86.UrbrWSServiceStub.FechaRefundidoE;

public class ClientConsole_v1_86 {
	...
	public static void setTargetEndPoint(String targetEndPoint) {
		ClientConsole_v1_86.targetEndPoint = targetEndPoint + "/urbrWS";
	}
	...
	public FicheroFipConsoleBean  obtenerFechaRefundido(ApplicationContext app, int idAmbito)throws Exception{
		...
		UrbrWSServiceStub customer = null;
		UrbrWSServiceStub.FechaRefundidoResponseE response = null;
		...
		try { 
			...
			// creamos el soporte
			customer = new UrbrWSServiceStub(targetEndPoint);
			...
			if (strXml != null) {
				 ...
				 fichFipConsole.setUrlFip(element.getAttribute("fip1"));
