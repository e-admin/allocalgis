...
public class ColumnDB
{
    ...
    {
        if (item.equalsIgnoreCase(ColumnDB.COL_GEOMETRY))
            return ColumnDB.GEOMETRY;
        else if (item.equalsIgnoreCase(ColumnDB.COL_INTEGER)|| item.equalsIgnoreCase(ColumnDB.COL_INT4)
                || item.equalsIgnoreCase(ColumnDB.COL_NUMERIC) )
            return ColumnDB.NUMERIC;
        else if (item.equalsIgnoreCase(ColumnDB.COL_CHAR) 
                || item.equalsIgnoreCase(ColumnDB.COL_VARCHAR))
            return ColumnDB.VARCHAR;
        else if (item.equalsIgnoreCase(ColumnDB.COL_DATE)
                || item.equalsIgnoreCase(ColumnDB.COL_TIMESTAMP))
            return ColumnDB.DATE;
        else if (item.equalsIgnoreCase(ColumnDB.COL_BOOLEAN))
