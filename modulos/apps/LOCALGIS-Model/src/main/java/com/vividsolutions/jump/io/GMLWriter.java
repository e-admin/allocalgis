...
public class GMLWriter implements JUMPWriter {
    ...
    public void write(FeatureCollection featureCollection, DriverProperties dp)
        ...
        //w = new java.io.OutputStreamWriter(new java.io.FileOutputStream(outputFname), "UTF-8");
        w = new java.io.OutputStreamWriter(new java.io.FileOutputStream(outputFname), "ISO-8859-1");
