...
public class CoordinateSystemRegistry {
	...
	private static final Log logger = LogFactory.getLog(CoordinateSystemRegistry.class);
    ...
    private CoordinateSystemRegistry() {
        ...
        add(PredefinedCoordinateSystems.GEOGRAPHICS_ED50);
        add(PredefinedCoordinateSystems.GEOGRAPHICS_ETRS89);
		add(PredefinedCoordinateSystems.GEOGRAPHICS_WGS_84);
		add(PredefinedCoordinateSystems.UTM_27N_WGS84);
		add(PredefinedCoordinateSystems.UTM_28N_WGS84);
    }
