...
import com.geopista.io.GeoReader;
...
public abstract class AbstractBasicFeature implements Feature {
    ...
    public void setAttribute(String attributeName, Object newAttribute) {
    	try{
    		...
    		setAttribute(schema.getAttributeIndex(GeoReader.parseFromUtf8ToLatin(attributeName)), newAttribute);
    	}
    }
    /**
