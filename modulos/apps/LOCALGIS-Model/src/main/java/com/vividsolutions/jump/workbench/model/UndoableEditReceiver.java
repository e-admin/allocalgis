    ...
    */
    ...
    public void receive(UndoableEdit undoableEdit) {
        Assert.isTrue(isReceiving());
          ...
          //si el flag esta a true se deshacen los cambios realizados sobre las features,
          //en caso contrario se introducen los cambios en el lista de operaciones a deshacer
          if(aborted==true)
            {
              //deshace los cambios
              undoableEdit.undo();
            ...
            else
            {
              ...
              //introduce los cambios en la lista de cambios temporales para hacerlos efectivos 
              //cuando se llama a la funcion stopReceiving
    ...
    public void setAborted(boolean flagValidateFalse)
    {
      this.aborted = flagValidateFalse;
    }
