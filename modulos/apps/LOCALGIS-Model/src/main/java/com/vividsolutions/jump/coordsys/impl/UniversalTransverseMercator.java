 ...
 *  @author $Author: miriamperez $
 * <pre>
 *  $Id: UniversalTransverseMercator.java,v 1.1 2009/07/03 12:31:54 miriamperez Exp $
 *  $Date: 2009/07/03 12:31:54 $
 *  $Log: UniversalTransverseMercator.java,v $
 *  Revision 1.1  2009/07/03 12:31:54  miriamperez
 *  Rama única LocalGISDOS
 *
 *  Revision 1.5  2005/10/11 08:28:43  jpcastro
 *  Ajustes para manejo adecuado de diversas proyecciones incluyendo soporte para todas las UTM
 *
 *  Revision 1.4  2005/10/05 10:53:00  jpcastro
 *  soporte para proyecciones en todos los husos
 *
 *  Revision 1.3  2004/05/27 08:51:57  jpcastro
 *  version 1.1.1 de Jump
 *
...
public class UniversalTransverseMercator extends Projection {
  ...
  /**
   * support europe 
   * TODO: REvisar esta suposición tan ligera
   * supongo que los merididanos usan parámetro según:
   * 5 -147
   * 4 -153
   * 3 -159
   * 2 -165
   ...
   * n -177+ n*6
   */
  transverseMercator.setParameters(zone*6-177);
