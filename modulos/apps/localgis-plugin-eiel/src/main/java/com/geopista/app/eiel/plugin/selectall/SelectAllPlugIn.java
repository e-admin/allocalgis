 ...
 */
package com.geopista.app.eiel.plugin.selectall;
...
public class SelectAllPlugIn extends ThreadedBasePlugIn {
	...
	public SelectAllPlugIn() {
    	...
    	ResourceBundle bundle2 = ResourceBundle.getBundle("com.geopista.app.eiel.plugin.selectall.languages.SelectAlli18n",loc,this.getClass().getClassLoader());    	
        I18N.plugInsResourceBundle.put("SelectAll",bundle2);
    }
            ...
            .add(new EnableCheck() {
            	public String check(JComponent component) {            		
            		...
            		for (int h=0;h<layerables.length;h++){            			
            				if (layerables[h].isVisible() == false) {
            					return null;
                			}
            			}            		      		
