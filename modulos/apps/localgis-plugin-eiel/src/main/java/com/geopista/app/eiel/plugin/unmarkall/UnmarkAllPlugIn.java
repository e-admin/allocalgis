 ...
 */
package com.geopista.app.eiel.plugin.unmarkall;
...
public class UnmarkAllPlugIn extends ThreadedBasePlugIn{
	
	private static AppContext aplicacion = (AppContext) AppContext
    .getApplicationContext();		
	
	public UnmarkAllPlugIn() {
    	Locale loc=Locale.getDefault();      	 
    	ResourceBundle bundle2 = ResourceBundle.getBundle("com.geopista.app.eiel.plugin.unmarkall.languages.UnmarkAlli18n",loc,this.getClass().getClassLoader());    	
        I18N.plugInsResourceBundle.put("UnmarkAll",bundle2);
    }
            ...
            .add(new EnableCheck() {
            	public String check(JComponent component) {
            		...
            		for (int h=0;h<layerables.length;h++){            			
            				if (layerables[h].isVisible() == true) {
            					return null;
                			}
            			}       
	...
	public void desmarcar (Layerable[] selectedLayers){
    ...
    {
		desmarcar((Layerable[]) (context.getLayerNamePanel()).getLayerManager().getLayerables(Layerable.class).toArray(new Layerable[] {  }));
    }
}
