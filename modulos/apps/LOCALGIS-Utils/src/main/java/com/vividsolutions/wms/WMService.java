...
import com.geopista.ui.wms.Parser;
...
public class WMService {   
  ...
  private Capabilities cap;
	...
	private static final Log logger = LogFactory.getLog(WMService.class);
   ...
   */
	public void initialize() throws IOException {
        ...
        if ("ArcIMS".equals(wmsVersion))return;
	    ...
	    logger.info("Solicitando Get Capabilities:"+requestUrlString);
	    ...
	    Parser p = new Parser();
	    logger.info("Parseando Capabilities:");
	    cap = p.parseCapabilities( this, inStream );
	    logger.info("Capabilities parseadas");
  }
