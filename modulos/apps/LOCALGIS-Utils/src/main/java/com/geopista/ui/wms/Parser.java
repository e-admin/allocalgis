...
//        throw new Exception( I18N.get("com.vividsolutions.wms.Parser.not-a-latlon-boundingbox-element") );
      ...
      // also possible NumberFormatException
        e.printStackTrace();
      throw new Exception( "com.vividsolutions.wms.Parser.invalid-bounding-box-element-node : " + e.toString() );
    }    
  }
...
//          parser.parse( new InputSource( inStream ) );
      ...
      Node formatNode = XMLTools.simpleXPath( doc, cadenaWMS+"/Capability/Request/GetMap" );
