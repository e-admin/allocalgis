 ...
 */
package com.geopista.ui.plugin.wms;
    ...
    public void initialize( PlugInContext context ) throws Exception {
        ...
        context.getFeatureInstaller().addPopupMenuItem(
        		 context.getWorkbenchContext().getIWorkbench()
        	        .getGuiComponent().getWMSLayerNamePopupMenu(), this,
...
// ------------------------------ ZoomToWMSPLugIn getSelectedWMSLayerNames ( )
            ...
            if ( anzBB == 0 ) {
                ...
                for (int k = 0; k < anzBB; k++) {
                    ...
                    if ( tmpSRS.indexOf( "latlon" ) >= 0 )
                        tmpSRS = "epsg:"+GEOGRAPHICS_ETRS89;
    ...
    void zoomToBoundingBox( PlugInContext context, Hashtable boundingBoxesForSRS, String selectedSRS )
        ...
        String tmpLatLon = "";
        if ( selectedSRS.indexOf(GEOGRAPHICS_ETRS89) >= 0 )
            tmpLatLon = " (LatLon)";
        ...
        context.getWorkbenchContext().getIWorkbench().getGuiComponent().setStatusMessage( message );
        ...
        ((LayerViewPanel)context.getLayerViewPanel()).updateUI();
