/**
 * GeopistaFusionViasStandalonePlugIn.java
...
public class GeopistaFusionViasStandalonePlugIn extends AbstractPlugIn implements ThreadedPlugIn
{
    /**
     * Logger for this class
     */
    private static final Log logger = LogFactory.getLog(GeopistaFusionViasStandalonePlugIn.class);
    ...
    public GeopistaFusionViasStandalonePlugIn()
        {
        }
	                ...
	                public void execute()
	                {
	                    ...
	                    try
	                    {
	                        while (insertKeysFeaturesIter.hasNext())
	                        {
	                            ...
	                            GeopistaSchema targetSchemaVias = (GeopistaSchema) capaVias.getFeatureCollectionWrapper().getFeatureSchema();
	                            currentInsertFeature.setAttribute(targetSchemaVias.getAttributeByColumn("valido"), 1);
	                    ...
	                    try
	                    {
	                    	...
	                    	String sridDestino = geoConn.getSRIDDefecto(false, Integer.parseInt(iSesion.getIdEntidad()));
