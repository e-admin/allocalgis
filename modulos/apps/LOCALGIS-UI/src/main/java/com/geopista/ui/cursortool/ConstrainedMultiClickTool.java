...
public abstract class ConstrainedMultiClickTool extends AbstractCursorTool
{
	...
	final static String lengthST =I18N.get("ConstrainedMultiClickTool","length");
	final static String angleST =I18N.get("ConstrainedMultiClickTool","angle");
	final static String degrees =I18N.get("ConstrainedMultiClickTool","degrees");
    ...
    public ConstrainedMultiClickTool()
    {
    	...
    	ResourceBundle bundle2 = ResourceBundle.getBundle("com.geopista.ui.cursortool.languages.ConstrainedMultiClickTooli18n",loc,this.getClass().getClassLoader());    	
        I18N.plugInsResourceBundle.put("ConstrainedMultiClickTool",bundle2);        
    }
...
//        {
        try
        {
            ...
            getPanel().getContext().setStatusMessage(I18N.get("ConstrainedMultiClickTool","length") + ": " + df3.format(length) + ";  " + I18N.get("ConstrainedMultiClickTool","angle") + ": " + df2.format(angle) + " " + I18N.get("ConstrainedMultiClickTool","degrees"));
...
//        }
    ...
    public void activate(ILayerViewPanel layerViewPanel)
    {
        ...
        constraintManager = new ConstraintManager(getIWorkbench().getContext());
    }
}
