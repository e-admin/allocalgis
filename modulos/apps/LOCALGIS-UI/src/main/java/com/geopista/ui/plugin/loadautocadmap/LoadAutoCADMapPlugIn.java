    ...
    public void run(TaskMonitor monitor, PlugInContext context) throws Exception
    {
    	...
    	try
    	{
			...
			try {
				...
				AppContext.getApplicationContext().getBlackboard().put(Const.KEY_SRID,geopistaMap.getMapSrid());
				AppContext.getApplicationContext().getBlackboard().put(DataSource.COORDINATE_SYSTEM_KEY,geopistaMap.getMapSrid());
			} catch (Exception e1) {
