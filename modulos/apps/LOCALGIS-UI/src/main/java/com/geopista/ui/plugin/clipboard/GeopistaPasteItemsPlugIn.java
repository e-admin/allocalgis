...
public class GeopistaPasteItemsPlugIn extends AbstractPlugIn {
    ...
    public GeopistaPasteItemsPlugIn() {
    }
   ...
   public void initialize(PlugInContext context) throws Exception {
      ...
      featureInstaller.addPopupMenuItem(layerNamePopupMenu, this,
            aplicacion.getI18nString(this.getNameWithMnemonic()), false, null,
            GeopistaPasteItemsPlugIn.createEnableCheck(context.getWorkbenchContext()));

        featureInstaller.addMainMenuItem(this, aplicacion.getI18nString("Edit"),
            aplicacion.getI18nString(this.getNameWithMnemonic()), null,
            GeopistaPasteItemsPlugIn.createEnableCheck(context.getWorkbenchContext()));
        /**
         * Keyboard shortcut
         */
        context.getWorkbenchContext().getIWorkbench().getGuiComponent().addKeyboardShortcut(KeyEvent.VK_PASTE,
                0, this, createEnableCheck(context.getWorkbenchContext()));      
   }
