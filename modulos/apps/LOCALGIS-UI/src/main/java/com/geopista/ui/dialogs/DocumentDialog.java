...
public class DocumentDialog extends JDialog implements FeatureDialogHome {
	...
	public DocumentDialog(Frame frame, String title, boolean modal, Vector features, ILayerViewPanel lyvPanel)
	{
    ...
    */
	...
	private JPanel getContentPanel() {
		if (contentPanel == null) {
            ...
            contentPanel.setPreferredSize(new Dimension(800,450));
		}
		return contentPanel;
	}
	/**
