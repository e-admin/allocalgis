 ...
 */
public class FileGeoreferencePlugIn extends ThreadedBasePlugIn 
{
...
//    private GeopistaListaMapasDialog ListaMapasDialog = null;
    ...
    public void initialize(PlugInContext context) throws Exception
    {
        ...
        featureInstaller.addMainMenuItem(this,
                ...
                I18N.get("Georreferenciacion","georeference.menu.title"), 
                false,
                null,
    ...
    public boolean execute(PlugInContext context) throws Exception
    {
        ...
        dialog.init(new WizardPanel[] {new FileGeoreferencePanel01("1","2",context),
                                  new FileGeoreferencePanel02("2","4",context),
                                  new FileGeoreferencePanel04("4","5",context),
                                  new FileGeoreferencePanel05("5","6",context),
