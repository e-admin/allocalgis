/**
 * DeselectAllDynamicFencePlugIn.java
 ...
 * 
 */
package com.geopista.ui.plugin.deselectalldynamicfence;
 ...
 *
 */
public class DeselectAllDynamicFencePlugIn extends AbstractPlugIn {
    ...
    public void initialize(final PlugInContext context) throws Exception {
        ...
        ResourceBundle bundle2 = ResourceBundle.getBundle("com.geopista.ui.plugin.deselectalldynamicfence.languages.DeselectAllDynamicFencePlugInPlugIni18n",loc,this.getClass().getClassLoader());
        I18N.plugInsResourceBundle.put("DeselectAllDynamicFencePlugIn", bundle2);        
    ...
    public String getName(){        
        ...
        String name = StringUtil.toFriendlyName(I18N.get("DeselectAllDynamicFencePlugIn", "DeselectAllDynamicFence"));
        return name;
    }
    ...
    private void getFeatures(PlugInContext context){
        ...
        try{
            if (i<n){
		        ...
		        layer.setFeatureCollection(resultFC);
				String nameLayer = layer.getSystemId();
                layerManager.getLayer(nameLayer).setDinamica(true);
                layerManager.getLayer(nameLayer).setEditable(false);
            }else{
