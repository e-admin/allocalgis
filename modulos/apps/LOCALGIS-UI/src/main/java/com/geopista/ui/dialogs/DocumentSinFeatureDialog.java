...
import com.geopista.app.document.DocumentSinFeatureExtendedForm;
 ...
 *
 */
public class DocumentSinFeatureDialog extends JDialog implements FeatureDialogHome {
    ...
    private DocumentSinFeatureExtendedForm documentExtendedForm;
...
//	protected LayerViewPanel	layerViewPanel;
	 ...
	 */
	public DocumentSinFeatureDialog() {
		super();
	...
	public DocumentSinFeatureDialog(Frame frame, String title, boolean modal, Vector features, ILayerViewPanel lyvPanel)
	{
...
//		    setLayerViewPanel(lyvPanel);
    ...
    public void buildDialog()
	{
		...
		public void componentShown(ComponentEvent arg0)
		{
		    pack();
		    pack();
		    GUIUtil.centreOnScreen(DocumentSinFeatureDialog.this);
		}
	  });
        try {
		    jbInit();
	...
	void jbInit() throws Exception {
        ...
        documentExtendedForm=new DocumentSinFeatureExtendedForm();
...
//		_strutPanel.add(getFlashFeatureButton(), null);  // Generated
    ...
    public void setVisible(boolean visible) {
        pack();
        pack();
        GUIUtil.centreOnWindow(DocumentSinFeatureDialog.this);
