...
public class JDialogLocalSinFeature extends JDialog
{
    ...
    public JPanelComentariosSinFeature jPanelComentario =new JPanelComentariosSinFeature();
    ...
    public JDialogLocalSinFeature(JFrame frame, char tipo){
        super(frame);
        jbinit(frame, tipo);
    }


    public JDialogLocalSinFeature(JFrame frame, char tipo, boolean fromInventario){
        super(frame);
        ...
        jPanelComentario= new JPanelComentariosSinFeature(fromInventario);
        jbinit(frame, tipo);
    }
