 ...
 */
public abstract class AbstractCenterTool implements CursorTool {
    ...
    public static WorkbenchFrame workbenchFrame(ILayerViewPanel layerViewPanel) {
        Window window = SwingUtilities.windowForComponent((LayerViewPanel)layerViewPanel);
    ...
    public static WorkBench iWorkbench(LayerViewPanel panel) {
        return ((WorkbenchGuiComponent) SwingUtilities.getAncestorOfClass(WorkbenchGuiComponent.class,
            panel)).getContext().getIWorkbench();
    }
    /**
