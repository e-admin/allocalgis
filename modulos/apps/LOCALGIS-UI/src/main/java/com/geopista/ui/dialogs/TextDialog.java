...
import com.geopista.app.text.TextExtendedForm;
 ...
 *
 */
public class TextDialog extends JDialog implements FeatureDialogHome {
    ...
    private TextExtendedForm textExtendedForm;
	...
	public TextDialog(Frame frame, String title, boolean modal, Vector features, ILayerViewPanel lyvPanel)
	{
    ...
    public void buildDialog()
	{
		...
		public void componentShown(ComponentEvent arg0)
		{
		    pack();
		    pack();
		    GUIUtil.centreOnScreen(TextDialog.this);
		}
	  });
        try {
		    jbInit();
	...
	void jbInit() throws Exception {
        ...
        textExtendedForm=new TextExtendedForm();
        textExtendedForm.initialize(this);
        setDescription();
    ...
    public void setLock()
    {
        if (textExtendedForm!=null)
            textExtendedForm.disableAll();
    }
    public void setVisible(boolean visible) {
        pack();
        pack();
        GUIUtil.centreOnWindow(TextDialog.this);
    ...
    */
    ...
    public Feature getFeature() {
         if (textExtendedForm!=null)
               return textExtendedForm.getSelectedFeature();
            return null;  //To
       }
    /* (non-Javadoc)
	...
	private JButton getZoomFeatureButton() {
		if (zoomFeatureButton == null) {
			...
			zoomFeatureButton.addActionListener(new java.awt.event.ActionListener()
			{
				...
				{
				   zoom(textExtendedForm.getSelectedFeature());
                   setDescription();
				}
			});
		}
    ...
    private void boxActionPerformed(){
            //if (jComboBoxFeatures.getSelectedIndex()!=0){
            	...
            	textExtendedForm.getInfoTextPanel().setFeature(feature);
			...
			flashFeatureButton.addActionListener(new java.awt.event.ActionListener()
				{
					public void actionPerformed(java.awt.event.ActionEvent e)
					{
                         flashFeature(textExtendedForm.getSelectedFeature());
                         setDescription();
					}
				});
