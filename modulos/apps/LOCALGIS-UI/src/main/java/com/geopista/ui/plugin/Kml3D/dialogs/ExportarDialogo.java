...
/**
 * Dialogo para exportar estilos
 * 
 * @author David Vicente
 *
 */
public class ExportarDialogo extends JDialog{
	...
	public void inicializar()
	{
		...
		this.setModal ( true );  
		this.setTitle ( I18N.get ( Kml3DPlugIn.name,"Kml3D.dialogoExportar.tituloDialogo" ) );
	...
	public void inicializaComponentes()
	{
		...
		this.botonExaminar = new JButton ( I18N.get ( Kml3DPlugIn.name, "Kml3D.dialogoExportar.botonExaminar" ) );
		this.botonExaminar.addActionListener ( 
				...
				{			
					public void actionPerformed(ActionEvent e) 
					{
					    ...
					    int returnVal = fileChooser.showSaveDialog(ExportarDialogo.this);
			
					    if (returnVal == JFileChooser.APPROVE_OPTION) 
					    {
					    	File file = fileChooser.getSelectedFile();	
					    	ExportarDialogo.this.campoFichero.setText ( file.getAbsolutePath() );
					    } 
					    else 
					    {				    	
					    }
	...
	private JPanel creaPanelImportarEstilo()
	{
		...
		JLabel etiquetaInformacion = new JLabel ( I18N.get ( Kml3DPlugIn.name, "Kml3D.dialogoExportar.etiquetaInforamcion" ) );
	...
	protected JPanel creaPanelBotonesAceptarCancelar()
	{
		...
		JButton botonAceptar = new JButton ( I18N.get ( Kml3DPlugIn.name, "Kml3D.dialogoExportar.aceptar" ) );
		JButton botonCancelar = new JButton ( I18N.get ( Kml3DPlugIn.name, "Kml3D.dialogoExportar.cancelar" ) );
