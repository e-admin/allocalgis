 ...
 * 
 */
public class LoadMapRenderer extends JPanel implements ListCellRenderer
{
            ...
            boolean isSelected, boolean cellHasFocus)
    {
    	...
    	if(value instanceof GeopistaMap){
        ...
        if (estadoMapa.equals(aplicacion.getI18nString("Mapa.Local")))       
            lblEstado.setIcon(com.geopista.ui.images.IconLoader.icon("Data.gif")); // Generated        
        else        
            lblEstado.setIcon(com.geopista.ui.images.IconLoader.icon("online.png")); // Generated
        ...
        return this;
    ...
    else{//Se trata de un mapa de la EIEL
    	  EIELMapTask task = (EIELMapTask) value;
          String fechaMapa = null;
          String estadoMapa = null;
          ...
          fechaMapa = (df.format(new GregorianCalendar().getTime()));
          estadoMapa = aplicacion.getI18nString("Mapa.Externo");
          ...
          lblEstado.setText(aplicacion.getI18nString("Mapa.Estado") + " " + estadoMapa);
          lblEstado.setOpaque(false);
          lblEstado.setIcon(com.geopista.ui.images.IconLoader.icon("online.png"));
          ...
          lblMunicipio.setText("Identificador de municipio:"+" "+AppContext.getIdMunicipio());
