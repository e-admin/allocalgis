/**
 * CNotificacionesTableModel.java
...
public class CNotificacionesTableModel extends DefaultTableModel {
        ...
        public static String[] columnNames = {"Estado", "Num. Expediente", "Estado Exp.", "Fecha Vencimiento", "DNI Interesado", "Fecha Notificación", "Fecha Reenvío"};
