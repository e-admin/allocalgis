 ...
 * Time: 15:56:49
 */
public class GeopistaPrintable extends javax.swing.JPanel implements Printable{
    private static Logger logger = Logger.getLogger(GeopistaPrintable.class);
        ...
        try
        {
            switch (tipoFicha) {
                case FICHA_ADMINISTRADOR:
                    break;
                case FICHA_CONTAMINANTE_ACTIVIDAD:
                case FICHA_CONTAMINANTE_ARBOLADO:
//                case FICHA_CONTAMINANTE_VERTEDERO:
//                    rbI18N = com.geopista.app.contaminantes.CMainContaminantes.messages;
//                    break;
...
//                    break;
//                case FICHA_CONTAMINANTE_PLANOS:
//                    rbI18N = com.geopista.app.contaminantes.CMainContaminantes.messages;
//                    break;
            }
...
//                                Object oEstruct = null;
                            if ((sValor != null) && (!sValor.equals(""))) {
                                switch (tipoFicha) {
                                    ...
                                    case FICHA_CONTAMINANTE_ARBOLADO:
//                                    case FICHA_CONTAMINANTE_VERTEDERO:
//                                        if (sDomSource.equalsIgnoreCase("DocumentacionTipoZonaArbolada")) {
//                                            Hashtable hDomainNodes = com.geopista.app.contaminantes.estructuras.Estructuras.getListaTipoZonaArbolada().getLista();
...
//                                                    sValor = ((DomainNode)com.geopista.app.contaminantes.estructuras.Estructuras.getListaTipoZonaArbolada().getDomainNode(sValor)).getTerm(com.geopista.app.contaminantes.CMainContaminantes.messages.getLocale().toString());
//                                            }
//                                        }
//                                        break;
                                    case FICHA_ACTIVIDAD_CONSULTA:
...
//                                            Hashtable hDomainNodes = com.geopista.app.ocupaciones.estructuras.Estructuras.getListaTipoOcupacion().getLista();
//                                            for (Enumeration _e=hDomainNodes.elements();_e.hasMoreElements();)
//                                            {
//                                                DomainNode auxDomain= (DomainNode)_e.nextElement();
//                                                if (auxDomain.getPatron().equalsIgnoreCase(sValor))
//                                                    sValor = ((DomainNode)com.geopista.app.ocupaciones.estructuras.Estructuras.getListaTipoOcupacion().getDomainNode(sValor)).getTerm(com.geopista.app.ocupaciones.CMainOcupaciones.literales.getLocale().toString());
//                                            }
//                                        }
//                                        else if (sDomSource.equalsIgnoreCase("ViasNotificacion"))
//                                            sValor = ((DomainNode)com.geopista.app.ocupaciones.estructuras.Estructuras.getListaViasNotificacion().getDomainNode(sValor)).getTerm(com.geopista.app.ocupaciones.CMainOcupaciones.literales.getLocale().toString());
//                                        else if (sDomSource.equalsIgnoreCase("DocumentacionTipoNotificacion")) {
//                                            Hashtable hDomainNodes = com.geopista.app.ocupaciones.estructuras.Estructuras.getListaEstadosNotificacion().getLista();
//                                            for (Enumeration _e=hDomainNodes.elements();_e.hasMoreElements();)
//                                            {
//                                                DomainNode auxDomain= (DomainNode)_e.nextElement();
//                                                if (auxDomain.getPatron().equalsIgnoreCase(sValor))
    ...
    public void printObjeto(String urlXml, Object objeto, Class clase, Image plano, int tipoFicha) throws Exception
    {
        this.tipoFicha = tipoFicha;
            ...
            this.clase=clase;
             ...
             ClassLoader cl =(new GeopistaPrintable()).getClass().getClassLoader();
