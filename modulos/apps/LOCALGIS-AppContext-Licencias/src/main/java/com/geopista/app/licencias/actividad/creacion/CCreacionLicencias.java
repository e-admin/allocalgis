...
public class CCreacionLicencias extends javax.swing.JInternalFrame implements IMultilingue{
	...
	private void configureComponents() {
        ...
        {
            logger.error("Excepción en los recursos",e);
        }
                ...
                if ((objeto instanceof String) && objeto!=null)
                {
                    if (((String)objeto).length()>0)
                    {
                    	...
                    	if(Estructuras.getListaTiposViaINE().getDomainNode((String)objeto)==null){
                    		CConstantesLicenciasActividad.referencia.setTipoVia("No Especificado");
                    		patron="NE";
                    	}
	...
	private void buscarDNIPromotorJButtonActionPerformed() {//GEN-FIRST:event_buscarDNIPromotorJButtonActionPerformed
		...
		if ((CConstantesLicencias_LCGIII.persona != null) && (CConstantesLicencias_LCGIII.persona.getDniCif() != null)) {
            ...
            cPostalPromotorJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getCpostal());
	...
	private void buscarDNITecnicoJButtonActionPerformed() {//GEN-FIRST:event_buscarDNITecnicoJButtonActionPerformed
		...
		if ((CConstantesLicencias_LCGIII.persona != null) && (CConstantesLicencias_LCGIII.persona.getDniCif() != null)) {
            ...
            cPostalTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getCpostal());
	...
	private void buscarDNIRepresentaAJButtonActionPerformed() {//GEN-FIRST:event_buscarDNIRepresentaAJButtonActionPerformed
		...
		if ((CConstantesLicencias_LCGIII.persona != null) && (CConstantesLicencias_LCGIII.persona.getDniCif() != null)) {
            DNIRepresentaAJTField.setText(CConstantesLicencias_LCGIII.persona.getDniCif());
            ...
            faxRepresentaAJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getFax());
            telefonoRepresentaAJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getTelefono());
            movilRepresentaAJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getMovil());
            ...
            numeroViaRepresentaAJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getNumeroVia());
            ...
            cPostalRepresentaAJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getCpostal());
	...
	private void buscarDNITitularJButtonActionPerformed() {//GEN-FIRST:event_buscarDNITitularJButtonActionPerformed
		...
		if ((CConstantesLicencias_LCGIII.persona != null) && (CConstantesLicencias_LCGIII.persona.getDniCif() != null)) {
            DNITitularJTField.setText(CConstantesLicencias_LCGIII.persona.getDniCif());
            ...
            faxTitularJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getFax());
            telefonoTitularJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getTelefono());
            movilTitularJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getMovil());
            ...
            numeroViaTitularJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getNumeroVia());
            ...
            cPostalTitularJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getCpostal());
...
/*                         Metodos propios                         */
    ...
    //Como estamos en la creación del ex
