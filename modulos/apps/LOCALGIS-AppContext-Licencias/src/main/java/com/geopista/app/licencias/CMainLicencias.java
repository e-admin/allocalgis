 ...
 * @author avivar
 */
public class CMainLicencias extends CMain   implements IMainLicencias,ISecurityPolicy 
 {
	...
	public CMainLicencias(boolean fromInicio) {
		aplicacion.setUrl(aplicacion.getString(UserPreferenceConstants.LOCALGIS_SERVER_URL) + WebAppConstants.LICENCIAS_OBRA_WEBAPP_NAME);
		//COperacionesLicencias.webappContext = File.separator + WebAppConstants.LICENCIAS_OBRA_WEBAPP_NAME +     ServletConstants.CSERVLETLICENCIAS_SERVLET_NAME;
		COperacionesLicencias.webappContext =  WebAppConstants.LICENCIAS_OBRA_WEBAPP_NAME +     ServletConstants.CSERVLETLICENCIAS_SERVLET_NAME;
...
//				CConstantesComando.loginLicenciasUrl = AppContext.getApplicationContext().getString(SSOConstants.SSO_SERVER_URL);
			SSOAuthManager.ssoAuthManager(CConstantesLicencias.idAppLicenciasObra);								
            ...
            if(!tienePermisos("LocalGIS.LicenciasObra.Login")){
            	noPermApp();
            	return;
            }            
        ...
        try
        {
		    ...
		    com.geopista.app.utilidades.CAuthDialog auth =
                new com.geopista.app.utilidades.CAuthDialog(this, true,
                        CConstantesComando.loginLicenciasUrl,CConstantesLicencias.idAppLicenciasObra,
	...
	public void setPolicy() throws AclNotFoundException, Exception{
         ...
         acl = com.geopista.security.SecurityManager.getPerfil("App.LocalGIS.LicenciasObra");
         applySecurityPolicy(acl, com.geopista.security.SecurityManager.getPrincipal());
	}
	...
	private boolean configureApp() {
		...
		try {
            ...
            try{
                   ...
                   com.geopista.protocol.CConstantesComando.servletLicenciasUrl = app.getString(UserPreferenceConstants.LOCALGIS_SERVER_URL)  + WebAppConstants.LICENCIAS_OBRA_WEBAPP_NAME + ServletConstants.CSERVLETLICENCIAS_SERVLET_NAME;
                   ...
                   com.geopista.protocol.CConstantesComando.loginLicenciasUrl = app.getString(UserPreferenceConstants.LOCALGIS_SERVER_URL)  + WebAppConstants.LICENCIAS_OBRA_WEBAPP_NAME;
                   com.geopista.protocol.CConstantesComando.adminCartografiaUrl = app.getString(UserPreferenceConstants.LOCALGIS_SERVER_URL)  + WebAppConstants.GEOPISTA_WEBAPP_NAME;
                   com.geopista.protocol.CConstantesComando.plantillasLicenciasUrl = app.getString(UserPreferenceConstants.LOCALGIS_SERVER_URL) + "/plantillas/licencias/";

                   CConstantesLicencias.Locale = app.getString(UserPreferenceConstants.DEFAULT_LOCALE_KEY,"es_ES");

                   try{
                	   //CConstantesLicencias.IdMunicipio=new Integer(app.getString("localgis.DefaultCityId")).intValue();
                	   CConstantesLicencias.IdMunicipio=new Integer(app.getString(UserPreferenceConstants.DEFAULT_MUNICIPALITY_ID)).intValue();                       
                   }catch (Exception e){
	...
	public void setLang(String resource, String locale) {
         try
         {
                ...
                if (CConstantesLicencias.selectedSubApp.equals(CConstantesLicencias.LicenciasObraMayor))
                    try
                    {
                         literales = ResourceBundle.getBundle("locale.licenciasObraMayor", new Locale(currentLocale));
                    ...
                    try {
                        literales = ResourceBundle.getBundle("locale.licenciasObraMenor", new Locale(currentLocale));
                    }catch (Exception e){
                        currentLocale=CConstantesLicencias.LocalCastellano;
                        literales = ResourceBundle.getBundle("locale.licenciasObraMenor", new Locale(currentLocale));
                    }
   ...
   /* private void mostrarEventosYNotificacionesPendientesJDialog() {
	...
	public String getIdApp() {
		return CConstantesLicencias.idAppLicenciasObra;
	}
	@Override
