/**
 * CReferenciaCatastralJDialog.java
    			...
    			new Thread(new Runnable()
    			{
    				public void run()  //throws Exception
    				{
    					...
    					try {
    						...
    						com.geopista.app.licencias.estructuras.Estructuras.cargarLista(com.geopista.app.licencias.estructuras.Estructuras.getListaTiposViaINE(), AppContext.getApplicationContext().getString(UserPreferenceConstants.LOCALGIS_SERVER_URL) + WebAppConstants.LICENCIAS_OBRA_WEBAPP_NAME);
