...
public class DocumentoEnDisco {
    ...
    public static String getURLPublica(DocumentBean documento) throws Exception{
        String sdfformat= sdf.format(documento.getFechaEntradaSistema());
        String path= "getDocumento.jsp?id="+documento.getId()+"&folder="+sdfformat+"&nombre="+URLEncoder.encode(documento.getFileName(),"UTF-8");
       	return path;
    }
