...
public class COperacionesPlantillas {
    ...
    private Collection getPlantillas(String path,String filtro,String patron,ArrayList patrones,String idEntidad, String idMunicipio) throws Exception{
        ...
        if (idEntidad==null)
        	...
        	dir = new File(ConstantesLocalGISPlantillas.DIR_PLANTILLAS+File.separator+idEntidad+File.separator+pathPlantillas+File.separator 
                    	...
                    	File[] children2 = file.listFiles();
                    	 if (children2 == null) {
                             ...
                             for (int j = 0; j < children2.length; j++) {
                                 ...
                                 imagen= new Object[2];
                                 if (idMunicipio!=null && file2.getName().contains(idMunicipio)){
        ...
        if (idEntidad==null)
        	...
        	dir = new File(ConstantesLocalGISPlantillas.DIR_PLANTILLAS+File.separator+idEntidad+File.separator+pathPlantillas+subPath);
    	//System.out.println("[COperacionesPlantillas.getPlantillas] - "+dir.toString());
    ...
    private Collection getSubReports(String idEntidad, String pathPlantillas) throws Exception{
        ...
        if (idEntidad==null)
        	...
        	dir = new File(ConstantesLocalGISPlantillas.DIR_PLANTILLAS+File.separator+idEntidad+File.separator+pathPlantillas +
        			File.separator + ConstantesLocalGISPlantillas.PATH_SUBREPORTS);
