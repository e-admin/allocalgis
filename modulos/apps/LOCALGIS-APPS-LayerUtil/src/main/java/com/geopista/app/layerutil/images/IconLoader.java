...
public class IconLoader {
	...
	try
		...
		String nuevoRecurso=filename.substring(0,indiceExtension)+"."+filename.substring(indiceExtension+1,filename.length()).toUpperCase();
		//si el resurso no existe lo buscamos con la extension en mayuscula
		if (url==null){						
			url = IconLoader.class.getResource(nuevoRecurso);
		}
