...
//    public static final String TAB_MULTIPOLYGON = "MULTIPOLYGON";
            ...
            try
            {
            	if (!operaciones.existeTabla(newTable.getDescription())){
	                ...
	                {        
	                    ...
	                    idDB.setName("id");
	                    idDB.setLength(8);
	                    idDB.setType(ColumnDB.COL_NUMERIC);
	                    ...
	                    idMunicipioDB.setType(ColumnDB.COL_NUMERIC);
	                    ...
	                    if (!(newTable.getGeometryType()<0))
	                    {
	                        ...
	                        idGeometryDB.setType(ColumnDB.COL_GEOMETRY);
        ...
        if (modifiedTable!=null)
        {
            ...
            try
            {
                if(operaciones.modificarTablaBD (selectedTable, modifiedTable))
                {
                	...
                	JOptionPane.showMessageDialog(TablesDBPanel.this, "La tabla modificada no esta dada de alta en LOCALGIS. Es necesario crear las columnas para cambiar la informacion",
                            "LocalGIS",
                            JOptionPane.INFORMATION_MESSAGE);
                	Identificadores.put("TablasModificadas", true);
                	Identificadores.put("TablasModificadas.TabTables", true);
    ...
    {              
        ...
        {
        	//NUEVO
        	//boolean tablasModificadas=((Boolean)Identificadores.get("TablasModificadas")).booleanValue();
        	boolean tablasModificadas_tabTables=((Boolean)Identificadores.get("TablasModificadas.TabTables")).booleanValue();
        	 if (tablasModificadas_tabTables)
        	 {
