// jecwppc.cpp : Defines the initialization routines for the DLL.
//
...
BEGIN_MESSAGE_MAP(CjecwppcApp, CWinApp)
END_MESSAGE_MAP()


// CjecwppcApp construction

CjecwppcApp::CjecwppcApp()
{
...
// The one and only CjecwppcApp object

CjecwppcApp theApp;


// CjecwppcApp initialization

BOOL CjecwppcApp::InitInstance()
{
