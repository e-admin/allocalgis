...
public class AsistenteInformesInicio extends JFrame implements HyperlinkListener, ActionListener,ISecurityPolicy {
	/**
	 ...
	 */
	 private static final Log logger;
	    static {
	       createDir();
	       logger  = LogFactory.getLog(AsistenteInformesInicio.class);
	    } 	
...
//	Contexto de la aplicación
	...
	public AsistenteInformesInicio ( ) {
//		setTitle ("GEOPISTA") ;
...
//		}
	...
	public static void main (String[] args) {
		...
		AsistenteInformesInicio appFrame = new AsistenteInformesInicio();
		appFrame.show() ;
