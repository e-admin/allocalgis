...
public class CMainOcupaciones extends CMain implements ISecurityPolicy {
	...
	public CMainOcupaciones(boolean fromInicio) {
		COperacionesLicencias.webappContext = WebAppConstants.OCUPACIONES_WEBAPP_NAME + ServletConstants.CSERVLETOCUPACIONES_SERVLET_NAME;
	...
	private void cargarMainOcupaciones(){
		...
		try
		{
			...
			Municipio municipio = (new OperacionesAdministrador(CConstantesComando.loginLicenciasUrl)).getMunicipio(new Integer(CConstantesOcupaciones.IdMunicipio).toString());
			if (municipio!=null){
	...
	private boolean configureApp() {
		...
		try {
			...
			try{
				...
				CConstantesComando.loginLicenciasUrl 	= urlServidorBase + WebAppConstants.OCUPACIONES_WEBAPP_NAME;
				CConstantesComando.servletLicenciasUrl 	= urlServidorBase + WebAppConstants.OCUPACIONES_WEBAPP_NAME + ServletConstants.CSERVLETOCUPACIONES_SERVLET_NAME;
				CConstantesComando.anexosLicenciasUrl 	= urlServidorBase + "/anexos/ocupacion/";
				CConstantesComando.adminCartografiaUrl 	= urlServidorBase + WebAppConstants.GEOPISTA_WEBAPP_NAME;
				CConstantesComando.plantillasOcupacionesUrl = urlServidorBase + WebAppConstants.PRINCIPAL_WEBAPP_NAME + "/plantillas/ocupacion/";

				CConstantesOcupaciones.IdMunicipio = AppContext.getIdMunicipio();
				
				CConstantesOcupaciones.Locale = app.getString(UserPreferenceConstants.DEFAULT_LOCALE_KEY,"es_ES");
				...
				CConstantesOcupaciones.DriverClassName = app.getString(UserPreferenceConstants.LOCALGIS_DATABASE_DIRECTCONNECTION_DRIVER);
				CConstantesOcupaciones.ConnectionInfo = app.getString(UserPreferenceConstants.LOCALGIS_DATABASE_DIRECTCONNECTION_URL);
				CConstantesOcupaciones.DBUser = app.getString(UserPreferenceConstants.LOCALGIS_DATABASE_DIRECTCONNECTION_USER);
				CConstantesOcupaciones.DBPassword = app.getString(UserPreferenceConstants.LOCALGIS_DATABASE_DIRECTCONNECTION_PASS);
				//CConstantesOcupaciones.DBPassword = UserPreferenceStore.getUserPreference(UserPreferenceConstants.LOCALGIS_DATABASE_DIRECTCONNECTION_PASS,"",false);
	...
	private void initComponents() {//GEN-BEGIN:initComponents
		...
		setTitle("LocalGIS - Licencias de Ocupación");
	 ...
	 */
	 ...
	 // Metodos que implementan la interfaz ISecurityPolicy
		...
		public String getIdApp() {
			return CConstantesOcupaciones.idApp;
		}
		@Override
