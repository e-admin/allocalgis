...
<div id="all">
	...
	<div id="lside"> 
				...
				<tr>
					<td width="420" height="85" valign="top">
						<p><strong>LocalGIS III.</strong></p>
              				<ul>
                				<li><a href="<%=rutaBase%>/views/manuales.jsp" title="Manuales y documentación LocalGIS">Manuales y documentaci&oacute;n</li>
			...
			<td id="content" valign="top">
                		<ul> 
                			<li><a href="<%=urlLocalgis%>/localgis-apps-configuracion.jnlp" title="Herramienta de Ayuda de Configuración LocalGIS">Herramienta de Ayuda de Configuraci&oacute;n LocalGIS III</a></li>
							...
							<li><a href="/localgis-guiaurbana/" title="Pulse para ir a la GuíaUrbana (Ventana de LocalGIS al exterior)">Gu&iacute;a Urbana (P&uacute;blica)</a></li>
						...
						<ul>
                			<li><a href="<%=rutaBase%>/config/LCGIII.reg" title="Configurador LOCALGIS">Configurador Automático de LocalGIS III</a></li>
						</ul>
			<br />
			...
			<br />
                		<ul>
							...
							<li><a href="<%=urlLocalgisLib%>/localgis-apps-movilidad-cab.zip" title="Aplicación Movilidad LocalGIS III.">Aplicaci&oacute;n Movilidad LocalGIS III</a></li>
							<li><a href="<%=urlLocalgisLib%>/localgis-apps-movilidad-tablet.zip" title="Aplicacióe Movilidad LocalGIS III">Aplicaci&oacute;n Movilidad LocalGIS III para Tablet</a></li>	
							<li><a href="<%=urlLocalgisLib%>/localgis-apps-movilidad-configuradorPDA.zip" title="Configurador Aplicacióe Movilidad LocalGIS III">Configurador Aplicaci&oacute;n Movilidad LocalGIS III.</a></li>
			...
			<br />
				<ul>
					<p><strong>Ejemplo de integración con AL SIGM</strong></p>
					<li>
						<a href="/localgis-geowfst/features/showFeatureMap.do?idFeature=EXP2013/000002&procedureName=VADO&idEntidad=000" title="Enlace SiGM">Enlace de ejemplo del Módulo de Integración con SiGM</a>
					</li>
                </ul>  
			<br />
...
<!--					  <p><strong>Entorno de INTEGRACIÓ</strong></p>
                		<ul> 
                			<li><a href="download/MODELOIntegracion.zip" title="Descomprimir y ejecutar">Configuracióa></li>					
							<li><a href="http://integmodelo.asturias.es:8080/localgis-guiaurbana/" title="Pulse para ir a la GuíaUrbana (Ventana de LocalGIS al exterior)">GuíaUrbana (Púa)</a></li>
                		</ul>-->
