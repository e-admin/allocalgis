/**
 * UnidadConstructivaXMLHandler.java
...
public class UnidadConstructivaXMLHandler extends DefaultHandler 
{  
    ...
    public UnidadConstructivaXMLHandler (XMLReader parser, DefaultHandler handlerToReturn,
    ...
    throws SAXException
    {
        ...
        //ccvscuc
        	...
        	if(!(Boolean)AppContext.getApplicationContext().getBlackboard().get("expSitFinales")){
        		...
        		if(actual.getTIPO_MOVIMIENTO().equals(UnidadConstructivaCatastro.TIPO_MOVIMIENTO_ALTA) ||
        				actual.getTIPO_MOVIMIENTO().equals(UnidadConstructivaCatastro.TIPO_MOVIMIENTO_MODIF)){
