    ...
    throws SAXException
    {
        ...
        //cccsc (coeficientes correctores conjuntos del valor del suelo y las construcciones) 
        	...
        	if(!(Boolean)AppContext.getApplicationContext().getBlackboard().get("expSitFinales")){
        		...
        		if(actual.getTIPO_MOVIMIENTO().equals(SueloCatastro.TIPO_MOVIMIENTO_ALTA) ||
        				actual.getTIPO_MOVIMIENTO().equals(SueloCatastro.TIPO_MOVIMIENTO_MODIF)){
