    ...
    throws SAXException
    {
        ...
        //dval - Datos de valoración de la finca
        	...
        	if((Boolean)AppContext.getApplicationContext().getBlackboard().get("expSitFinales")){
        		...
        		finca.setTIPO_MOVIMIENTO(valor.toString());
        		if(valor.toString().equals(FincaCatastro.TIPO_MOVIMIENTO_ALTA) ||
        				valor.toString().equals(FincaCatastro.TIPO_MOVIMIENTO_MODIF)){
        			finca.setElementoModificado(true);
        		}
        		
        		if(valor.toString().equals(FincaCatastro.TIPO_MOVIMIENTO_BAJA)){
        			finca.setTIPO_MOVIMIENTO_DELETE(FincaCatastro.TIPO_MOVIMIENTO_BAJA);
        		}
        		else{
        			finca.setTIPO_MOVIMIENTO_DELETE(FincaCatastro.TIPO_MOVIMIENTO_FINAL);
        		}
        	}
        }
