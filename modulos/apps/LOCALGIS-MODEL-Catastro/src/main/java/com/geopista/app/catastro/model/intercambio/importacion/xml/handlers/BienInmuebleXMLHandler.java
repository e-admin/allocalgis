...
{     
    ...
    throws SAXException
    {
        ...
        {   
            Double valorCat = new Double(ImportarUtils.doubleToStringWithFactor(ImportarUtils.strToDouble(valor.toString().replaceAll(",",".")), 100));
        ...
        {
        	Double valorSuelo = new Double(ImportarUtils.doubleToStringWithFactor(ImportarUtils.strToDouble(valor.toString().replaceAll(",",".")), 100));
        ...
        {
        	Double valorConstruccion = new Double(ImportarUtils.doubleToStringWithFactor(ImportarUtils.strToDouble(valor.toString().replaceAll(",",".")), 100));
