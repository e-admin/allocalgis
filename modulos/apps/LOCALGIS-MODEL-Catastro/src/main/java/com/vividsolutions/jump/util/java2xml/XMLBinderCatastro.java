...
public class XMLBinderCatastro {
    ...
    protected void visit(java.util.List specElements, SpecVisitor visitor, Class c,Object object) throws Exception {
        ...
        for (Iterator i = specElements.iterator(); i.hasNext();) {
            ...
            Attribute javaCondition1 = specElement.getAttribute("java-condition1");
            ...
            if (specElement.getName().equals("element")) {
            	...
            	visitor.tagSpecFound(xmlName.getValue(),
                        (javaName != null) ? javaName.getValue() : null, (javaCondition != null) ? javaCondition.getValue() : null,
                        (javaCondition1 != null) ? javaCondition1.getValue() : null,method,specElement.getChildren(),caseSensitive);
    ...
    protected interface SpecVisitor {
    	public void tagSpecFound(String xmlName, String javaName, String javaCondition, 
          		String javaCondition1, ArrayList method,
