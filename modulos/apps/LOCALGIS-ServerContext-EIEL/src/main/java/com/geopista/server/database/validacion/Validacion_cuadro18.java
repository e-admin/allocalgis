...
public class Validacion_cuadro18 {
	private static org.apache.log4j.Logger logger = org.apache.log4j.Logger
			.getLogger(Validacion_cuadro18.class);
	...
	public static void validacion(Connection connection, StringBuffer str, ArrayList lstValCuadros){
		...
		try
        {
			...
			String sql_sin_nucleo = "select * from v_potabilizacion_enc_sin_nucleo";
	    	...
	    	ArrayList lstpotabilizacion_enc_sin_nucleo = new ArrayList();
			...
			while (rs.next()) {	
				...
				potabilizacion_enc_bean.setOrganismo(rs.getString("ORGANISMO"));
				potabilizacion_enc_bean.setEstado(rs.getString("ESTADO"));
				lstpotabilizacion_enc_sin_nucleo.add(potabilizacion_enc_bean);
			...
			if(lstValCuadros.contains("v01")){
				...
				for (int i = 0; i < lstpotabilizacion_enc_sin_nucleo.size(); i++)
	            {
					int count = 0;
	                V_potabilizacion_enc_bean potabilizacion_enc_bean  = (V_potabilizacion_enc_bean)lstpotabilizacion_enc_sin_nucleo.get(i);
					if (count == 0){
						if (contTexto == 0)
						 {
							 str.append(Messages.getString("errorMPT") + " " +Messages.getString("cuadro18.V_01") + "\n");
