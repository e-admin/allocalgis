...
public class Validacion_cuadro39 {
	private static org.apache.log4j.Logger logger = org.apache.log4j.Logger
			.getLogger(Validacion_cuadro39.class);
	public static void validacion(Connection connection, StringBuffer str, ArrayList lstValCuadros){
        ...
        {     
			...
			String sql_sin_nucleo = "select * from v_depuradora_enc_2_sin_nucleo";
			...
			ArrayList lstdepuradora_enc_2_sin_nucleo = new ArrayList();
			...
			while (rs.next()) {	
				...
				depuradora_enc_2_bean.setLodo_sin_a(new Integer(rs.getString("LODO_SIN_A")));
				depuradora_enc_2_bean.setLodo_ot(new Integer(rs.getString("LODO_OT")));
				lstdepuradora_enc_2_sin_nucleo.add(depuradora_enc_2_bean);
			}
			...
			if(lstValCuadros.contains("v01")){	
				...
				for (int i = 0; i < lstdepuradora_enc_2_sin_nucleo.size(); i++)
	            {
					V_depuradora_enc_2_bean depuradora_enc_2_bean   = (V_depuradora_enc_2_bean)lstdepuradora_enc_2_sin_nucleo.get(i);
					int count = 0;					
					if(count  == 0){
						if (contTexto == 0)
						 {
