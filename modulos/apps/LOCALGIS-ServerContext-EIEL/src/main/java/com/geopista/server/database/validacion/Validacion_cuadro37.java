...
public class Validacion_cuadro37 {
	private static org.apache.log4j.Logger logger = org.apache.log4j.Logger
			.getLogger(Validacion_cuadro37.class);
	...
	public static void validacion(Connection connection, StringBuffer str, ArrayList lstValCuadros){
        ...
        {     
			...
			String sql_sin_nucleo = "select * from v_depuradora_enc_sin_nucleo";
			...
			ArrayList lstdepuradora_enc_sin_nucleo = new ArrayList();
			...
			while (rs.next()) {	
				...
				depuradora_enc_bean.setTrat_ld_2(rs.getString("TRAT_LD_2"));
				depuradora_enc_bean.setTrat_ld_3(rs.getString("TRAT_LD_3"));
				lstdepuradora_enc_sin_nucleo.add(depuradora_enc_bean);
			...
			if(lstValCuadros.contains("v01")){
				...
				for (int i = 0; i < lstdepuradora_enc_sin_nucleo.size(); i++)
	            {
					V_depuradora_enc_bean depuradora_enc_bean   = (V_depuradora_enc_bean)lstdepuradora_enc_sin_nucleo.get(i);
						if (contTexto == 0)
						 {
