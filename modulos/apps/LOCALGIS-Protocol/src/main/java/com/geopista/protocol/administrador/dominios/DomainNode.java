...
public class DomainNode  implements java.io.Serializable, Cloneable{
    ...
    //Variable booleana que serï¿½ true si el idioma en el que nos interesa  recibir el dominio 
    //estï¿½ establecido
    ...
    /**Mï¿½todo que se puede utilizar para que una posterior llamada al mï¿½todo toString
    ...
    /**Este mï¿½todo devuelve el dominio en el idioma previamente establecido, si este no se
     * rellenado el mï¿½todo devolverï¿½ el dominio en el idioma "que le de la gana" (el primero
