...
public class CExpedienteLicencia implements java.io.Serializable {
	...
	private Double presupuesto_actualizado;
	private Double presupuesto_antiguo;
	private int numeroRegistroEntrada;
	...
	public int getNumeroRegistroEntrada() {
		return numeroRegistroEntrada;
	}

	public void setNumeroRegistroEntrada(int numeroRegistroEntrada) {
		this.numeroRegistroEntrada = numeroRegistroEntrada;
	}

	private Date fechaRegistroEntrada;
	
	public Double getPresupuesto_actualizado() {
	...
	public void setPresupuesto_actualizado(Double presupuesto_actualizado) {
		this.presupuesto_actualizado = presupuesto_actualizado;
	}

	public Double getPresupuesto_antiguo() {
		return presupuesto_antiguo;
	}

	public void setPresupuesto_antiguo(Double presupuesto_antiguo) {
		this.presupuesto_antiguo = presupuesto_antiguo;
	}
	...
	//Extensiï¿½n para consultas rapidas
	...
	public CExpedienteLicencia(String numExpediente, long idSolicitud, CTipoTramitacion tipoTramitacion, CTipoFinalizacion tipoFinalizacion, String servicioEncargado, String asunto, String silencioAdministrativo, String formaInicio, int numFolios, Date fechaApertura, String responsable, Date plazoVencimiento, String habiles, int numDias, String observaciones,String condicionesEspeciales, CEstado estado, Vector notificaciones, Double presupuestoActualizado, Double presupuestoAntiguo, int numeroRegistro, Date fechaRegistro, String numeroLicencia, String numeroArchivo) {
		this.numExpediente = numExpediente;
		this.idSolicitud = idSolicitud;
		this.tipoTramitacion = tipoTramitacion;
		this.tipoFinalizacion = tipoFinalizacion;
		...
		this.estado=estado;
        this.notificaciones= notificaciones;
        this.condiciones_especiales = condicionesEspeciales;
        this.presupuesto_actualizado = presupuestoActualizado;
        this.presupuesto_antiguo = presupuestoAntiguo;
        this.numeroRegistroEntrada = numeroRegistro;
        this.fechaRegistroEntrada = fechaRegistro;
        this.numeroLicencia = numeroLicencia;
        this.numeroArchivo = numeroArchivo;
        

	}
	public CExpedienteLicencia(String numExpediente, long idSolicitud, CTipoTramitacion tipoTramitacion, CTipoFinalizacion tipoFinalizacion, String servicioEncargado, String asunto, String silencioAdministrativo, String formaInicio, int numFolios, Date fechaApertura, String responsable, Date plazoVencimiento, String habiles, int numDias, String observaciones,String condicionesEspeciales, CEstado estado, Vector notificaciones, Double presupuestoActualizado, Double presupuestoAntiguo, int numeroRegistro,  String numeroLicencia, String numeroArchivo) {
		this.numExpediente = numExpediente;
		this.idSolicitud = idSolicitud;
		this.tipoTramitacion = tipoTramitacion;
		this.tipoFinalizacion = tipoFinalizacion;
