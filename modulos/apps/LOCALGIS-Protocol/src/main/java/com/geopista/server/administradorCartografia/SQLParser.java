...
public class SQLParser {
    ...
    */
    ...
    public PreparedStatement[] newUpdateLotes(int iMunicipio,String sSQL, IACLayer schema, ACFeatureUpload featureUpload, PreparedStatement[] aPs) throws SQLException, ACException{
        String sQueries[]=sSQL.split(";");
        if (aPs==null)
...
//                throw new NullPointerException("Geometry=Null");
   ...
   /* REFACTORIZACION ORACLE
    public PreparedStatement newSelect(int iMunicipio,String sSQL, ACLayer schema,Geometry geometry, FilterNode fn)
        ...
        String sGeomFilter=(geometry==null? "?" // Se sustituirï¿½ por "true"
    ...
    */
    ...
    /* REFACTORIZACION ORACLE
     //Todo Hay  que cambiar esta funciï¿½n para que funcione con oracle
