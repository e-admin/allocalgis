 ...
 *  $Revision: 1.1 $
 *  $Date: 2009/07/03 12:31:53 $
 *  $Source: /usr/cvslocalgis/.CVSROOT/localgisdos/core/src/org/geotools/dbffile/DbfFile.java,v $
 */
...
public class DbfFile implements DbfConsts {
    ...
    public Integer getFieldWidth(int row) {
        return (fielddef[row].fieldlen);
    }    
    
    public Integer getFieldDecimal(int row) {
        return (fielddef[row].fieldnumdec);
    }
