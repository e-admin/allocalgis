...
public class MobileModifyPanel01  extends JPanel implements WizardPanel
{
    ...
    public MobileModifyPanel01 (String id, String nextId, PlugInContext context)
    {
        this.nextID = nextId;
        this.localId = id;
    ...
    {
        return I18N.get(MobileAssignCellsPlugin.PluginMobileExtracti18n,MobilePluginI18NResource.MobileModifyPanel01_delProy);
    }
