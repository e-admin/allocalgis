...
public class NamingExceptionException0 extends java.lang.Exception{
    ...
    private com.geopista.webservices.cilvilwork.client.protocol.CivilWorkWSStub.NamingException faultMessage;
    ...
    public void setFaultMessage(com.geopista.webservices.cilvilwork.client.protocol.CivilWorkWSStub.NamingException msg){
       faultMessage = msg;
    }
    
    public com.geopista.webservices.cilvilwork.client.protocol.CivilWorkWSStub.NamingException getFaultMessage(){
       return faultMessage;
    }
}
