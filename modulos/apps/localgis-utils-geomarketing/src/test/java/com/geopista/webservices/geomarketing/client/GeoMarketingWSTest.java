...
import com.geopista.webservices.geomarketing.client.protocol.GeoMarketingWSCallbackHandler;
...
public class GeoMarketingWSTest extends junit.framework.TestCase{
	...
	/*private GeoMarketingWSStub getStub(String username,String password) throws AxisFault{
          	 ConfigurationContext ctx = ConfigurationContextFactory.createConfigurationContextFromFileSystem("WEB-INF", null);
          	GeoMarketingWSStub stub = new GeoMarketingWSStub(ctx);
          	 stub._getServiceClient().engageModule("addressing");
               stub._getServiceClient().engageModule("rampart");
	...
	public  void testgetPortalStepRelations() throws java.lang.Exception{
		...
		GeoMarketingWSStub stub = getStub();//the default implementation should point to the right endpoint

		GeoMarketingWSStub.GetPortalStepRelations getPortalStepRelations28= (GeoMarketingWSStub.GetPortalStepRelations)getTestObject(GeoMarketingWSStub.GetPortalStepRelations.class);
		...
		assertNotNull(stub.getPortalStepRelations(getPortalStepRelations28));
	}
	...
	public  void testStartgetPortalStepRelations() throws java.lang.Exception{
		GeoMarketingWSStub stub = getStub();
		GeoMarketingWSStub.GetPortalStepRelations getPortalStepRelations28=(GeoMarketingWSStub.GetPortalStepRelations)getTestObject(GeoMarketingWSStub.GetPortalStepRelations.class);
		// TODO : Fill in the getPortalStepRelations28 here
		stub.startgetPortalStepRelations(getPortalStepRelations28, new tempCallbackN65548());
	}

	private class tempCallbackN65548  extends GeoMarketingWSCallbackHandler{
		public tempCallbackN65548(){ 
			super(null);
		}
		public void receiveResultgetPortalStepRelations(GeoMarketingWSStub.GetPortalStepRelationsResponse result) {
		}
	...
	public  void testgetGeomarketingData() throws java.lang.Exception{
		...
		GeoMarketingWSStub.GetGeomarketingData getGeomarketingData30= (GeoMarketingWSStub.GetGeomarketingData)getTestObject(GeoMarketingWSStub.GetGeomarketingData.class);
		...
		assertNotNull(stub.getGeomarketingData(getGeomarketingData30));
	...
	public  void testStartgetGeomarketingData() throws java.lang.Exception{
		...
		stub.startgetGeomarketingData(getGeomarketingData30, new tempCallbackN65620());
	}

	private class tempCallbackN65620  extends GeoMarketingWSCallbackHandler{
		public tempCallbackN65620() { 
			super(null);
		}
		public void receiveResultgetGeomarketingData(GeoMarketingWSStub.GetGeomarketingDataResponse result) {
		}
	...
	public  void testgetGeomarketingAndElementsData() throws java.lang.Exception{
		...
		GeoMarketingWSStub.GetGeomarketingAndElementsData getGeomarketingAndElementsData32=(GeoMarketingWSStub.GetGeomarketingAndElementsData)getTestObject(GeoMarketingWSStub.GetGeomarketingAndElementsData.class);
		...
		assertNotNull(stub.getGeomarketingAndElementsData(getGeomarketingAndElementsData32));
	}
	...
	public  void testStartgetGeomarketingAndElementsData() throws java.lang.Exception{
		...
		stub.startgetGeomarketingAndElementsData(getGeomarketingAndElementsData32, new tempCallbackN65692());
	}

	private class tempCallbackN65692  extends GeoMarketingWSCallbackHandler{
		public tempCallbackN65692(){ super(null);}

		public void receiveResultgetGeomarketingAndElementsData(
				GeoMarketingWSStub.GetGeomarketingAndElementsDataResponse result
				) {
	...
	private class tempCallbackN65780  extends GeoMarketingWSCallbackHandler{
		public tempCallbackN65780(){ super(null);}

		public void receiveResultgetPostalDataFromIdTramosAndIdVia(
				GeoMarketingWSStub.GetPostalDataFromIdTramosAndIdViaResponse result
				) {
	...
	public  void testgetNumElements() throws java.lang.Exception{
		...
		GeoMarketingWSStub.GetNumElements getNumElements36=
	...
	private class tempCallbackN65852  extends GeoMarketingWSCallbackHandler{
		public tempCallbackN65852(){ super(null);}

		public void receiveResultgetNumElements(
				GeoMarketingWSStub.GetNumElementsResponse result
				) {
	...
	public  void testgetGeomarketingByIdLayerAndAttributeName() throws java.lang.Exception{
		...
		GeoMarketingWSStub.GetGeomarketingByIdLayerAndAttributeName getGeomarketingByIdLayerAndAttributeName38=
				(GeoMarketingWSStub.GetGeomarketingByIdLayerAndAttributeName)getTestObject(GeoMarketingWSStub.GetGeomarketingByIdLayerAndAttributeName.class);
	...
	private class tempCallbackN65940  extends GeoMarketingWSCallbackHandler{
		public tempCallbackN65940(){ super(null);}

		public void receiveResultgetGeomarketingByIdLayerAndAttributeName(
				GeoMarketingWSStub.GetGeomarketingByIdLayerAndAttributeNameResponse result
				) {
	...
	public  void testgetGeomarketingAndElementsDataByIdLayerAndAttributeName() throws java.lang.Exception{
		...
		GeoMarketingWSStub.GetGeomarketingAndElementsDataByIdLayerAndAttributeName getGeomarketingAndElementsDataByIdLayerAndAttributeName40=
	...
	private class tempCallbackN66012  extends GeoMarketingWSCallbackHandler{
		public tempCallbackN66012(){ super(null);}

		public void receiveResultgetGeomarketingAndElementsDataByIdLayerAndAttributeName(
				GeoMarketingWSStub.GetGeomarketingAndElementsDataByIdLayerAndAttributeNameResponse result
				) {
