...
{    
    ...
    private JLabel jLabelCodigoViaDireccion = null;
    private JTextField jTextFieldCodigoViaDireccion = null;
	...
	private JButton jButtonModificarUC = null;
    ...
    public void load (UnidadConstructivaCatastro uc)
    {
        ...
        jTextFieldCodigoViaDireccion.getDocument().addDocumentListener(new ListenerTextField());
        if (uc.getDirUnidadConstructiva().getCodigoVia() == -1){
        	jTextFieldCodigoViaDireccion.setText("");
        }
        else{
        	jTextFieldCodigoViaDireccion.setText(String.valueOf(uc.getDirUnidadConstructiva().getCodigoVia()));
        }
        ...
        jTextFieldLongitudFachada.setText(uc.getDatosFisicos().getLongFachada()!=null?
        		EdicionUtils.getStringValue(uc.getDatosFisicos().getLongFachada().floatValue()):"");
    ...
    public UnidadConstructivaCatastro getUnidadConstructiva ()
    {
        if(unidadCons!=null)
        {
            ...
            if(!jTextFieldCodigoViaDireccion.getText().equals("")){
            	unidadCons.getDirUnidadConstructiva().setCodigoVia(Integer.parseInt(jTextFieldCodigoViaDireccion.getText()));
            }
            
//            if(!jTextFieldCodigoVia.getText().equals("")){
//            	unidadCons.getDirUnidadConstructiva().setCodigoVia(new Integer(jTextFieldCodigoVia.getText()).intValue());
//            }
//            else{
//            	unidadCons.getDirUnidadConstructiva().setCodigoVia(new Integer(-1).intValue());
//            }
//            
            ...
            try
            {
                DireccionLocalizacion dir = ConstantesRegExp.clienteCatastro.getViaPorNombreYCodigo(unidadCons.getDirUnidadConstructiva().getNombreVia(),unidadCons.getDirUnidadConstructiva().getCodigoVia());
...
//                    jComboBoxTramo.getSelectedItem().toString():"");
            ...
            if (unidadCons.getDatosEconomicos().getZonaValor().getCodZonaValor() != null &&
            	...
            	try {
					...
					PonenciaZonaValor ponenciaZonaValor = ConstantesRegExp.clienteCatastro.obtenerPonenciaZonaValor(unidadCons.getDatosEconomicos().getZonaValor().getCodZonaValor());
            ...
            if (unidadCons.getDatosEconomicos().getTramoPonencia().getCodTramo() != null &&
            	...
            	try {
					...
					PonenciaTramos tramos = ConstantesRegExp.clienteCatastro.obtenerPonenciaTramos(unidadCons.getDatosEconomicos().getTramoPonencia().getCodTramo());
    ...
    private JPanel getJPanelDatosLocalizacion()
    {
        if (jPanelDatosLocalizacion == null)
        {
            ...
            jLabelVia.setText(I18N.get("Expedientes", "unidadconstructiva.panel.datoslocalizacion.via")); 
            jLabelCodigoViaDireccion = new JLabel("", JLabel.CENTER); 
            jLabelCodigoViaDireccion.setText(I18N.get("Expedientes", "unidadconstructiva.panel.datoslocalizacion.codigoVia"));
            ...
            jPanelDatosLocalizacion.add(jLabelCodigoViaDireccion, new GridBagConstraints(0, 2, 1, 1, 0.1,0.1, GridBagConstraints.CENTER,GridBagConstraints.HORIZONTAL, new Insets (0,5,0,5), 0,0));
            jPanelDatosLocalizacion.add(jLabelVia, new GridBagConstraints(1, 2, 2, 1, 0.1,0.1, GridBagConstraints.CENTER,GridBagConstraints.HORIZONTAL, new Insets (0,5,0,5), 0,0));
            jPanelDatosLocalizacion.add(jLabelDireccion, new GridBagConstraints(3, 2, 7, 1, 0.1,0.1, GridBagConstraints.CENTER,GridBagConstraints.HORIZONTAL, new Insets (0,5,0,5), 0,0));
            ...
            jPanelDatosLocalizacion.add(getJTextFieldCodigoViaDireccion(), new GridBagConstraints(0, 3, 1, 1, 0.1,0.1, GridBagConstraints.CENTER,GridBagConstraints.HORIZONTAL, new Insets (0,5,0,5), 0,0));
            jPanelDatosLocalizacion.add(getJComboBoxTipoVia(), new GridBagConstraints(1, 3, 2, 1, 0.1,0.1, GridBagConstraints.CENTER,GridBagConstraints.HORIZONTAL, new Insets (0,5,0,5), 0,0));
            jPanelDatosLocalizacion.add(getJTextFieldDireccion(), new GridBagConstraints(3, 3, 6, 1, 0.1,0.1, GridBagConstraints.CENTER,GridBagConstraints.HORIZONTAL, new Insets (0,5,0,5), 0,0));
    ...
    private JPanel getJPanelDatosFisicos()
    {
        if (jPanelDatosFisicos == null)
        {
            ...
            jLabelLongitudFachada.setText(I18N.get("Expedientes", "unidadconstructiva.panel.datosfisicos.longfachada")+ " ("+I18N.get("Expedientes","unidadconstructiva.panel.datosfisicos.metros")+")"); 
    ...
    private JButton getJButtonBuscarDireccion()
    {
        if (jButtonBuscar == null)
        {
            ...
            jButtonBuscar.setIcon(IconLoader.icon(GestionExpedienteConst.ICONO_BUSCAR));
            jButtonBuscar.addActionListener(new java.awt.event.ActionListener()
                ...
                public void actionPerformed(java.awt.event.ActionEvent e)
                {
                    ...
                    int codigoVia = 0;
                    if (!jTextFieldCodigoViaDireccion.getText().equals("")){
                    	codigoVia = new Integer(jTextFieldCodigoViaDireccion.getText()).intValue();
                    }
                    ...
                    tipoVia = dialog.getTipoVia();
                    String codVia = Integer.toString(dialog.getCodigoVia());
                    jComboBoxTipoVia.setSelectedPatron(tipoVia);
                    jTextFieldDireccion.setText(nombreVia);
                    jTextFieldCodigoViaDireccion.setText(codVia);
                }
                    });
    ...
    /**
     * This method initializes jTextFieldCodigoViaDireccion	
     * 	
     * @return javax.swing.JTextField	
     */
    private JTextField getJTextFieldCodigoViaDireccion()
    {
    	if (jTextFieldCodigoViaDireccion == null)
        {
    		jTextFieldCodigoViaDireccion = new TextField(5);
            
        }
    	jTextFieldCodigoViaDireccion.getDocument().addDocumentListener(new ListenerTextField());  
        return jTextFieldCodigoViaDireccion;
    }
        ...
        if (jTextFieldLongitudFachada == null)
        {
            ...
            jTextFieldLongitudFachada.addCaretListener(new CaretListener()
                ...
                public void caretUpdate(CaretEvent evt)
                {
                    ...
                    if(!jTextFieldLongitudFachada.getText().equals("")){
	                    Float longFachada = Float.parseFloat(jTextFieldLongitudFachada.getText());
	                    if(longFachada >= 1000){
	                    	JOptionPane.showMessageDialog(aplicacion.getMainFrame(), 
	                    			I18N.get("Expedientes","unidadconstructiva.panel.datosfisicos.fachada.longitud.maxima") + " 999.99 " +
	                    			I18N.get("Expedientes","unidadconstructiva.panel.datosfisicos.metros"));
	                        UtilRegistroExp.retrocedeCaracter(jTextFieldLongitudFachada,jTextFieldLongitudFachada.getText().length()-1);
...
*/        }
	...
	private JPanel getJPanelBotonera()
    {
        if (jPanelBotonera  == null)
        {
        	...
        	if(!(Boolean)AppContext.getApplicationContext().getBlackboard().get("expSitFinales")){
        		//se incluye el botón modificar cuando el expediente es de variaciones
	        	jPanelBotonera.add(getJButtonModificarUC(), 
	...
	private JButton getJButtonEliminarUC()
    {
        ...
        jButtonEliminarUC.setName("_eliminarUC");
        return jButtonEliminarUC;
    }
	
	
	private JButton getJButtonModificarUC(){
		if (jButtonModificarUC   == null)
        {
			jButtonModificarUC = new JButton();
			jButtonModificarUC.setText(I18N.get("Expedientes", "unidadconstructiva.panel.boton.modificarunidadconstructiva"));
			
			jButtonModificarUC.addActionListener(new java.awt.event.ActionListener()
            {
            	public void actionPerformed(java.awt.event.ActionEvent e)
            	{
            		EdicionUtils.enablePanel(UnidadConstructivaPanel.this, true);
            		if(!unidadCons.getTIPO_MOVIMIENTO().equals(UnidadConstructivaCatastro.TIPO_MOVIMIENTO_ALTA)){
            			unidadCons.setTIPO_MOVIMIENTO(UnidadConstructivaCatastro.TIPO_MOVIMIENTO_MODIF);
            		}
            		unidadCons.setElementoModificado(true);
            	}
            });
        }
		jButtonModificarUC.setName("_modificarUC");
        return jButtonModificarUC;
	}
	...
	private JButton getJButtonNuevaUC()
    {
        if (jButtonNuevaUC   == null)
        {
        	...
        	jButtonNuevaUC.addActionListener(new java.awt.event.ActionListener()
            {
            	public void actionPerformed(java.awt.event.ActionEvent e)
            	{
            		if(!(Boolean)AppContext.getApplicationContext().getBlackboard().get("expSitFinales")){
            			EdicionUtils.enablePanel(UnidadConstructivaPanel.this, true);
            			//EdicionUtils.disabledButtons(UnidadConstructivaPanel.this, "_eliminarUC");
            		}
            		...
            		UnidadConstructivaPanel.this.getJTextFieldCodigoViaDireccion().setText(String.valueOf(fincaActual.getDirParcela().getCodigoVia()));
        ...
        jButtonNuevaUC.setName("_nuevoUC");
	...
	private JButton getJButtonAniadirUC()
    {
        ...
        jButtonAniadirUC.setName("_anadirUC");
    ...
    private void annadeUC()
    {
    	if(this.datosMinimosYCorrectosUC()){
	        ...
	        if(!(Boolean)AppContext.getApplicationContext().getBlackboard().get("expSitFinales")){
	        	unidadCons.setElementoModificado(true);
	        	unidadCons.setTIPO_MOVIMIENTO(UnidadConstructivaCatastro.TIPO_MOVIMIENTO_ALTA);
	        }
            ...
            if(!(Boolean)AppContext.getApplicationContext().getBlackboard().get("expSitFinales")){
            	...
            	EdicionUtils.enablePanel(UnidadConstructivaPanel.this, true);
            	UnidadConstructivaPanel.this.getJButtonEliminarUC().setEnabled(true);
            }
    	}else{
    ...
    private void eliminaUC()
    {
        			...
        			&&unidadCons.getCodUnidadConstructiva().equalsIgnoreCase(uc.getCodUnidadConstructiva()))
      	    {
	        	if((Boolean)AppContext.getApplicationContext().getBlackboard().get("expSitFinales")){
	        		...
	        		if(uc.getTIPO_MOVIMIENTO().equals(UnidadConstructivaCatastro.TIPO_MOVIMIENTO_ALTA)){
	        			lstUC.remove(i);
		                continua = false;
	        			uc.setElementoModificado(false);
	        			...
	        			uc.setTIPO_MOVIMIENTO(UnidadConstructivaCatastro.TIPO_MOVIMIENTO_BAJA);
	        			uc.setElementoModificado(false);
        ...
        EdicionUtils.enablePanel(this, false);
        /*TreePath path = new TreePath(arbol.getSelectionPath().getParentPath().getLastPathComponent());
        panelExpedientes.removeObject(arbol.getSelectionPath().getLastPathComponent());        
        arbol.setSelectionPath(path);
        */
