/**
 * GeopistaMostrarDatosCatastroXMLNoProtegidos.java
 ...
 */
public class GeopistaMostrarDatosCatastroXMLNoProtegidos extends JDialog
{
    ...
    private JLabel lblSuperficieContruida = null;
    private JLabel lblDesSuperficieContruida = null;
    
    private JLabel lblCoeficienteParticipacion = null;
    private JLabel lblDesCoeficienteParticipacion = null;

    private JLabel lblAntiguedad = null;
    private JLabel lblDesAntiguedad = null;
    ...
    private JLabel lblSuperficie = null;
    ...
    private JLabel lblDesSuperficie= null;
     ...
     * @throws IOException 
     */
    public GeopistaMostrarDatosCatastroXMLNoProtegidos(JFrame fondo, String sCadena)
        ...
        lstBienes.addListSelectionListener(new ListSelectionListener()
            {
                ...
                public void valueChanged(ListSelectionEvent e)
                {
                    ...
                    // de solapas.
                    resetarValoresVentanaCatastro(true, false, false, true, false);
    ...
    private JTabbedPane getJTabbedPane()
    {
        if (jTabbedPane == null)
        {
            ...
            jTabbedPane.addTab(aplicacion.getI18nString("certificados.datos.generales"),
                    null, getJPanel(), null);
            //jTabbedPane.addTab(aplicacion.getI18nString("certificados.titulares"), null,getJPanel1(), null);
            //jTabbedPane.addTab(aplicacion.getI18nString("certificados.movimientos.finca"), null,getJPanel2(), null);
            jTabbedPane.addTab(aplicacion.getI18nString("certificados.construcciones"),null, getJPanel3(), null);
            //jTabbedPane.addTab(aplicacion.getI18nString("certificados.subparcelas"),null, getJPanel4(), null);
            //jTabbedPane.addTab(aplicacion.getI18nString("certificados.rusticos.solapa"),null, getJPanel14(), null);
    ...
    private JPanel getJPanel()
    {
        if (jPanel == null)
        {
            ...
            lblSuperficieContruida = new JLabel();
            lblDesSuperficieContruida = new JLabel();

            lblCoeficienteParticipacion = new JLabel();
            lblDesCoeficienteParticipacion = new JLabel();

            lblAntiguedad = new JLabel();
            lblDesAntiguedad = new JLabel();
            ...
            lblSuperficieContruida.setText(aplicacion.getI18nString("certificados.superficie.construida"));
            lblSuperficieContruida.setFont(new java.awt.Font("Dialog", java.awt.Font.BOLD, 12));
            lblDesSuperficieContruida.setText("");

            lblCoeficienteParticipacion.setText("Coeficiente Partipacion:");
            lblCoeficienteParticipacion.setFont(new java.awt.Font("Dialog", java.awt.Font.BOLD, 12));
            lblDesCoeficienteParticipacion.setText("");

            lblAntiguedad.setText("Antiguedad:");
            lblAntiguedad.setFont(new java.awt.Font("Dialog", java.awt.Font.BOLD, 12));
            lblDesAntiguedad.setText("");
            ...
            lblRefCat.setBounds(10, 76, 150, 16);        
            lblSuperficieContruida.setBounds(10, 106, 140, 16);
            lblCoeficienteParticipacion.setBounds(10, 136, 140, 16);
            lblAntiguedad.setBounds(10, 166, 140, 16);

            lblDesDomicilioTributario.setBounds(148, 28, 364, 16);
            lblUso.setBounds(287, 8, 33, 16);
            lblDesNaturaleza.setBounds(147, 6, 132, 16);
            
            lblDesRefCat.setBounds(179, 76, 366, 16);
            lblDesSuperficieContruida.setBounds(179, 106, 366, 16);
            lblDesCoeficienteParticipacion.setBounds(179, 136, 366, 16);
            lblDesAntiguedad.setBounds(179, 166, 366, 16);
            
            lblProvincia.setBounds(11, 52, 67, 16);
            lblDesProvincia.setBounds(148, 52, 131, 16);
            lblMunicipio.setBounds(290, 50, 65, 16);
            lblDesMunicipio.setBounds(361, 50, 151, 16);
    ...
    private JPanel getJPanel3()
    {
        if (jPanel3 == null)
        {
            ...
            jLabel.setText(aplicacion.getI18nString("certificados.listado.Construcciones"));
    ...
    private JPanel getJPanel6()
    {
        if (jPanel6 == null)
        {
            ...
            jPanel6.setBounds(161, 41, 522, 600);
            ...
            jPanel6.add(lblSuperficieContruida, null);
            jPanel6.add(lblCoeficienteParticipacion, null);
            jPanel6.add(lblAntiguedad, null);
            ...
            jPanel6.add(lblDesSuperficieContruida, null);
            jPanel6.add(lblDesCoeficienteParticipacion, null);
            jPanel6.add(lblDesAntiguedad, null);
    ...
    private void rellenarListaBienes(Document doc, JList lstBienes)
    {
        ...
        Element Consulta_DNP = soapBody.getChild("Consulta_DNP", nm);
        Namespace nm2 = Namespace.getNamespace("http://www.catastro.meh.es/");
        Element consulta_dnp = Consulta_DNP.getChild("consulta_dnp",nm2);
        /*Element resp = ovc_consulta_datos_out.getChild("resp", ovc_consulta_datos_out
                .getNamespace());*/
        Element bico = consulta_dnp.getChild("bico", consulta_dnp.getNamespace());

        // Debo llegar al dsa
        //Element lbi = bico.getChild("lbi", bico.getNamespace());
        if (bico!=null){
	        List bienes = bico.getChildren("bi", bico.getNamespace());
	        Iterator iBienes = bienes.iterator();
	        while (iBienes.hasNext())
	        {
	            Element dbi = (Element) iBienes.next();
	            Element idbi = dbi.getChild("idbi", dbi.getNamespace());
	            Element rc = idbi.getChild("rc", idbi.getNamespace());
    ...
    private void rellenarDatosGenerales(Document doc, String refCat)
    {
        ...
        while (iBienes.hasNext())
        {
            ...
            if ((pc1.getText() + pc2.getText()).equals(refCat))
            {
                ...
                // Naturaleza
                Element cn = idbi.getChild("cn", idbi.getNamespace());
                ...
                Element dt = dbi.getChild("dt", dbi.getNamespace());
                Element loine = dt.getChild("loine", dt.getNamespace());
                Element cp = loine.getChild("cp", loine.getNamespace());
                Element cm = loine.getChild("cm", loine.getNamespace());
                
                Element npProvincia =dt.getChild("np", dbi.getNamespace());
                Element nmMunicipio =dt.getChild("nm", dbi.getNamespace());
                lblDesMunicipio.setText(nmMunicipio.getText());
                lblDesProvincia.setText(npProvincia.getText());
                ...
                Element ltd = dbi.getChild("ldt", dbi.getNamespace());
                lblDesDomicilioTributario.setText(ltd == null ? "" : ltd.getText());
                
                
                // Uso,superficei, coeficiente y año
                Element debi = dbi.getChild("debi", dbi.getNamespace());
                Element luso = debi.getChild("luso", debi.getNamespace());
                lblDesUso.setText(luso == null ? "" : luso.getText());
                
                
                Element sfc = debi.getChild("sfc", debi.getNamespace());
                lblDesSuperficieContruida.setText(sfc == null ? "" : sfc.getText()+" m2");

                Element cpt = debi.getChild("cpt", debi.getNamespace());
                lblDesCoeficienteParticipacion.setText(cpt == null ? "" : cpt.getText());

                Element ant = debi.getChild("ant", debi.getNamespace());
                lblDesAntiguedad.setText(ant == null ? "" : ant.getText());
				...
				*/
                ...
                3..setText(sfc == null ? "" : sfc.getText());
    ...
    private void rellenarListaConstrucciones(Document doc)
    {
        ...
        // Se ha alcanzado las posición
        Element lcons = bico.getChild("lcons", bico.getNamespace());
        if (lcons != null)
        {
            List construcciones = lcons
                    .getChildren("cons", lcons.getNamespace());
    ...
    private void rellenarDatosConstruccion(Document doc, String sUso, int nPosicion)
    {
        ...
        Element lcons = bico.getChild("lcons", bico.getNamespace());
        List construcciones = lcons.getChildren("cons", lcons.getNamespace());
        Iterator iConstrucciones = construcciones.iterator();
        int posicion = 0;
        while (iConstrucciones.hasNext())
        {

            Element cons = (Element) iConstrucciones.next();
            Element lcd = cons.getChild("lcd", cons.getNamespace());
            if (nPosicion == posicion++)
            {
                if (lcd.getText().equals(sUso))
                {
                    // Estamos en el mismo valor
                    Element dt = cons.getChild("dt", cons.getNamespace());
                    ...
                    if (dt!=null && dt.getText() != null)
                    {
	                    ...
	                    Element pt = loint.getChild("pt", loint.getNamespace());
	                    ...
	                    if (pt != null)
	                    {
	                        lblDesPlantaConstruccion.setText(pt.getText());
	                    }
	                    if (pu != null)
	                    {
                    ...
                    Element dfcons = cons.getChild("dfcons", cons.getNamespace());
                    if (dfcons!=null && dfcons.getText() != null){
                    	 Element superficie = dfcons.getChild("stl", dfcons.getNamespace());
                    	 if (superficie != null)
 	                    {
 	                        lblDesSuperficie.setText(superficie.getText()+" m2");
 	                    }
                    }
                    break;
                }
    ...
    private JPanel getJPanel12()
    {
        if (jPanel12 == null)
        {
            ...
            jPanel12.setBorder(javax.swing.BorderFactory.createLineBorder(java.awt.Color.black, 2));
            ...
            lblLocalizacionInterna.setBounds(16, 10, 137, 21);
            lblLocalizacionInterna.setText(aplicacion.getI18nString("certificados.localizacion.interna"));
            lblBloque.setBounds(35, 40, 53, 26);
            lblBloque.setText(aplicacion.getI18nString("certificados.bloque"));
            lblEscalera.setBounds(35, 70, 66, 26);
            lblEscalera.setText(aplicacion.getI18nString("certificados.escalera"));
            lblPlantaConstruccion.setBounds(35, 100, 53, 26);
            lblPlantaConstruccion.setText(aplicacion.getI18nString("certificados.planta"));
            lblPuerta.setBounds(35, 130, 53, 26);
            lblPuerta.setText(aplicacion.getI18nString("certificados.puerta"));
            lblSuperficie.setBounds(35, 160, 53, 26);
            lblSuperficie.setText("Superficie");
            
            lblDesBloque.setBounds(140, 40, 204, 26);
            lblDesBloque.setText("");
            lblDesEscalera.setBounds(140, 70, 204, 26);
            lblDesEscalera.setText("");
            lblDesPlantaConstruccion.setBounds(140, 100, 204, 26);
            lblDesPlantaConstruccion.setText("");
            lblDesPuerta.setBounds(140, 130, 204, 26);
            lblDesPuerta.setText("");
            lblDesSuperficie.setBounds(140, 160, 204, 26);
            lblDesSuperficie.setText("");
            
            //jPanel12.add(lblDomicilioConstruccion, null);
            //jPanel12.add(getTxtDomicilioConstruccion(), null);
            getTxtDomicilioConstruccion();
            //jPanel12.add(lblLocalizacionUrbana, null);
            //jPanel12.add(getTxtLocalizacionUrbana(), null);
            getTxtLocalizacionUrbana();
            ...
            jPanel12.add(lblSuperficie, null);
            ...
            jPanel12.add(lblDesSuperficie, null);
        }
        return jPanel12;
    }
