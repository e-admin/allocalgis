...
public class EdicionOperations
{
     ...
     */
    public ArrayList obtenerViasCatastro (String nomVia) throws DataExceptionCatastro
    {        
    ...
    public ArrayList obtenerViasINE (String nomVia) throws DataExceptionCatastro
    {        
        ArrayList lstVias = new ArrayList();
     ...
     * @throws DataExceptionCatastro Si se produce un error de acceso a datos 
     */
    public ArrayList obtenerViasCatastro (String nomVia, String tipoVia) throws DataExceptionCatastro
    {        
        ArrayList lstVias = new ArrayList();
    ...
    public ArrayList obtenerViasCatastroMunic (String nomVia, String idMunicipio) throws DataExceptionCatastro
    {        
        ArrayList lstVias = new ArrayList();
...
//            s.setInt(1,AppContext.getIdMunicipio());
    ...
    public ArrayList obtenerViasCatastroCodigoVia (String nomVia, String tipoVia, int codigoVia) throws DataExceptionCatastro
    { 
    	ArrayList lstVias = new ArrayList();
    	 try
         { 
    ...
    public Municipio obtenerMunicipioPorId (Integer idMunicipio) throws DataExceptionCatastro
    { 
    ...
    public ArrayList obtenerViasCatastro (String nomVia, String tipoVia, String idMunicipio) throws DataExceptionCatastro
    {        
        ArrayList lstVias = new ArrayList();
    ...
    public ArrayList obtenerViasINE (String nomVia, String tipoVia) throws DataExceptionCatastro
    {        
        ArrayList lstVias = new ArrayList();
     ...
     * @throws DataExceptionCatastro Si se produce un error de acceso a datos 
     */
    public ArrayList obtenerParajesCatastro (String nomParaje) throws DataExceptionCatastro
    {        
    ...
    public String obtenerDxf (long idExpediente, String refCatastral) throws DataExceptionCatastro
    {        
        String dxf  = null;
    ...
    public ArrayList obtenerLstImagenes (long idExpediente, String refCatastral) throws DataExceptionCatastro
    {        
    ...
    public String obtenerAsc(long idExpediente, String refCatastral) throws DataExceptionCatastro
    {        
        String dxf  = null;
...
//            String denominacion = null;
     ...
     * @throws DataExceptionCatastro Si se produce un error de acceso a datos 
     */
    public ArrayList obtenerTitulares (String nif, String nombreApellidos) throws DataExceptionCatastro
    {        
