        ...
        if (row>=0)
        {
            ...
            case TIPO_LOCAL:
                        ...
                        && ((ConstruccionCatastro)obj).getDatosEconomicos().getCodModalidadReparto()!=null)
                {
                    ...
                    sTitle.append("Local :").append(" ").append(GeopistaCommonUtils.completarConCeros(((ConstruccionCatastro)obj).getNumOrdenConstruccion(), 4));
                }
                else
                {
            ...
            case TIPO_SUELO:
                ...
                sTitle.append("Suelo:").append(" ").append(GeopistaCommonUtils.completarConCeros(((SueloCatastro)obj).getNumOrden(),4)); 
                break;
                
            case TIPO_UC:
                setIcon(IconLoader.icon(ICONO_UC)); 
                sTitle.append("U.Constructiva:").append(" ").append(GeopistaCommonUtils.completarConCeros(((UnidadConstructivaCatastro)obj).getCodUnidadConstructiva(),4)); 
                break;
