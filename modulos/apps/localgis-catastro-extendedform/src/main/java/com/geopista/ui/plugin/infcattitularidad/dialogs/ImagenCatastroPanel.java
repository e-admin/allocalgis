...
public class ImagenCatastroPanel extends JPanel implements FeatureExtendedPanel, ImagenInterface
{
	...
	private JPanel getJPanelDatosImagenes() {
		...
		if (jPanelDatosImagenes == null){
			...
			jPanelDatosImagenes.setBorder(BorderFactory.createTitledBorder
                    (null, I18N.get("InfCatastralTitularidadPlugIn", "infCatastralTitularidad.img.panel.title"), TitledBorder.LEADING, 
	...
	private JPanel getJPanelDatos(){
		...
		if (jPanelDatos == null){
            ...
            jLabelNombre.setText(I18N.get("InfCatastralTitularidadPlugIn", "infCatastralTitularidad.img.panel.attribute.name")); 
            
            jLabelExtension = new JLabel("", JLabel.CENTER); 
            jLabelExtension.setText(I18N.get("InfCatastralTitularidadPlugIn", "infCatastralTitularidad.img.panel.attribute.ext")); 
            
            jLabelTipoDocumento = new JLabel("", JLabel.CENTER); 
            jLabelTipoDocumento.setText(I18N.get("InfCatastralTitularidadPlugIn", "infCatastralTitularidad.img.panel.attribute.type")); 
	...
	private JPanel getJPanelMostrarImagen(){
		...
		if (jPanelMostrarImagen == null){
			...
			jPanelMostrarImagen.setBorder(BorderFactory.createTitledBorder
                    (null, I18N.get("InfCatastralTitularidadPlugIn", "infCatastralTitularidad.img.panel.imagen"), TitledBorder.LEADING, 
                    		TitledBorder.TOP, new Font(null, Font.BOLD, 12))); 
	...
	private JPanel getJPanelThumbnails() {
		...
		if (jPanelThumbnails == null){
			...
			jPanelThumbnails.setBorder(BorderFactory.createTitledBorder
                    (null, I18N.get("InfCatastralTitularidadPlugIn", "infCatastralTitularidad.img.panel.thumbnail.title"), TitledBorder.LEADING, 
                    		TitledBorder.TOP, new Font(null, Font.BOLD, 12))); 
...
//        this.setMinimumSize(this.getPreferredSize());
    ...
    public void enter()
    {
        ...
        progressDialog.report(I18N.get("InfCatastralTitularidadPlugIn","infCatastralTitularidad.img.panel.loadimages"));
...
//                auxPintarImagen.setSelected(imageSelected == null ? false : auxImagen.getImagen().equals(imageSelected.getImagen()));
	...
	private ImagenCatastro addImagen(){
		...
		try{
			...
			JOptionPane.showMessageDialog(null,I18N.get("InfCatastralTitularidadPlugIn","infCatastralTitularidad.img.panel.buttons.add.error"),
