...
public class DatosValoracion
{
    ...
    private boolean recopilaDatosBD(Connection conn) throws DataExceptionCatastro
    {
    ...
    private void generaDatosValoracion(Connection conn,FincaCatastro finca, int annoAprobacion, String idMunicipio)throws DataExceptionCatastro
    {
    ...
    private boolean calculaZonaUnitario(Connection conn, FincaCatastro finca, int annoAprobacion, String idMunicipio)throws DataExceptionCatastro
    {
    ...
    private boolean calculaZonaRepercusion (Connection conn, FincaCatastro finca, int annoAprobacion, String idMunicipio)throws DataExceptionCatastro
    {
        ArrayList listaSuelos = finca.getLstSuelos();
        if(listaSuelos!=null)
        {
    ...
    private void rellenaCodCalificacion(Connection conn, SueloCatastro suelo, int annoAprobacion, String idMunicipio)throws DataExceptionCatastro
    {
        PreparedStatement s = null;
        ResultSet r = null;
        try
    ...
    private Integer calculaAnnoNormas(Connection conn, Integer annoAprobacionPonencia, String idMunicipio) throws DataExceptionCatastro
    {
