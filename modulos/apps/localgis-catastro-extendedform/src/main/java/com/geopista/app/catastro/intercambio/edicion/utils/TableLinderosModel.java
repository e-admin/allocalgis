...
public class TableLinderosModel extends AbstractTableModel {
	...
	public LinderoCatastro buscarLinderoPorTipo(String tipoLindero) {
		// TODO Auto-generated method stub
		try{
