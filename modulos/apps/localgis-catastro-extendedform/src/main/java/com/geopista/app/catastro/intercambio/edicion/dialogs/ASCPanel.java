...
public class ASCPanel extends JPanel implements FeatureExtendedPanel {
	...
	private JPanel jPanelExpediente = null;
	...
	private JLabel jLabelEjercicio = null;
	private JLabel jLabelNumeroExpediente = null;
	private JLabel jLabelEntidadColaboradora = null;
	private JTextField jTextFieldEjercicio = null;
	private JTextField jTextFieldNumeroExpediente = null;
	private JTextField jTextFieldEntidadColaboradora = null;
	...
	private JButton jButtonModificarDXF = null;
	
	private ASCCatastro asc;
	private FincaCatastro finca;
	private PlantaCatastro plantaCatSelected;
	...
	public ASCPanel() {
		...
		EdicionUtils.editablePanel(getJPanelIdentificacion(), false);
		EdicionUtils.enablePanel(getJPanelIdentificacion(), false);
	...
	private void initialize() {
		...
		this.add(getJPanelPlantas(), new GridBagConstraints(
				0, 1, 1, 1, 0.1, 0.1, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(0, 5, 0, 5), 0, 0));
	...
	private JPanel getJPanelIdentificacion() {
		if (jPanelIdentificacion == null) {
			...
			jPanelIdentificacion.add(getJTextFieldFechaCaptura(),
					new GridBagConstraints(4, 7, 2, 1, 0.1, 0.1,
							GridBagConstraints.NORTH,
							GridBagConstraints.HORIZONTAL, new Insets(0, 5, 0,
									5), 0, 0));

			jPanelIdentificacion.add(getJButtonModificarDXF(), 
	    			new GridBagConstraints(6, 7, 1, 1, 0.1, 0.1, GridBagConstraints.EAST,
	...
	private JPanel getJPanelPlantas() {
		if (jPanelPlantas == null) {
			...
			jPanelPlantas.setBorder(BorderFactory.createTitledBorder(null, I18N
					.get("Expedientes", "asc.panel.datosplantas.titulo"),
					TitledBorder.LEADING, TitledBorder.TOP, new Font(null,
							Font.BOLD, 12)));
	...
	/**
	 * This method initializes jPanelExpediente
	 * 
	 * @return javax.swing.JPanel
	 */
	private JPanel getJPanelExpediente() {
		if (jPanelExpediente == null) {
			jLabelEntidadColaboradora = new JLabel();
			jLabelEntidadColaboradora
			.setText("Código de Entidad Colaboradora Origen");

			jLabelNumeroExpediente = new JLabel();
			jLabelNumeroExpediente.setText("Número de expediente");

			jLabelEjercicio = new JLabel();
			jLabelEjercicio.setText("Ejercicio");
			jPanelExpediente = new JPanel(new GridBagLayout());
			jPanelExpediente.setBorder(BorderFactory
					.createTitledBorder(null, I18N.get("Expedientes",
					"asc.panel.datosexpediente.titulo"),
					TitledBorder.LEADING, TitledBorder.TOP, new Font(
							null, Font.BOLD, 12)));
			jPanelExpediente.add(jLabelEjercicio,
					new GridBagConstraints(0, 0, 1, 1, 0.1, 0.1,
							GridBagConstraints.NORTH,
							GridBagConstraints.HORIZONTAL, new Insets(0, 5, 0,
									5), 0, 0));
			jPanelExpediente.add(jLabelNumeroExpediente,
					new GridBagConstraints(1, 0, 1, 1, 0.1, 0.1,
							GridBagConstraints.NORTH,
							GridBagConstraints.HORIZONTAL, new Insets(0, 5, 0,
									5), 0, 0));
			jPanelExpediente.add(jLabelEntidadColaboradora,
					new GridBagConstraints(2, 0, 1, 1, 0.1, 0.1,
							GridBagConstraints.NORTH,
							GridBagConstraints.HORIZONTAL, new Insets(0, 5, 0,
									5), 0, 0));
			jPanelExpediente.add(getJTextFieldEjercicio(),
					new GridBagConstraints(0, 1, 1, 1, 0.1, 0.1,
							GridBagConstraints.NORTH,
							GridBagConstraints.HORIZONTAL, new Insets(0, 5, 0,
									5), 0, 0));
			jPanelExpediente.add(getJTextFieldNumeroExpediente(),
					new GridBagConstraints(1, 1, 1, 1, 0.1, 0.1,
							GridBagConstraints.NORTH,
							GridBagConstraints.HORIZONTAL, new Insets(0, 5, 0,
									5), 0, 0));
			jPanelExpediente.add(getJTextFieldEntidadColaboradora(),
	...
	private JTextField getJTextFieldCodDelegacion() {
		if (jTextFieldCodDelegacion == null) {
			jTextFieldCodDelegacion = new JTextField(3);
	...
	/**
	 * This method initializes jTextFieldEjercicio
	 * 
	 * @return javax.swing.JTextField
	 */
	private JTextField getJTextFieldEjercicio() {
		if (jTextFieldEjercicio == null) {
			jTextFieldEjercicio = new TextField(4);
			
			jTextFieldEjercicio.addFocusListener(new FocusAdapter() {
			    public void focusLost(FocusEvent e) {
			    	
			    	try{
			    		if (!jTextFieldEjercicio.getText().equals("")){
			    			int cod = Integer.parseInt(jTextFieldEjercicio.getText());
			    			asc.setEjercicioExpediente(String.valueOf(cod));
			    		} else{
				    		JOptionPane.showMessageDialog(AppContext.getApplicationContext().getMainFrame(), 
		    				"El año de ejercicio del expediente no puede estar vacío.");
			    		}
			    	} catch (NumberFormatException ex) {
						// TODO: handle exception
			    		JOptionPane.showMessageDialog(AppContext.getApplicationContext().getMainFrame(), 
			    			"El año de ejercicio del expediente debe ser un número.");
					}
			    }
			  });
			
		}
		return jTextFieldEjercicio;
	}

	/**
	 * This method initializes jTextFieldNumeroExpediente
	 * 
	 * @return javax.swing.JTextField
	 */
	private JTextField getJTextFieldNumeroExpediente() {
		if (jTextFieldNumeroExpediente == null) {
			jTextFieldNumeroExpediente = new TextField(13);
			
			jTextFieldNumeroExpediente.addFocusListener(new FocusAdapter() {
			    public void focusLost(FocusEvent e) {
			    	if (!jTextFieldNumeroExpediente.getText().equals("")){
			    		asc.setRefExpedienteAdministrativo(jTextFieldNumeroExpediente.getText());
			    	} else{
			    		JOptionPane.showMessageDialog(AppContext.getApplicationContext().getMainFrame(), 
			    				"El numero de pediente no puede estar vacío.");
			    	}
			    }
			  });
	...
	/**
	 * This method initializes jTextFieldEntidadColaboradora
	 * 
	 * @return javax.swing.JTextField
	 */
	private JTextField getJTextFieldEntidadColaboradora() {
		if (jTextFieldEntidadColaboradora == null) {
			jTextFieldEntidadColaboradora = new TextField(3);
			
			jTextFieldEntidadColaboradora.addFocusListener(new FocusAdapter() {
			    public void focusLost(FocusEvent e) {
			    	
			    	try{
			    		if (!jTextFieldEntidadColaboradora.getText().equals("")){
			    			int cod = Integer.parseInt(jTextFieldEntidadColaboradora.getText());
			    			asc.setCodEntidadColaboradora(String.valueOf(cod));
			    		} else{
				    		JOptionPane.showMessageDialog(AppContext.getApplicationContext().getMainFrame(), 
		    				"El codigo de la entidad colaboradora no puede estar vacío.");
			    		}
			    	} catch (NumberFormatException ex) {
						// TODO: handle exception
			    		JOptionPane.showMessageDialog(AppContext.getApplicationContext().getMainFrame(), 
			    			"El codigo de la entidad colaboradora debe ser un número.");
					}
			    }
			  });
		...
		return jTextFieldEntidadColaboradora;
	}
	...
	private JScrollPane getJScrollPaneListaPlantas() {
		if (jScrollPaneListaPlantas == null) {
			...
			jScrollPaneListaPlantas.setBorder(BorderFactory
					.createTitledBorder(I18N.get("Expedientes",
					"asc.panel.datosplantas.listaplantas")));
	...
	private JTable getJTableListaPlantas() {
		if (jTableListaPlantas == null) {
			...
			tableplantasmodel =  new ListaPlantasTableModel();
			...
			jTableListaPlantas.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
			...
			.addListSelectionListener(new ListSelectionListener() {
				public void valueChanged(ListSelectionEvent e) {
					...
					((TableUsosModel) ((TableSorted) jTableListaUsos.getModel()).getTableModel()).borrarTodasFilas();
					if (!lsm.isSelectionEmpty()) {
						...
						PlantaCatastro plantaCat = null;
						String namePS = (String)((TableSorted)jTableListaPlantas.getModel()).getValueAt(indexSelectedColumnRow, 0);
						ArrayList lstElementosData = (ArrayList)((ListaPlantasTableModel)((TableSorted)jTableListaPlantas.getModel()).getTableModel()).getData();
						for(int i=0; i<lstElementosData.size();i++){
							plantaCat = (PlantaCatastro)lstElementosData.get(i);
							if(plantaCat.getNombre().equals(namePS)){
								plantaCatSelected = new PlantaCatastro();
								plantaCatSelected.setNombre(plantaCat.getNombre());
								plantaCatSelected.setNumPlantasReales(plantaCat.getNumPlantasReales());
								plantaCatSelected.setLstUsos(plantaCat.getLstUsos());
								int usosSize = plantaCat.getLstUsos().size();
								for (int j = 0; j < usosSize; j++) {
									((TableUsosModel) ((TableSorted) jTableListaUsos
											.getModel()).getTableModel()).anniadirUso(
													(UsoCatastro) plantaCat.getLstUsos().get(j));
								}
							}
						}
...
//							((TableUsosModel) ((TableSorted) jTableListaUsos
//									.getModel()).getTableModel()).anniadirUso(
//											(UsoCatastro) plantaCat.getLstUsos().get(i));
//						}
					}
				}
			});
	...
	private JScrollPane getJScrollPaneListaUsos() {
		if (jScrollPaneListaUsos == null) {
			...
			jScrollPaneListaUsos.setBorder(BorderFactory
					.createTitledBorder(I18N.get("Expedientes",
					"asc.panel.datosplantas.listausos")));
	...
	public void setDxfData(String refCat, long idExp) {
	...
	public void enter() {
		...
		final long id_Expediente = this.idExpediente;
		...
		if (AppContext.getApplicationContext().getBlackboard().get("ascTemp")!= null){

			if (AppContext.getApplicationContext().getBlackboard().get("ascTemp") instanceof String){
				String ascTemp = (String)AppContext.getApplicationContext().getBlackboard().get("ascTemp");
				if (!ascTemp.equals("")){
					load(ascTemp);
				}
			}
		...
		"asc.panel.ComprobandoFicheroASC"));
								...
								if (asc != null && !asc.equals("")) {
									...
									try {
										...
										if ((fxccPanel.geopistaEditor != null)
												&& (fxccPanel.geopistaEditor.getLayerManager().getLayers().size() > 0)) {
											...
											loadASC(progressDialog, fxcc.getASC());
											loadExpedienteData(gestionExpedientePanel.getExpediente());
											loadSuperficiePlantaGeneral();
										} else {
				...
				if (!this.fxccPanel.getGeopistaEditor().getLayerManager().getLayers().isEmpty()){
					...
					while(it.hasNext()){
						...
						if (actualCategory.getName().startsWith("PS")){
							...
							if(actualLayerAU != null && actualLayerAS != null){
	...
	private ArrayList getUsosFromLayer(Layer layerAU, Layer layerAS) {
		...
		for (Iterator iterAUFeatures = layerAU.getFeatureCollectionWrapper().getFeatures().iterator(); iterAUFeatures.hasNext();){
			...
			if (objAU instanceof GeopistaFeature){
				...
				if(nom != null && !((String)nom).startsWith("PTO")){
					for (Iterator iterASFeatures = layerAS.getFeatureCollectionWrapper().getFeatures().iterator(); iterASFeatures.hasNext();){
						...
						if (objAS instanceof GeopistaFeature){
							...
							double dis =featureAU.getGeometry().distance(featureAS.getGeometry());
		...
		try {
			...
			while ((linea = br.readLine()) != null) {
				...
				case 26:
					...
					((TablePlantasModel)((TableSorted)this.getJTableListaPlantas().getModel()).getTableModel()).borrarTodasFilas();
					for (int j = 0; j < numPlantasSignificativas; j++) {
						plantaCat = new PlantaCatastro();
						...
						if(linea != null && !linea.equals("null")){
							...
							if(j<10){
								plantaCat.setNombre("0"+String.valueOf(j));
							}
							else{
								plantaCat.setNombre(String.valueOf(j));
							}
						}
						
						this.ponerNombrePlantaSignificativaCategory(j, plantaCat.getNombre());
						PlantaSignificativaInfo pInfo = null;
						if(linea != null && !linea.equals("null")){
							pInfo = new PlantaSignificativaInfo(plantaCat.getNumPlantasReales(),linea);
							ASCPanel.get_instance().infoplantas.put(linea, pInfo);
							
						}
						else{
							pInfo = new PlantaSignificativaInfo(plantaCat.getNumPlantasReales(),plantaCat.getNombre());
							if(j<10){
								plantaCat.setNombre("0"+String.valueOf(j));
								ASCPanel.get_instance().infoplantas.put("0"+String.valueOf(j), pInfo);
							}
							else{
								plantaCat.setNombre(String.valueOf(j));
								ASCPanel.get_instance().infoplantas.put(String.valueOf(j), pInfo);
							}
...
//						
					...
					//((TablePlantasModel)((TableSorted)this.getJTableListaPlantas().getModel()).getTableModel()).setData(asc.getLstPlantas());
					for(int k = 0; k < asc.getLstPlantas().size(); k++) {
						
						((TablePlantasModel)((TableSorted)this.getJTableListaPlantas().getModel()).getTableModel()).anniadirPlanta((PlantaCatastro)asc.getLstPlantas().get(k));
					}
	...
	public void loadFincaCatastroData(FincaCatastro info, Expediente expediente) {
		// TODO Auto-generated method stub

		String codigoDelegacion = info.getCodDelegacionMEH();
		jTextFieldCodDelegacion.setText(codigoDelegacion);
		this.asc.setCodDelegacion(codigoDelegacion);
		// donde sacar el nombre de la gerencia		
		jTextFieldNombreGerencia.setText("");
		this.asc.setNombreGerencia(expediente.getEntidadGeneradora().getNombre());
		...
		String primerNumero = Integer.toString(info.getDirParcela().getPrimerNumero());
		jTextFieldNumPolicia.setText("");
		this.asc.setNumPolicia(primerNumero);

		String pimeraLetra = "";
		if(info.getDirParcela().getPrimeraLetra()!= null ){
			pimeraLetra =info.getDirParcela().getPrimeraLetra();
		}
		jTextFieldLetraDuplicado.setText("");
		this.asc.setLetraDuplicado(pimeraLetra);
		...
		jTextFieldEjercicio.setText("");
		jTextFieldNumeroExpediente.setText("");
		jTextFieldEntidadColaboradora.setText("");



	}

	public void loadExpedienteData(Expediente info) {

		// Añadimos el ejercicio del expediente.
		String ejercicio = Integer.toString(info.getAnnoExpedienteAdminOrigenAlteracion());
		jTextFieldEjercicio.setText(ejercicio);
		this.asc.setEjercicioExpediente(ejercicio);

		// Añadimos el numero de expediente
		String numeroExpediente = info.getNumeroExpediente().toString();
		jTextFieldNumeroExpediente.setText(numeroExpediente);
		this.asc.setRefExpedienteAdministrativo(numeroExpediente);

		// Añadimos el nobre de la entidad colaboradora.
		int entidadColaboradora = info.getEntidadGeneradora().getCodigo();
		jTextFieldEntidadColaboradora.setText(String.valueOf(entidadColaboradora));
		this.asc.setCodEntidadColaboradora(String.valueOf(entidadColaboradora));
	...
	public void loadSuperficiePlantaGeneral(){
		
		String superficieParcela = "0";
		if(finca.getDatosFisicos().getSupFinca() != null)
			superficieParcela = String.valueOf(finca.getDatosFisicos().getSupFinca());
		jTextFieldSuperficieParcela.setText(superficieParcela);
		this.asc.setSupParcela(superficieParcela);
		
		String superficieBR = "0";
		if(finca.getDatosFisicos().getSupBajoRasante() != null)
			superficieBR = String.valueOf(finca.getDatosFisicos().getSupBajoRasante());
		jTextFieldSuperficieBR.setText(superficieBR);
		this.asc.setSupBajoRasante(superficieBR);
		
		String superficieSR = "0";
		if(finca.getDatosFisicos().getSupSobreRasante() != null)
			superficieSR = String.valueOf(finca.getDatosFisicos().getSupSobreRasante());
		jTextFieldSuperficieSR.setText(superficieSR);
		this.asc.setSupSobreRasante(superficieSR);
		
		String superficieConstruida = "0";
		if(finca.getDatosFisicos().getSupTotal() != null)
			superficieConstruida = String.valueOf(finca.getDatosFisicos().getSupTotal());
		jTextFieldSuperficieConstruida.setText(superficieConstruida);
		this.asc.setSupConstruida(superficieConstruida);
	...
	public void setAsc(){
		...
		if (asc != null && asc instanceof ASCCatastro){
			...
			if (jTextFieldEjercicio.getText()!=null){
				asc.setEjercicioExpediente(jTextFieldEjercicio.getText());
			}
			if (jTextFieldNumeroExpediente.getText()!=null){
				asc.setRefExpedienteAdministrativo(jTextFieldNumeroExpediente.getText());
			}
			if (jTextFieldEntidadColaboradora.getText()!=null){
				asc.setCodEntidadColaboradora(jTextFieldEntidadColaboradora.getText());
			}
	...
	public void loadData(ASCCatastro asc) {
		...
		((TablePlantasModel) ((TableSorted) jTableListaPlantas.getModel()).getTableModel()).setData(asc.getLstPlantas());
		...
		jTextFieldEjercicio.setText(asc.getEjercicioExpediente());
		jTextFieldNumeroExpediente.setText(asc.getRefExpedienteAdministrativo());
		jTextFieldEntidadColaboradora.setText(asc.getCodEntidadColaboradora());
	}
	 ...
	 * @return javax.swing.JPanel
	 */
	public JPanel getJPanelPlantaGeneral() {
		if (jPanelPlantaGeneral == null) {
			...
			jPanelPlantaGeneral.setBorder(BorderFactory.createTitledBorder(
					null, I18N.get("Expedientes",
					"asc.panel.plantageneral.titulo")));
	...
	private JPanel getJPanelPlantasSignificativas() {
		if (jPanelPlantasSignificativas == null) {
			...
			jPanelPlantasSignificativas.setBorder(BorderFactory
					.createTitledBorder(null, I18N.get("Expedientes",
					"asc.panel.plantassignificativas.titulo")));
		...
		if (geopistaEditor.getLayerManager().getLayers().size() > 0) {
			...
			if (asc == null) {
				try {
					if (fxcc.getASC() != null) {
						SAXBuilder builder = new SAXBuilder();
						Document docFxcc = builder.build(ImportarUtils
...
//			ascWrite.write(asc, geopistaEditor.getLayerManager());
	...
	public String getASC() {
		...
		if (asc != null) {
			...
			LinderoCatastro linderoDR = null;
			LinderoCatastro linderoIZ = null;
			LinderoCatastro linderoFD = null;
			
			if(!asc.getLstLinderos().isEmpty()){
				//Ordenamos los linderos
				for (int i = 0; i < asc.getLstLinderos().size(); i++) {
					
					if( ((LinderoCatastro) asc.getLstLinderos().get(i)).getTipoLindero().equals("DR")){
						linderoDR = (LinderoCatastro) asc.getLstLinderos().get(i);
					}
					else if(((LinderoCatastro) asc.getLstLinderos().get(i)).getTipoLindero().equals("IZ")){
						linderoIZ = (LinderoCatastro) asc.getLstLinderos().get(i);
					}
					else if(((LinderoCatastro) asc.getLstLinderos().get(i)).getTipoLindero().equals("FD")){
						linderoFD = (LinderoCatastro) asc.getLstLinderos().get(i);
					}
				}
			}
			if(linderoDR != null){
				out.println(linderoDR.getTipoLindero());
				out.println(linderoDR.getCodVia());
				String cont = "";
				if (linderoDR.getSiglaVia() != null) {
					cont = linderoDR.getSiglaVia() + 
					EdicionUtils.completarCadenaLonguitud(linderoDR.getNombreVia(),25) +
					EdicionUtils.completarConCerosIzq(String.valueOf(linderoDR.getNumVia()),4) + 
					linderoDR.getLetraDuplicado();
				}
				out.println(cont);
			}
			else{
			...
			if(linderoIZ != null){
				out.println(linderoIZ.getTipoLindero());
				out.println(linderoIZ.getCodVia());
				String cont = "";
				if (linderoIZ.getSiglaVia() != null) {
					cont = linderoIZ.getSiglaVia() + 
					EdicionUtils.completarCadenaLonguitud(linderoIZ.getNombreVia(),25) +
					EdicionUtils.completarConCerosIzq(String.valueOf(linderoIZ.getNumVia()),4) + 
					linderoIZ.getLetraDuplicado();
				}
				out.println(cont);
			}
			else{
			...
			if(linderoFD != null){
				out.println(linderoFD.getTipoLindero());
				out.println(linderoFD.getCodVia());
				String cont = "";
				if (linderoFD.getSiglaVia() != null) {
					cont = linderoFD.getSiglaVia() + 
					EdicionUtils.completarCadenaLonguitud(linderoFD.getNombreVia(),25) +
					EdicionUtils.completarConCerosIzq(String.valueOf(linderoFD.getNumVia()),4) + 
					linderoFD.getLetraDuplicado();
				}
				out.println(cont);
			}
			else{
			...
			out.println(fillWithCeros(String.valueOf(asc.getLstPlantas().size()), 2));
	...
	public void guardarASCNoSeleccionado(FX_CC fxcc) {
		EdicionOperations oper = new EdicionOperations();
		try {
			String textFxcc = oper.obtenerDxf(this.idExpediente,
					this.refCatastral);
			if (textFxcc != null) {
				SAXBuilder builder = new SAXBuilder();
				Document docFxcc = builder.build(ImportarUtils
				...
				Element dxf = raizFxcc.getChild("asc");
				if (dxf != null) {
	...
	public void cleanup() {
		...
		jTextFieldEjercicio = null;
		jTextFieldNumeroExpediente = null;
		jTextFieldEntidadColaboradora = null;
	...
	private void saveASCTemp(){
	 ...
	 public JButton getJButtonModificarDXF()
	    {
	    	if (jButtonModificarDXF  == null)
	    	{
	    		jButtonModificarDXF = new JButton();
	    		jButtonModificarDXF.setText(I18N.get("Expedientes", "fxcc.panel.boton.modificardxf"));

	    		jButtonModificarDXF.addActionListener(new java.awt.event.ActionListener()
	    		{
	    		...
	    		jButtonModificarDXF.setName("_modificardxf");
	    	}
	    	return jButtonModificarDXF;
	    }

	 private void onNuevoDocumento() {
			// TODO Auto-generated method stub
			ASCEditDialog ascDialog = new ASCEditDialog(asc, fxccPanel);
		}

	 public class ListaPlantasTableModel extends TablePlantasModel
	 {
	    ...
	    public void setValueAt(Object value, int row, int col) 
	    {
	    	...
	    	ArrayList lstElementos = getData();
	    	PlantaCatastro pc = null;
	    	PlantaCatastro pcSeleccionada = null;
	    	int index = 0;
	    	switch (col) {
	    	case 0:
					
	    		pcSeleccionada = (PlantaCatastro)this.getValueAt(row);
	    		index = lstElementos.indexOf(pcSeleccionada);
				pc = ((PlantaCatastro) lstElementos.get(index));
				pc.setNombre(((String)value));
				asc.setLstPlantas(lstElementos);
				if(ASCPanel.get_instance().infoplantas != null){
					((PlantaSignificativaInfo)ASCPanel.get_instance().infoplantas.get(plantaCatSelected.getNombre())).setNombrePlantas(((String)value));
				}
				// se llama al load para cambiar el nombre de la categoria de la layer en el arbol del panel DXF
				load(getASC());
				break;
			case 1:
	    		...
	    		index = lstElementos.indexOf(pcSeleccionada);
				pc = ((PlantaCatastro) lstElementos.get(index));
				pc.setNumPlantasReales(((Integer)value).intValue());
				asc.setLstPlantas(lstElementos);
				if(ASCPanel.get_instance().infoplantas != null){
					((PlantaSignificativaInfo)ASCPanel.get_instance().infoplantas.get(pc.getNombre())).setNumPlantas(((Integer)value).intValue());
				}
