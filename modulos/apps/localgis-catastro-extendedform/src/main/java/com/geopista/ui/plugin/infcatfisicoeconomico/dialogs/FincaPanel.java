                    ...
                    else
                    {
                        ...
                        if (dialog.getConstruccionCatastro(construccion)!=null){
                        	if (construccion.getRefParcela()!=null && construccion.getRefParcela().getRefCatastral()!=null && construccion.getNumOrdenBienInmueble()!=null){
                        		String refFinca = GeopistaCommonUtils.completarConCeros(construccion.getRefParcela().getRefCatastral(),14);
                        		String numBien = GeopistaCommonUtils.completarConCeros(construccion.getNumOrdenBienInmueble(),4);
    			...
    			public void actionPerformed(java.awt.event.ActionEvent e)
    			{
    				...
    				if (cons!=null)
    				{
    					...
    					if (cons.getRefParcela()!=null && cons.getRefParcela().getRefCatastral()!=null && cons.getNumOrdenBienInmueble()!=null){
    						String refFinca = GeopistaCommonUtils.completarConCeros(cons.getFinca().getRefFinca().getRefCatastral(),14);
    						String numBien = GeopistaCommonUtils.completarConCeros(cons.getNumOrdenBienInmueble(),4);
    					}
    					loadData(cons);
                    }
    			}
    ...
    private BienInmuebleCatastro obtenerBien(String idBienInmueble)
    {
        ...
        if(lstBienes!=null)
        {
            for (Iterator iterLstBienes = lstBienes.iterator();iterLstBienes.hasNext();){
            	...
            	String refFinca = GeopistaCommonUtils.completarConCeros(bien.getIdBienInmueble().getParcelaCatastral().getRefCatastral(),14);            	
            	String numBien = GeopistaCommonUtils.completarConCeros(bien.getIdBienInmueble().getNumCargo(),4);
