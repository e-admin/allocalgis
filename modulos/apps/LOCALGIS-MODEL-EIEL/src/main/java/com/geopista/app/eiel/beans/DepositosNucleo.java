...
public class DepositosNucleo {

	private DepositosEIEL depositos = null;
	...
	public DepositosEIEL getDepositos() {
		return depositos;
	}

	public void setDepositos(DepositosEIEL depositos) {
