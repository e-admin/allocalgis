...
public class V_casa_consitorial_bean {
	...
	public String getOrden_casa() {
		return orden_casa;
	}
	public void setOrden_casa(String orden_casa) {
		this.orden_casa = orden_casa;
	}
