...
public class ServiciosAbastecimientosEIEL extends WorkflowEIEL implements Serializable, EIELPanel{
	...
	public ServiciosAbastecimientosEIEL(){
		...
		relacionFields.add(new LCGCampoCapaTablaEIEL("Código Provincia","codprov","eiel_t_abast_serv","getCodINEProvincia"));
		relacionFields.add(new LCGCampoCapaTablaEIEL("Código Municipio","codmunic","eiel_t_abast_serv","getCodINEMunicipio"));
		relacionFields.add(new LCGCampoCapaTablaEIEL("Código INE Entidad","codentidad","eiel_t_abast_serv","getCodINEEntidad"));
		relacionFields.add(new LCGCampoCapaTablaEIEL("Código INE Núcleo","codpoblamiento","eiel_t_abast_serv","getCodINEPoblamiento"));
	}
