...
public class CuadroMandoEIEL extends WorkflowEIEL implements Serializable, EIELPanel{
	
	public CuadroMandoEIEL(){
		...
		relacionFields.add(new LCGCampoCapaTablaEIEL("id","id","eiel_c_alum_cmp",""));
	}	
