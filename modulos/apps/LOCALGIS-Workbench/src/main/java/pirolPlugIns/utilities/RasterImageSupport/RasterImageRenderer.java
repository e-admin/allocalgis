 ...
 *  $RCSfile: RasterImageRenderer.java,v $
 *  $Revision: 1.1 $
 *  $Date: 2009/07/03 12:31:55 $
 *  $Source: /usr/cvslocalgis/.CVSROOT/localgisdos/core/src/pirolPlugIns/utilities/RasterImageSupport/RasterImageRenderer.java,v $
 */
...
//import pirolPlugIns.utilities.debugOutput.DebugUserId;
...
public class RasterImageRenderer extends ImageCachingRenderer {
	...
	private static final Log logger = LogFactory.getLog(RasterImageRenderer.class);
     ...
     *@param panel
     */
    public RasterImageRenderer(Object contentID, ILayerViewPanel panel) {
        super(contentID, (LayerViewPanel) panel);
    }
    
    protected IRasterImageLayer getRasterImageLayer(){
        return (IRasterImageLayer) this.getContentID();
    }
    ...
    private IRasterImageLayer getLayer() {
        return (IRasterImageLayer) getContentID();
    }
    // ############
    ...
    protected void renderHook(ThreadSafeImage image) throws Exception {
        ...
        IRasterImageLayer rLayer = getRasterImageLayer();
        ...
        if (false && rLayer.getOrigImageWidth() * rLayer.getOrigImageHeight() > rLayer.getMaxPixelsForFastDisplayMode()){
            ...
            if (drawingRect!=null){
                ...
                Drawer defaultDrawer = new Drawer() {
                    public void draw(Graphics2D g) throws Exception {
                        ...
                        g.drawRect(drawingRect.x, drawingRect.y, drawingRect.width, -drawingRect.height);
                    }
                };
