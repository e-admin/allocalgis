...
public class Header {
	...
	/**
	 * Creates a Header grid file from the specified number of header's records (numorec), the number of grid's records, the number of grids,
	 * the nodes value's units, the file version, the system start ellipsoid (systemf), the system finish ellipsoid (systemt), 
	 * the bigger semiaxis start ellipsoid, the lower semiaxis start ellipsoid, the bigger semiaxis finish ellipsoid and the lower semiaxis finish ellipsoid.    
	 * @param numorec number of header's records. 
	 * @param numsrec number of grid's records.
	 * @param numfile number of grids.
	 * @param gstype nodes value's units.
	 * @param version file version .
	 * @param systemf system start ellipsoid.
	 * @param systemt system finish ellipsoid.
	 * @param majorf bigger semiaxis start ellipsoid.
	 * @param minorf lower semiaxis start ellipsoid.
	 * @param majort bigger semiaxis finish ellipsoid.
	 * @param minort lower semiaxis finish ellipsoid.
	 */
	public Header(long numorec, long numsrec, long numfile,
			char[] gstype, char[] version, char[] systemf, char[] systemt,
			double majorf, double minorf, double majort, double minort) {
		super();
		numOREC = numorec;
		numSREC = numsrec;
		numFile = numfile;
	 ...
	 * @param num_orec number of header's records.
	 */
	 ...
	 * @param num_srec number of header's records.
	 */
	 ...
	 * @param num_file number of grids.
	 */
	 ...
	 * @param gs_type node's values units.
	 */
	 ...
	 * @param system_f system start ellipsoid.
	 */
	 ...
	 * @param system_t system finish ellipsoid
	 */
	 ...
	 * @param major_f system start ellipsoid's bigger semiaxis.
	 */
	 ...
	 * @param minor_f system start ellipsoid's lower semiaxis.
	 */
	 ...
	 * @param major_t system finish ellipsoid's bigger semiaxis.
	 */
	 ...
	 * @param minort system finish ellipsoid's lower semiaxis.
	 */
	 ...
	 * @param buf {@link RandomAccessFile} to read the header.
	 */
