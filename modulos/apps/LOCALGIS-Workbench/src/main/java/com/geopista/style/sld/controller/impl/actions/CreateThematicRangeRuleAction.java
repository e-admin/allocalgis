/**
 * CreateThematicRangeRuleAction.java
 ...
 *
 */
public class CreateThematicRangeRuleAction implements Action {
	...
	public ActionForward doExecute(Request request) {
		...
		List rangeList = (List) request.getAttribute("RangeList");
		...
		int cont = 0;
		while ((rangeListIterator.hasNext())&&(styleListIterator.hasNext())) {
			List expressions = (List)rangeListIterator.next();
			HashMap style = (HashMap) styleListIterator.next();
			Integer operationID = new Integer(OperationDefines.PROPERTYISBETWEEN);
