/**
 * AddDistanceBufferOpAction.java
 ...
 *
 */
public class AddDistanceBufferOpAction extends AbstractAction {

	private int _targetOperatorType;

	public AddDistanceBufferOpAction(String name, int targetOperatorType) {
		super(name);
