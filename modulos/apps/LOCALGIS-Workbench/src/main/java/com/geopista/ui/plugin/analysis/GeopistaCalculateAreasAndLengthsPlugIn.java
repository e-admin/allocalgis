/**
 * GeopistaCalculateAreasAndLengthsPlugIn.java
...
*
*/
public class GeopistaCalculateAreasAndLengthsPlugIn extends AbstractPlugIn {
   ...
   public void initialize(PlugInContext context) throws Exception {
    ...
    private MultiInputDialog prompt(PlugInContext context) {
        final MultiInputDialog dialog =
            new MultiInputDialog(GeopistaFunctionUtils.getFrame(context.getWorkbenchGuiComponent()), getName(), true);
                            ...
                            new EnableCheck() {
                                ...
                                return dialog.getBoolean(AREA_CHECK_BOX)
                                    ...
                                    && dialog.getText(AREA_COMBO_BOX).equals(
                                        dialog.getText(LENGTH_COMBO_BOX))
                                        ? aplicacion.getI18nString("GeopistaCalculateAreasAndLengthsPlugIn.AreaLongitudDiferentes")
                                        : null;
                }
            }
        }));
                            ...
                            new EnableCheck() {
                                ...
                                return dialog.getBoolean(checkBoxFieldName)
                                    && dialog.getComboBox(comboBoxFieldName).getItemCount()
                                        == 0
                                        ? aplicacion.getI18nString("GeopistaCalculateAreasAndLengthsPlugIn.CapaNoString")
                                        : null;
                }
            }
        }));
    ...
    private static final String LAYER_COMBO_BOX = aplicacion.getI18nString("GeopistaCalculateAreasAndLengthsPlugIn.Capa");
    private static final String AREA_COMBO_BOX = aplicacion.getI18nString("GeopistaCalculateAreasAndLengthsPlugIn.NombreArea");
    private static final String LENGTH_COMBO_BOX = aplicacion.getI18nString("GeopistaCalculateAreasAndLengthsPlugIn.NombreLongitud");
    private static final String LENGTH_CHECK_BOX = aplicacion.getI18nString("GeopistaCalculateAreasAndLengthsPlugIn.CalcularLongitud");
    private static final String AREA_CHECK_BOX = aplicacion.getI18nString("GeopistaCalculateAreasAndLengthsPlugIn.CalcularArea");
