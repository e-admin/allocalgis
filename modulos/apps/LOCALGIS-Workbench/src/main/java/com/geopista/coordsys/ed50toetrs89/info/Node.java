...
public class Node {
	...
	/**
	 * Creates a Node from the specified latitude increase to pass from ED50 to ETRS89, longitude increase to pass from
	 * ED50 to ETRS89, latitude increase precision and longitude increase precision.  
	 * @param ilatitude latitude increase.
	 * @param ifloatitude longitude increase.
	 * @param platitude latitude increase precision.
	 * @param plongitude longitude increase precision.
	 */
	public Node (float ilatitude, float ifloatitude, float platitude, float plongitude){
		super();
		this.ilat = ilatitude;
	 ...
	 * @param plat latitude precision increase.
	 */
	 ...
	 * pass to string all the node information.
	 */
