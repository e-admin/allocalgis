...
public class FilteredAttributeTab extends JPanel implements LayerNamePanel {
    ...
    private FilteredAttributePanel panel;
    ...
    public FilteredAttributeTab(
        final InfoModel model,
        final WorkbenchContext workbenchContext,
        final TaskComponent taskFrame,
        ...
        panel =
            new FilteredAttributePanel(model, workbenchContext, taskFrame, layerManagerProxy) {
            public void layerAdded(LayerTableModel layerTableModel) {
                super.layerAdded((ILayerTableModel)layerTableModel);
                ...
                MouseListener mouseListener = new MouseAdapter() {
                    public void mouseReleased(MouseEvent e) {
                        ...
                        setEnableLastSelectedLayers(true, FilteredAttributeTab.this);
                        ...
                        try {
                            ...
                            setEnableLastSelectedLayers(false, FilteredAttributeTab.this);
                        }
                    }
                };
        ...
        model.addListener(new InfoModelListener() {
            public void layerAdded(ILayerTableModel layerTableModel) {
                panel
                    .getTablePanel(((LayerTableModel)layerTableModel).getLayer())
                    .getTable()
                    .getSelectionModel()
    ...
    private void installToolBarButtons(final WorkbenchContext workbenchContext, final TaskComponent taskFrame) {
        toolBar
            .add(
                new JButton(),
    ...
    private void zoom(FilteredAttributePanel.Row row) throws NoninvertibleTransformException {
    ...
    private static TitledPopupMenu popupMenu(WorkbenchContext context) {
        return (TitledPopupMenu) context.getIWorkbench().getBlackboard().get(
            FilteredAttributeTab.class.getName() + " - LAYER POPUP MENU",
            new TitledPopupMenu());
    }
    ...
    private static PlugIn wrap(final PlugIn plugIn) {
        ...
        return new PlugIn() {
            ...
            public boolean execute(PlugInContext context) throws Exception {
                ...
                FilteredAttributeTab attributeTab = (FilteredAttributeTab) context.getLayerNamePanel();
    ...
    private static void setEnableLastSelectedLayers(
        boolean enabled,
        FilteredAttributeTab attributeTab) {
    ...
    public FilteredAttributePanel getPanel() {
        return panel;
    }
