 ...
 *
 */
public class SelectLayerFieldPanel extends JPanel
{
	/**
	 * Logger for this class
	 */
	private static final Log	logger	= LogFactory
												.getLog(SelectLayerFieldPanel.class);

	private static final String SELECTEDTARGETLAYER = SelectLayerFieldPanel.class.getName()+"_targetLayer";
	private static final String EXPRESION_FORMULA = SelectLayerFieldPanel.class.getName()+"_expresionFormula";;
	private static final String ATTRIBUTE_ID_ON_TARGET = SelectLayerFieldPanel.class.getName()+"ATTRIBUTE_ID_ON_TARGET"; 
	 ...
	 * 
	 */
	public SelectLayerFieldPanel() {
		super();
		initialize();
	}
	public SelectLayerFieldPanel(PlugInContext context) {
		super();
		setContext(context);
		initialize();
	}
			...
			lstTargetField.addMouseListener(new java.awt.event.MouseAdapter() { 
				public void mouseClicked(java.awt.event.MouseEvent e) { 
					...
					if (e.getClickCount()==2)
						...
						fire(SelectLayerFieldPanel.this,SelectLayerFieldPanel.FIELD_ACTIONED,"FieldActioned");
						}
				}
			});
		...
		cbTargetLayer.addActionListener(new java.awt.event.ActionListener() 
			...
			public void actionPerformed(java.awt.event.ActionEvent e)
			{
				...
				updateFieldList(lstTargetField, targetLayer,
						getFromBlackboard(ATTRIBUTE_ID_ON_TARGET));
			}
