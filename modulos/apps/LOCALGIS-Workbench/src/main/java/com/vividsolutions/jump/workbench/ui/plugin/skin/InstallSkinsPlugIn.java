...
public class InstallSkinsPlugIn extends AbstractPlugIn {
    ...
    public void initialize(PlugInContext context) throws Exception {
        ...
        skins.add(createProxy(appContext.getI18nString("Default"),
        ...
        context.getWorkbenchContext().getIWorkbench().getBlackboard().put(SkinOptionsPanel.SKINS_KEY,
            skins);
        OptionsDialog.instance(context.getWorkbenchContext().getIWorkbench()).addTab(
            appContext.getI18nString("Skins"),
            new SkinOptionsPanel(context.getWorkbenchContext().getIWorkbench().getBlackboard(), GeopistaFunctionUtils.getFrame(context.getWorkbenchGuiComponent())));                                    
    }
}
