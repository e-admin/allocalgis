...
public class InfoModel implements IInfoModel {
    /* (non-Javadoc)
	 * @see com.vividsolutions.jump.workbench.ui.IInfoModel#dispose()
	 */
    @Override
	public void dispose() {
    ...
    /* (non-Javadoc)
	 * @see com.vividsolutions.jump.workbench.ui.IInfoModel#getLayerTableModels()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.vividsolutions.jump.workbench.ui.IInfoModel#add(com.vividsolutions.jump.workbench.model.Layer, java.util.Collection)
	 */
    @Override
	public void add(ILayer layer, Collection features) {
        boolean layerNew = !layerToTableModelMap.containsKey(layer);
        LayerTableModel layerTableModel = (LayerTableModel)getTableModel(layer);
        ...
        if (layerNew) {
            for (Iterator i = listeners.iterator(); i.hasNext();) {
                ...
                listener.layerAdded((ILayerTableModel)layerTableModel);
            }
        }
    }

    /* (non-Javadoc)
	 * @see com.vividsolutions.jump.workbench.ui.IInfoModel#remove(com.vividsolutions.jump.workbench.model.Layer)
	 */
    @Override
	public void remove(ILayer layer) {
        ...
        for (Iterator i = listeners.iterator(); i.hasNext();) {
            InfoModelListener listener = (InfoModelListener) i.next();
            listener.layerRemoved((ILayerTableModel)layerTableModel);
        }
    }

    /* (non-Javadoc)
	 * @see com.vividsolutions.jump.workbench.ui.IInfoModel#clear()
	 */
    @Override
	public void clear() {
    ...
    /* (non-Javadoc)
	 * @see com.vividsolutions.jump.workbench.ui.IInfoModel#getTableModel(com.vividsolutions.jump.workbench.model.Layer)
	 */
    @Override
	public ILayerTableModel getTableModel(ILayer layer) {
        if (!layerToTableModelMap.containsKey(layer)) {
            layerToTableModelMap.put(layer, new LayerTableModel((Layer)layer));
        }

        return (ILayerTableModel) layerToTableModelMap.get(layer);
    }

    /* (non-Javadoc)
	 * @see com.vividsolutions.jump.workbench.ui.IInfoModel#getLayers()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.vividsolutions.jump.workbench.ui.IInfoModel#addListener(com.vividsolutions.jump.workbench.ui.InfoModelListener)
	 */
    @Override
