...
public abstract class ImageCachingRenderer implements Renderer {
    ...
    protected ILayerViewPanel panel;
    protected volatile boolean rendering = false;

    public ImageCachingRenderer(Object contentID, ILayerViewPanel panel) {
    ...
    public Runnable createRunnable() {
        ...
        return new Runnable() {
                public void run() {
                    try {              
                        if (cancelled) { 
                            //This short-circuit exit made a big speed increase (21 March 2003). [Jon Aquino]
                            return; 
                        }
                        ...
                        //Don't wait for the RenderingManager's 1-second repaint-timer. [Jon Aquino]
