...
public class WorkbenchToolBar extends EnableableToolBar {
    ...
    public ToolConfig addCursorTool(final CursorTool cursorTool) {
        return addCursorTool(cursorTool.getName(), cursorTool,
                new JToggleButton() {
                    ...
                    return aplicacion.getI18nString(cursorTool.getName());
                }
                });
    }
    ...
    public static class ToolConfig {
        ...
        public void remove(){
        	if (this.quasimodeTool!=null){
	        	this.quasimodeTool.clean();
	        	this.quasimodeTool=null;
        	}
        }
    ...
    public JButton addPlugIn(Icon icon, final PlugIn plugIn,
        ...
        //System.out.println(plugIn.getName()+" TaskMonitor:"+taskMonitorManager);
    ...
    //result that when the latter was updated (to handle ThreadedPlugIns), the
    //changes were left out from the former. [Jon Aquino]
    public JComponent addPlugIn(Icon icon, final PlugIn plugIn,
        EnableCheck enableCheck, WorkbenchContext workbenchContext, JComponent jcomponent) {
    	JButton button = new JButton();
    	button.add(jcomponent);
        add(button, plugIn.getName(), icon,
            AbstractPlugIn.toActionListener(plugIn, workbenchContext,
                taskMonitorManager), enableCheck);
    ...
    public void removeCursorTools(){    	
        cursorToolClassToButtonMap.clear();
        
        cursorToolClassToButtonMap=null;
    }
