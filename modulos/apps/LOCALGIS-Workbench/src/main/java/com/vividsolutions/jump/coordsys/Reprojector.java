...
import com.geopista.coordsys.ed50toetrs89.main.Ed50ToETRS89;
...
public class Reprojector {
	...
	public boolean wouldChangeValues(CoordinateSystem source,
		...
		if (source!=null && source.getDatum().equals("ETRS89") && destination.getDatum().equals("ED50")){
	...
	public void reproject(Geometry geom, final CoordinateSystem source,
		...
		try{
			...
			//!source.getDatum().equals("ED50") || !destination.getDatum().equals("ETRS89"))
			if (!(source!=null && source.getDatum().equals("ED50") && destination.getDatum().equals("ETRS89"))){
					...
					geom.apply(new CoordinateFilter() {
						public void filter(Coordinate coord) {
							try{
								...
								CoordinateSystem auxDestination1 = PredefinedCoordinateSystems.GEOGRAPHICS_ED50;
								...
								// convertED50_ETRS89();
								CoordinateSystem auxDestination2 = PredefinedCoordinateSystems.GEOGRAPHICS_ETRS89;
