...
public class SnapOptionsPanel extends JPanel implements OptionsPanel {
    ...
    public String validateInput() {
        String errorMessage = "\"" + gridSizeTextField.getText() +
            "\" " + appContext.getI18nString("errorMessage01");
    ...
    private void jbInit() throws Exception {
        titledBorder1 = new TitledBorder(BorderFactory.createEtchedBorder(Color.white,new Color(148, 145, 140)),appContext.getI18nString("snappingSnapOptions"));
