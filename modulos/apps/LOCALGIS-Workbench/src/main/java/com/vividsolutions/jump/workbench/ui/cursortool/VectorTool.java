...
public abstract class VectorTool extends NClickTool {
    ...
    protected Feature feature(LineString lineString, ILayer iLayer, UndoableCommand command) {
        Feature feature = new BasicFeature(iLayer.getFeatureCollectionWrapper().getFeatureSchema());
        ...
        return new UndoableCommand(getName()) {
            ...
            public void execute() {
                ...
                if (vector == null) {
                    ...
                    vector = feature(lineString, (Layer)vectorLayerFinder.getLayer(), this);
                }
