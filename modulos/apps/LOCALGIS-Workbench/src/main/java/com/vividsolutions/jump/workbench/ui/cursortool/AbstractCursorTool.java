...
public abstract class AbstractCursorTool implements CursorTool {
    ...
    public void activate(ILayerViewPanel layerViewPanel) {
        if (workbenchFrame((LayerViewPanel)layerViewPanel) != null) {
            workbenchFrame((LayerViewPanel)layerViewPanel).log("Activating " + getName());
        }
        ...
        getPanel().firePropertyChange("SelectedTool", null, true);
    }
    ...
    protected void drawShapeXOR(Shape shape, Graphics2D graphics) {
        ...
        try {
        	...
        	System.out.println("Warning. drawShapeXOR");
