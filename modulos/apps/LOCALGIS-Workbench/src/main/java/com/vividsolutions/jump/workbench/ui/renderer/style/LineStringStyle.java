...
public abstract class LineStringStyle implements Style {
    ...
    protected void paintGeometry(Geometry geometry, Graphics2D graphics,
        IViewport viewport) throws Exception {
    ...
    protected abstract void paintLineString(LineString lineString,
        IViewport viewport, Graphics2D graphics) throws Exception;

    private void paintGeometryCollection(GeometryCollection gc,
        Graphics2D graphics, IViewport viewport) throws Exception {
    ...
    public void initialize(ILayer ilayer) {
    ...
    public void paint(Feature f, Graphics2D g, IViewport viewport) throws Exception {
        paintGeometry(f.getGeometry(), g, (IViewport)viewport);
    }
}
