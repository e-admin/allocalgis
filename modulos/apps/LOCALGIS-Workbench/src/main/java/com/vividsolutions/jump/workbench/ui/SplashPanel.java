...
public class SplashPanel extends JPanel {
    ...
    public SplashPanel(Icon image, String caption) {
        try {
            ...
            /*try{
            	com.geopista.app.version.Release release=new com.geopista.app.version.Release();            	
            	String releaseText=release.getRelease();
            	releaseLabel.setText(releaseText);
            }
            catch(Throwable e){            	
            }*/
        } catch (Exception e) {
    ...
    private void jbInit() throws Exception {
        ...
        captionLabel.setText("Version 3.0");

        releaseLabel.setFont(new java.awt.Font("Dialog", 1, 10));
        releaseLabel.setForeground(Color.white);
        releaseLabel.setBorder(border1);
        
        this.setBackground(Color.decode("#3F3E8C"));
