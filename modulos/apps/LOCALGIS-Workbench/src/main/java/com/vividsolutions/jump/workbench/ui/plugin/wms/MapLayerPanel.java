...
public class MapLayerPanel extends JPanel {
    ...
    public List getRemovedElements(){
    	return addRemovePanel.getRemovedElements();
    }
    ...
    void jbInit() throws Exception {
        addRemovePanel.setRightText(AppContext.getApplicationContext().getI18nString("ChosenLayers"));
    ...
    private void initAddRemovePanel() {
        ...
        leftLabelPanel.add(new JLabel(AppContext.getApplicationContext().getI18nString("AvailableLayers")),
        ...
        final JCheckBox checkBox = new JCheckBox(AppContext.getApplicationContext().getI18nString("SortLayersAvailables"));
    ...
    public List getSelectedItemsFromRigthList(){
    	return this.addRemovePanel.getRightList().getSelectedItems();
    }
