...
public class WarpingPanel extends JPanel {
    ...
    private void hideTriangulation() {
        if (!(toolbox.getContext().getIWorkbench().getGuiComponent().getActiveInternalFrame()
    ...
    private boolean layerViewPanelProxyActive() {
        return toolbox.getContext().getIWorkbench().getGuiComponent().getActiveInternalFrame()
            instanceof LayerViewPanelProxy;
    }
    ...
    private String outputLayerName(String sourceLayerName) {
        return aplicacion.getI18nString("Warped") + " " + sourceLayerName;
    }
        ...
        Collection vectorLineStrings =
            FeatureUtil.toGeometries(
                CopySelectedLayersToWarpingVectorsPlugIn.removeNonVectorFeaturesAndWarn(
                    vectorFeatures,
                    toolbox.getContext().getIWorkbench().getGuiComponent()));
        Map triangleMap =
    ...
    public WarpingPanel(ToolboxDialog toolbox) {
        ...
        layerLabel.setText(aplicacion.getI18nString("SourceLayer"));
        this.setLayout(gridBagLayout1);
        warpIncrementallyCheckBox.setToolTipText(aplicacion.getI18nString(
            "WarpsRelativeToTheOutputLayerAsSoonAsAVectorIsDrawn"));
        warpIncrementallyCheckBox.setSelected(false);
        warpIncrementallyCheckBox.setText(aplicacion.getI18nString("WarpIncrementally"));
        ...
        warpButton.setText(aplicacion.getI18nString("Warp"));
        warpButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(ActionEvent e) {
                warpButton_actionPerformed(e);
            }
        });
        clearOutputButton.setText(aplicacion.getI18nString("ClearAllVectors"));
        clearOutputButton.setToolTipText(aplicacion.getI18nString("DeletesTheWarpOutputLayerAndTheVectors"));
        clearOutputButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(ActionEvent e) {
                clearOutputButton_actionPerformed(e);
            }
        });
        autoHideCheckBox.setToolTipText(aplicacion.getI18nString(
            "AutoHidesTheSourceLayerAndTheWarpingVectors"));
        autoHideCheckBox.setSelected(true);
        autoHideCheckBox.setText(aplicacion.getI18nString
                ("Autohidelayers"));
        triangulationCheckBox.setToolTipText(aplicacion.getI18nString(
            "ShowsTheInitialAndFinalTriangulationLayers"));
        triangulationCheckBox.setText(aplicacion.getI18nString("DisplayTriangulation"));
        triangulationCheckBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(ActionEvent e) {
                triangulationCheckBox_actionPerformed(e);
            }
        });
        copyLayerButton.setToolTipText(aplicacion.getI18nString(
            "CopiesTheFeaturesInTheSelectedLayer"));
        copyLayerButton.setText(aplicacion.getI18nString("CopyLayerToVectors"));
    ...
    public void updateComponents() {
        ...
        clearOutputButton.setEnabled(
            toolbox.getContext().getIWorkbench().getGuiComponent().getActiveInternalFrame()
