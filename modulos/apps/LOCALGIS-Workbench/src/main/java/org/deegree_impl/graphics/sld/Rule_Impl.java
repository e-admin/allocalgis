...
public class Rule_Impl implements Rule, Marshallable {
	...
	*/
	Rule_Impl( Symbolizer[] symbolizers, String name, String title, String abstract_, 
	...
	*/
	...
	/**
	 * The MinScaleDenominator and MaxScaleDenominator elements of a Rule define
	 * the range of map-rendering scales for which the rule should be applied. * The MinScaleDenominator and MaxScaleDenominator elements, as their names
	 * suggest, are simply the minimum and maximum ranges of scale (denominators)
	 * of maps for which a rule should apply.
	...
	*/
	public void removeSymbolizer(Symbolizer symbolizer) {
	   if(symbolizers.indexOf( (Object)symbolizer ) != -1) {
			symbolizers.remove( symbolizers.indexOf( (Object)symbolizer) );
	   }
	}
