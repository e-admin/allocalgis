 ...
 * Time: 16:16:52
 */
public class GetInspectores  extends LoggerHttpServlet {
       private org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(GetInspectores.class);
               ...
               try
               {
            	   JAASUserPrincipal userPrincipal = (JAASUserPrincipal)request.getUserPrincipal();
                    ...
                    else
                    {
                        ...
                        resultado=COperacionesContaminantes.getListaInspectores(sMunicipio);
                    }
               }catch(Exception e)
               {
