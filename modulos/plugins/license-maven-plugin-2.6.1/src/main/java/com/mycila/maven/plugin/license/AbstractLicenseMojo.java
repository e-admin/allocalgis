...
public abstract class AbstractLicenseMojo extends AbstractMojo {
	...
	protected static ArrayList listaProyectosExcluidos=new ArrayList();

	protected static ArrayList listaProyectosExcluidosGPL=new ArrayList();
	protected static ArrayList listaProyectosIncluidosEUPL=new ArrayList();
    ...
    static{
    	//Proyectos que no vamos a tratar de ninguna forma
    	listaProyectosExcluidos.add("LouRED\\localgis-gestorfip-client");    	
    	listaProyectosExcluidos.add("LouRED\\localgis-gestorfip-ws");
    	listaProyectosExcluidos.add("AgendaLocal21\\AgendaLocal21-AppWeb");
    	listaProyectosExcluidos.add("AgendaLocal21\\AgendaLocal21-DataModel");
    	listaProyectosExcluidos.add("Firma\\CryptoApplet");
    	
    	//Proyectos que no vamos a tratar como GPL sino como EUPL
    	listaProyectosExcluidosGPL.add("localgis-apps-movilidad");    	
    	listaProyectosExcluidosGPL.add("LOCALGIS-SVGViewer");
    ...
    private String[] listSelectedFiles() {
        ...
        //System.out.println("From: "+ basedir);
        //System.out.println("Including: "+ deepToString(selection.getIncluded()));
        //System.out.println("Excluding:"+ deepToString(selection.getExcluded()));
        
        /*for (int i=0;i<selection.getSelectedFiles().length;i++){
        	System.out.println("Fichero:"+selection.getSelectedFiles()[i]);
        }*/
