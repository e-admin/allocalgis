/**
 * RouteEngineTSPDrawPointTool.java
 ...
 */
package com.geopista.ui.plugin.routeenginetools.tsp.utils;
...
import com.geopista.ui.plugin.routeenginetools.tsp.TSPClickPlugIn;
...
public class RouteEngineTSPDrawPointTool extends NClickTool{
	
	public static Point pointDrawed = null; 

	private RouteEngineTSPDrawPointTool() {
		super(1);
	}
	...
	public static CursorTool create(LayerNamePanelProxy layerNamePanelProxy) {
		...
		return featureDrawingUtil.prepare(
			new RouteEngineTSPDrawPointTool(), false);
	}
	...
	protected void gestureFinished() throws Exception {
		...
		execute(
		TSPClickPlugIn.createAddCommand(
				getPoint(), this
		));
