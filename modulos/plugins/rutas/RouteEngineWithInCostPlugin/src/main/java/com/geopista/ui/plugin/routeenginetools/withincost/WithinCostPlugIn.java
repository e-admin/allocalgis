...
//						}
						...
						WithinCostAlgorithm wca=((BasicNetworkManager)NetworkModuleUtilWorkbench.getNetworkManager(context)).computeExactWithinCostRoutes(source, coste, weighter, prohibidos, permitidos);
