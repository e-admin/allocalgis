...
/**
 * Utiliza un buffer de queries en los {@link PreparedStatement} que se ejecutan por lotes o AL CERRAR la conexión
 * 
 * @param connection
 * @param size tamaÃ±o del buffer de consultas enviadas a GeopistaConnection
 */
 ...
 */
    ...
    /**
     * devuelve un statement con agrupación de queries
     */
