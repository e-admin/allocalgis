/**
 * LocalgisStreetGraphGeneratorFactory.java
...
public class LocalgisStreetGraphGeneratorFactory implements GraphGeneratorFactory{

	@Override
	public GraphGenerator createGraphGenerator() {
		
	return NetworkModuleUtilWorkbench.getLocalGISStreetGraphGenerator();
	}
