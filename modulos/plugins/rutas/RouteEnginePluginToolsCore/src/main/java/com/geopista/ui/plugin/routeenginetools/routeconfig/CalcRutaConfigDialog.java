...
public class CalcRutaConfigDialog extends JDialog{
	...
	private boolean onAcceptButtonDo() {
		...
		if (this.listaVehiculosComboBox.getSelectedItem().toString().equals("Caminando")){
			...
			parametersList.add("anchuraAcera" + "=" + prmParametersJPanel.getjTextAnchuraMinAcera().getText() );
			parametersList.add("pendienteTransversal" + "=" + prmParametersJPanel.getjTextMaxPendTransAcera().getText() );
			parametersList.add("pendienteLongitudinal" + "=" + prmParametersJPanel.getjTextMaxPendLongAcera().getText() );
