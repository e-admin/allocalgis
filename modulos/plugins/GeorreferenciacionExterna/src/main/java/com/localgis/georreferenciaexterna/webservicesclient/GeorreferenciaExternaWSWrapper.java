/**
 * GeorreferenciaExternaWSWrapper.java
 ...
 */
package com.localgis.georreferenciaexterna.webservicesclient;
...
import com.localgis.ws.georreferenciaexterna.client.GeoreferenciaExternaClientWS;
import com.localgis.ws.georreferenciaexterna.client.protocol.SQLExceptionException0;
import com.localgis.ws.georreferenciaexterna.client.protocol.ServicesStub;
import com.localgis.ws.georreferenciaexterna.client.protocol.ServicesStub.ConsultaDatosBean;
import com.localgis.ws.georreferenciaexterna.client.protocol.ServicesStub.RowBean;


public class GeorreferenciaExternaWSWrapper extends javax.swing.JPanel{  
	...
	public static boolean eliminarConsulta(int idConsulta) throws SQLExceptionException0{
		...
		try {
			// creamos el soporte
			customer = GeoreferenciaExternaClientWS.getGeoreferenciaExternaStub();	
	...
	public static RowBean[] obtenerDatosBbdd(String tipoBbdd, String nombreTabla, Hashtable campos, String camposRef, 
		...
		com.localgis.ws.georreferenciaexterna.client.protocol.ServicesStub.FiltroData[] filtros = new com.localgis.ws.georreferenciaexterna.client.protocol.ServicesStub.FiltroData[lstFiltros.size()];
		RowBean[] strh=null;
		...
		if(!lstFiltros.isEmpty()){
			for(int j=0; j<lstFiltros.size();j++){
				...
				com.localgis.ws.georreferenciaexterna.client.protocol.ServicesStub.FiltroData filtroData = new com.localgis.ws.georreferenciaexterna.client.protocol.ServicesStub.FiltroData();
