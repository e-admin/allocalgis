...
public class Reprojector {
	...
	public void  transformED50ToEtrs89(final CoordinateSystem source,
		...
		if(source.getEPSGCode()==PredefinedCoordinateSystems.getCoordinateSystem(4230).getEPSGCode())
		{
		...
		{
			LonLat lonlat = ed2etConv.ed50toEtrs89(coord.y,
					coord.x);
			coord.y = -lonlat.getLongitude();
			coord.x = lonlat.getLatitude();
		}
