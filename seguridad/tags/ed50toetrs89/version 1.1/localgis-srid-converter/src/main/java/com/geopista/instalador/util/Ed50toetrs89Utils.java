...
public class Ed50toetrs89Utils {
	...
	public static void addConstraint(Connection con, String table) throws SQLException
	{
		...
		try {
			// Se crea la nueva columna, que será la que
			// contenga los datos en geográficas ETRS89
			String sSQL = "ALTER TABLE "+table +" ADD CONSTRAINT \"enforce_srid_Geometry\" CHECK (st_srid(the_geom) = 25830)";
			ps2 = con.prepareStatement(sSQL);
			ps2.execute();
