...
<form id="formularioCamposEvolucion" action="indicadores.htm" method="post">
	<input type="hidden" name="accion" value="visualizarEvolucion"/>
	<input type="hidden" name="id" value="${indicadorDto.id}"/>
	
	<c:set var="num" value="0"></c:set>
	<c:forEach var="contador" varStatus="status" begin="0" end="${numFilas-1}" step="1">
	...
	<div class="areacentral">
		...
		<div class="fder ancho17">
			<ul class="operaciones">
				...
				<li><a href="indicadores.htm?accion=exportarPDF&id=${indicadorDto.id}&idHistorico=0&tipo=tabla&desde=0"><spring:message code="jsp.indicador.informe.pdf"/></a></li>
			</ul>
		</div>
		<div class="clear"></div>
		<br>
...
$(document).ready(function() {
 ...
 var plot1 = $.jqplot('evolucion', [
  ...
  var legendTable = $($('.jqplot-table-legend')[0]);    
	...
	legendTable.css('height','72%');
	legendTable.css('width','145px');
