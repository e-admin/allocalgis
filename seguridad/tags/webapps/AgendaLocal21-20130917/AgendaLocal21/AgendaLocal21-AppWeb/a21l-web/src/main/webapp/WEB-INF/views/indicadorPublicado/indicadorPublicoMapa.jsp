...
<div class="cuerpoprincipal">
	<div class="areamenu">
		<ul class="menusecundario">
			...
			<li>
				<a href="indicadorPublico.htm?accion=mostrarOpcionesDiagramasPublicos&id=${idIndicador}&tipo=barras">
				<spring:message code="jsp.indicador.diagrama.barras"/>
				</a>
			</li>
			<li>
				<a href="indicadorPublico.htm?accion=mostrarOpcionesDiagramasPublicos&id=${idIndicador}&tipo=sectores">
