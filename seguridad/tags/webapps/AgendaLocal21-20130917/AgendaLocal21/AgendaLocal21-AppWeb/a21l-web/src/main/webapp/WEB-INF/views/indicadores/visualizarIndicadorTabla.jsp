	...
	<div class="areacentral">
		...
		<div class="fder ancho17">
			<ul class="operaciones">
				...
				<li><a href="indicadores.htm?accion=exportarPDF&id=${indicadorDto.id}&idHistorico=${historico.id}&tipo=tabla&desde=0"><spring:message code="jsp.indicador.informe.pdf"/></a></li>
