	...
	<div class="areacentral">
		...
		<div class="fder ancho17">
			<ul class="operaciones">
				...
				<li><a href="indicadorPublico.htm?accion=exportarPDF&id=${indicadorDto.id}&idHistorico=0&tipo=tabla&desde=0"><spring:message code="jsp.indicador.informe.pdf"/></a></li>
			</ul>
		</div>
		<div class="clear"></div>
		<br>
