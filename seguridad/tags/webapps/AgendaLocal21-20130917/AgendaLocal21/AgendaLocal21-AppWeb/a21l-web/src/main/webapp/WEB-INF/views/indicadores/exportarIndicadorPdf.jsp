...
<div class="cuerpoprincipal">
	...
	<div class="clear"></div>
		<div class="botones_accion">
			<a href="indicadores.htm?accion=visualizarIndicadorTabla&id=${indicadorDto.id}" class="boton izq10 sup10 fondo_blanco fder"><spring:message code="elementos.jsp.boton.cancelar"/></a>
...
$(document).ready(function() {
	...
	$("#generar").click(function() {
		...
		if (n==0){
			alert("<spring:message code="jsp.exportar.pdf.seleccionarElementos"/>");
			return false;
		}
		$('#formulario').submit();
	});
