...
//	}
	...
	@ExceptionHandler
	public String irSinPermisos(HttpServletRequest request,HttpServletResponse response) throws IOException {
    ...
    public static byte[] decompress(byte[] contentBytes){
	  ...
	  protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		protected UsuarioDto cargaUsuarioPorIdSW(Long id) {
		...
		protected void ordenarElementosJerarquiaCategorias(Map<Long, List<CategoriaDto>> mapa){
			Collection<List<CategoriaDto>> valores=mapa.values();
			for(List<CategoriaDto> lista:valores){
				Collections.sort(lista);
			}
		}
		protected void ordenarElementosJerarquiaIndicadores(Map<Long, List<IndicadorDto>> mapa){
			Collection<List<IndicadorDto>> valores=mapa.values();
			for(List<IndicadorDto> lista:valores){
				Collections.sort(lista);
			}
		}
