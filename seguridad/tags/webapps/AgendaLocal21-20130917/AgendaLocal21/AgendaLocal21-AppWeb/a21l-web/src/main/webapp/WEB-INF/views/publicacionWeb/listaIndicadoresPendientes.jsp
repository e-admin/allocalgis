...
<script type="text/javascript">
	...
	$("#autorizarIndicador").click(function(){
		...
		document.location.href="publicacionWeb.htm?accion=autorizarIndicadorPublicacionWeb&id="+idIndicador;
		return false;
	});
	...
	$("#descartarIndicador").click(function(){ 
		...
		document.location.href="publicacionWeb.htm?accion=descartarIndicadorPublicacionWeb&id="+idIndicador;
		return false;
	});
