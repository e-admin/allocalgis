...
public class GestorCUFuenteImpl implements GestorCUFuente{
    ...
    private TipoCodificacionRepositorio tipoCodificacionRepositorio;
    private CaracterSeparadorRepositorio caracterSeparadorRepositorio;
    ...
    public FuenteDto garda(FuenteDto fuenteDto, Long idUsuarioCreador, EncapsuladorErroresSW erros,String sistemaCoordenadas) {
        ...
        Fuente fuente = new FuenteDto2FuenteTransformer(mapper, fuenteRepositorio,caracterSeparadorRepositorio,tipoCodificacionRepositorio).transform(fuenteDto);
    ...
    public EncapsuladorListSW<TablaFuenteDatosDto> listarTablasFuenteExterna(long id, String path) {
    	...
    	FuenteDto2FuenteTransformer transformer = new FuenteDto2FuenteTransformer(mapper, fuenteRepositorio,caracterSeparadorRepositorio,tipoCodificacionRepositorio);
