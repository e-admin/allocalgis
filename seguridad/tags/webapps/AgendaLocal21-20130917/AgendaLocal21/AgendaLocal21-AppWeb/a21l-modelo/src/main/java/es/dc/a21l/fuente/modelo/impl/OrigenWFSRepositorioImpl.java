...
public class OrigenWFSRepositorioImpl extends RepositorioBaseImpl<Fuente> implements OrigenWFSRepositorio {
	private static final Logger log = LoggerFactory.getLogger(OrigenWFSRepositorioImpl.class);
    ...
    public EncapsuladorListSW<AtributoFuenteDatosDto> listarColumnasTablaFuenteExterna(Fuente fuente, String tabla, String path) {
    	...
    	try  {
            ...
            //URL servicioWFS = new URL(cadenaConexion);
            //InputStreamReader is = new InputStreamReader(servicioWFS.openStream());
    		is = new URL(cadenaConexion).openStream();
    ...
    public AtributosMapDto obtenerMapaTablaFuenteExterna(Fuente fuente, String tabla, String path) {
    	...
    	try  {
    		//this.setFichero(new File(cadenaConexion));
    		//InputStream is = new FileInputStream (this.getFichero());
    		InputStream is = new URL(cadenaConexion).openStream();
    		InputSource input = new InputSource(is);
