...
public class Relacion2RelacionDtoTransformer extends TransformadorEntidadBase2DtoBase<Relacion, RelacionDto>{
	public Relacion2RelacionDtoTransformer(Mapper mapper) {
		super(mapper);
	}
}
