...
public class FuenteControladorSW extends GenericAbstractController {
	...
	private GestorCUCaracterSeparador gestorCUCaracterSeparador;
	private GestorCUTipoCodificacion gestorCUTipoCodificacion;
	...
	@Autowired	
	public void setGestorCUCaracterSeparador(
			GestorCUCaracterSeparador gestorCUCaracterSeparador) {
		this.gestorCUCaracterSeparador = gestorCUCaracterSeparador;
	}

	@Autowired
	public void setGestorCUTipoCodificacion(
			GestorCUTipoCodificacion gestorCUTipoCodificacion) {
		this.gestorCUTipoCodificacion = gestorCUTipoCodificacion;
	}
	...
	public ResponseEntity<EncapsuladorListSW<FuenteDto>> cargaTodos() {
		EncapsuladorListSW<FuenteDto>listaOrdenada=gestorCUFuente.cargaTodos();
		Collections.sort(listaOrdenada.getLista());
		return new ResponseEntity<EncapsuladorListSW<FuenteDto>>(listaOrdenada, responseHeaders, HttpStatus.OK);
	}	
	...
	public ResponseEntity<EncapsuladorListSW<TablaFuenteDatosDto>> listaTablas(@PathVariable("id") Long id,@PathVariable("tipo") String tipo, HttpServletRequest request) {
		...
		EncapsuladorListSW<TablaFuenteDatosDto>listaFuentes=gestorCUFuente.listarTablasFuenteExterna(id,realPath);
		Collections.sort(listaFuentes.getLista());
		return new ResponseEntity<EncapsuladorListSW<TablaFuenteDatosDto>>(listaFuentes, responseHeaders, HttpStatus.OK);
	}
	...
	@RequestMapping(method = RequestMethod.GET, value = { "/cargaTiposCodificacion" })
	public ResponseEntity<EncapsuladorListSW<TipoCodificacionDto>> cargarTiposCodificacion() {
		EncapsuladorListSW<TipoCodificacionDto> lista= gestorCUTipoCodificacion.cargaTiposCodificacion();
		return new ResponseEntity<EncapsuladorListSW<TipoCodificacionDto>>(lista,responseHeaders, HttpStatus.OK);
	}
	
	@RequestMapping(method = RequestMethod.GET, value = { "/cargaCaracterSeparador" })
	public ResponseEntity<EncapsuladorListSW<CaracterSeparadorDto>> cargarCaracterSeparador() {
		EncapsuladorListSW<CaracterSeparadorDto> lista= gestorCUCaracterSeparador.cargaCaracteresSeparadores();
		return new ResponseEntity<EncapsuladorListSW<CaracterSeparadorDto>>(lista,responseHeaders, HttpStatus.OK);
	}
}