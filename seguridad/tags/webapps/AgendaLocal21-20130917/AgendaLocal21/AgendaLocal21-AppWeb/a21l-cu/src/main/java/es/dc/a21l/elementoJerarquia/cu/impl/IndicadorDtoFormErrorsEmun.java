...
public enum IndicadorDtoFormErrorsEmun implements FormErrorEmun{
	...
	ERROR_VALOR_NUMERICO_MINX("minX","validacion.indicador.error.coordenadas.minx"),
	ERROR_VALOR_NUMERICO_MINY("minY","validacion.indicador.error.coordenadas.miny"),
	ERROR_VALOR_NUMERICO_MAXX("maxX","validacion.indicador.error.coordenadas.maxx"),
	ERROR_VALOR_NUMERICO_MAXY("maxY","validacion.indicador.error.coordenadas.maxY");
