...
public class AtributoDto extends DtoBase {
	...
	private boolean sridColumnaGeometricaErroneo;
	...
	public boolean isSridColumnaGeometricaErroneo() {
		return sridColumnaGeometricaErroneo;
	}
	public void setSridColumnaGeometricaErroneo(boolean sridColumnaGeometricaErroneo) {
		this.sridColumnaGeometricaErroneo = sridColumnaGeometricaErroneo;
	}
