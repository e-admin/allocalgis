...
<script src="js/util/comun/cambioMenu.js"></script>
	<div class="cuerpoprincipal">
		...
		<div class="areacentral">
			<h2><spring:message code="jsp.roles.rol.crearRol" /></h2>
			<br/>
			<!--  mensajes de error -->
			...
			<form:form id="formularioAltaRol" modelAttribute="rolDto" action="?">
				<input type="hidden" id="accion" name="accion" value="guardarRol" />
		...
		<div class="botones_accion">
			...
			<a href="#" onclick="$('#formularioAltaRol').submit();return false;" class="boton izq10 sup10 fondo_blanco fder"><spring:message code="elementos.jsp.boton.aceptar"/></a>
		</div>
	</div>
