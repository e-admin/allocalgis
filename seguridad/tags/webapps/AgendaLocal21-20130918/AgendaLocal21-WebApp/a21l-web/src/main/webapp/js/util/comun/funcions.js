 ...
 */
function mostrarOcultarArbore(trClassName, imgId, esPrimero, accionAbrir, accionCerrar){
	...
	if (elementos != null && elementos.length > 0) {
		...
		for (var i = 0; i < elementos.length; i++) {
			...
			if (vectorIdCategoria.length == 2) {
				mostrarOcultarArbore("idcategoriapadre-" + vectorIdCategoria[vectorIdCategoria.length -1] + "_tr", "idcategoria" + vectorIdCategoria[vectorIdCategoria.length -1] + "_img", false, accionAbrir, accionCerrar);
			}
		}
	}
}