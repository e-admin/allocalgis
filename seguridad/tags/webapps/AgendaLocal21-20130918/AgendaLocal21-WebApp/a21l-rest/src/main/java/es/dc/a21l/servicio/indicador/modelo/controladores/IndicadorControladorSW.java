...
public class IndicadorControladorSW extends GenericAbstractController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/borraIndicador/{id}")
	public ResponseEntity<EncapsuladorBooleanSW> borrarIndicador(@PathVariable("id") Long id, HttpServletRequest request) {
		...
		try {
			...
			gestorCUIndicadorUsuarioModificacion.borraPorIdIndicador(id);
