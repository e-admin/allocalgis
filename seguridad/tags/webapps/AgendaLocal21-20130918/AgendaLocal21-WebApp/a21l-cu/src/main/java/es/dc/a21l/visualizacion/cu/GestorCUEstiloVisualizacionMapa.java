...
public interface GestorCUEstiloVisualizacionMapa {	
	public EstiloVisualizacionMapaDto cargaPorIdUsuarioEIdIndicador(Long idUsuario, Long idIndicador );
	public EstiloVisualizacionMapaDto guarda(EstiloVisualizacionMapaDto estiloVisualizacionMapaDto,EncapsuladorErroresSW errores);
