...
public class DatosEconomicosConstruccion implements Serializable {
     ...
     */
    private Float correctorApreciación;
    /**
     ...
     */
    public Float getCorrectorApreciación()
    {
        return correctorApreciación;
    }
    
    /**
     * @param correctorApreciación The correctorApreciación to set.
     */
    public void setCorrectorApreciación(Float correctorApreciación)
    {
        this.correctorApreciación = correctorApreciación;
    }
