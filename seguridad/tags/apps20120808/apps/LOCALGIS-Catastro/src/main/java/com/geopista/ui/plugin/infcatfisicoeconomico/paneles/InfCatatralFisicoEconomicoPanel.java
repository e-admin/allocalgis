...
import com.geopista.ui.plugin.infcatfisicoeconomico.dialogs.ASCPanel;
import com.geopista.ui.plugin.infcatfisicoeconomico.dialogs.FincaPanel;
import com.geopista.ui.plugin.infcatfisicoeconomico.dialogs.FxccPanel;
import com.geopista.ui.plugin.infcatfisicoeconomico.dialogs.ImagenCatastroPanel;
import com.geopista.ui.plugin.infcatfisicoeconomico.dialogs.SueloPanel;
import com.geopista.ui.plugin.infcatfisicoeconomico.dialogs.UnidadConstructivaPanel;
...
public class InfCatatralFisicoEconomicoPanel extends JPanel implements
	...
	public InfCatatralFisicoEconomicoPanel( boolean isEditable, Collection coll,String convenio) {
		super();
	...
	public InfCatatralFisicoEconomicoPanel() {
	...
	private void initialize() {
		...
		ResourceBundle bundle = ResourceBundle.getBundle("com.geopista.ui.plugin.infcatfisicoeconomico.languages.InfCatastralFisicoEconomicoPlugIni18n",
						loc, this.getClass().getClassLoader());
		I18N.plugInsResourceBundle.put("InfCatastralFisicoEconomicoPlugIn", bundle);
		...
		for (Iterator iterator = collParcelas.iterator(); iterator.hasNext();) {
			...
			try{
				FincaCatastro finca = ConstantesRegistroExp.clienteCatastro.obtenerInfCastatralFinca(idParcela, convenio);
...
//				loadBienesAscPanel(lstReferencias);
	...
	private JPanel getJPanelVisualizar() {
		if (jPanelVisualizar == null) {
			...
			jPanelVisualizar.setBorder(BorderFactory.createTitledBorder(null,
					I18N.get("InfCatastralFisicoEconomicoPlugIn",
							"infCatastralFisicoEconomico.panel.visualizar.titulo"),
	...
	private JCheckBox getJCheckBoxUC() {
		if (jCheckBoxUC == null) {
			...
			jCheckBoxUC.setText(I18N.get("InfCatastralFisicoEconomicoPlugIn",
					"infCatastralFisicoEconomico.panel.visualizar.unidadesconstructivas"));
	...
	private JCheckBox getJCheckBoxSuelos() {
		if (jCheckBoxSuelos == null) {
			...
			jCheckBoxSuelos.setText(I18N.get("InfCatastralFisicoEconomicoPlugIn",
					"infCatastralFisicoEconomico.panel.visualizar.suelos"));
		}
	...
	private JCheckBox getJCheckBoxLcomunes() {
		if (jCheckBoxLcomunes == null) {
			...
			jCheckBoxLcomunes.setText(I18N.get("InfCatastralFisicoEconomicoPlugIn",
					"infCatastralFisicoEconomico.panel.visualizar.lcomunes"));
		}
	...
	private JTabbedPane getJTabbedPaneExpediente() {
		if (jTabbedPane == null) {
			...
			jTabbedPane.addTab(I18N.get("InfCatastralFisicoEconomicoPlugIn",
					"infCatastralFisicoEconomico.pestania.finca.titulo"), IconLoader
					.icon(ICONO_FINCA), parcelaPanel, null);
			jTabbedPane.addTab(I18N.get("InfCatastralFisicoEconomicoPlugIn",
					"infCatastralFisicoEconomico.pestania.suelo.titulo"), IconLoader
					.icon(ICONO_SUELO), sueloPanel, null);
			jTabbedPane.addTab(I18N.get("InfCatastralFisicoEconomicoPlugIn",
					"infCatastralFisicoEconomico.pestania.uc.titulo"), IconLoader
			...
			EdicionUtils.enablePanel(jTabbedPane, isEditable);
...
*/
		...
		EdicionUtils.enabledButtons(parcelaPanel.getJPanelBotoneraLocal(), "_Cmasdatoslocales");
		...
		EdicionUtils.enablePanel(ucPanel.getJPanelDatosEconomicos(),false);
