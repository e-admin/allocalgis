...
public class ImportarFINRetornoMasivo extends JPanel implements WizardPanel
{
     ...
     */
    private static final String TIPO_FICHERO = "finretorno";
    
    public static final int DIM_X=700;
    public static final int DIM_Y=450;
    
    public ImportarFINRetornoMasivo()
    {   
        try
        {     
                ...
                new Thread(new Runnable()
                    ...
                    public void run()
                    {
                        try
                        {
                            ...
                            panel.getJComboBoxDatosImportar().addItem(I18N.get("Importacion","importar.asistente.finretornomasivo.tipo"));
    				...
    				new Thread(new Runnable()
    				{
    					...
    					{                            
    						try
    						{
    							...
    							//Comprobar que el XML se valida con el esquema dado y corresponde al tipo finretorno
