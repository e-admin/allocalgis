...
//    }
    ...
    public boolean execute(PlugInContext context) throws Exception
    {
        ...
        WizardDialog d = new WizardDialog(GeopistaUtil.getFrame(context
                .getWorkbenchGuiComponent()), Constants.APLICACION.getI18nString("ExtractDialog"),
    ...
    public void run(TaskMonitor monitor, PlugInContext context) throws Exception
    {
    	try {
	    	...
	    	GeopistaUtil.httpUploadFiles(Constants.URL_TOMCAT, listaRutasFicherosUpload, paramNames, paramValues);
