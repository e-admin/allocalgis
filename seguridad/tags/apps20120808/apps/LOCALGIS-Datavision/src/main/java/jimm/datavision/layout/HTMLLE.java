...
import jimm.datavision.Format;
import jimm.datavision.ImageField;
import jimm.datavision.Line;
import jimm.datavision.Rectangle;
import jimm.datavision.Section;
import jimm.datavision.SortedLayoutEngine;
...
public class HTMLLE extends SortedLayoutEngine {
	public static String PLANTILLAS_PATH="plantillas/licencias/";
	protected int rowX;
...
protected void doOutputImage(ImageField image) {
    ...
    /** satec */
    if (url.startsWith(PLANTILLAS_PATH.replace('\\', '/')))
    url= url.substring(PLANTILLAS_PATH.length());
    /** fin satec */
