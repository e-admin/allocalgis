...
public class Const {
    ...
    public static final String SRID_PROPERTIES="config"+File.separator+"srid.properties";
    public static final String SRID_PROP_PREFIX="geopista.srid.";
    
    public static final String SRID_DEFECTO = "config" + File.separator + "sridDefecto.properties";
    public static final String SRID_INICIAL = "config" + File.separator + "sridInicial.properties";
