...
public class XMLBinder {
    ...
    public XMLBinder() {
       ...
       classToCustomConverterMap.put(java.sql.Time.class,
            new CustomConverter() {
                public Object toJava(String value) {
        ...
        classToCustomConverterMap.put(java.util.Date.class,
            new CustomConverter() {
                public Object toJava(String value) {
        ...
        classToCustomConverterMap.put(float.class,
                new CustomConverter() {
                    public Object toJava(String value) {
    ...
    public void removeCustomConverter(Class c) {
        classToCustomConverterMap.remove(c);
    }
