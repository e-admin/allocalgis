   ...
   //     cPostalTitularTField.setSignAllowed(false);
                ...
                if ((objeto instanceof String) && objeto!=null)
                {
                    if (((String)objeto).length()>0)
                    {
                    	...
                    	if(Estructuras.getListaTiposViaINE().getDomainNode((String)objeto)==null){
                    		CConstantesLicencias.referencia.setTipoVia(CMainLicencias.literales.getString("CModificacionLicenciasForm.tipovianoespecificado.text"));
                    		patron="NE";
                    	}
	...
	private void buscarDNIPromotorJButtonActionPerformed() {//GEN-FIRST:event_buscarDNIPromotorJButtonActionPerformed
		...
		if ((CConstantesLicencias.persona != null) && (CConstantesLicencias.persona.getDniCif() != null)) {
            ...
            cPostalPromotorTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getCpostal());
	...
	private void buscarDNIRepresentaAJButtonActionPerformed() {//GEN-FIRST:event_buscarDNIRepresentaAJButtonActionPerformed
		...
		if ((CConstantesLicencias.persona != null) && (CConstantesLicencias.persona.getDniCif() != null)) {
            DNIRepresentaATField.setText(CConstantesLicencias.persona.getDniCif());
            ...
            faxRepresentaATField.setText(CConstantesLicencias.persona.getDatosNotificacion().getFax());
            telefonoRepresentaATField.setText(CConstantesLicencias.persona.getDatosNotificacion().getTelefono());
            movilRepresentaATField.setText(CConstantesLicencias.persona.getDatosNotificacion().getMovil());
            ...
            numeroViaRepresentaATField.setText(CConstantesLicencias.persona.getDatosNotificacion().getNumeroVia());
            ...
            cPostalRepresentaATField.setText(CConstantesLicencias.persona.getDatosNotificacion().getCpostal());
	...
	private void buscarDNITitularJButtonActionPerformed() {//GEN-FIRST:event_buscarDNITitularJButtonActionPerformed
		...
		if ((CConstantesLicencias.persona != null) && (CConstantesLicencias.persona.getDniCif() != null)) {
            ...
            DNITitularTField.setText(CConstantesLicencias.persona.getDniCif());
            ...
            faxTitularTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getFax());
            telefonoTitularTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getTelefono());
            movilTitularTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getMovil());
            ...
            numeroViaTitularTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getNumeroVia());
            ...
            cPostalTitularTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getCpostal());
                    ...
                    for (int i = 0; i < referenciasCatastralesJTable.getRowCount(); i++) {
                        ...
                        if ((objeto instanceof String) && objeto!=null)
                        {
                            if (((String)objeto).length()>0)
                            {
                            	...
                            	if(Estructuras.getListaTiposViaINE().getDomainNode((String)objeto)==null){
                            		CConstantesLicencias.referencia.setTipoVia("No Especificado");
                            		tipoVia="NE";
                            	}
