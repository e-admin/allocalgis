...
public class CSearchJDialog extends javax.swing.JDialog {
	...
	public void initComboBoxesEstructuras(boolean buscarObra){
        try
        {
            ...
            if ((desktop instanceof CMainLicencias) || ((desktop instanceof MainActividad) && (buscarObra)))
            {
                ...
                }else if (tipoLicenciaEJCBox.getSelectedPatron().equalsIgnoreCase(new Integer(CConstantesLicencias_LCGIII.ObraMayor).toString())){
                ...
                }else if (tipoLicenciaEJCBox.getSelectedPatron().equalsIgnoreCase(new Integer(CConstantesLicencias_LCGIII.ObraMenor).toString())){
	...
	private void configureComponents(boolean editable) {
        try
        {
            ...
            CConstantesLicencias_LCGIII.searchValue = "";
    ...
    private void buscarDNIJButtonActionPerformed() {//GEN-FIRST:event_buscarDNIJButtonActionPerformed
        ...
        if (CConstantesLicencias.persona != null) {
            nifPropietarioJTextField.setText(CConstantesLicencias.persona.getDniCif());
        }
    ...
    private void buscarFechaHastaJButtonActionPerformed() {//GEN-FIRST:event_buscarFechaHastaJButtonActionPerformed
        ...
        if ((CConstantesLicencias_LCGIII.calendarValue != null) && (!CConstantesLicencias_LCGIII.calendarValue.trim().equals(""))) {
            fechaAperturaHastaJTextField.setText(CConstantesLicencias_LCGIII.calendarValue);
        }
    ...
    private void buscarFechaDesdeJButtonActionPerformed() {//GEN-FIRST:event_buscarFechaDesdeJButtonActionPerformed
        ...
        if ((CConstantesLicencias_LCGIII.calendarValue != null) && (!CConstantesLicencias_LCGIII.calendarValue.trim().equals(""))) {
            fechaAperturaDesdeJTextField.setText(CConstantesLicencias_LCGIII.calendarValue);
        }
	...
	private void buscarJButtonActionPerformed() {//GEN-FIRST:event_buscarJButtonActionPerformed
		...
		expedientesLicencia= COperacionesLicencias.getSearchedExpedientes(hash, tiposLicencia);
		...
		for (int i = 0; i < expedientesLicencia.size(); i++) {
            ...
            try{
                if (patronTipoLicencia != null){
                    if (patronTipoLicencia.equalsIgnoreCase(new Integer(CConstantesLicencias_LCGIII.ObraMayor).toString())) {
                    ...
                    }else if (patronTipoLicencia.equalsIgnoreCase(new Integer(CConstantesLicencias_LCGIII.ObraMenor).toString())) {
                        ...
                        sTipoLicencia=((DomainNode)Estructuras.getListaLicencias().getDomainNode(new Integer(expedienteLicencia.getTipoLicenciaDescripcion()).toString())).getTerm(literales.getLocale().toString());
                    }else if (patronTipoLicencia.equalsIgnoreCase(new Integer(CConstantesLicencias_LCGIII.Actividades).toString())||patronTipoLicencia.equalsIgnoreCase(new Integer(CConstantesLicencias_LCGIII.ActividadesNoCalificadas).toString())) {
			...
			expedientesJTableModel.addRow(new Object[]{sTipoLicencia,
													   ...
													   CConstantesLicencias_LCGIII.df.format(expedienteLicencia.getFechaApertura()),
													   tipoVia,
	...
	private void cancelarJButtonActionPerformed() {//GEN-FIRST:event_cancelarJButtonActionPerformed
		...
		CConstantesLicencias_LCGIII.searchValue= "";
        /** null, cancela */
        CConstantesLicencias_LCGIII.patronSelectedTipoLicencia= null;
        CConstantesLicencias_LCGIII.patronSelectedTipoObra= null;
        CConstantesLicencias_LCGIII.patronSelectedEstado= null;
        CConstantesLicencias_LCGIII.selectedDniSolicitante= null;

        CConstantesLicencias_LCGIII.searchCanceled= true;
	...
	private void aceptarJButtonActionPerformed() {//GEN-FIRST:event_aceptarJButtonActionPerformed
        //getExpedienteSeleccionado();
		CConstantesLicencias_LCGIII.searchValue= selectedExpediente;
        CConstantesLicencias_LCGIII.searchCanceled= false;

        if ((selectedExpediente != null) && (selectedExpediente.trim().length() > 0)){
            CConstantesLicencias_LCGIII.patronSelectedTipoLicencia= tipoLicenciaEJCBox.getSelectedPatron();
            CConstantesLicencias_LCGIII.patronSelectedTipoObra= tipoObraEJCBox.getSelectedPatron();
            CConstantesLicencias_LCGIII.patronSelectedEstado= estadoEJCBox.getSelectedPatron();
            CConstantesLicencias_LCGIII.selectedDniSolicitante= nifPropietarioJTextField.getText();
        }else{
            CConstantesLicencias_LCGIII.patronSelectedTipoLicencia= null;
            CConstantesLicencias_LCGIII.patronSelectedTipoObra= null;
            CConstantesLicencias_LCGIII.patronSelectedEstado= null;
