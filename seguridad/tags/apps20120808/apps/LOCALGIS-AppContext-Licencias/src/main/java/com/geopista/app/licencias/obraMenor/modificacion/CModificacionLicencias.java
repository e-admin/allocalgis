package com.geopista.app.licencias.obraMenor.modificacion;
/**
 *
   ...
   /**
	...
	private boolean configureComponents() {
		...
		try {
			...
			String[] columnNamesNotificaciones = {CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.notificacionesJTable.colum6"),
                                                  CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.notificacionesJTable.colum1"),
												  CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.notificacionesJTable.colum2"),
												  CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.notificacionesJTable.colum3"),
												  CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.notificacionesJTable.colum4"),
												  CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.notificacionesJTable.colum5"),
                                                  "HIDDEN"};
			...
			String[] columnNamesEventos = {CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.eventosJTable.colum1"),
										   CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.eventosJTable.colum2"),
										   CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.eventosJTable.colum3"),
										   CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.eventosJTable.colum4"),
										   CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.eventosJTable.colum5"),
                                           "HIDDEN"};
			...
			String[] columnNamesHistorico = {CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.historicoJTable.colum2"),
											 CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.historicoJTable.colum3"),
											 CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.historicoJTable.colum4"),
											 CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.historicoJTable.colum5"),
                                             "HIDDEN"};
			...
			referenciasCatastralesJTableModel = new CReferenciasCatastralesTableModel(new String[]{CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.referenciasCatastralesJTable.column1"),
																				   CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.referenciasCatastralesJTable.column2"),
																				   CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.referenciasCatastralesJTable.column3"),
																				   CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.referenciasCatastralesJTable.column4"),
																				   CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.referenciasCatastralesJTable.column5"),
																				   CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.referenciasCatastralesJTable.column6"),
																				   CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.referenciasCatastralesJTable.column7"),
																				   CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.referenciasCatastralesJTable.column8"),
																				   CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.referenciasCatastralesJTable.column9"),
                                                                                   CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.referenciasCatastralesJTable.column10"), ""});
            ...
            datosSolicitudJPanel.add(tasaTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 160, 330, -1));

            /** impuesto */
            impuestoTextField= new com.geopista.app.utilidades.JNumberTextField(JNumberTextField.CURRENCY, new Integer(99999999), true);
            datosSolicitudJPanel.add(impuestoTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 180, 330, -1));
            ...
            okJButton.setToolTipText(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.okJButtonToolTipText.text"));
    ...
    public void initComboBoxesEstructuras(){
        ...
        datosNotificacionPropietarioJPanel.add(tipoViaNotificacionPropietarioEJCBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 130, 300, 20));
        ...
        datosNotificacionRepresentanteJPanel.add(tipoViaNotificacionRepresentanteEJCBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 130, 300, 20));
        ...
        datosNotificacionTecnicoJPanel.add(tipoViaNotificacionTecnicoEJCBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 130, 300, 20));
    ...
    private void viaNotificacionPropietarioEJCBoxActionPerformed() {
        ...
        if (index.equalsIgnoreCase(CConstantesLicencias.patronNotificacionEmail)){
            emailPropietarioJLabel.setText(CUtilidadesComponentes.getLabelConAsterisco(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.emailPropietarioJLabel.text")));
            emailPropietarioObligatorio= true;
        }else{
            emailPropietarioJLabel.setText(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.emailPropietarioJLabel.text"));
    ...
    private void viaNotificacionRepresentanteEJCBoxActionPerformed() {
        ...
        if (index.equalsIgnoreCase(CConstantesLicencias.patronNotificacionEmail)){
            emailRepresentanteJLabel.setText(CUtilidadesComponentes.getLabelConAsterisco(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.emailRepresentanteJLabel.text")));
            emailRepresentanteObligatorio= true;
        }else{
            emailRepresentanteJLabel.setText(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.emailRepresentanteJLabel.text"));
    ...
    private void viaNotificacionTecnicoEJCBoxActionPerformed() {
        ...
        if (index.equalsIgnoreCase(CConstantesLicencias.patronNotificacionEmail)){
            emailTecnicoJLabel.setText(CUtilidadesComponentes.getLabelConAsterisco(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.emailTecnicoJLabel.text")));
            emailTecnicoObligatorio= true;
        }else{
            emailTecnicoJLabel.setText(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.emailTecnicoJLabel.text"));
    ...
    private void viaNotificacionPromotorEJCBoxActionPerformed() {
        ...
        if (index.equalsIgnoreCase(CConstantesLicencias.patronNotificacionEmail)){
            emailPromotorJLabel.setText(CUtilidadesComponentes.getLabelConAsterisco(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.emailPromotorJLabel.text")));
            emailPromotorObligatorio= true;
        }else{
            emailPromotorJLabel.setText(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.emailPromotorJLabel.text"));
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        expedienteJPanel.add(estadoExpedienteJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 170, 20));
        ...
        expedienteJPanel.add(servicioExpedienteJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 170, 20));
        expedienteJPanel.add(tramitacionJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 170, 20));
        expedienteJPanel.add(asuntoExpedienteJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 170, 20));
        expedienteJPanel.add(fechaAperturaJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, 170, 20));
        ...
        expedienteJPanel.add(inicioJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, 170, 20));
        ...
        expedienteJPanel.add(silencioJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 170, 20));
        ...
        datosSolicitudJPanel.add(tipoObraJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 140, 20));

        datosSolicitudJPanel.add(unidadTJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 140, 20));
        datosSolicitudJPanel.add(motivoJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 140, 20));

        datosSolicitudJPanel.add(asuntoJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 140, 20));

        datosSolicitudJPanel.add(fechaSolicitudJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 140, 20));
        ...
        datosSolicitudJPanel.add(observacionesJScrollPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 205, 330, 70));
        ...
        datosSolicitudJPanel.add(unidadRJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 140, 20));

        datosSolicitudJPanel.add(unidadRJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 60, 330, -1));

        datosSolicitudJPanel.add(tasaJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 140, 20));

        datosSolicitudJPanel.add(impuestoJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 140, 20));
        ...
        obraMayorJPanel.add(datosSolicitudJPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 520, 280));
        ...
        emplazamientoJPanel.add(referenciasCatastralesJScrollPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 135, 470, 120));
        ...
        emplazamientoJPanel.add(deleteParcelaJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 235, 20, 20));

        obraMayorJPanel.add(emplazamientoJPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 280, 520, 267));
        ...
        datosPersonalesPropietarioJPanel.add(nombrePropietarioJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 45, 130, 20));

        datosPersonalesPropietarioJPanel.add(nombrePropietarioJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 45, 300, -1));

        datosPersonalesPropietarioJPanel.add(apellido1PropietarioJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 66, 130, 20));

        datosPersonalesPropietarioJPanel.add(apellido2PropietarioJLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 87, 130, 20));

        datosPersonalesPropietarioJPanel.add(apellido1PropietarioJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 66, 300, -1));

        datosPersonalesPropietarioJPanel.add(apellido2PropietarioJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 87, 300, -1));
        ...
        propietarioJPanel.add(datosPersonalesPropietarioJPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 520, 127));
        ...
        datosNotificacionPropietarioJPanel.add(tipoViaPropietarioJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 130, 20));

        datosNotificacionPropietarioJPanel.add(nombreViaPropietarioJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 151, 130, 20));

        datosNotificacionPropietarioJPanel.add(numeroViaPropietarioJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 172, 90, 20));

        datosNotificacionPropietarioJPanel.add(portalPropietarioJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 235, 50, 20));

        datosNotificacionPropietarioJPanel.add(plantaPropietarioJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 193, 70, 20));

        datosNotificacionPropietarioJPanel.add(escaleraPropietarioJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 256, 60, 20));

        datosNotificacionPropietarioJPanel.add(letraPropietarioJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 214, 40, 20));

        datosNotificacionPropietarioJPanel.add(cPostalPropietarioJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 277, 130, 20));

        datosNotificacionPropietarioJPanel.add(municipioPropietarioJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 298, 130, 20));

        datosNotificacionPropietarioJPanel.add(provinciaPropietarioJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 319, 130, 20));
        ...
        datosNotificacionPropietarioJPanel.add(nombreViaPropietarioJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 151, 300, -1));

        datosNotificacionPropietarioJPanel.add(numeroViaPropietarioJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 172, 150, -1));

        datosNotificacionPropietarioJPanel.add(plantaPropietarioJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 193, 150, -1));

        datosNotificacionPropietarioJPanel.add(portalPropietarioJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 235, 150, -1));

        datosNotificacionPropietarioJPanel.add(escaleraPropietarioJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 256, 150, -1));

        datosNotificacionPropietarioJPanel.add(letraPropietarioJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 214, 150, -1));

        datosNotificacionPropietarioJPanel.add(cPostalPropietarioJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 277, 300, -1));

        datosNotificacionPropietarioJPanel.add(municipioPropietarioJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 298, 300, -1));

        datosNotificacionPropietarioJPanel.add(provinciaPropietarioJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 319, 300, -1));
        ...
        propietarioJPanel.add(datosNotificacionPropietarioJPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 127, 520, 420));
        ...
        datosPersonalesRepresentanteJPanel.add(nombreRepresentanteJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 45, 130, 20));

        datosPersonalesRepresentanteJPanel.add(nombreRepresentanteJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 45, 300, -1));

        datosPersonalesRepresentanteJPanel.add(apellido1RepresentanteJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 66, 130, 20));

        datosPersonalesRepresentanteJPanel.add(apellido2RepresentanteJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 87, 130, 20));

        datosPersonalesRepresentanteJPanel.add(apellido1RepresentanteJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 66, 300, -1));

        datosPersonalesRepresentanteJPanel.add(apellido2RepresentanteJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 87, 300, -1));
        ...
        representanteJPanel.add(datosPersonalesRepresentanteJPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 520, 127));
        ...
        datosNotificacionRepresentanteJPanel.add(tipoViaRepresentanteJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 130, 20));

        datosNotificacionRepresentanteJPanel.add(nombreViaRepresentanteJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 151, 100, 20));

        datosNotificacionRepresentanteJPanel.add(numeroViaRepresentanteJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 172, 90, 20));

        datosNotificacionRepresentanteJPanel.add(portalRepresentanteJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 235, 50, 20));

        datosNotificacionRepresentanteJPanel.add(plantaRepresentanteJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 193, 70, 20));

        datosNotificacionRepresentanteJPanel.add(escaleraRepresentanteJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 256, 60, 20));

        datosNotificacionRepresentanteJPanel.add(letraRepresentanteJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 214, 40, 20));

        datosNotificacionRepresentanteJPanel.add(cPostalRepresentanteJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 277, 130, 20));

        datosNotificacionRepresentanteJPanel.add(municipioRepresentanteJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 298, 130, 20));

        datosNotificacionRepresentanteJPanel.add(provinciaRepresentanteJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 319, 130, 20));
        ...
        datosNotificacionRepresentanteJPanel.add(nombreViaRepresentanteJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 151, 300, -1));

        datosNotificacionRepresentanteJPanel.add(numeroViaRepresentanteJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 172, 150, -1));

        datosNotificacionRepresentanteJPanel.add(plantaRepresentanteJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 193, 150, -1));

        datosNotificacionRepresentanteJPanel.add(portalRepresentanteJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 235, 150, -1));

        datosNotificacionRepresentanteJPanel.add(escaleraRepresentanteJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 256, 150, -1));

        datosNotificacionRepresentanteJPanel.add(letraRepresentanteJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 214, 150, -1));

        datosNotificacionRepresentanteJPanel.add(cPostalRepresentanteJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 277, 300, 20));

        datosNotificacionRepresentanteJPanel.add(municipioRepresentanteJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 298, 300, 20));

        datosNotificacionRepresentanteJPanel.add(provinciaRepresentanteJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 319, 300, 20));
        ...
        representanteJPanel.add(datosNotificacionRepresentanteJPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 127, 520, 420));
        ...
        datosPersonalesTecnicoJPanel.add(nombreTecnicoJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 45, 130, 20));

        datosPersonalesTecnicoJPanel.add(nombreTecnicoJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 45, 300, -1));

        datosPersonalesTecnicoJPanel.add(apellido1TecnicoJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 66, 130, 20));

        datosPersonalesTecnicoJPanel.add(apellido2TecnicoJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 87, 130, 20));

        datosPersonalesTecnicoJPanel.add(apellido1TecnicoJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 66, 300, -1));

        datosPersonalesTecnicoJPanel.add(apellido2TecnicoJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 87, 300, -1));
        ...
        datosPersonalesTecnicoJPanel.add(colegioTecnicoJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 108, 130, 20));

        datosPersonalesTecnicoJPanel.add(visadoTecnicoJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 129, 130, 20));

        datosPersonalesTecnicoJPanel.add(titulacionTecnicoJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 130, 20));

        datosPersonalesTecnicoJPanel.add(colegioTecnicoJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 108, 300, -1));

        datosPersonalesTecnicoJPanel.add(visadoTecnicoJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 129, 300, -1));

        datosPersonalesTecnicoJPanel.add(titulacionTecnicoJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 150, 300, -1));
        ...
        tecnicoJPanel.add(datosPersonalesTecnicoJPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 520, 177));
        ...
        datosNotificacionTecnicoJPanel.add(nombreViaTecnicoJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 151, 300, -1));

        datosNotificacionTecnicoJPanel.add(numeroViaTecnicoJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 172, 150, -1));

        datosNotificacionTecnicoJPanel.add(plantaTecnicoJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 193, 150, -1));

        datosNotificacionTecnicoJPanel.add(portalTecnicoJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 235, 150, -1));

        datosNotificacionTecnicoJPanel.add(escaleraTecnicoJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 256, 150, -1));

        datosNotificacionTecnicoJPanel.add(letraTecnicoJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 214, 150, -1));

        datosNotificacionTecnicoJPanel.add(cPostalTecnicoJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 277, 300, -1));

        datosNotificacionTecnicoJPanel.add(municipioTecnicoJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 298, 300, -1));

        datosNotificacionTecnicoJPanel.add(provinciaTecnicoJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 319, 300, -1));

        notificarTecnicoJCheckBox.setVisible(false);
        datosNotificacionTecnicoJPanel.add(notificarTecnicoJCheckBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 340, 40, -1));

        notificarTecnicoJLabel.setVisible(false);
        datosNotificacionTecnicoJPanel.add(notificarTecnicoJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 340, 150, 20));

        tecnicoJPanel.add(datosNotificacionTecnicoJPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 177, 520, 370));
        ...
        datosPersonalesPromotorJPanel.add(nombrePromotorJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 45, 300, -1));

        datosPersonalesPromotorJPanel.add(apellido1PromotorJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 66, 130, 20));

        datosPersonalesPromotorJPanel.add(apellido2PromotorJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 87, 130, 20));

        datosPersonalesPromotorJPanel.add(apellido1PromotorJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 66, 300, -1));

        datosPersonalesPromotorJPanel.add(apellido2PromotorJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 87, 300, -1));
        ...
        promotorJPanel.add(datosPersonalesPromotorJPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 520, 177));
        ...
        datosNotificacionPromotorJPanel.add(numeroViaPromotorJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 172, 150, -1));
        ...
        datosNotificacionPromotorJPanel.add(cPostalPromotorJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 277, 300, -1));
        ...
        datosNotificacionPromotorJPanel.add(notificarPromotorJCheckBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 340, 40, -1));
        ...
        promotorJPanel.add(datosNotificacionPromotorJPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 177, 520, 370));
        ...
        notificacionesJPanel.add(datosNotificacionesJPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 530, 580));
        ...
        eventosJPanel.add(datosEventosJPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 530, 580));
        ...
        historicoJPanel.add(datosHistoricoJPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 530, 580));
    ...
    private void generarFichaHistoricoJButtonActionPerformed() {//GEN-FIRST:event_generarFichaHistoricoJButtonActionPerformed
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            CUtilidadesComponentes.generarFichaHistorico(this.desktop, _vHistorico, _expediente,
                    _solicitud, selectedFile, CMainLicencias.literales);
        }
    ...
    private void borrarPromotorJButtonActionPerformed() {//GEN-FIRST:event_borrarPromotorJButtonActionPerformed
        ...
        if (CUtilidadesComponentes.hayDatosPersonaJuridicoFisica(DNIPromotorJTField.getText().trim(),
            ...
            int ok= JOptionPane.showConfirmDialog(obraMayorJPanel, CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.promotorJPanel.borrarPromotorJButton.Message"), CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.promotorJPanel.borrarPromotorJButton.tittle"), JOptionPane.YES_NO_OPTION);
    ...
    private void borrarTecnicoJButtonActionPerformed() {//GEN-FIRST:event_borrarTecnicoJButtonActionPerformed
        ...
        if (CUtilidadesComponentes.hayDatosPersonaJuridicoFisica(DNITecnicoJTField.getText().trim(),
            ...
            /** mostramos ventana de confirmacion */
            int ok= JOptionPane.showConfirmDialog(obraMayorJPanel, CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.tecnicoJPanel.borrarTecnicoJButton.Message"), CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.tecnicoJPanel.borrarTecnicoJButton.tittle"), JOptionPane.YES_NO_OPTION);
            if (ok == JOptionPane.YES_OPTION){
                borrarCamposTecnico();
    ...
    private void borrarRepresentanteJButtonActionPerformed() {//GEN-FIRST:event_borrarRepresentanteJButtonActionPerformed
        ...
        if (CUtilidadesComponentes.hayDatosPersonaJuridicoFisica(DNIRepresentanteJTField.getText().trim(),
            ...
            /** mostramos ventana de confirmacion */
            int ok= JOptionPane.showConfirmDialog(obraMayorJPanel, CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.representanteJPanel.borrarRepresentanteJButton.Message"), CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.representanteJPanel.borrarRepresentanteJButton.tittle"), JOptionPane.YES_NO_OPTION);
            if (ok == JOptionPane.YES_OPTION){
    ...
    private void referenciasCatastralesJTableMouseClicked() {//GEN-FIRST:event_referenciasCatastralesJTableMouseClicked
        ...
        try {
            ...
            if (selectedRow != -1) {
                ...
                {
                    CConstantesLicencias.referencia.setTipoVia(((DomainNode)objeto).getTerm(literales.getLocale().toString()));
                ...
                if ((objeto instanceof String) && objeto!=null)
                {
                    ...
                    {
                        CConstantesLicencias.referencia.setTipoVia(Estructuras.getListaTiposViaINE().getDomainNode((String)objeto).getTerm(literales.getLocale().toString()));
        ...
        if (row != -1) {
            ...
            if (historico != null){
                if ((historico.getIdHistorico() != -1) && (historico.getSistema().equals("1"))){
                    ...
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.historicoTab.mensaje1"));
                    return;
                }
	...
	private void nuevoHistoricoJButtonActionPerformed() {//GEN-FIRST:event_nuevoHistoricoJButtonActionPerformed
        ...
        nuevo.setUsuario(CConstantesLicencias.principal.getName());
            ...
            if (historico != null){
                ...
                if (idHistorico == -1){
                    ...
                    if (!historico.getSistema().equals("1")) {
                        ...
                        mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.historicoTab.mensaje2"));
                        return;
                    }
                }
		...
		if (ro != null) {
			if ((ro.getSolicitudes() != null) && (ro.getExpedientes() != null)) {
				...
				if ((_solicitud != null) && (_expediente != null)) {
					...
					mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.solicitudJPanel.mensaje1"));
					clearScreen();
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
					return;
				}
	...
	private void aceptarJButtonActionPerformed() {//GEN-FIRST:event_aceptarJButtonActionPerformed
		if (_consultaOK) {
			...
			if (rellenaCamposObligatorios()) {
				...
				if (datosPropietarioOK() && datosRepresentanteOK() && datosTecnicoOK() && datosPromotorOK()) {
					...
					if (CUtilidades.excedeLongitud(_unidadRegistro, CConstantesLicencias.MaxLengthUnidad) || CUtilidades.excedeLongitud(_unidadTramitadora, CConstantesLicencias.MaxLengthUnidad)) {
						mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.SolicitudTab.mensaje1"));
						return;
					}

					_motivo = motivoJTField.getText().trim();
					if (CUtilidades.excedeLongitud(_motivo, CConstantesLicencias.MaxLengthMotivo)) {
						mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.SolicitudTab.mensaje2"));
						return;
					}
					_asunto = asuntoJTField.getText().trim();
					if (CUtilidades.excedeLongitud(_asunto, CConstantesLicencias.MaxLengthAsunto)) {
						mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.SolicitudTab.mensaje3"));
						return;
					}
					...
					if (CUtilidades.excedeLongitud(_observaciones, CConstantesLicencias.MaxLengthObservaciones)) {
						mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.SolicitudTab.mensaje5"));
						return;
					}
					...
					if (CUtilidades.excedeLongitud(_servicioEncargado, CConstantesLicencias.MaxLengthServicioEncargado)) {
						mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.ExpedienteTab.mensaje1"));
						return;
					}
					...
					if (CUtilidades.excedeLongitud(_asuntoExpediente, CConstantesLicencias.MaxLengthAsuntoExpediente)) {
						mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.ExpedienteTab.mensaje2"));
						return;
					}
					...
					if (CUtilidades.excedeLongitud(_formaInicio, CConstantesLicencias.MaxLengthFormaInicio)) {
						mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.ExpedienteTab.mensaje3"));
						return;
					}
					...
					if (CUtilidades.excedeLongitud(_observacionesExpediente, CConstantesLicencias.MaxLengthObservaciones)) {
						mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.ExpedienteTab.mensaje9"));
						return;
					}
                    ...
                    String numero= "";
                    try{numero= numeroViaPropietarioJTField.getNumber().toString();}catch(Exception e){}
                    String cPostal= "";
                    try{cPostal= cPostalPropietarioJTField.getNumber().toString();}catch(Exception e){}
                    ...
                    numero= "";
                    try{numero= numeroViaRepresentanteJTField.getNumber().toString();}catch(Exception e){}
                    cPostal= "";
                    try{cPostal= cPostalRepresentanteJTField.getNumber().toString();}catch(Exception e){}
					...
					datosNotificacion = new CDatosNotificacion(_DNI_CIF_Tecnico, viaNotificacion, fax, telefono, movil, _emailTecnico, _tipoViaTecnico, _nombreViaTecnico, numero, _portalTecnico, _plantaTecnico, _escaleraTecnico, _letraTecnico, cPostal, _municipioTecnico, _provinciaTecnico, new Integer(_seNotificaTecnico).toString());
					// @param CPersonaJuridicoFisica String dniCif, String nombre, String apellido1, String apellido2, String colegio, String visado, String titulacion, CDatosNotificacion datosNotificacion
					...
					if (_vEventos != null) {
						...
						while (e.hasMoreElements()) {
							...
							if (renderCheck.isSelected()) {
								...
								*/
								String revisadoPor = CConstantesLicencias.principal.getName();
					...
					if (resultado.getResultado()) {
                       ...
                       if (resultado.getDescripcion().equalsIgnoreCase("FileUploadBase.SizeLimitExceededException")){
                         ...
                         JOptionPane optionPane= new JOptionPane(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.SolicitudTab.mensaje21") +"\n"+resultado.getDescripcion(),JOptionPane.ERROR_MESSAGE);
                         JDialog dialog =optionPane.createDialog(this,"ERROR");
                         dialog.show();
                       }
                    }
			...
			if (resultado.getResultado()){
				...
				//Modificacion: Quitar mensaje 27-02-09 JIS
				//else{
	...
	private void publicarJButtonActionPerformed() {
		...
		if ((CConstantesLicencias.persona != null) && (CConstantesLicencias.persona.getDniCif() != null)) {
            ...
            try{
                cPostalPromotorJTField.setNumber(new Integer(CConstantesLicencias.persona.getDatosNotificacion().getCpostal()));
            ...
            CConstantesLicencias.promotor= CConstantesLicencias.persona;
	...
	private void buscarDNITecnicoJButtonActionPerformed() {//GEN-FIRST:event_buscarDNITecnicoJButtonActionPerformed
		...
		if ((CConstantesLicencias.persona != null) && (CConstantesLicencias.persona.getDniCif() != null)) {
            ...
            try{
                cPostalTecnicoJTField.setNumber(new Integer(CConstantesLicencias.persona.getDatosNotificacion().getCpostal()));
            ...
            CConstantesLicencias.tecnico= CConstantesLicencias.persona;
	...
	private void buscarDNIRepresentanteJButtonActionPerformed() {//GEN-FIRST:event_buscarDNIRepresentanteJButtonActionPerformed
		...
		if ((CConstantesLicencias.persona != null) && (CConstantesLicencias.persona.getDniCif() != null)) {
            ...
            DNIRepresentanteJTField.setText(CConstantesLicencias.persona.getDniCif());
            nombreRepresentanteJTField.setText(CConstantesLicencias.persona.getNombre());
            apellido1RepresentanteJTField.setText(CConstantesLicencias.persona.getApellido1());
            apellido2RepresentanteJTField.setText(CConstantesLicencias.persona.getApellido2());
            faxRepresentanteJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getFax());
            telefonoRepresentanteJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getTelefono());
            movilRepresentanteJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getMovil());
            emailRepresentanteJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getEmail());
            try{
                tipoViaNotificacionRepresentanteEJCBox.setSelectedPatron(CConstantesLicencias.persona.getDatosNotificacion().getTipoVia());
            }catch (Exception e){
                DomainNode auxNode=Estructuras.getListaTiposViaINE().getDomainNodeByTraduccion(CConstantesLicencias.persona.getDatosNotificacion().getTipoVia());
                if (auxNode!=null)
            ...
            try{
                viaNotificacionRepresentanteEJCBox.setSelectedPatron(new Integer(CConstantesLicencias.persona.getDatosNotificacion().getViaNotificacion().getIdViaNotificacion()).toString());
            }catch (Exception e){
                DomainNode auxNode=Estructuras.getListaViasNotificacion().getDomainNodeByTraduccion(new Integer(CConstantesLicencias.persona.getDatosNotificacion().getViaNotificacion().getIdViaNotificacion()).toString());
                if (auxNode!=null)
            ...
            nombreViaRepresentanteJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getNombreVia());
            numeroViaRepresentanteJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getNumeroVia());
            plantaRepresentanteJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getPlanta());
            portalRepresentanteJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getPortal());
            escaleraRepresentanteJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getEscalera());
            letraRepresentanteJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getLetra());
            try{
                cPostalRepresentanteJTField.setNumber(new Integer(CConstantesLicencias.persona.getDatosNotificacion().getCpostal()));
            }catch(Exception e){cPostalRepresentanteJTField.setText("");}
            municipioRepresentanteJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getMunicipio());
            provinciaRepresentanteJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getProvincia());
            if (CConstantesLicencias.persona.getDatosNotificacion().getNotificar().equalsIgnoreCase("1"))
                notificarRepresentanteJCheckBox.setSelected(true);
            else notificarRepresentanteJCheckBox.setSelected(false);

            CConstantesLicencias.representante= CConstantesLicencias.persona;
	...
	private void buscarDNIPropietarioJButtonActionPerformed() {//GEN-FIRST:event_buscarDNIPropietarioJButtonActionPerformed
		...
		if ((CConstantesLicencias.persona != null) && (CConstantesLicencias.persona.getDniCif() != null)) {
            DNIPropietarioJTField.setText(CConstantesLicencias.persona.getDniCif());
            nombrePropietarioJTField.setText(CConstantesLicencias.persona.getNombre());
            apellido1PropietarioJTField.setText(CConstantesLicencias.persona.getApellido1());
            apellido2PropietarioJTField.setText(CConstantesLicencias.persona.getApellido2());
            faxPropietarioJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getFax());
            telefonoPropietarioJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getTelefono());
            movilPropietarioJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getMovil());
            emailPropietarioJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getEmail());
            try{
                tipoViaNotificacionPropietarioEJCBox.setSelectedPatron(CConstantesLicencias.persona.getDatosNotificacion().getTipoVia());
            }catch (Exception e){
                DomainNode auxNode=Estructuras.getListaTiposViaINE().getDomainNodeByTraduccion(CConstantesLicencias.persona.getDatosNotificacion().getTipoVia());
                if (auxNode!=null)
            ...
            try{
                viaNotificacionPropietarioEJCBox.setSelectedPatron(new Integer(CConstantesLicencias.persona.getDatosNotificacion().getViaNotificacion().getIdViaNotificacion()).toString());
            }catch (Exception e){
                DomainNode auxNode=Estructuras.getListaViasNotificacion().getDomainNodeByTraduccion(new Integer(CConstantesLicencias.persona.getDatosNotificacion().getViaNotificacion().getIdViaNotificacion()).toString());
                if (auxNode!=null)
            ...
            nombreViaPropietarioJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getNombreVia());
            numeroViaPropietarioJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getNumeroVia());
            plantaPropietarioJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getPlanta());
            portalPropietarioJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getPortal());
            escaleraPropietarioJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getEscalera());
            letraPropietarioJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getLetra());
            try{
                cPostalPropietarioJTField.setNumber(new Integer(CConstantesLicencias.persona.getDatosNotificacion().getCpostal()));
            }catch(Exception e){cPostalPropietarioJTField.setText("");}
            municipioPropietarioJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getMunicipio());
            provinciaPropietarioJTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getProvincia());
            /*
            if (CConstantesLicencias.persona.getDatosNotificacion().getNotificar().equalsIgnoreCase("1"))
                notificarPropietarioJCheckBox.setSelected(true);
	...
	public boolean datosPropietarioOK() {
		try {
			if (CUtilidades.excedeLongitud(_DNI_CIF_Propietario, CConstantesLicencias.MaxLengthDNI)) {
				mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PropietarioTab.mensaje1"));
				return false;
			}
			if (CUtilidades.excedeLongitud(_nombrePropietario, CConstantesLicencias.MaxLengthNombre)) {
				mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PropietarioTab.mensaje2"));
				return false;
			}
			if (CUtilidades.excedeLongitud(_apellido1Propietario, CConstantesLicencias.MaxLengthApellido) || CUtilidades.excedeLongitud(_apellido2Propietario, CConstantesLicencias.MaxLengthApellido)) {
				mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PropietarioTab.mensaje3"));
				return false;
			}
			...
			if (CUtilidades.excedeLongitud(_emailPropietario, CConstantesLicencias.MaxLengthEmail)) {
				mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PropietarioTab.mensaje6"));
				return false;
			}
			...
			if (CUtilidades.excedeLongitud(_nombreViaPropietario, CConstantesLicencias.MaxLengthNombreVia)) {
				mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PropietarioTab.mensaje8"));
				return false;
			}
			...
			if (CUtilidades.excedeLongitud(_portalPropietario, CConstantesLicencias.MaxLengthPortal)) {
				mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PropietarioTab.mensaje11"));
				return false;
			}
			...
			if (_plantaPropietario.length() > 0) {
                if (CUtilidades.excedeLongitud(_plantaPropietario, CConstantesLicencias.MaxLengthPlanta)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PropietarioTab.mensaje13"));
                    return false;
                }
			}
			...
			if (CUtilidades.excedeLongitud(_escaleraPropietario, CConstantesLicencias.MaxLengthPlanta)) {
				mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PropietarioTab.mensaje14"));
				return false;
			}
			...
			if (CUtilidades.excedeLongitud(_letraPropietario, CConstantesLicencias.MaxLengthLetra)) {
				mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PropietarioTab.mensaje15"));
				return false;
			}
			...
			if (CUtilidades.excedeLongitud(_municipioPropietario, CConstantesLicencias.MaxLengthMunicipio)) {
				mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PropietarioTab.mensaje18"));
				return false;
			}
			...
			if (CUtilidades.excedeLongitud(_provinciaPropietario, CConstantesLicencias.MaxLengthProvincia)) {
				mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PropietarioTab.mensaje19"));
				return false;
			}
		...
		try {
			...
			if (_DNI_CIF_Representante.trim().length() > 0) {
				if (CUtilidades.excedeLongitud(_DNI_CIF_Representante, CConstantesLicencias.MaxLengthDNI)) {
					mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.RepresentanteTab.mensaje1"));
					return false;
				}
				if (CUtilidades.excedeLongitud(_nombreRepresentante, CConstantesLicencias.MaxLengthNombre)) {
					mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.RepresentanteTab.mensaje2"));
					return false;
				}
				if (CUtilidades.excedeLongitud(_apellido1Representante, CConstantesLicencias.MaxLengthApellido) || CUtilidades.excedeLongitud(_apellido2Representante, CConstantesLicencias.MaxLengthApellido)) {
					mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.RepresentanteTab.mensaje3"));
					return false;
				}
				...
				if (CUtilidades.excedeLongitud(_emailRepresentante, CConstantesLicencias.MaxLengthEmail)) {
					mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.RepresentanteTab.mensaje6"));
					return false;
				}
				...
				if (CUtilidades.excedeLongitud(_nombreViaRepresentante, CConstantesLicencias.MaxLengthNombreVia)) {
					mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.RepresentanteTab.mensaje8"));
					return false;
				}
				...
				if (_portalRepresentante.length() > 0) {
					if (CUtilidades.excedeLongitud(_portalRepresentante, CConstantesLicencias.MaxLengthPortal)) {
						mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.RepresentanteTab.mensaje11"));
						return false;
					}
				}
				...
				if (_plantaRepresentante.length() > 0) {
                    if (CUtilidades.excedeLongitud(_plantaRepresentante, CConstantesLicencias.MaxLengthPlanta)) {
                        mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.RepresentanteTab.mensaje13"));
                        return false;
                    }
				}
				...
				if (CUtilidades.excedeLongitud(_escaleraRepresentante, CConstantesLicencias.MaxLengthPlanta)) {
					mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.RepresentanteTab.mensaje14"));
					return false;
				}
				...
				if (CUtilidades.excedeLongitud(_letraRepresentante, CConstantesLicencias.MaxLengthLetra)) {
					mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.RepresentanteTab.mensaje15"));
					return false;
				}
				...
				if (CUtilidades.excedeLongitud(_municipioRepresentante, CConstantesLicencias.MaxLengthMunicipio)) {
					mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.RepresentanteTab.mensaje18"));
					return false;
				}
				...
				if (CUtilidades.excedeLongitud(_provinciaRepresentante, CConstantesLicencias.MaxLengthProvincia)) {
					mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.RepresentanteTab.mensaje19"));
					return false;
				}
		...
		try {
			...
			if (_DNI_CIF_Tecnico.trim().length() > 0) {
                if (CUtilidades.excedeLongitud(_DNI_CIF_Tecnico, CConstantesLicencias.MaxLengthDNI)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.TecnicoTab.mensaje1"));
                    return false;
                }
                if (CUtilidades.excedeLongitud(_nombreTecnico, CConstantesLicencias.MaxLengthNombre)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.TecnicoTab.mensaje2"));
                    return false;
                }
                if (CUtilidades.excedeLongitud(_apellido1Tecnico, CConstantesLicencias.MaxLengthApellido) || CUtilidades.excedeLongitud(_apellido2Tecnico, CConstantesLicencias.MaxLengthApellido)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.TecnicoTab.mensaje3"));
                    return false;
                }
                if (CUtilidades.excedeLongitud(_colegioTecnico, CConstantesLicencias.MaxLengthColegio)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.TecnicoTab.mensaje4"));
                    return false;
                }
                if (CUtilidades.excedeLongitud(_visadoTecnico, CConstantesLicencias.MaxLengthVisado)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.TecnicoTab.mensaje5"));
                    return false;
                }
                if (CUtilidades.excedeLongitud(_titulacionTecnico, CConstantesLicencias.MaxLengthTitulacion)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.TecnicoTab.mensaje6"));
                    return false;
                }
                ...
                if (CUtilidades.excedeLongitud(_emailTecnico, CConstantesLicencias.MaxLengthEmail)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.TecnicoTab.mensaje9"));
                    return false;
                }
                ...
                if (CUtilidades.excedeLongitud(_nombreViaTecnico, CConstantesLicencias.MaxLengthNombreVia)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.TecnicoTab.mensaje11"));
                    return false;
                }
                ...
                if (_portalTecnico.length() > 0) {
                    if (CUtilidades.excedeLongitud(_portalTecnico, CConstantesLicencias.MaxLengthPortal)) {
                        mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.TecnicoTab.mensaje14"));
                        return false;
                    }
                }
                ...
                if (_plantaTecnico.length() > 0) {
                    if (CUtilidades.excedeLongitud(_plantaTecnico, CConstantesLicencias.MaxLengthPlanta)) {
                        mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.TecnicoTab.mensaje16"));
                        return false;
                    }
                }
                ...
                if (CUtilidades.excedeLongitud(_escaleraTecnico, CConstantesLicencias.MaxLengthPlanta)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.TecnicoTab.mensaje17"));
                    return false;
                }
                ...
                if (CUtilidades.excedeLongitud(_letraTecnico, CConstantesLicencias.MaxLengthLetra)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.TecnicoTab.mensaje18"));
                    return false;
                }
                ...
                if (CUtilidades.excedeLongitud(_municipioTecnico, CConstantesLicencias.MaxLengthMunicipio)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.TecnicoTab.mensaje21"));
                    return false;
                }
                ...
                if (CUtilidades.excedeLongitud(_provinciaTecnico, CConstantesLicencias.MaxLengthProvincia)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.TecnicoTab.mensaje22"));
                    return false;
                }
		...
		try {
			...
			if (_DNI_CIF_Promotor.trim().length() > 0) {
                if (CUtilidades.excedeLongitud(_DNI_CIF_Promotor, CConstantesLicencias.MaxLengthDNI)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PromotorTab.mensaje1"));
                    return false;
                }
                if (CUtilidades.excedeLongitud(_nombrePromotor, CConstantesLicencias.MaxLengthNombre)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PromotorTab.mensaje2"));
                    return false;
                }
                if (CUtilidades.excedeLongitud(_apellido1Promotor, CConstantesLicencias.MaxLengthApellido) || CUtilidades.excedeLongitud(_apellido2Promotor, CConstantesLicencias.MaxLengthApellido)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PromotorTab.mensaje3"));
                    return false;
                }
                if (CUtilidades.excedeLongitud(_colegioPromotor, CConstantesLicencias.MaxLengthColegio)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PromotorTab.mensaje4"));
                    return false;
                }
                if (CUtilidades.excedeLongitud(_visadoPromotor, CConstantesLicencias.MaxLengthVisado)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PromotorTab.mensaje5"));
                    return false;
                }
                if (CUtilidades.excedeLongitud(_titulacionPromotor, CConstantesLicencias.MaxLengthTitulacion)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PromotorTab.mensaje6"));
                    return false;
                }
                ...
                if (CUtilidades.excedeLongitud(_emailPromotor, CConstantesLicencias.MaxLengthEmail)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PromotorTab.mensaje9"));
                    return false;
                }
                ...
                if (CUtilidades.excedeLongitud(_nombreViaPromotor, CConstantesLicencias.MaxLengthNombreVia)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PromotorTab.mensaje11"));
                    return false;
                }
                ...
                if (_portalPromotor.length() > 0) {
                    if (CUtilidades.excedeLongitud(_portalPromotor, CConstantesLicencias.MaxLengthPortal)) {
                        mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PromotorTab.mensaje14"));
                        return false;
                    }
                }
                ...
                if (_plantaPromotor.length() > 0) {
                    if (CUtilidades.excedeLongitud(_plantaPromotor, CConstantesLicencias.MaxLengthPlanta)) {
                        mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PromotorTab.mensaje16"));
                        return false;
                    }
                }
                ...
                if (CUtilidades.excedeLongitud(_escaleraPromotor, CConstantesLicencias.MaxLengthPlanta)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PromotorTab.mensaje17"));
                    return false;
                }
                ...
                if (CUtilidades.excedeLongitud(_letraPromotor, CConstantesLicencias.MaxLengthLetra)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PromotorTab.mensaje18"));
                    return false;
                }
                ...
                if (CUtilidades.excedeLongitud(_municipioPromotor, CConstantesLicencias.MaxLengthMunicipio)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PromotorTab.mensaje21"));
                    return false;
                }
                ...
                if (CUtilidades.excedeLongitud(_provinciaPromotor, CConstantesLicencias.MaxLengthProvincia)) {
                    mostrarMensaje(CMainLicencias.literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.PromotorTab.mensaje22"));
                    return false;
                }
    ...
    public CPersonaJuridicoFisica modificarRepresentante(CPersonaJuridicoFisica persona){
        ...
        if ((_solicitud.getRepresentante() != null) && (_solicitud.getIdRepresentanteToDelete() == -1)) {
            ...
            */
            if ((CConstantesLicencias.representante != null) || (_DNI_CIF_Representante.trim().length() > 0)){
                if (CConstantesLicencias.representante != null){
                    /** caso 1 */
                   logger.debug("************** 1.- Se ha asignado un representante de BD ID="+CConstantesLicencias.representante.getIdPersona());
                   representante.setIdPersona(CConstantesLicencias.representante.getIdPersona());
                }else{
                    /** caso 2 */
            ...
            if ((CConstantesLicencias.representante != null) || (_DNI_CIF_Representante.trim().length() > 0)){
                if (CConstantesLicencias.representante != null){
                    /** caso 1 */
                    logger.debug("************** 4.- Se ha asignado un representante de BD ID="+CConstantesLicencias.representante.getIdPersona());
                   representante.setIdPersona(CConstantesLicencias.representante.getIdPersona());
                }else{
                    /** caso 2 */
    ...
    public CPersonaJuridicoFisica modificarTecnico(CPersonaJuridicoFisica persona){
        ...
        if ((_solicitud.getTecnicos() != null) && (_solicitud.getTecnicos().size() > 0) && (_solicitud.getIdTecnicoToDelete() == -1)) {
            ...
            */
            if ((CConstantesLicencias.tecnico != null) || (_DNI_CIF_Tecnico.trim().length() > 0)){
                if (CConstantesLicencias.tecnico != null){
                    /** caso 1 */
                   logger.debug("************** 1.- Se ha asignado un tecnico de BD ID="+CConstantesLicencias.tecnico.getIdPersona());
                   tecnico.setIdPersona(CConstantesLicencias.tecnico.getIdPersona());
                }else{
                    /** caso 2 */
            ...
            if ((CConstantesLicencias.tecnico != null) || (_DNI_CIF_Tecnico.trim().length() > 0)){
                if (CConstantesLicencias.tecnico != null){
                    /** caso 1 */
                    logger.debug("************** 4.- Se ha asignado un tecnico de BD ID="+CConstantesLicencias.tecnico.getIdPersona());
                    tecnico.setIdPersona(CConstantesLicencias.tecnico.getIdPersona());
                }else{
                    /** caso 2 */
    ...
    public CPersonaJuridicoFisica modificarPromotor(CPersonaJuridicoFisica persona){
        ...
        if ((_solicitud.getPromotor() != null) && (_solicitud.getIdPromotorToDelete() == -1)) {
            ...
            */
            if ((CConstantesLicencias.promotor != null) || (_DNI_CIF_Promotor.trim().length() > 0)){
                if (CConstantesLicencias.promotor != null){
                    /** caso 1 */
                   logger.debug("************** 1.- Se ha asignado un tecnico de BD ID="+CConstantesLicencias.promotor.getIdPersona());
                   promotor.setIdPersona(CConstantesLicencias.promotor.getIdPersona());
                }else{
                    /** caso 2 */
            ...
            if ((CConstantesLicencias.promotor != null) || (_DNI_CIF_Promotor.trim().length() > 0)){
                if (CConstantesLicencias.promotor != null){
                    /** caso 1 */
                    logger.debug("************** 4.- Se ha asignado un promotor de BD ID="+CConstantesLicencias.promotor.getIdPersona());
                    promotor.setIdPersona(CConstantesLicencias.promotor.getIdPersona());
                }else{
                    /** caso 2 */
			...
			if ((_vNotificaciones != null) && (_vNotificaciones.size() > 0)) {
				...
				for (int i=0; i<_vNotificaciones.size(); i++) {
                    ...
                    try{
                        ...
                        logger.error("ERROR al cargar la fila NOTIFICACIONES "+e);
                    }
				}
			}
		} catch (Exception ex) {
	...
	public void renombrarComponentes(ResourceBundle literales) {
		...
		try {
            if(CConstantesLicencias.selectedSubApp.equals(CConstantesLicencias.LicenciasObraMenor)){
                ...
                jTabbedPaneSolicitud.setTitleAt(1, CUtilidadesComponentes.annadirAsterisco(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.propietarioJPanel.TitleTab")));
                jTabbedPaneSolicitud.setTitleAt(2, literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.representanteJPanel.TitleTab"));
                jTabbedPaneSolicitud.setTitleAt(3, literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.tecnicoJPanel.TitleTab"));
                jTabbedPaneSolicitud.setTitleAt(4, literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.promotorJPanel.TitleTab"));
                ...
                publicarJButton.setText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.publicarJButton.text"));
                ...
                cancelarJButton.setToolTipText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.salirJButton.text"));
                ...
                publicarJButton.setToolTipText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.publicarJButton.toolTipText"));
                ...
                buscarExpedienteJButton.setToolTipText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.buscarExpedienteJButton.text"));
                fechaLimiteObraJButton.setToolTipText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.fechaLimiteObraJButton.text"));
                nombreViaJButton.setToolTipText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.nombreViaJButton.text"));
                refCatastralJButton.setToolTipText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.refCatastralJButton.text"));
                mapToTableJButton.setToolTipText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.mapToTableJButton.text"));
                tableToMapJButton.setToolTipText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.tableToMapJButton.text"));
                deleteParcelaJButton.setToolTipText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.deleteParcelaJButton.text"));
                buscarDNIPropietarioJButton.setToolTipText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.buscarDNIPropietarioJButton.text"));
                buscarDNIRepresentanteJButton.setToolTipText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.buscarDNIRepresentanteJButton.text"));
                borrarRepresentanteJButton.setToolTipText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.borrarRepresentanteJButton.text"));
                buscarDNITecnicoJButton.setToolTipText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.buscarDNITecnicoJButton.text"));
                borrarTecnicoJButton.setToolTipText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.borrarTecnicoJButton.text"));
                buscarDNIPromotorJButton.setToolTipText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.buscarDNIPromotorJButton.text"));
                borrarPromotorJButton.setToolTipText(literales.getString("CModificacionLicenciasForm.ObraMenorJMenuItem.borrarPromotorJButton.text"));
    ...
    private void generarFicha()
       {
           try
           {
               ...
               _expediente.setEstructuraTipoObra(Estructuras.getListaTiposObraMenor());
               _expediente.setLocale(CMainLicencias.currentLocale);
               _expediente.setSolicitud(_solicitud);
                  new GeopistaPrintable().printObjeto(FichasDisponibles.fichalicenciaobramenor, _expediente , CExpedienteLicencia.class, geopistaEditor.getLayerViewPanel(), GeopistaPrintable.FICHA_LICENCIAS_OBRA_MENOR_MODIFICACION);
           } catch (Exception ex) {
    ...
    private void verWorkFlow()
    {
    	try
        {
           ...
           JDialogWorkFlow dialogImagen = new JDialogWorkFlow(desktop, _expediente.getEstado().getIdEstado(),
                   _solicitud.getTipoLicencia().getIdTipolicencia());
