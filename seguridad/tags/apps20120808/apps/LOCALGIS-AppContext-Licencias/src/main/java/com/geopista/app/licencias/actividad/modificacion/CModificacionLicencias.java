package com.geopista.app.licencias.actividad.modificacion;
/**
 *
    ...
    private void generarFicha()
       {
           try
           {
               ...
               _expediente.setSolicitud(_solicitud);
                  new GeopistaPrintable().printObjeto(FichasDisponibles.fichalicenciaactividad, _expediente , CExpedienteLicencia.class, MainActividad.geopistaEditor.getLayerViewPanel(), GeopistaPrintable.FICHA_LICENCIAS_ACTIVIDAD_MODIFICACION);
           } catch (Exception ex) {
