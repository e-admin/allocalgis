 ...
 * format has been specified as XMLSCHEMA. A WFS may support different
 * formats for formatting its responses. Only GML is mandatory.
 *
 * <p>--------------------------------------------------------</p>
 *
 ...
 */
class WFSDescribeFeatureTypeResponse_Impl extends WFSBasicResponse_Impl
    implements WFSDescribeFeatureTypeResponse {
    private Document featureTypeSchema = null;

    /**
     * constructor initializing the class with the <WFSDescribeFeatureTypeResponse_Impl >
     */
    ...
    /**
     * returns the respose of a DescribeFeatureTypeRequest
     * as XML-Schema
     */
    ...
    /**
     * sets the respose of a DescribeFeatureTypeRequest
     * as XML-Schema
     */
 ...
 *
 * $Log: WFSDescribeFeatureTypeResponse_Impl.java,v $
 ...
 * no message
 *
 * Revision 1.4  2002/05/06 16:02:22  ap
 * no message
 *
