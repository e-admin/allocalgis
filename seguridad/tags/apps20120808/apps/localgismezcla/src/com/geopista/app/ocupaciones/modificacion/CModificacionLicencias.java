...
package com.geopista.app.ocupaciones.modificacion;
...
import com.geopista.app.ocupaciones.utilidades.*;
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                if (selectedFile != null){
                   ...
                   /** Comprobamos si existe el directorio. */
                    ...
                    boolean resultado = CUtilidadesComponentes.GetURLFile(CConstantesComando.anexosLicenciasUrl + solicitud.getIdSolicitud() + "/" + fileName, tmpFile, "", 0);
                    if (!resultado) {
    ...
    private void generarFicha()
    {
    	try
        {
            ...
            expediente.setSolicitud(solicitud);
           	new GeopistaPrintable().printObjeto(FichasDisponibles.fichalicenciaocupacion, expediente , CExpedienteLicencia.class, CMainOcupaciones.geopistaEditor.getLayerViewPanel(), GeopistaPrintable.FICHA_OCUPACIONES_MODIFICACION);
		} catch (Exception ex) {
            ...
            if (construir) {
              ...
              }catch(Exception e)
              {
               ...
               }catch(Exception e)
               {
                ...
                ocupacionJTabbedPane.setTitleAt(0, com.geopista.app.licencias.CUtilidadesComponentes.annadirAsterisco(CMainOcupaciones.literales.getString("CModificacionLicenciasForm.expedienteJPanel.TitleTab")));
                ocupacionJTabbedPane.setTitleAt(1, com.geopista.app.licencias.CUtilidadesComponentes.annadirAsterisco(CMainOcupaciones.literales.getString("CModificacionLicenciasForm.solicitudJPanel.TitleTab")));
                JTabbedPane jTabbedSolicitud= new JTabbedPane();
