...
import com.geopista.app.ocupaciones.tableModels.CNotificacionesTableModel;
...
public class TareasPendientesJPanel extends javax.swing.JPanel implements IMultilingue {
    ...
    private void aceptarJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarJButtonMouseClicked
        ...
        mainOcupaciones.mostrarJInternalFrame(new com.geopista.app.ocupaciones.modificacion.CModificacionLicencias((JFrame)this.desktopMain, _expedienteSelected.getNumExpediente(), false));
