...
public class General extends  JPanel implements FeatureExtendedPanel {
  ...
  private void jbInit() throws Exception
  {
    ...
    cmbPropiedad = new ComboBoxEstructuras(Estructuras.getListaTiposPropiedad(), null, app.getString(AppContext.GEOPISTA_LOCALE_KEY,"es_ES"), true);
    cmbPropiedad.setSelectedIndex(0);
    
    cmbAprovechamiento = new ComboBoxEstructuras(Estructuras.getListaTiposAprovechamiento(), null, app.getString(AppContext.GEOPISTA_LOCALE_KEY,"es_ES"), true);
