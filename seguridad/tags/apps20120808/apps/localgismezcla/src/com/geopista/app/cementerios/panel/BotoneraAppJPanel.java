...
import com.geopista.app.inventario.panel.BotoneraEditorJPanel;
...
public class BotoneraAppJPanel  extends JPanel{
    ...
    /**
     * Método que genera un panel con la botonera que se muestra en el modulo de cementerio para las aplicaciones cliente
     * @param desktop
     */
...
//    }
    ...
    public void renombrarComponentes(){
        try{consultarJButton.setText(aplicacion.getI18nString("cementerio.botoneraApp.tag1"));}catch(Exception e){}
        try{buscarJButton.setText(aplicacion.getI18nString("cementerio.botoneraApp.tag2"));}catch(Exception e){}
        try{filtrarJButton.setText(aplicacion.getI18nString("cementerio.botoneraApp.tag3"));}catch(Exception e){}
//        try{informesJButton.setText(aplicacion.getI18nString("cementerio.botoneraApp.tag4"));}catch(Exception e){}
//        try{recuperarJButton.setText(aplicacion.getI18nString("cementerio.botoneraApp.tag5"));}catch(Exception e){}
    }

    public void renombrarFiltrarJButton(boolean b){
        filtrarJButton.setIcon(b?com.geopista.app.cementerios.UtilidadesComponentes.iconoOK:null);
    }
