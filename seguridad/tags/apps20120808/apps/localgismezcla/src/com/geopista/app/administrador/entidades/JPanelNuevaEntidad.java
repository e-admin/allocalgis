...
//    private JButton cancelarAniadirEntidadJButton;
    ...
    private void initialize(ResourceBundle messages){
        ...
        this.setPreferredSize(new Dimension(238, 215));
        this.setMaximumSize(new Dimension(238, 215));
        ...
        this.add(backupJCheckBox, new GridBagConstraints(1, 5, 1, 1, 0.0,
                0.0, GridBagConstraints.FIRST_LINE_START, GridBagConstraints.NONE, new Insets(0, 5,
                        5, 5), 0, 0) );
            
        aniadirEntidadListaJButton = new JButton();
        this.add(aniadirEntidadListaJButton, new GridBagConstraints(0, 6, 2, 1, 0.0,
