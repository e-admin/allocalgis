...
public class CUtilidades {
    ...
    public static void crearReportCharSepSource(Vector v, String path, String reportName, String formato) throws Exception{
        ...
        if (new Integer(formato).intValue() == com.geopista.app.contaminantes.init.Constantes.formatoPDF){
        ...
        }else if (new Integer(formato).intValue() == com.geopista.app.contaminantes.init.Constantes.formatoTEXTO){
        ...
        else if(new Integer(formato).intValue() == com.geopista.app.contaminantes.init.Constantes.formatoPREVIEW){
    ...
    public static void crearReportBDSource(Hashtable h, String pathPlantilla, String reportName, String formato, String pathReport, String app) throws Exception{
        ...
        try{
            ...
            if (h.containsKey("PLANTILLA")){
                ...
                logger.debug("***** XMLTemplate="+XMLTemplate.getPath());
                Report r= new Report();
                if ((com.geopista.app.contaminantes.init.Constantes.DriverClassName != null) && (com.geopista.app.contaminantes.init.Constantes.DriverClassName.equalsIgnoreCase("oracle.jdbc.driver.OracleDriver"))){
                    r.setOracle(true);
                }
                ...
                */
                ...
                /** caso 1 */
                Driver dPostgres= (Driver)Class.forName(com.geopista.app.contaminantes.init.Constantes.DriverClassName).newInstance();
                ...
                conn = DriverManager.getConnection(com.geopista.app.contaminantes.init.Constantes.ConnectionInfo, com.geopista.app.contaminantes.init.Constantes.DBUser, com.geopista.app.contaminantes.init.Constantes.DBPassword);
                r.setDatabaseConnection(conn);


                /** caso 2 */
                /*
                r.setDatabasePassword(com.geopista.app.contaminantes.init.Constantes.DBPassword);
                */
                ...
                if (hasDictionary){
                    if (r.isOracle()){
                        ...
                        ColumnField cf= new ColumnField(null, r, section, com.geopista.app.contaminantes.init.Constantes.DBUser.toUpperCase()+"."+"DOMAINNODES.ID_DESCRIPTION", false);
                        section.addField(cf);
                    }
    ...
    public static String addToWhereClause(String app){
        ...
        //"DICTIONARY.LOCALE='" + com.geopista.app.contaminantes.init.Constantes.Locale + "' " +
        ...
        try{
            ...
            for (Enumeration e= vHist.elements(); e.hasMoreElements();){
                try{
                    ...
                    String sTipo="";
                    DomainNode nodeTipo=com.geopista.app.contaminantes.estructuras.Estructuras.getListaTipoMedioambiental().getDomainNode(new Integer(aux.getTipo_medioambiental()).toString());
                    if (nodeTipo!=null)
                      sTipo=nodeTipo.getTerm(com.geopista.app.contaminantes.init.Constantes.Locale);
                    String sAccion="";
                    DomainNode nodeAccion=com.geopista.app.contaminantes.estructuras.Estructuras.getListaTipoAccion().getDomainNode(new Integer(aux.getAccion()).toString());
                    if (nodeAccion!=null)
                       sAccion=nodeAccion.getTerm(com.geopista.app.contaminantes.init.Constantes.Locale);
                    String datos= sFecha + ", " +
    ...
    public static boolean bajarInformeFiles(CPlantilla p, String rutaInforme){
        ...
        try {
            ...
            pathDestino = localPath + aplicacion.REPORT_DIR_NAME + File.separator + rutaInforme;
