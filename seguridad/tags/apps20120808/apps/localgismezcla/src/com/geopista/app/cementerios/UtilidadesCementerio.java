...
import com.geopista.app.inventario.UtilidadesComponentes;
 ...
 */
public class UtilidadesCementerio {
    private static Logger logger = Logger.getLogger(UtilidadesCementerio.class);
    ...
    public static void inicializar(){
        try{
            ClassLoader cl= (new UtilidadesCementerio()).getClass().getClassLoader();
    ...
    public static void setEnabled(boolean b, JFrame desktop) {
        try {
            ...
            if (b){
                ...
                GeopistaAcl acl= com.geopista.security.SecurityManager.getPerfil("Cementerio");
