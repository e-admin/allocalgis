...
public class JDialogDBTable extends JDialog
{
    ...
    private JComboBox getJComboBox()
    {
        if (cmbGeometryType == null)
        {
            ...
            cmbGeometryType.addItem(TablesDBPanel.TAB_GEOMETRY);
            cmbGeometryType.addItem(TablesDBPanel.TAB_POINT);
            cmbGeometryType.addItem(TablesDBPanel.TAB_LINESTRING);
            cmbGeometryType.addItem(TablesDBPanel.TAB_POLYGON);
            cmbGeometryType.addItem(TablesDBPanel.TAB_COLLECTION);
            cmbGeometryType.addItem(TablesDBPanel.TAB_MULTIPOINT);
            cmbGeometryType.addItem(TablesDBPanel.TAB_MULTILINESTRING);
            cmbGeometryType.addItem(TablesDBPanel.TAB_MULTIPOLYGON);
    ...
    {
        if (item.equals(TablesDBPanel.TAB_POINT))
            return Table.POINT;
        else if (item.equals(TablesDBPanel.TAB_LINESTRING))
            return Table.LINESTRING;
        else if (item.equals(TablesDBPanel.TAB_POLYGON))
            return Table.POLYGON;
        else if (item.equals(TablesDBPanel.TAB_COLLECTION))
            return Table.COLLECTION;
        else if (item.equals(TablesDBPanel.TAB_MULTIPOINT))
            return Table.MULTIPOINT;
        else if (item.equals(TablesDBPanel.TAB_MULTILINESTRING))
            return Table.MULTILINESTRING;
        else if (item.equals(TablesDBPanel.TAB_MULTIPOLYGON))
            return Table.MULTIPOLYGON;
        else if (item.equals(TablesDBPanel.TAB_GEOMETRY))
    ...
    {
        if (item ==Table.POINT)
            return TablesDBPanel.TAB_POINT;
        else if (item ==Table.LINESTRING)
            return TablesDBPanel.TAB_LINESTRING;
        else if (item == Table.POLYGON)
            return TablesDBPanel.TAB_POLYGON;
        else if (item == Table.COLLECTION )
            return TablesDBPanel.TAB_COLLECTION;
        else if (item == Table.MULTIPOINT )
            return TablesDBPanel.TAB_MULTIPOINT;
        else if (item == Table.MULTILINESTRING)
            return TablesDBPanel.TAB_MULTILINESTRING;
        else if (item == Table.MULTIPOLYGON)
            return TablesDBPanel.TAB_MULTIPOLYGON;
        else if (item == Table.GEOMETRY)
            return TablesDBPanel.TAB_GEOMETRY;
        else 
