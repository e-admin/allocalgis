   ...
   private void initDatos()
    {
        try
        {
            CResultadoOperacion result= new OperacionesContaminantes(com.geopista.app.contaminantes.init.Constantes.url).getInspectores();
      ...
      public void eliminarInspector(Inspector inspectorEliminado)
    {
           ...
           try
           {
               result=(new OperacionesContaminantes(com.geopista.app.contaminantes.init.Constantes.url)).deleteInspector(inspectorEliminado);
           }catch(Exception e)
           {
    ...
    private void salvar()
    {
        ...
        try
        {
            ...
            try
            {
                result=(new OperacionesContaminantes(com.geopista.app.contaminantes.init.Constantes.url)).saveInspector(auxInspector);
                if (modoNuevo)
