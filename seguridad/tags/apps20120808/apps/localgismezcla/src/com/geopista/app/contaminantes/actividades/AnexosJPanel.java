...
import com.geopista.app.contaminantes.util.ComboBoxTableEditor;
import com.geopista.app.contaminantes.util.TextFieldRenderer;
import com.geopista.app.contaminantes.util.TextFieldTableEditor;
...
Logger logger = Logger.getLogger(AnexosJPanel.class);
        ...
        if (_inspeccion != null){
            if (_inspeccion.getAnexos() != null){
                ...
                while (en.hasMoreElements()) {
                    ...
                    col1.setCellEditor(new ComboBoxTableEditor(new ComboBoxEstructuras(Estructuras.getListaTipoAnexos(), null, com.geopista.app.contaminantes.init.Constantes.Locale.toString(), false)));
                    col1.setCellRenderer(new ComboBoxRendererEstructuras(Estructuras.getListaTipoAnexos(), null, com.geopista.app.contaminantes.init.Constantes.Locale.toString(), false));
                    ...
                    String descTipo= Estructuras.getListaTipoAnexos().getDomainNode(combox.getSelectedPatron()).getTerm(com.geopista.app.contaminantes.init.Constantes.Locale.toString());

                    /** comprobamos que no este marcado como borrado */
                    if (anexo.getEstado() != com.geopista.protocol.contaminantes.CConstantes.CMD_ANEXO_DELETED){
            ...
            if (selectedFiles.length > 0) {
                for (int i = 0; i < selectedFiles.length; i++) {
                    ...
                    if ((_hAnexosAnnadidos.get(selectedFiles[i].getName()) == null)) {
                        ...
                        anexo.setEstado(CConstantes.CMD_ANEXO_ADDED);
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                if (selectedFile != null){
                   ...
                   /** Comprobamos si existe el directorio. */
                    ...
                    boolean resultado = CUtilidades.GetURLFile(CConstantes.anexosActividadesContaminantesUrl + _inspeccion.getId() + "/" + fileName, tmpFile, "", 0);
                    if (!resultado) {
    ...
    public void configureComponents(){
        ...
        abrirJButton.setIcon(com.geopista.app.contaminantes.util.CUtilidades.iconoAbrir);
        annadirJButton.setIcon(com.geopista.app.contaminantes.util.CUtilidades.iconoAdd);
        eliminarJButton.setIcon(com.geopista.app.contaminantes.util.CUtilidades.iconoRemove);
    ...
    public Vector getListaAnexos(){
            ...
            if (!sizeFilesUploadedExceeded(vAnexosUploaded)){
                for (Enumeration e= vAnexosUploaded.elements(); e.hasMoreElements();){
                    ...
                    if ((_hAnexosInspeccion.get(anexo.getFileName()) != null) && (_hAnexosAnnadidos.get(anexo.getFileName()) != null)){
                        ...
                        anexo.setEstado(com.geopista.protocol.contaminantes.CConstantes.CMD_ANEXO_DELETED);
                        ...
                        nuevo.setEstado(com.geopista.protocol.contaminantes.CConstantes.CMD_ANEXO_ADDED);
                        ...
                        */
                        ...
                        anexo.setEstado(com.geopista.protocol.contaminantes.CConstantes.CMD_ANEXO_ADDED);
                        /** -- MultipartPostMethod: comentamos para no enviar el contenido. Enviamos el file directamente. */
                        /*
                        byte[] content = CUtilidades.getBytesFromFile(file);
                        ...
                        */
                        ...
                        if (existente.getEstado() == com.geopista.protocol.contaminantes.CConstantes.CMD_ANEXO_ADDED){
        ...
        while (enumerationElement.hasMoreElements()) {
            ...
            if (hAnexosAux.get(a.getFileName()) == null) {
                a.setEstado(com.geopista.protocol.contaminantes.CConstantes.CMD_ANEXO_DELETED);
                ...
                try {
                    if ((anexo.getPath() != null) && (!anexo.getPath().trim().equalsIgnoreCase(""))){
                        ...
                        if (file.isAbsolute()) {
                            ...
                            if (totalSizeFilesUploaded > com.geopista.app.contaminantes.init.Constantes.totalMaxSizeFilesUploaded){
                                JOptionPane optionPane= new JOptionPane(_messages.getString("AnexosJPanel.Message2")+": " +com.geopista.app.contaminantes.init.Constantes.totalMaxSizeFilesUploaded+" bytes", JOptionPane.ERROR_MESSAGE);
