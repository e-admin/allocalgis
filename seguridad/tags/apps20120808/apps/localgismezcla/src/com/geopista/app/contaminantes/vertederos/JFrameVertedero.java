...
public class JFrameVertedero extends JInternalFrameShowMap implements LayerListener {
			...
			public void featureAdded(FeatureEvent e) {
                ...
                for(Iterator i=features.iterator();i.hasNext();)
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            new OperacionesContaminantes((com.geopista.app.contaminantes.init.Constantes.url)).gestionarHistorico(new Historico(new Integer(vertederoSelected.getId()).intValue(), com.geopista.app.contaminantes.init.Constantes.ADD, com.geopista.app.contaminantes.init.Constantes.VERTEDEROS));
                        }catch(Exception ex){}
	...
	private void salvar() {
		...
		try {
			...
			String sMensaje = "";
			try {
				result = (new OperacionesContaminantes(com.geopista.app.contaminantes.init.Constantes.url)).saveVertedero(jPanelVertedero.getVertedero());
			...
			if (result.getResultado()) {
                ...
                try
                {
                     new OperacionesContaminantes((com.geopista.app.contaminantes.init.Constantes.url)).gestionarHistorico(new Historico(new Integer(vertederoSelected.getId()).intValue(), com.geopista.app.contaminantes.init.Constantes.MODIFICAR, com.geopista.app.contaminantes.init.Constantes.VERTEDEROS));
                }catch(Exception ex){}
	...
	public void eliminar(boolean mostrarMensaje) {
		...
		try {
			result=(new OperacionesContaminantes(com.geopista.app.contaminantes.init.Constantes.url)).deleteVertedero(vertederoSelected);
		...
		if (result.getResultado()) {
            ...
            try
            {
                new OperacionesContaminantes((com.geopista.app.contaminantes.init.Constantes.url)).gestionarHistorico(new Historico(new Integer(vertederoSelected.getId()).intValue(), com.geopista.app.contaminantes.init.Constantes.BORRAR  , com.geopista.app.contaminantes.init.Constantes.VERTEDEROS));
             }catch(Exception ex){}
			vertederoSelected = null;
            if (mostrarMensaje)
            {
    ...
    private Vector actualizarListado(Vertedero vertedero, boolean borrar) {
     ...
     private void  generarFicha()
     {
         try
         {
             ...
             new GeopistaPrintable().printObjeto(FichasDisponibles.fichavertedero, vertederoSelected , Vertedero.class, getGeopistaEditor().getLayerViewPanel(), GeopistaPrintable.FICHA_CONTAMINANTE_VERTEDERO);
         }catch(Exception e)
         {
