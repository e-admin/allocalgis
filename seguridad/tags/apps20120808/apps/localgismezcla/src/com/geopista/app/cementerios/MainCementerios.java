...
public class MainCementerios extends CMain {
    ...
    public MainCementerios(boolean fromInicio) {
        ...
        try{
            ...
            if(SSOAuthManager.isSSOActive()){ 				
 				com.geopista.protocol.CConstantesComando.servletLicenciasUrl = AppContext.getApplicationContext().getString(SSOAuthManager.SSO_SERVER_URL)+"CServletLicencias";
                com.geopista.protocol.CConstantesComando.loginLicenciasUrl = AppContext.getApplicationContext().getString(SSOAuthManager.SSO_SERVER_URL);
                com.geopista.protocol.CConstantesComando.adminCartografiaUrl = AppContext.getApplicationContext().getString(SSOAuthManager.SSO_SERVER_URL);
       	  	}	           
    ...
    private boolean configureApp() {
        try {
            ...
            try{
            		 com.geopista.protocol.CConstantesComando.servletLicenciasUrl = aplicacion.getString("geopista.conexion.servidorurl")+"licencias/CServletLicencias";
                    com.geopista.protocol.CConstantesComando.loginLicenciasUrl = aplicacion.getString("geopista.conexion.servidorurl")+"cementerios";
                    com.geopista.protocol.CConstantesComando.adminCartografiaUrl = aplicacion.getString("geopista.conexion.servidorurl")+"geopista/";
