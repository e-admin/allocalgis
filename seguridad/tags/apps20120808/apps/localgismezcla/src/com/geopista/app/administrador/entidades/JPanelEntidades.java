...
public class JPanelEntidades extends JPanel {
    ...
    public Entidad aniadirEntidad(String nombreEntidad, String srid, boolean isBackup, int aviso, int periodicidad, int intentos) {
    ...
    private void modificarEntidadListaEntidades(String codigoEntidad, String nombreEntidad, String srid) {
        Iterator it = listaEntidades.iterator();
        while (it.hasNext()){
            Entidad entidad = (Entidad)it.next();
            if (entidad.getId().equals(codigoEntidad)){
    ...
    public void modificarEntidad(String codigoEntidad, String nombreEntidad, String srid, boolean isBackup, int aviso, int periodicidad, int intentos) {
        CResultadoOperacion result = null;
        Entidad entidad = null;
        String sMensaje = "";
        if (codigoEntidad != null && !codigoEntidad.equals("")) {
            ...
            if (result.getResultado()) {
                ...
                if (entidadEliminadaCheckBox != null) {
                    ...
                    modificarEntidadListaEntidades(entidad.getId(), entidad.getNombre(), entidad.getSrid());
                    this.repaint();
                    this.invalidate();
                    this.validate();
                }
