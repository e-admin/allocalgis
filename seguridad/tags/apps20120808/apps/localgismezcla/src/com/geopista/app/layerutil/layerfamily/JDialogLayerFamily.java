...
public class JDialogLayerFamily extends JDialog
{
    ...
    private void jButtonAceptar() 
    {
        ...
        if (htDescripciones.get(GestorCapas.DEFAULT_LOCALE)==null)
            htDescripciones.put(GestorCapas.DEFAULT_LOCALE, txtLayerfamilyDescription.getText());
        if (htNombres.get(GestorCapas.DEFAULT_LOCALE)==null)
            htNombres.put(GestorCapas.DEFAULT_LOCALE, txtLayerfamilyName.getText());
    ...
    {           
        ...
        if (htNombres.get(locale)!=null)
            ...
            txtLayerfamilyName.setText(htNombres.get(GestorCapas.DEFAULT_LOCALE).toString());
        else
    ...
    {           
        ...
        if (htDescripciones.get(locale)!=null)
            ...
            txtLayerfamilyDescription.setText(htDescripciones.get(GestorCapas.DEFAULT_LOCALE).toString());
        else
