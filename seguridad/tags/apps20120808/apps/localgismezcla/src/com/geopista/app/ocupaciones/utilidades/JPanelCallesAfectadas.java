...
public class JPanelCallesAfectadas extends javax.swing.JPanel implements IMultilingue{
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jComboBoxTipoVia =new ComboBoxEstructuras(com.geopista.app.ocupaciones.estructuras.Estructuras.getListaTiposViaINE(), null, literales.getLocale().toString());
    ...
    private void imprimirInforme()
    {
        try
        {
            ...
            new GeopistaPrintable().printObjeto(FichasDisponibles.fichacallesafectadas, expediente , CExpedienteLicencia.class, geopistaEditor.getLayerViewPanel(), GeopistaPrintable.FICHA_OCUPACIONES_UTILIDADES);
    } catch (Exception ex) {
