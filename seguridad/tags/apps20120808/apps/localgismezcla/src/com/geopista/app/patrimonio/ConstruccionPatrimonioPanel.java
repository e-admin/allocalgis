...
import com.geopista.ui.plugin.consultarOVCPlugIn;
...
public class ConstruccionPatrimonioPanel extends  JPanel implements FeatureExtendedPanel 
{
  ...
  private void jbInit() throws Exception
  {
    ...
    cmbTipo = new ComboBoxEstructuras(Estructuras.getListaTiposConstruccion(), null, app.getString(AppContext.GEOPISTA_LOCALE_KEY,"es_ES"), true);
    cmbEstado = new ComboBoxEstructuras(Estructuras.getListaEstadosConservacion(), null, app.getString(AppContext.GEOPISTA_LOCALE_KEY,"es_ES"), true);
    cmbMaterial = new ComboBoxEstructuras(Estructuras.getListaTiposMaterial(), null, app.getString(AppContext.GEOPISTA_LOCALE_KEY,"es_ES"), true);
    cmbCubierta = new ComboBoxEstructuras(Estructuras.getListaTiposCubierta(), null, app.getString(AppContext.GEOPISTA_LOCALE_KEY,"es_ES"), true);
    cmbCarpinteria = new ComboBoxEstructuras(Estructuras.getListaTiposCarpinteria(), null, app.getString(AppContext.GEOPISTA_LOCALE_KEY,"es_ES"), true);
