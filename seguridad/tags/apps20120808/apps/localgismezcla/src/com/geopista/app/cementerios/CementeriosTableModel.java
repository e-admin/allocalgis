    ...
    private Object[] getDatosRow(Object obj){
     //   if (!(obj instanceof ElemCementerioBean)) return null;
        ...
        if (obj instanceof UnidadEnterramientoBean){
            ...
            if (elemCementerio.getTipo_tarifa()== Constantes.TARIFA_GPROPIEDAD){
            ...
            Object row[]= new Object[] {
            					...
            					elemCementerio.getTipo_tarifa()==Constantes.TARIFA_GPROPIEDAD? "Tarifa Gestión Propiedades" : "Tarifa Gestión servicios",
            ...
            Object row[]= new Object[] {
            					elemCementerio.getCodigo(),
            					elemCementerio.getFechaInicio(),
            					elemCementerio.getFechaFin(),
