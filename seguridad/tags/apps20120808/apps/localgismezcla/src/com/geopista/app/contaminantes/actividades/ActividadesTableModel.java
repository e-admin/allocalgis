        ...
        public void setModelData(Vector listaActividades) {
            try
            {
                ...
                for (Enumeration e=listaActividades.elements();e.hasMoreElements();) {
                    ...
                    DomainNode tipo=com.geopista.app.contaminantes.estructuras.Estructuras.getListaTipo().getDomainNode(aux.getId_tipo());
                    String sTipo="";
                    if (tipo!=null) sTipo=tipo.getTerm(com.geopista.app.contaminantes.init.Constantes.Locale);
