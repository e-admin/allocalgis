...
//	 */
//	private static String getPathFromUuid(String uuid){
//		Node node = getPropertyFromNode(new AlfrescoKey(uuid,AlfrescoKey.KEY_UUID),Constants.PROP_USER_HOMEFOLDER);
//		if(node != null)
//			return ;
//		return null;
//	}
