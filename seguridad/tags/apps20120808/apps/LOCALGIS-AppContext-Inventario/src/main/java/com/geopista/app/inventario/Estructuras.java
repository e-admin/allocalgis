...
public class Estructuras {
   ...
   public static void cargarListaDominios(){
		...
		try {
		    ...
		    String url= ((AppContext) AppContext.getApplicationContext()).getString("geopista.conexion.servidorurl")+"Administracion";
   ...
   public static void cargarLista(ListaEstructuras lista) throws CancelException{
      ...
      String url= ((AppContext) AppContext.getApplicationContext()).getString("geopista.conexion.servidorurl")+WebAppConstants.INVENTARIO_WEBAPP_NAME;      
