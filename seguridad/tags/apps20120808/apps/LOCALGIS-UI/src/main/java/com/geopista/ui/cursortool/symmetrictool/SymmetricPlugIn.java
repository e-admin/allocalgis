...
public class SymmetricPlugIn extends AbstractPlugIn
{
    private boolean selectSymmetricButtonAdded = false;
    ...
    {
        if (!selectSymmetricButtonAdded)
        {
            toolbox.add(new SymmetricTool(null));
            toolbox.finishAddingComponents();
            toolbox.validate();
            selectSymmetricButtonAdded = true;
        }
    }
}
