...
public abstract class ConstrainedMultiClickArcTool extends ConstrainedMultiClickTool
{
    ...
    protected Shape getShape() throws NoninvertibleTransformException
    {
        if (coordinates.size() > 1)
        {
            ...
            double length = firstCoordinate.distance(secondCoordinate);
            DecimalFormat df2 = new DecimalFormat("##0.0#");
            DecimalFormat df3 = new DecimalFormat("###,###,##0.0##");
            getPanel().getContext().setStatusMessage(I18N.get("ConstrainedMultiClickTool","length") + ": " + df3.format(length) + ";  " + I18N.get("ConstrainedMultiClickTool","angle") + ": " + df2.format(fullAngle) + " " + I18N.get("ConstrainedMultiClickTool","degrees"));
        ...
        {
        	Coordinate firstCoordinate = (Coordinate) coordinates.get(0);
        	double length = firstCoordinate.distance(tentativeCoordinate);
            DecimalFormat df2 = new DecimalFormat("##0.0#");
            DecimalFormat df3 = new DecimalFormat("###,###,##0.0##");
            double angle = 0;
