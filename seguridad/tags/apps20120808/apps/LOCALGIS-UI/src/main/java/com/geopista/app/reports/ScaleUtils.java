...
public class ScaleUtils {
	...
	public static Envelope getReportPrintEnvelope(LayerViewPanel layerViewPanel, 
	...
	public static double getReportPrintEnvelopeScale(LayerViewPanel layerViewPanel, 
			int imageHeight, int imageWidth) {
