...
/**
 *
 * Esta clase envuelve a la clase FeatureCollection, encargandose
 * de notificar los eventos que sobre esta se producen a los 'escuchadores'
 * registrados.
 * Los tipos de eventos que se encarga de notificar un FeatureCollectionWrapper son:
 * a) Features añadidos
 * b) Features quitados.
 * c)
 *
 *
 * A wrapper for a FeatureCollection; the original FeatureCollection may be
 * obtained using the #getWrappee method.
 * <p>
