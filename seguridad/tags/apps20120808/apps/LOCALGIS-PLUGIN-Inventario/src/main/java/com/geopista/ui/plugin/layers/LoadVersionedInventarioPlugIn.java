...
public class LoadVersionedInventarioPlugIn extends AbstractPlugIn {
	...
	public boolean seleccionVersion(PlugInContext context) throws Exception {
        InventarioInternalFrame jFrame = (InventarioInternalFrame)((MainInventario)((WorkbenchGuiComponent) context.getWorkbenchContext().getIWorkbench().getGuiComponent()).getMainFrame()).getIFrame();
