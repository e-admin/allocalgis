...
package com.geopista.ui.plugin.inventario.edit.compare.geometries.images;
	...
	public static ImageIcon icon(String filename) {
		...
		try {
			...
			if (logger.isInfoEnabled()) {
				logger.info("icon(String) - Falta el recurso imagen:"
						+ filename, ex);
			}

			URL url = IconLoader.class.getResource("comparegeometries.gif");
			if (url != null)
				im = new ImageIcon(url);
