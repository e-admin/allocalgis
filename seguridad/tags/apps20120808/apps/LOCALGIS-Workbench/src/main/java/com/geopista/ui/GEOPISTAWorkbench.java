...
public class GEOPISTAWorkbench implements JUMPWorkbench, LayerListener{
    ...
    private static String imagePath = appContext.getUserPreference(AppContext.PREFERENCES_DATA_PATH_KEY,AppContext.DEFAULT_DATA_PATH,false);
    private static String icono = appContext.getUserPreference(AppContext.PREFERENCES_APPICON_KEY,null,false);
...
//splashImage=APP_ICON;
    ...
    private static ImageIcon APP_ICON = 
    		appContext.getUserPreference(AppContext.PREFERENCES_APPICON_KEY,null,false)==null?
    				IconLoader.icon("app-icon.gif"):
    				new javax.swing.ImageIcon(appContext.getUserPreference(AppContext.PREFERENCES_DATA_PATH_KEY,AppContext.DEFAULT_DATA_PATH,false)+
    						appContext.getUserPreference(AppContext.PREFERENCES_APPICON_KEY,null,false));
...
//azabala. esto lo he añadido yo
       ...
       */
       ...
       //obtenemos el valor por defecto del usaurio para el Escalado  de pintado
        ...
        String scalePaint = appContext.getUserPreference(SLDStyleImpl.SYMBOLIZER_SIZES_REFERENCE_SCALE,null,false);
	...
	public static void main(String[] args) {
        try {
            ...
            String nameIcon=appContext.getUserPreference(AppContext.PREFERENCES_APPICON_KEY,null,false);
            String pathIcon=appContext.getUserPreference(AppContext.PREFERENCES_DATA_PATH_KEY,AppContext.DEFAULT_DATA_PATH,false);
