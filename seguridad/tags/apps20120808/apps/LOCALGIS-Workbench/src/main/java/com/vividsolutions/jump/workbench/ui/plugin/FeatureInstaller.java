...
public class FeatureInstaller {
  ...
  private interface Menu {
    ...
    private int index = Integer.parseInt(appContext.getUserPreference("menu.fuente","0",true));
    ...
    public FeatureInstaller(WorkbenchContext workbenchContext) {
        ...
        try
        {
            tamanno = Integer.parseInt(appContext.getUserPreference("menu.tamanno","12",true));
        }catch(Exception e)
        {}
    }
