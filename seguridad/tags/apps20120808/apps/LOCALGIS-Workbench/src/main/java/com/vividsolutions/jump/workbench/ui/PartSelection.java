...
public class PartSelection extends AbstractSelection implements IPartSelection {

    /* (non-Javadoc)
	 * @see com.vividsolutions.jump.workbench.ui.IPartSelection#items(com.vividsolutions.jts.geom.Geometry)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.vividsolutions.jump.workbench.ui.IPartSelection#getRendererContentID()
	 */
    @Override
