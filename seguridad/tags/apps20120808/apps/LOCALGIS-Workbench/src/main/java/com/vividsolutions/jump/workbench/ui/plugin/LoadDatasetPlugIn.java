...
public class LoadDatasetPlugIn extends ThreadedBasePlugIn {
    ...
    public void initialize(PlugInContext context) throws Exception {
        addLayerDialog = new DriverDialog(GeopistaFunctionUtils.getFrame(context.getWorkbenchGuiComponent()),
                "Load Dataset", true);
    ...
    public void run(TaskMonitor monitor, PlugInContext context)
        ...
        inputDriver.input((LayerManager)context.getLayerManager(), categoryName);
    }
}
