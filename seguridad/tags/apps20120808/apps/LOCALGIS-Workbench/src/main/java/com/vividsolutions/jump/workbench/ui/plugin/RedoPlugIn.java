...
public class RedoPlugIn extends AbstractPlugIn
{
    ...
    {
        context.getWorkbenchContext().getIWorkbench().getGuiComponent().getToolBar().addPlugIn(
                this.getIcon(), this,
        ...
        featureInstaller.addMainMenuItem(this, GeopistaFunctionUtils.i18n_getname("Edit"),
        		GeopistaFunctionUtils.i18n_getname(this.getName()), GUIUtil.toSmallIcon(this
                        .getIcon()), createEnableCheck(context.getWorkbenchContext()));
        featureInstaller.addMenuSeparator(GeopistaFunctionUtils.i18n_getname("Edit")); // ===================
    ...
    public boolean execute(PlugInContext context) throws Exception
    {
        ...
        /*LayerManager layerManager = ((LayerManagerProxy) context.getWorkbenchContext()
                .getIWorkbench().getGuiComponent().getActiveInternalFrame()).getLayerManager();*/
        layerManager.getUndoableEditReceiver().getUndoManager().redo();
        ...
        if (layerManager.getUndoableEditReceiver().isAborted())
        {
                ...
                new EnableCheck()
                    {
                        public String check(JComponent component)
                        {
                        	...
                        	/*UndoManager undoManager = ((LayerManagerProxy) workbenchContext
                                    .getIWorkbench().getGuiComponent().getActiveInternalFrame())
                                    .getLayerManager().getUndoableEditReceiver()
                                    .getUndoManager();*/
                            component.setToolTipText(undoManager
