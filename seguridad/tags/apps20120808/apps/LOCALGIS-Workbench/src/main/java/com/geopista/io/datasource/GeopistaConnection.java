...
public class GeopistaConnection implements Connection, IGeopistaConnection
{
	...
	public FeatureCollection executeQueryLayer(String query, Collection exceptions, TaskMonitor monitor, GeopistaLayer localLayer)
    {
	...
	public List loadFeatures(GeopistaLayer localLayer, Object[] featureIds)
    {
        try
        {
