...
public class SchemaTableModel extends ColumnBasedTableModel {
    ...
    public final static String FIELD_NAME_COLUMN_NAME = AppContext.getMessage("SchemaTableModel.FieldName");
    public final static String DATA_TYPE_COLUMN_NAME = AppContext.getMessage("SchemaTableModel.DataType");
