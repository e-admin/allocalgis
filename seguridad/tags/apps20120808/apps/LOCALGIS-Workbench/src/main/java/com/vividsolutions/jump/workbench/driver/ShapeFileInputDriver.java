...
/**
 * Driver para tomar datos de archivos ShapeFile.<br>
 *
 * Mantiene una referencia al consumidor de datos (ShapefileReader)
 * y un panel que permite seleccionar ficheros shape. (panel.getSelectedFile())
 *
 * */
public class ShapeFileInputDriver extends AbstractInputDriver {
    ...
    public void input(LayerManager layerManager, String categoryName)
        ...
        ILayer layer = layerManager.addLayer(categoryName, name,
                featureCollection);
    }
