...
public class ACLayer implements Serializable, IACLayer{
	 ...
	 */
	@Override
	public GeopistaLayer convert(LayerManager layerManager){
	 ...
	 */
	@Override
	public void applyStyle(GeopistaLayer gpLayer,LayerManager layerManager,String sXML){
    ...
    public static String findPrimaryTable(GeopistaLayer layer){
        String sRet=null;
        try{
