...
public class AbastecimientoAutonomoPanel extends JPanel implements FeatureExtendedPanel
{
    ...
    public void loadData(AbastecimientoAutonomoEIEL elemento)
    {
        if (elemento!=null)
        {
        	...
        	jComboBoxProvincia.setSelectedItem(ConstantesLocalGISEIEL.idProvincia);
        	
        	jComboBoxMunicipio.setSelectedItem(ConstantesLocalGISEIEL.idMunicipio.substring(2));
        }
    }
