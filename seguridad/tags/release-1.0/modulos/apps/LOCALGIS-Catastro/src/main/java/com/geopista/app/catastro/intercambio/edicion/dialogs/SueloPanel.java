...
public class SueloPanel extends JPanel implements FeatureExtendedPanel
{
        ...
        if(suelo!=null)
        {
            ...
            if (suelo.getDatosEconomicos().getZonaUrbanistica().getCodZona() != null &&
            	...
            	try {
					...
					PonenciaUrbanistica ponenciaUrbanistica = ConstantesRegistroExp.clienteCatastro.obtenerPonenciaUrbanistica(suelo.getDatosEconomicos().getZonaUrbanistica().getCodZona());
            ...
            if (suelo.getDatosEconomicos().getTramos() != null && suelo.getDatosEconomicos().getTramos().getCodTramo() != null &&
            	...
            	try {
					...
					PonenciaTramos ponenciaTramos = ConstantesRegistroExp.clienteCatastro.obtenerPonenciaTramos(suelo.getDatosEconomicos().getTramos().getCodTramo());
    ...
    private JPanel getJPanelDatosFisicos()
    {
        if (jPanelDatosFisicos == null)
        {
            ...
            jPanelDatosFisicos.add(jLabelSuperficie, new GridBagConstraints(0, 0, 1, 1, 0.1, 0, GridBagConstraints.CENTER,GridBagConstraints.HORIZONTAL, new Insets (0,5,0,5), 0,0));
            jPanelDatosFisicos.add(jLabelFondo, new GridBagConstraints(1, 0, 1, 1, 0.1, 0, GridBagConstraints.CENTER,GridBagConstraints.HORIZONTAL, new Insets (0,5,0,5), 0,0));
            jPanelDatosFisicos.add(getJTextFieldSuperficie(), new GridBagConstraints(0, 1, 1, 1, 0.1, 0, GridBagConstraints.CENTER,GridBagConstraints.HORIZONTAL, new Insets (0,5,0,5), 0,0));
            jPanelDatosFisicos.add(getJTextFieldFondo(), new GridBagConstraints(1, 1, 1, 1, 0.1, 0, GridBagConstraints.CENTER,GridBagConstraints.HORIZONTAL, new Insets (0,5,0,5), 0,0));
