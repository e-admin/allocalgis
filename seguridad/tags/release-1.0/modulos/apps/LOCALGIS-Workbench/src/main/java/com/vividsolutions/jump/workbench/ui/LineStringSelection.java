...
public class LineStringSelection extends AbstractSelection implements ILineStringSelection {
    /* (non-Javadoc)
	 * @see com.vividsolutions.jump.workbench.ui.ILineStringSelection#items(com.vividsolutions.jts.geom.Geometry)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.vividsolutions.jump.workbench.ui.ILineStringSelection#getRendererContentID()
	 */
    @Override
