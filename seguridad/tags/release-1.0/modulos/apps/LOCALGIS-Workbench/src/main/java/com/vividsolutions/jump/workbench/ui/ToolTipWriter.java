 ...
 */
public class ToolTipWriter implements IToolTipWriter {
    private boolean enabled = false;
    private ILayerViewPanel panel;
    /* (non-Javadoc)
	 * @see com.vividsolutions.jump.workbench.ui.IToolTipWriter#isEnabled()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.vividsolutions.jump.workbench.ui.IToolTipWriter#setEnabled(boolean)
	 */
    @Override
	public void setEnabled(boolean enabled) {
        this.enabled = enabled;
    }
    public ToolTipWriter(ILayerViewPanel panel) {
        this.panel = panel;
    }
    /* (non-Javadoc)
	 * @see com.vividsolutions.jump.workbench.ui.IToolTipWriter#write(java.lang.String, java.awt.geom.Point2D)
	 */
    @Override
