...
public class CConsultaLicencias extends javax.swing.JInternalFrame implements IMultilingue{
    ...
    private void generarFicha()
    {
        try
        {
            ...
            expedienteLicencia.setEstructuraTipoLicencia(Estructuras.getListaTiposLicenciaActividad());
               ...
               new GeopistaPrintable().printObjeto(FichasDisponibles.fichalicenciaactividad, expedienteLicencia , CExpedienteLicencia.class, MainActividadLicencias.geopistaEditor.getLayerViewPanel(), GeopistaPrintable.FICHA_LICENCIAS_ACTIVIDAD_CONSULTA);
        } catch (Exception ex) {
	...
	private void modificarJButtonActionPerformed() {//GEN-FIRST:event_modificarJButtonActionPerformed
		...
		com.geopista.app.licencias.actividad.CModificacionLicencias modificacionLicencias = new com.geopista.app.licencias.actividad.CModificacionLicencias(desktop, numExpedienteJTField.getText(),literales, false);
