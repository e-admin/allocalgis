 ...
 * Time: 15:56:49
 */
public class GeopistaPrintableLicenciasActividad extends javax.swing.JPanel implements Printable{
    private static Logger logger = Logger.getLogger(GeopistaPrintableLicenciasActividad.class);
        ...
        try
        {
            switch (tipoFicha) {
                ...
                case FICHA_LICENCIAS_ACTIVIDAD_MODIFICACION:
                    rbI18N = com.geopista.app.licencias.actividad.MainActividadLicencias.literales;
                    break;
                                            ...
                                            for (Enumeration _e=hDomainNodes.elements();_e.hasMoreElements();)
                                            {
                                                ...
                                                if (auxDomain.getPatron().equalsIgnoreCase(sValor)) {
                                                    if ((tipoFicha==FICHA_LICENCIAS_ACTIVIDAD_CONSULTA) || (tipoFicha==FICHA_LICENCIAS_ACTIVIDAD_MODIFICACION))
                                                        sValor = auxDomain.getTerm(com.geopista.app.licencias.actividad.MainActividadLicencias.literales.getLocale().toString());
                                                    else
                                                        sValor = auxDomain.getTerm(com.geopista.app.licencias.CMainLicencias.literales.getLocale().toString());
                                                }
                                            }
    ...
    public void printObjeto(String urlXml, Object objeto, Class clase, Image plano, int tipoFicha) throws Exception
    {
        this.tipoFicha = tipoFicha;
            ...
            this.clase=clase;
             ...
             ClassLoader cl =(new GeopistaPrintableLicenciasActividad()).getClass().getClassLoader();
