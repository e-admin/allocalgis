...
public class CMainMetadatos extends CMain implements IConnection {
	...
	private boolean configureApp() {
		...
		try {
            ...
            try{
                   ...
                   com.geopista.app.metadatos.init.Constantes.url= app.getString("geopista.conexion.servidorurl")+ WebAppConstants.METADATOS_WEBAPP_NAME;
                   com.geopista.app.metadatos.init.Constantes.Locale = app.getString(AppContext.GEOPISTA_LOCALE_KEY,"es_ES");
                   try{com.geopista.app.metadatos.init.Constantes.idMunicipio=new Integer(app.getString("geopista.DefaultCityId")).intValue();
                   }catch (Exception e){
