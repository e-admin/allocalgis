       ...
       private org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(GetPlantillas.class);
            public void doPost (HttpServletRequest request, HttpServletResponse response)
               ...
               try{
                   ...
                   logger.error("Excepción al conseguir las plantillas:"+sw.toString());
                   resultado=new CResultadoOperacion(false, "Excepción al conseguir las plantillas:"+e.toString());
               }
