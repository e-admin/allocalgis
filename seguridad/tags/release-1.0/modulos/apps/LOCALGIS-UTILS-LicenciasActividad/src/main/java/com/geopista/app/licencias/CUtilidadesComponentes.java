...
public class CUtilidadesComponentes {
	...
	public static ILayerManager getLayerManagerFromFile(Layer layer, String fileName) throws Exception {
...
//			Layer auxLayer=(Layer)categoria.getLayerManager().getLayers().iterator().next();
    ...
    */
    ...
    public static String getCabeceraFicha(CExpedienteLicencia expediente, CSolicitudLicencia solicitud,
        ...
        }else if (solicitud.getTipoLicencia().getIdTipolicencia() == CConstantesLicencias.Actividades || solicitud.getTipoLicencia().getIdTipolicencia() == CConstantesLicenciasActividad.ActividadesNoCalificadas){
