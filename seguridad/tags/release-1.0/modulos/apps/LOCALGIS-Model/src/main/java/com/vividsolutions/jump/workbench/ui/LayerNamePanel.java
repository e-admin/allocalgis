...
public interface LayerNamePanel extends LayerManagerProxy {
    ...
    public void selectLayerables(Layerable[] layers); // to synchronize different panels.
    
    public void setTargetSelectedLayers(Layerable[] layers); // to synchronize different panels.
    /**
