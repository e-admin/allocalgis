...
public abstract class AbstractLayerable implements Layerable {
    ...
    public AbstractLayerable(String name, ILayerManager layerManager) {
...
public Image createImage(ILayerViewPanel layerViewPanel) throws IOException {
	// TODO Auto-generated method stub
	return null;
}

public Rectangle getDrawingRectangle(double imgWidth, double imgHeight,
		Envelope imageEnv, IViewport viewport)
