...
/**
 * Esta clase guarda propiedades de un Driver de entrada salida en forma campo-valor.
 * Para los drivers basados en fichero, la propiedad por defecto, 'DefaultValue' es
 * la ruta del fichero que lee por defecto.
 * La propiedad 'File' es el fichero a leer.
 * Etc. Etc
 *
 *
