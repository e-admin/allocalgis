...
public class FeatureDataset implements FeatureCollection {
    ...
    /**
     * En este caso, como todo esta en memoria, devolvemos el iterador del
     * List obtenido por query.
     * (No hay ganancia visible)
     * */
    public Iterator queryIterator(Envelope env){
      return query(env).iterator();
    }
     ...
     */
    public void clear() {
    	//System.out.println("Borrando FEATURES de FeatureDataSet");
        invalidateEnvelope();
        features.clear();
    }
    ...
    public void removeAll(Collection features) {
    	//System.out.println("FeatureDataSet.removeAll");
