//$HeadURL: https://svn.wald.intevation.org/svn/deegree/base/trunk/src/org/deegree/model/filterencoding/ArithmeticExpression.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class ArithmeticExpression extends Expression {
    ...
    public Object evaluate( Feature feature )
        ...
        case ExpressionDefines.DIV:
            return new Double( d1 / d2 );
        default: {
            throw new FilterEvaluationException( "Unknown ArithmeticExpression: '"
                                                 + getExpressionName() + "'!" );
        }
        }
    }
 ...
 *** empty log message ***
 ...
 Revision 1.15  2007/03/19 08:41:22  wanhoff
 Fixed Javadoc (@param, @return, @throws)
