   ...
   /**
	...
	private void publicarJButtonActionPerformed() {
		...
		if ((CConstantesLicencias_LCGIII.persona != null) && (CConstantesLicencias_LCGIII.persona.getDniCif() != null)) {
            DNIPromotorJTField.setText(CConstantesLicencias_LCGIII.persona.getDniCif());
            ...
            faxPromotorJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getFax());
            telefonoPromotorJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getTelefono());
            movilPromotorJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getMovil());
            ...
            numeroViaPromotorJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getNumeroVia());
            ...
            try{
                cPostalPromotorJTField.setNumber(new Integer(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getCpostal()));
            ...
            CConstantesLicencias_LCGIII.promotor= CConstantesLicencias_LCGIII.persona;
	...
	private void buscarDNITecnicoJButtonActionPerformed() {//GEN-FIRST:event_buscarDNITecnicoJButtonActionPerformed
		...
		if ((CConstantesLicencias_LCGIII.persona != null) && (CConstantesLicencias_LCGIII.persona.getDniCif() != null)) {
            DNITecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getDniCif());
            nombreTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getNombre());
            apellido1TecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getApellido1());
            apellido2TecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getApellido2());
            colegioTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getColegio());
            visadoTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getVisado());
            titulacionTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getTitulacion());
            faxTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getFax());
            telefonoTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getTelefono());
            movilTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getMovil());
            emailTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getEmail());
            try{
                tipoViaNotificacionTecnicoEJCBox.setSelectedPatron(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getTipoVia());
            }catch (Exception e){
                DomainNode auxNode=Estructuras.getListaTiposViaINE().getDomainNodeByTraduccion(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getTipoVia());
                if (auxNode!=null)
            ...
            try{
                viaNotificacionTecnicoEJCBox.setSelectedPatron(new Integer(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getViaNotificacion().getIdViaNotificacion()).toString());
            }catch (Exception e){
                DomainNode auxNode=Estructuras.getListaViasNotificacion().getDomainNodeByTraduccion(new Integer(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getViaNotificacion().getIdViaNotificacion()).toString());
                if (auxNode!=null)
            ...
            nombreViaTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getNombreVia());
            numeroViaTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getNumeroVia());
            plantaTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getPlanta());
            portalTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getPortal());
            escaleraTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getEscalera());
            letraTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getLetra());
            try{
                cPostalTecnicoJTField.setNumber(new Integer(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getCpostal()));
            }catch(Exception e){cPostalTecnicoJTField.setText("");}
            municipioTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getMunicipio());
            provinciaTecnicoJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getProvincia());
            if (CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getNotificar().equalsIgnoreCase("1"))
                notificarTecnicoJCheckBox.setSelected(true);
            else notificarTecnicoJCheckBox.setSelected(false);

            CConstantesLicencias_LCGIII.tecnico= CConstantesLicencias_LCGIII.persona;
	...
	private void buscarDNIRepresentanteJButtonActionPerformed() {//GEN-FIRST:event_buscarDNIRepresentanteJButtonActionPerformed
		...
		if ((CConstantesLicencias_LCGIII.persona != null) && (CConstantesLicencias_LCGIII.persona.getDniCif() != null)) {
            ...
            DNIRepresentanteJTField.setText(CConstantesLicencias_LCGIII.persona.getDniCif());
            ...
            faxRepresentanteJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getFax());
            telefonoRepresentanteJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getTelefono());
            movilRepresentanteJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getMovil());
            ...
            numeroViaRepresentanteJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getNumeroVia());
            ...
            try{
                cPostalRepresentanteJTField.setNumber(new Integer(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getCpostal()));
            ...
            CConstantesLicencias_LCGIII.representante= CConstantesLicencias_LCGIII.persona;
	...
	private void buscarDNIPropietarioJButtonActionPerformed() {//GEN-FIRST:event_buscarDNIPropietarioJButtonActionPerformed
		...
		if ((CConstantesLicencias_LCGIII.persona != null) && (CConstantesLicencias_LCGIII.persona.getDniCif() != null)) {
            DNIPropietarioJTField.setText(CConstantesLicencias_LCGIII.persona.getDniCif());
            ...
            faxPropietarioJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getFax());
            telefonoPropietarioJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getTelefono());
            movilPropietarioJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getMovil());
            ...
            numeroViaPropietarioJTField.setText(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getNumeroVia());
            ...
            try{
                cPostalPropietarioJTField.setNumber(new Integer(CConstantesLicencias_LCGIII.persona.getDatosNotificacion().getCpostal()));
            ...
            */
            if ((CConstantesLicencias_LCGIII.representante != null) || (_DNI_CIF_Representante.trim().length() > 0)){
                if (CConstantesLicencias_LCGIII.representante != null){
                    /** caso 1 */
                   logger.debug("************** 1.- Se ha asignado un representante de BD ID="+CConstantesLicencias_LCGIII.representante.getIdPersona());
            ...
            if ((CConstantesLicencias_LCGIII.representante != null) || (_DNI_CIF_Representante.trim().length() > 0)){
                if (CConstantesLicencias_LCGIII.representante != null){
                    /** caso 1 */
                    logger.debug("************** 4.- Se ha asignado un representante de BD ID="+CConstantesLicencias_LCGIII.representante.getIdPersona());
                   representante.setIdPersona(CConstantesLicencias_LCGIII.representante.getIdPersona());
                }else{
                    /** caso 2 */
    ...
    public CPersonaJuridicoFisica modificarTecnico(CPersonaJuridicoFisica persona){
        ...
        if ((_solicitud.getTecnicos() != null) && (_solicitud.getTecnicos().size() > 0) && (_solicitud.getIdTecnicoToDelete() == -1)) {
            ...
            */
            if ((CConstantesLicencias_LCGIII.tecnico != null) || (_DNI_CIF_Tecnico.trim().length() > 0)){
                if (CConstantesLicencias_LCGIII.tecnico != null){
                    /** caso 1 */
                   logger.debug("************** 1.- Se ha asignado un tecnico de BD ID="+CConstantesLicencias_LCGIII.tecnico.getIdPersona());
                   tecnico.setIdPersona(CConstantesLicencias_LCGIII.tecnico.getIdPersona());
                }else{
                    /** caso 2 */
            ...
            if ((CConstantesLicencias_LCGIII.tecnico != null) || (_DNI_CIF_Tecnico.trim().length() > 0)){
                if (CConstantesLicencias_LCGIII.tecnico != null){
                    /** caso 1 */
                    logger.debug("************** 4.- Se ha asignado un tecnico de BD ID="+CConstantesLicencias_LCGIII.tecnico.getIdPersona());
                    tecnico.setIdPersona(CConstantesLicencias_LCGIII.tecnico.getIdPersona());
                }else{
                    /** caso 2 */
    ...
    public CPersonaJuridicoFisica modificarPromotor(CPersonaJuridicoFisica persona){
        ...
        if ((_solicitud.getPromotor() != null) && (_solicitud.getIdPromotorToDelete() == -1)) {
            ...
            */
            if ((CConstantesLicencias_LCGIII.promotor != null) || (_DNI_CIF_Promotor.trim().length() > 0)){
                if (CConstantesLicencias_LCGIII.promotor != null){
                    /** caso 1 */
                   logger.debug("************** 1.- Se ha asignado un tecnico de BD ID="+CConstantesLicencias_LCGIII.promotor.getIdPersona());
                   promotor.setIdPersona(CConstantesLicencias_LCGIII.promotor.getIdPersona());
                }else{
                    /** caso 2 */
            ...
            if ((CConstantesLicencias_LCGIII.promotor != null) || (_DNI_CIF_Promotor.trim().length() > 0)){
                if (CConstantesLicencias_LCGIII.promotor != null){
                    /** caso 1 */
                    logger.debug("************** 4.- Se ha asignado un promotor de BD ID="+CConstantesLicencias_LCGIII.promotor.getIdPersona());
                    promotor.setIdPersona(CConstantesLicencias_LCGIII.promotor.getIdPersona());
                }else{
                    /** caso 2 */
