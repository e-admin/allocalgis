...
public class MainActividad extends CMain implements IMainLicencias
 {
	...
	public MainActividad(boolean fromInicio) {
		COperacionesLicencias.webappContext = "/" + WebAppConstants.LICENCIAS_ACTIVIDAD_WEBAPP_NAME +
	...
	private boolean configureApp() {
		...
		try {
            ...
            try{
                   ...
                   com.geopista.protocol.CConstantesComando.servletLicenciasUrl = app.getString("geopista.conexion.servidorurl") + WebAppConstants.LICENCIAS_ACTIVIDAD_WEBAPP_NAME + ServletConstants.CSERVLETLICENCIAS_SERVLET_NAME;
                   com.geopista.protocol.CConstantesComando.anexosLicenciasUrl = app.getString("geopista.conexion.servidorurl")+"anexos/licencias/";
                   com.geopista.protocol.CConstantesComando.loginLicenciasUrl = app.getString("geopista.conexion.servidorurl") + WebAppConstants.LICENCIAS_ACTIVIDAD_WEBAPP_NAME;
