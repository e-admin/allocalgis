...
import com.geopista.app.contaminantes.JFrameArbolado;
import com.geopista.app.contaminantes.JFrameInformes;
import com.geopista.app.contaminantes.JFrameInformesVertedero;
import com.geopista.app.contaminantes.JFrameContaminantes;
...
import com.geopista.app.contaminantes.JFrameVertedero;
import com.geopista.app.AppContext;
import com.geopista.app.AppContextMap;
import com.geopista.app.administrador.init.Constantes;
import com.geopista.app.contaminantes.JFrameGeneracionPlanos;
	...
	public CMainContaminantes(boolean fromInicio) {
		...
		try {
			...
			if(SSOAuthManager.isSSOActive())
				com.geopista.app.contaminantes.Constantes.url = AppContext.getApplicationContext().getString(SSOConstants.SSO_SERVER_URL);
		...
		try {
			...
			//*******************************************************
	         try{
                   ...
                   com.geopista.app.contaminantes.Constantes.url= app.getString("geopista.conexion.servidorurl")+"contaminantes/";
                   ...
                   com.geopista.protocol.CConstantesComando.servidorUrl= app.getString("geopista.conexion.servidorurl");


                   com.geopista.protocol.contaminantes.CConstantes.anexosActividadesContaminantesUrl=app.getString("geopista.conexion.servidorurl")+"anexos/contaminantes/";
                   com.geopista.app.contaminantes.Constantes.Locale = app.getString(AppContext.GEOPISTA_LOCALE_KEY,"es_ES");
                   try{com.geopista.app.contaminantes.Constantes.idMunicipio=new Integer(app.getString("geopista.DefaultCityId")).intValue();
                   }catch (Exception e){
                 ...
                 try{
                     com.geopista.app.contaminantes.Constantes.totalMaxSizeFilesUploaded= new Long(app.getString("geopista.anexos.totalMaxSizeFilesUploaded")).longValue();
                 }catch(Exception ex){
                 ...
                 com.geopista.app.contaminantes.Constantes.DriverClassName = app.getString("conexion.driver");
                 com.geopista.app.contaminantes.Constantes.ConnectionInfo = app.getString("conexion.url");
                 com.geopista.app.contaminantes.Constantes.DBUser = app.getString("conexion.user");
                 //com.geopista.app.contaminantes.Constantes.DBPassword = app.getString("conexion.pass");
                 com.geopista.app.contaminantes.Constantes.DBPassword=app.getUserPreference("conexion.pass","",false);
...
//        setIconImage(img);
	...
	private void showInformes() {
		...
		try
            ...
            {
                messages = ResourceBundle.getBundle("config.contaminantes", new Locale(Constantes.LOCALE_CASTELLANO));
            }jFrameInformesArbolado = new com.geopista.app.contaminantes.JFrameInformes(messages, this);
     ...
     public boolean mostrarAyuda()
    {
        ...
        try
        {
                String helpSetFile = "help/contaminantes/GeopistaHelpContaminantes_" + com.geopista.app.contaminantes.Constantes.Locale + ".hs";
        		...
        		if (url == null)//tomamos el idioma castellano por defecto
                {
                    ...
                    helpSetFile = "help/contaminantes/GeopistaHelpContaminantes_" + com.geopista.app.contaminantes.Constantes.LOCALE_CASTELLANO + ".hs";
