...
//        return null;
    ...
    private void reColorearBloqueo(){
          ...
          for (int i=0; i < tableSorted.getRowCount(); i++){
              ...
              if (bb != null && bb.getBloqueado()!=null && !bb.getBloqueado().equalsIgnoreCase(com.geopista.security.SecurityManager.getPrincipal()!=null?com.geopista.security.SecurityManager.getPrincipal().getName():AppContext.getApplicationContext().getUserPreference(AppContext.USER_LOGIN,null,false))){
