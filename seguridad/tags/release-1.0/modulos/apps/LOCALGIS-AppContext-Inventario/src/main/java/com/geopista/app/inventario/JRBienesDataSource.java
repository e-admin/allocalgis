...
public class JRBienesDataSource {
    ...
    private static Object getDocumentoValue(JRField field, BienBean bien) throws Exception{
        if (field == null) return null;
        Object value= null;
        DocumentClient documentClient= new DocumentClient(((AppContext) AppContext.getApplicationContext()).getString(AppContext.GEOPISTA_CONEXION_ADMINISTRADORCARTOGRAFIA) +
