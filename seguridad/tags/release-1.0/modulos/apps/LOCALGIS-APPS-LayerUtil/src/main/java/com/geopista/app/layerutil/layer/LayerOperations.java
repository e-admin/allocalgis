...
public class LayerOperations
{
    ...
    {   
        ...
        try
        {
            ...
            //delete from columns_domains where id_column=? and id_domain=? 
    ...
    {   
        ...
        try{
        	...
        	if (!existeSecuencia("seq_"+nombreTabla)){
    ...
    {        
        ...
        {    
            ...
            if (columnaExistente)
            {
                //update columns_domains set id_domain=?, level=? where id_domain=? and id_column=? 
            ...
            {
                //insert into columns_domains (id_domain, id_column, level) values (?,?,?)
    ...
    public com.geopista.apps.administrador.web.LocalgisLayer publishMap(LayerTable lt) throws Exception
    {
         ...
         try {
             ...
             com.geopista.apps.administrador.web.LocalgisLayer localgisLayer = new com.geopista.apps.administrador.web.LocalgisLayer();
    ...
    public void crearCamposVersionado(String tableName, boolean tablaVersionada) throws Exception{
        ...
        try {
            ...
            if (tablaVersionada){
		        ...
		        ps.setLong(1, 0);
		        ps.setString(2, aplicacion.getString(AppContext.USER_LOGIN));
            ...
            if ((listaFKs != null && listaFKs.size() > 0) || tablaVersionada){
				...
				ps.executeUpdate();
			        ...
			        //Vuelvo a crear la clave primaria ampliada con los campos de versionadao
    ...
    public void deshacerCamposVersionado(String tableName, boolean tablaVersionada) throws Exception{
        ...
        try {
	        ...
	        if ((listaFKs != null && listaFKs.size() > 0) || tablaVersionada){
	            ...
	            //Borro la clave primaria
		        query = new StringBuffer("ALTER TABLE ").append(tableName).append(" DROP CONSTRAINT ").append(tableName)
		            		.append("_pkey cascade");
		        ps = conn.prepareStatement(query.toString());
		        ps.executeUpdate();
	
		        //Vuelvo a crear la clave primaria quitando los campos de versionadao
		        query = new StringBuffer("ALTER TABLE ").append(tableName).append(" ADD CONSTRAINT ").append(tableName)
		            		.append("_pkey PRIMARY KEY(").append(sb.toString()).append(")");
		        ps = conn.prepareStatement(query.toString());
		        ps.executeUpdate();
	            ps.close();
	        }
    	...
    	try{
	        ...
	        while (itFKs.hasNext()){
	        	...
	        	if (crear){
	            	...
	            	//Regenero foreign key
	    	        query = new StringBuffer("ALTER TABLE ").append(campos[0]).append(" ADD FOREIGN KEY (").append(campos[1]);
	    	        query = query.append(") REFERENCES ").append(tableName);
	    	        ps = conn.prepareStatement(query.toString());
	    	        ps.executeUpdate();
		    	}
	            ps.close();
