...
public class GestorCapas extends JFrame
{
    ...
    private void initComponents(){
        ...
        //------NUEVO------>
//        if(SSOAuthManager.isSSOActive()) Constantes.url = aplicacion.getString(SSOConstants.SSO_SERVER_URL);
//        else 
        Constantes.url = aplicacion.getString("geopista.conexion.servidorurl") + WebAppConstants.ADMINISTRACION_WEBAPP_NAME;
        //----FIN NUEVO---->  
