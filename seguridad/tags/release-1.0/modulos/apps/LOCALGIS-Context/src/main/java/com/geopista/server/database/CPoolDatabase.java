		...
		try {
            ...
            if (datasource==null)
            {
                ...
                //datasource = (DataSource) context.lookup("geopista");
           		...
           		standardXAdataSource.setUser(DBPropertiesStore.getDBContext().getString(DBConstants.DDBBCONNECTION_USERNAME));
           		standardXAdataSource.setPassword(DBPropertiesStore.getDBContext().getString(DBConstants.DDBBCONNECTION_PASSWORD));
