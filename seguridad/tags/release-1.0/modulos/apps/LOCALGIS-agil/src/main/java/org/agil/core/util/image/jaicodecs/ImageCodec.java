...
import org.agil.core.util.image.jaicodecs.imageformats.bmp.BMPCodec;
import org.agil.core.util.image.jaicodecs.imageformats.fpx.FPXCodec;
import org.agil.core.util.image.jaicodecs.imageformats.gif.GIFCodec;
import org.agil.core.util.image.jaicodecs.imageformats.jpg.JPEGCodec;
import org.agil.core.util.image.jaicodecs.imageformats.png.PNGCodec;
import org.agil.core.util.image.jaicodecs.imageformats.tif.TIFFCodec;
...
public abstract class ImageCodec {
	...
	public static String[] getDecoderNames(SeekableStream src) {
		...
		Enumeration enumerationElement = codecs.elements();
		Vector nameVec = new Vector();

		String opName = null;
		while (enumerationElement.hasMoreElements()) {
			ImageCodec codec = (ImageCodec)enumerationElement.nextElement();
