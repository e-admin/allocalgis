...
import org.agil.core.util.image.jaicodecs.PropertySet;
...
public class FPXImage extends SimpleRenderedImage {
	...
	org.agil.core.util.image.jaicodecs.stream.SeekableStream subimageHeaderStream;
	...
	public String[] getPropertyNames() {
		...
		Enumeration enumerationElement = properties.keys();

		int count = 0;
		while (enumerationElement.hasMoreElements()) {
			names[count++] = (String)enumerationElement.nextElement();
		}
