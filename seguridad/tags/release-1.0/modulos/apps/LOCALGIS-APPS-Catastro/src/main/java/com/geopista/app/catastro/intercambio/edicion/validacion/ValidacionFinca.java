...
public class ValidacionFinca {
	...
	public String validacionParcialFinca(Connection conn, FincaCatastro finca, String idMunicipio) throws Exception
	{
    ...
    public String validacionesGlobalesFinca(Connection conn, DatosValoracion datosVal, FincaCatastro finca, boolean hayRustica,
                                            boolean esCorrectaPonencia, String idMunicipio)throws DataException
    {
    ...
    private int getAnnoRevisionTotal(Connection conn, String idMunicipio, Integer annoAprobacion)  throws DataException
    {
    ...
    private int getAnnoNormasPonencia(Connection conn, String idMunicipio, Integer annoAprobacion) throws DataException
    {
        int annoNormas = -1;
        PreparedStatement s = null;
        ResultSet r = null;
