                    ...
                    public void run()
                    {
                        try
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    referenciasCatastrales= (ArrayList)ConstantesRegistroExp.clienteCatastro.getFincasCatastroBuscadasPorDir(patronNombreVia, patronTipoVia);
                                }
                                ...
                                {
                                    referenciasCatastrales= (ArrayList)ConstantesRegistroExp.clienteCatastro.getBienInmuebleCatastroBuscadasPorDir(patronNombreVia, patronTipoVia);
                                }
                                cargaDatosTabla();
                            }
                            catch(ACException e)
