...
public class DialogoModosConvenios extends javax.swing.JDialog
{
    ...
    private void aceptarJButtonActionPerformed()
    {
        ...
        try
        {
            ...
            ConstantesRegistroExp.clienteCatastro.guardarParametroConfiguracion(datos);
            ...
            ConstantesRegistroExp.modoGeneracion = datos.getModoGenerarFXCC();
            ConstantesRegistroExp.tiposExpedientes = ConstantesRegistroExp.clienteCatastro.getTiposExpedientes(ConstantesRegistroExp.tipoConvenio);
