...
public class BienInmuebleExtendedInfoPanel extends JPanel
{
    ...
    public class ListenerTextField implements  DocumentListener{
        ...
        public void insertUpdate(DocumentEvent e){
			...
			if(jTextFieldParaje.getDocument()==e.getDocument() || jTextFieldParcela.getDocument()==e.getDocument() || jTextFieldZona.getDocument()==e.getDocument() || jTextFieldPoligono.getDocument()==e.getDocument()){
			    ...
			    if(jTextFieldDireccion.getDocument().getLength()<=0 && jComboBoxTipoVia.getSelectedIndex()<=0 && jTextFieldNumero.getDocument().getLength()<=0 && jTextFieldLetra.getDocument().getLength()<=0 && jTextFieldNumeroD.getDocument().getLength()<=0 && jTextFieldLetraD.getDocument().getLength()<=0 && jTextFieldBloque.getDocument().getLength()<=0 && jTextFieldDirNoEstructurada.getDocument().getLength()<=0 && jTextFieldKm.getDocument().getLength()<=0 && jComboBoxEscalera.getSelectedIndex()<=0 && jComboBoxPlanta.getSelectedIndex()<=0 && jComboBoxPuerta.getSelectedIndex()<=0)
			...
			if(jTextFieldNumRegistro.getDocument()==e.getDocument() || jTextFieldCodRegistro.getDocument()==e.getDocument()){
				...
				jLabelCodRegistro.setText(UtilRegistroExp.getLabelConAsterisco(I18N.get("Expedientes","bieninmueble.extended.fincaregistral.codregistro")));
		        jLabelNumRegistro.setText(UtilRegistroExp.getLabelConAsterisco(I18N.get("Expedientes","bieninmueble.extended.fincaregistral.numregistro")));
		    }
			//Panel Urbana obligatoria
			if(jTextFieldDireccion.getDocument()==e.getDocument() || jTextFieldNumero.getDocument()==e.getDocument() || jTextFieldLetra.getDocument()==e.getDocument() || jTextFieldNumeroD.getDocument()==e.getDocument() || jTextFieldLetraD.getDocument()==e.getDocument() || jTextFieldBloque.getDocument()==e.getDocument() || jTextFieldDirNoEstructurada.getDocument()==e.getDocument() || jTextFieldKm.getDocument()==e.getDocument()){
				jLabelTipoVia.setText(UtilRegistroExp.getLabelConAsterisco(I18N.get("Expedientes", "bieninmueble.extended.urbana.tipovia")));
                jLabelDirección.setText(UtilRegistroExp.getLabelConAsterisco(I18N.get("Expedientes", "bieninmueble.extended.urbana.direccion")));
        ...
        public void removeUpdate(DocumentEvent e){
			...
			if(jTextFieldDireccion.getDocument().getLength()<=0 && jComboBoxTipoVia.getSelectedIndex()<=0 && jTextFieldNumero.getDocument().getLength()<=0 && jTextFieldLetra.getDocument().getLength()<=0 && jTextFieldNumeroD.getDocument().getLength()<=0 && jTextFieldLetraD.getDocument().getLength()<=0 && jTextFieldBloque.getDocument().getLength()<=0 && jTextFieldDirNoEstructurada.getDocument().getLength()<=0 && jTextFieldKm.getDocument().getLength()<=0 && jComboBoxEscalera.getSelectedIndex()<=0 && jComboBoxPlanta.getSelectedIndex()<=0 && jComboBoxPuerta.getSelectedIndex()<=0){
                ...
                jLabelDirección.setText(I18N.get("Expedientes", "bieninmueble.extended.urbana.direccion"));
    ...
    public class ListenerCombo implements  ActionListener{
        ...
        public void actionPerformed(ActionEvent e){  
        	...
        	//Panel Urbana obligatoria
        	if(jComboBoxTipoVia.getSelectedIndex()>0 || jTextFieldDireccion.getDocument().getLength()>0 || jTextFieldNumero.getDocument().getLength()>0 || jTextFieldLetra.getDocument().getLength()>0 || jTextFieldLetraD.getDocument().getLength()>0 || jTextFieldNumeroD.getDocument().getLength()>0 || jTextFieldBloque.getDocument().getLength()>0 || jTextFieldDirNoEstructurada.getDocument().getLength()>0 || jTextFieldKm.getDocument().getLength()>0 || jComboBoxEscalera.getSelectedIndex()>0 || jComboBoxPlanta.getSelectedIndex()>0 || jComboBoxPuerta.getSelectedIndex()>0){
                jLabelTipoVia.setText(UtilRegistroExp.getLabelConAsterisco(I18N.get("Expedientes", "bieninmueble.extended.urbana.tipovia")));
                jLabelDirección.setText(UtilRegistroExp.getLabelConAsterisco(I18N.get("Expedientes", "bieninmueble.extended.urbana.direccion")));  
        	    if(jTextFieldParaje.getDocument().getLength()>0 || jTextFieldParcela.getDocument().getLength()>0 || jTextFieldZona.getDocument().getLength()>0 || jTextFieldPoligono.getDocument().getLength()>0 || jComboBoxMunicipioAgregado.getSelectedIndex()>0)
        	    	jLabelParaje.setText(I18N.get("Expedientes", "bieninmueble.extended.rustica.paraje"));
    	...
    	if (bi!=null){
            ...
            if (bi.getDomicilioTributario().getProvinciaINE()!=null){
                ...
                if (bi.getDomicilioTributario().getProvinciaINE().length()<2){
                    bi.getDomicilioTributario().setProvinciaINE(GeopistaFunctionUtils.completarConCeros(bi.getDomicilioTributario().getProvinciaINE(), 2));
                }
    ...
    public BienInmuebleJuridico getBienInmueble (BienInmuebleJuridico biJ){
    	...
    	if (okPressed)
    	{
	    	...
	    	idBienInmueble.setNumCargo(GeopistaFunctionUtils.completarConCeros(jTextFieldCargo.getText(),4));	    	
            ...
            if (jTextFieldNumRegistro.getText().length()>0 &&
            	...
            	String codigoProvincia = GeopistaFunctionUtils.completarConCeros(provincia.getIdProvincia(),2);
            	String numeroRegistro = GeopistaFunctionUtils.completarConCeros(jTextFieldNumRegistro.getText(), 3);
            	String numeroFincaRegistral = GeopistaFunctionUtils.completarConCeros(jTextFieldNumRegistro.getText(),14);
...
//                numFincaReg.getRegistroPropiedad().setCodigoProvincia(provincia.getIdProvincia());
            ...
            try
            {
                ...
                DireccionLocalizacion dir = ConstantesRegistroExp.clienteCatastro.getViaPorNombre(bi.getDomicilioTributario().getNombreVia());
    ...
    private void fechaAltButtonActionPerformed(ActionEvent evt)
    {
        ...
        {
			jTextFieldAnioFin.setText(ConstantesRegistroExp.calendarValue);
		}
    }
    ...
    private JPanel getJPanelUrbana()
    {
        ...
        {            
            ...
            jLabelNumero = new JLabel(I18N.get("Expedientes","bieninmueble.extended.urbana.numero"), 
                    JLabel.CENTER);     
            jLabelDirección = new JLabel(I18N.get("Expedientes","bieninmueble.extended.urbana.direccion"), 
                    JLabel.CENTER);       
            ...
            jPanelUrbana.add(jLabelTipoVia, 
                    new GridBagConstraints(0, 0, 2, 1, 0.1, 0.1,
                            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                            new Insets(0, 5, 0, 5), 0, 0));
            jPanelUrbana.add(jLabelDirección, 
            ...
            jPanelUrbana.add(getJTextFieldDireccion(), 
                    new GridBagConstraints(3, 1, 8, 1, 0.1, 0.1,
    ...
    private JButton getJButtonCodigoRegistro()
    {
        if (jButtonCodigoRegistro  == null)
        {
        	...
        	jButtonCodigoRegistro.setIcon(IconLoader.icon(GestionExpedientePanel.ICONO_BUSCAR));
    ...
    private JTextField getJTextFieldDC1()
    {
        ...
        public void caretUpdate(CaretEvent evt)
        {
            EdicionUtils.chequeaLongYCharCampoEdit(jTextFieldDC1,1, aplicacion.getMainFrame());
        }
            });
        }
    ...
    private JTextField getJTextFieldDC2()
    {
        ...
        public void caretUpdate(CaretEvent evt)
        {
            EdicionUtils.chequeaLongYCharCampoEdit(jTextFieldDC2,1, aplicacion.getMainFrame());
        }
            });
        }
    ...
    public boolean datosMinimosYCorrectos()
    {
    	...
    	if( (jComboCodProvincia!=null && jComboCodProvincia.getSelectedItem()!=null && jComboCodProvincia.getSelectedIndex()>0)
    		|| (jTextFieldCodRegistro.getText()!=null && !jTextFieldCodRegistro.getText().equalsIgnoreCase(""))
    		|| (jTextFieldNumRegistro.getText()!=null && !jTextFieldNumRegistro.getText().equalsIgnoreCase("")) ){
