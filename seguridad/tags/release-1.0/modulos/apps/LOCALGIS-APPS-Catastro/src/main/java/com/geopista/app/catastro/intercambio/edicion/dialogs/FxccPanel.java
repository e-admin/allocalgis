...
//										PlantaCatastro planta = new PlantaCatastro(pInfo.getNombrePlantas(), pInfo.getNumPlantas());
    ...
    public JButton getJButtonNuevoDXF()
    {
    	if (jButtonNuevoDXF  == null)
    	{
    		...
    		jButtonNuevoDXF.setText(I18N.get("Expedientes", "fxcc.panel.boton.nuevodxf"));
