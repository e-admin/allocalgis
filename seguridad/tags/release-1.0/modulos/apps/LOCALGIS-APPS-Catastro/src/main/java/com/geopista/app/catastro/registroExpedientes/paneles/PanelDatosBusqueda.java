...
public class PanelDatosBusqueda extends JPanel implements IMultilingue {
    ...
    private void fechaRegistroInicialJButtonActionPerformed()
    {
        ...
        {
			fechaRegistroInicialJTfield.setText(ConstantesRegistroExp.calendarValue);
		}
    }
    /**
    ...
    private void fechaRegistroFinalJButtonActionPerformed()
    {
		...
		if ((ConstantesRegistroExp.calendarValue != null) && (!ConstantesRegistroExp.calendarValue.trim().equals("")))
        {
			fechaRegistroFinalJTfield.setText(ConstantesRegistroExp.calendarValue);
		}
    }
...
//        	String aux = domainNode.getTerm(ConstantesRegistroExp.Locale);
...
//        }
    ...
    public boolean recopilaDatosPanel(Hashtable hashDatos)
    {
        ...
        hashDatos.put(ConstantesRegistroExp.expedienteNumeroExpediente, numExpedienteJTfield.getText());
        hashDatos.put(ConstantesRegistroExp.expedienteTipoExpediente, tipoExpe);
        hashDatos.put(ConstantesRegistroExp.expedienteIdEstado, idEstado);
        hashDatos.put(ConstantesRegistroExp.expedienteIdTecnicoCatastro, tecnicoCatastro);
        //TODO esto mirar como hacerlo, o si dejarlo asi.
        hashDatos.put(ConstantesRegistroExp.expedienteFechaRegistro + "Inicial",fechaRegistroInicialJTfield.getText());
        hashDatos.put(ConstantesRegistroExp.expedienteFechaRegistro+ "Final",fechaRegistroFinalJTfield.getText());
        hashDatos.put(ConstantesRegistroExp.expedienteAnnoExpedienteAdminOrigenAlteracion, annoExpedienteAdminOrigenAlt_EjercicioJTfield.getText());
        hashDatos.put(ConstantesRegistroExp.entidadGeneradoraCodigo, codigoEntidadGeneradora);
        String referenciaExp= referenciaCatastralParcela1JTfield.getText().concat(referenciaCatastralParcela2JTfield.getText());
        hashDatos.put(ConstantesRegistroExp.expedienteReferenciasCatastrales, referenciaExp);
        hashDatos.put(ConstantesRegistroExp.expedienteNifPresentador, nifPresentadorJTfield.getText());
