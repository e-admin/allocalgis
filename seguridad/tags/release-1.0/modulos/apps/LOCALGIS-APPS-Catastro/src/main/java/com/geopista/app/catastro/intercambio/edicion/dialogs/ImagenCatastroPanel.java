...
//import com.geopista.app.image.ImagePanel;
...
public class ImagenCatastroPanel extends JPanel implements FeatureExtendedPanel, ImagenInterface
{
	...
	private JButton jButtonAnadir = null;
	...
	private JPanel getJPanelDatosImagenes() {
		...
		if (jPanelDatosImagenes == null){
			...
			jPanelDatosImagenes.setBorder(BorderFactory.createTitledBorder
                    (null, I18N.get("Expedientes", "img.panel.title"), TitledBorder.LEADING, 
	...
	private JPanel getJPanelDatos(){
		...
		if (jPanelDatos == null){
            ...
            jLabelNombre.setText(I18N.get("Expedientes", "img.panel.attribute.name")); 
            
            jLabelExtension = new JLabel("", JLabel.CENTER); 
            jLabelExtension.setText(I18N.get("Expedientes", "img.panel.attribute.ext")); 
            
            jLabelTipoDocumento = new JLabel("", JLabel.CENTER); 
            jLabelTipoDocumento.setText(I18N.get("Expedientes", "img.panel.attribute.type")); 
	...
	private JPanel getJPanelMostrarImagen(){
		...
		if (jPanelMostrarImagen == null){
			...
			jPanelMostrarImagen.setBorder(BorderFactory.createTitledBorder
                    (null, I18N.get("Expedientes", "img.panel.imagen"), TitledBorder.LEADING, 
                    		TitledBorder.TOP, new Font(null, Font.BOLD, 12))); 
	...
	private JPanel getJPanelBotoneraImagenes() {
		...
		if (jPanelBotoneraImagenes == null){
			...
			jPanelBotoneraImagenes.add(getJButtonAnadir(), new GridBagConstraints(0,0,1,1, 0.1, 0.1,
                    GridBagConstraints.EAST, GridBagConstraints.NONE, 
                    new Insets(0,5,0,5),0,0));
			
			jPanelBotoneraImagenes.add(getJButtonBorrar(), new GridBagConstraints(1,0,1,1, 0.1, 0.1,
                    GridBagConstraints.WEST, GridBagConstraints.NONE, 
                    new Insets(0,5,0,5),0,0));
	...
	private JPanel getJPanelThumbnails() {
		...
		if (jPanelThumbnails == null){
			...
			jPanelThumbnails.setBorder(BorderFactory.createTitledBorder
                    (null, I18N.get("Expedientes", "img.panel.thumbnail.title"), TitledBorder.LEADING, 
                    		TitledBorder.TOP, new Font(null, Font.BOLD, 12))); 
...
//        this.setMinimumSize(this.getPreferredSize());
    ...
    public void enter()
    {
        ...
        progressDialog.report(I18N.get("Expedientes","img.panel.loadimages"));
...
//                            }
	...
	public void borrar(ImagenCatastro imagen)
    {
		
        int n = JOptionPane.showOptionDialog(null,
                I18N.get("Expedientes","document.infodocument.respuesta.mensaje"),
                "",
	...
	public void setLstImagenes(String refCat,long idExp){
...
//                auxPintarImagen.setSelected(imageSelected == null ? false : auxImagen.getImagen().equals(imageSelected.getImagen()));
	...
	private ImagenCatastro addImagen(){
		...
		try{
			...
			JOptionPane.showMessageDialog(null,I18N.get("Expedientes","img.panel.buttons.add.error"),
	...
	private JButton getJButtonAnadir() {
		
		if (jButtonAnadir == null){
			
			jButtonAnadir = new JButton();
			jButtonAnadir.setText(I18N.get("Expedientes","img.panel.buttons.add"));
			jButtonAnadir.addActionListener(new ActionListener()
	        {
	            public void actionPerformed(ActionEvent e)
	            {
	            	ImagenCatastro imagen = addImagen();
	            	if (imagen != null){
	            		setImageSelected(imagen);
	            		indiceImagenSeleccionada++;
	            		pintarImagen(imagen);
	...
	private JButton getJButtonBorrar() {
		...
		if (jButtonBorrar == null){
			...
			jButtonBorrar.setText(I18N.get("Expedientes","img.panel.buttons.delete"));
			jButtonBorrar.addActionListener(new ActionListener()
	        {
	            public void actionPerformed(ActionEvent e)
	            {
	                borrar(imageSelected);
	            }
	        });
