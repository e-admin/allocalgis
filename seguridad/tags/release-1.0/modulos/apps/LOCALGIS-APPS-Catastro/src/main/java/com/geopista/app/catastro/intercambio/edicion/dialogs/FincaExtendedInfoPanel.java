    ...
    public class ListenerTextField implements  DocumentListener{
        ...
        public void insertUpdate(DocumentEvent e){
			...
			if(jTextFieldDireccion.getDocument()==e.getDocument() || jTextFieldNumero.getDocument()==e.getDocument() || jTextFieldLetra.getDocument()==e.getDocument() || jTextFieldNumeroD.getDocument()==e.getDocument() || jTextFieldLetraD.getDocument()==e.getDocument() || jTextFieldBloque.getDocument()==e.getDocument() || jTextFieldDirNoEstructurada.getDocument()==e.getDocument() || jTextFieldKm.getDocument()==e.getDocument()){
                ...
                jLabelDirección.setText(UtilRegistroExp.getLabelConAsterisco(I18N.get("Expedientes", "finca.extended.urbana.direccion")));
        ...
        public void removeUpdate(DocumentEvent e){
			...
			if(jTextFieldDireccion.getDocument().getLength()<=0 && jComboBoxTipoVia.getSelectedIndex()<=0 && jTextFieldNumero.getDocument().getLength()<=0 && jTextFieldLetra.getDocument().getLength()<=0 && jTextFieldNumeroD.getDocument().getLength()<=0 && jTextFieldLetraD.getDocument().getLength()<=0 && jTextFieldBloque.getDocument().getLength()<=0 && jTextFieldDirNoEstructurada.getDocument().getLength()<=0 && jTextFieldKm.getDocument().getLength()<=0){
                ...
                jLabelDirección.setText(I18N.get("Expedientes", "finca.extended.urbana.direccion"));
    	...
    	if (okPressed)
    	{
            ...
            try
            {
            	if (finca.getDirParcela().getTipoVia()!=null && !finca.getDirParcela().getTipoVia().equals("") && finca.getDirParcela().getNombreVia()!=null && !finca.getDirParcela().getNombreVia().equals("")
            		...
            		DireccionLocalizacion dir = ConstantesRegistroExp.clienteCatastro.getViaPorNombre(finca.getDirParcela().getNombreVia());
    ...
    private JPanel getJPanelUrbana()
    {
        ...
        {            
            ...
            jPanelUrbana.add(jLabelDirección, 
                    new GridBagConstraints(2, 0, 7, 1, 0.1, 0.1,
                            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                            new Insets(0, 5, 0, 5), 0, 0));
            ...
            jPanelUrbana.add(getJTextFieldDireccion(), 
                    new GridBagConstraints(2, 1, 7, 1, 0.1, 0.1,
                            GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                            new Insets(0, 5, 0, 5), 0, 0));
