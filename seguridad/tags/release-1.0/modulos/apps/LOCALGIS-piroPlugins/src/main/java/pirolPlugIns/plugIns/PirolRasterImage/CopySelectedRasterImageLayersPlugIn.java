...
public class CopySelectedRasterImageLayersPlugIn extends LayerableClipboardPlugIn {
    ...
    protected final static String shortClassName = CopySelectedRasterImageLayersPlugIn.class.getName().substring(CopySelectedRasterImageLayersPlugIn.class.getName().lastIndexOf(".")+1);
    ...
    public String getName() {
        return PirolPlugInMessages.getString(shortClassName);
    }
