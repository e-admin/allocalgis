    ...
    public void execute() throws Exception 
    {
    	if (centrosAsistencialesPanel != null) {
    		if (centrosAsistencialesPanel.datosMinimosYCorrectos()){
    			...
    			ConstantesLocalGISEIEL.clienteLocalGISEIEL.insertarElemento(centrosAsistencialesPanel.getCentrosAsistenciales(captacion), idLayer, ConstantesLocalGISEIEL.CENTROS_ASISTENCIALES);
