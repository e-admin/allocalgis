    ...
    public void execute() throws Exception 
    {
    	if (casaConsistorialPanel != null) {
    		 if (casaConsistorialPanel.datosMinimosYCorrectos()){
    			 ...
    			 ConstantesLocalGISEIEL.clienteLocalGISEIEL.insertarElemento(casaConsistorialPanel.getCasaConsistorial(casaConsistorial), idLayer, ConstantesLocalGISEIEL.CASAS_CONSISTORIALES);
