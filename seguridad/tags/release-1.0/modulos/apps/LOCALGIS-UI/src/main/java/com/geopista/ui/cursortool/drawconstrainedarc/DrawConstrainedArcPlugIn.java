...
public class DrawConstrainedArcPlugIn extends AbstractPlugIn
{
    ...
    final static String errorSeeOutputWindow =I18N.get("Error-See-Output-Window");
    ...
    public boolean execute(PlugInContext context) throws Exception
    {
        ...
        {
            context.getWorkbenchFrame().warnUser(I18N.get("DrawConstrainedArcTool","Error-See-Output-Window"));
