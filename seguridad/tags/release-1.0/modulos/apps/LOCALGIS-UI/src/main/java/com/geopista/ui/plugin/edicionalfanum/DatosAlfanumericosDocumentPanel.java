...
public class DatosAlfanumericosDocumentPanel extends  JPanel implements DocumentInterface, FeatureExtendedPanel
{
    private static final Log logger = LogFactory.getLog(DatosAlfanumericosDocumentPanel.class);

    /* Paneles */
    private JPanel jPanelButtons = new JPanel();
    private JPanel jPanelListado = new JPanel();
    private DocumentPanel panelDocumentos;
    private DatosAlfanumericosPanel jTextPanel;
    ...
    public DatosAlfanumericosDocumentPanel()
    {
        try
        {
            jbInit();
    ...
    private void jbInit() throws Exception
    {
        ...
        /** Comentarios
          * Panel */
        jTextPanel = new DatosAlfanumericosPanel();
                ...
                new Thread(new Runnable()
                {
                    public void run()
                    {
                        try
                        {
                            ...
                            // NUEVO
							if (!AlfrescoManagerUtils.isAlfrescoActive() && AlfrescoManagerUtils.isAlfrescoUuid(auxDocument.getId(), auxDocument.getIdMunicipio()))
