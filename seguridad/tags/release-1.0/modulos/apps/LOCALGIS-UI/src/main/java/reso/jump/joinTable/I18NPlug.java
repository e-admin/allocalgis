...
public final class I18NPlug {
	...
	private static Hashtable plugInResourceBundle = new Hashtable();
	  ...
	  public static void setPlugInRessource(String pluginName, String bundle){
		...
		try {
			TestLocale = AppConstants.I18N_SETLOCALE;
		...
		if (jumpi18n == true) {
			...
			I18NPlug.plugInResourceBundle.put(pluginName, ResourceBundle.getBundle("reso.jump.joinTable.resources"));
			//LOG.debug(I18NPlug.plugInResourceBundle.get(pluginName)+" cz.vsb.gisak.jump.rasterimage");					
		}
	 }
	...
	{		
		if (jumpi18n == true) {
			...
			*/
			...
			/*
			if (LOG.isDebugEnabled()){
			  LOG.debug(I18NPlug.plugInResourceBundle.get(pluginName)+" "+label
