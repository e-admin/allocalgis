...
//		CLASSID_SERVICIOS_RECOGIDA_BASURA,
	...
	public static String URL_SERVER = APLICACION.getString("geopista.conexion.servidorurl") + _ADD_URL_SERVER;
	public static String URL_DELETE_SERVER = APLICACION.getString("geopista.conexion.servidorurl") + _DELETE_URL_TOMCAT;
