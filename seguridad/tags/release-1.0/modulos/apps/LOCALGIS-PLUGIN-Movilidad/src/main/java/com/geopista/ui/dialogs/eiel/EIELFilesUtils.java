...
public class EIELFilesUtils extends FilesUtils{
	...
	public EIELFilesUtils(String extractLayerName){
		...
		initialize(extractLayersNames, ConstantesLocalGISEIEL_LCGIII.Locale,new LocalGISEIELClient(AppContext.getApplicationContext().getString(AppContext.GEOPISTA_CONEXION_ADMINISTRADORCARTOGRAFIA)+ServletConstants.EIEL_SERVLET_NAME));		
	}
	...
	public EIELFilesUtils(ArrayList<String> extractLayersNames, String locale){	
		initialize(extractLayersNames, locale, new LocalGISEIELClient(AppContext.getApplicationContext().getString(AppContext.GEOPISTA_CONEXION_ADMINISTRADORCARTOGRAFIA)+ServletConstants.EIEL_SERVLET_NAME));		
	}
