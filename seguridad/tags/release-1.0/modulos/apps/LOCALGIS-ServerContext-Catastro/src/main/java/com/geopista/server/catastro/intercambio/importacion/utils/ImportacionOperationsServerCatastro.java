...
import com.geopista.server.catastro.intercambio.importacion.utils.EdicionUtilsCatastroServer;
        ...
        if (udsa.getFincaCatastro()!=null){
        	if(udsa.getFxcc()!=null){
        		if(udsa.getFxcc().getDXF()!=null){
        			...
        			geometriaParcela = ImportarUtilsServerCatastro.obtenerGeometriaParcela(dxf, null);
   ...
   */
     ...
     */
      ...
      throws Exception
      {
          ...
          pers.getDerecho().setPorcentajeDerecho(ImportarUtilsServerCatastro.strToFloat(linea.substring(54, 57)+"."+linea.substring(57,59)));
          ...
          pers.getDomicilio().setKilometro(ImportarUtilsServerCatastro.strToDouble(linea.substring(284,287)+"."+linea.substring(287, 289)));
