...
{     
    ...
    throws SAXException
    {
        ...
        {   
            Double valorCat = ImportarUtilsServerCatastro.strToDouble(valor.toString().replaceAll(",","."));
        ...
        {
            Double valorSuelo = ImportarUtilsServerCatastro.strToDouble(valor.toString().replaceAll(",","."));
        ...
        {
            Double valorConstruccion = ImportarUtilsServerCatastro.strToDouble(valor.toString().replaceAll(",","."));
        ...
        {
            Long baseLiquidable = new Long(ImportarUtilsServerCatastro.doubleToStringWithFactor(ImportarUtilsServerCatastro.strToDouble(valor.toString().replaceAll(",",".")), 1));
        ...
        //    bru
            ...
            biCat.getDatosEconomicosBien().setImporteBonificacionRustica(new Long(ImportarUtilsServerCatastro.doubleToStringWithFactor(ImportarUtilsServerCatastro.strToDouble(valor.toString().replaceAll(",",".")), 1)));
