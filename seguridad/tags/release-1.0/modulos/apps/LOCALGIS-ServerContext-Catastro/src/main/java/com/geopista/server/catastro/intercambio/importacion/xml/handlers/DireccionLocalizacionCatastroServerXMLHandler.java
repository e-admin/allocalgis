...
public class DireccionLocalizacionCatastroServerXMLHandler extends DefaultHandler 
{
    /**
    ...
    public DireccionLocalizacionCatastroServerXMLHandler (XMLReader parser, DefaultHandler handler,
    ...
    {   
        ...
        //TODO: cv es "([0-9]|NOAPL)+", el NOAPL no está contemplado!
           ...
           dirLocalizacion.setKilometro(ImportarUtilsServerCatastro.strToDouble(valor.toString().replaceAll(",",".")));
