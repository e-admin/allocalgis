...
public class Depuradoras1Dialog extends JDialog
{
    ...
    public Depuradoras1Dialog(Depuradora1EIEL elemento, boolean isEditable)
    {
        ...
        getDepuradoras1Panel().getJComboBoxProvincia().setEnabled(false);
        getDepuradoras1Panel().getJComboBoxMunicipio().setEnabled(false);
    ...
    private void onTabbedPageChange(ChangeEvent e) {
        ...
        if (sel == 1){
        	this.getDepositosNucleosPanel().tabbedChanged(getDepuradoras1Panel().getDepuradora1Data());
        }
	}
	...
	public Depuradora1NucleosPanel getDepositosNucleosPanel(){
