...
import com.geopista.app.eiel.Constantes;
...
public class ListaRendererEIEL extends DefaultListCellRenderer
{
    private String locale;
    public ListaRendererEIEL(){
    }

    public ListaRendererEIEL(String locale){
        this.locale= locale;
    }
