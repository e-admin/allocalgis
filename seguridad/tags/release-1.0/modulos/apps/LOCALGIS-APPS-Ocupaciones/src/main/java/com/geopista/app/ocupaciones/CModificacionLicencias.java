                ...
                if (selectedFile != null){
                   ...
                   /** Comprobamos si existe el directorio. */
                    ...
                    if(!AlfrescoManagerUtils.isAlfrescoUuid(anexo.getIdAnexo(), String.valueOf(AppContext.getIdMunicipio()))){
                    	...
                    	AlfrescoDocumentClient alfrescoDocumentClient = new AlfrescoDocumentClient(AppContext.getApplicationContext().getString(AppContext.HOST_ADMCAR) + "/" + WebAppConstants.ALFRESCO_WEBAPP_NAME +
