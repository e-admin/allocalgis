...
import com.geopista.app.ocupaciones.CConsultaLicencias;
import com.geopista.app.ocupaciones.Estructuras;
import com.geopista.app.ocupaciones.CListaAnexosTableModel;
import com.geopista.app.ocupaciones.CReferenciasCatastralesTableModel;
import com.geopista.app.ocupaciones.ComboBoxRenderer;
import com.geopista.app.ocupaciones.ComboBoxTableEditor;
import com.geopista.app.ocupaciones.TextFieldRenderer;
import com.geopista.app.ocupaciones.TextFieldTableEditor;
...
/**
                        ...
                        if (geoF.getSystemId() == null || geoF.getSystemId().length() <= 0) {
                        	...
                        	final Runnable runnable = new Runnable(){
								...
								private String transformFeatureGeom(GeopistaFeature targetFeature) throws Exception {
									...
									String sridInicial = ((AppContextMap)AppContext.getApplicationContext()).getClient().getSRIDDefecto(true, Integer.parseInt(iSesion.getIdEntidad()));
 							        String sridDefecto = ((AppContextMap)AppContext.getApplicationContext()).getClient().getSRIDDefecto(false, Integer.parseInt(iSesion.getIdEntidad()));
	...
	private void configureComponents() {
		...
		String[] columnNamesAnexos = {CMainOcupaciones.literales.getString("CCreacionLicenciasForm.ObraMayorJMenuItem.listaAnexosJTable.column1"),
									  ...
									  CMainOcupaciones.literales.getString("CCreacionLicenciasForm.ObraMayorJMenuItem.listaAnexosJTable.column4")};
        ...
        listaAnexosJTable.getColumnModel().getColumn(3).setCellEditor(textFieldTableEditorStore);
