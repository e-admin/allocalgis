...
public class GeoMarketingFeaturesListPanel extends JPanel{
	...
	public static void flashZoomSelectedGeometries(Geometry ge, LayerViewPanel panel) throws NoninvertibleTransformException {
...
//				panel);
	...
	private void selectFeature(LayerViewPanel layerViewPanel, GeopistaLayer geopistaLayer, Feature feature) {
