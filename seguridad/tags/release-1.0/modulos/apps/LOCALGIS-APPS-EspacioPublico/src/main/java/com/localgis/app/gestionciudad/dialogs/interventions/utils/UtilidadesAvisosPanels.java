...
//			}
	...
	public static com.localgis.webservices.civilwork.client.CivilWorkWSStub.LayerFeatureBean[] buildLayerFeaturesToFeatureLayerStubBean(
			LayerFeatureBean[] features) {
		if (features!=null && features.length>0){
			ArrayList<com.localgis.webservices.civilwork.client.CivilWorkWSStub.LayerFeatureBean> resultado = new ArrayList<com.localgis.webservices.civilwork.client.CivilWorkWSStub.LayerFeatureBean>();
			for(int i = 0; i < features.length; i ++){
				try{
					com.localgis.webservices.civilwork.client.CivilWorkWSStub.LayerFeatureBean newLayerFeatureBean = new com.localgis.webservices.civilwork.client.CivilWorkWSStub.LayerFeatureBean();
			...
			return resultado.toArray(new com.localgis.webservices.civilwork.client.CivilWorkWSStub.LayerFeatureBean[resultado.size()]);
		}
