 ...
 * @author juacas
 */
public class GEOPISTABean2 extends JPanel 
{
...
//	getBeanProxy();
	...
	try
		...
		jLabel = new JLabel();
		jLabel.setText((new Date()).toString()+"GEOPISTA");  // Generated
	...
	GEOPISTABean2 bean = new GEOPISTABean2();
	...
	public boolean edit()
	{
	System.out.println("Llamado a edit()");
	...
	{
	System.out.println("Llamado a getMapName()");
