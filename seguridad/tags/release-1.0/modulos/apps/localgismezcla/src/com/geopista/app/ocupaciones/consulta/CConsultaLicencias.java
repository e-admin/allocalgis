...
import com.geopista.app.ocupaciones.tableModels.*;
...
import com.geopista.app.ocupaciones.utilidades.JPanelCallesAfectadas;
...
public class CConsultaLicencias extends javax.swing.JInternalFrame implements IMultilingue{
    ...
    private void generarFicha()
    {
    	try
        {
            ...
            expedienteLicencia.setSolicitud(solicitudLicencia);
           	new GeopistaPrintable().printObjeto(FichasDisponibles.fichalicenciaocupacion, expedienteLicencia , CExpedienteLicencia.class, CMainOcupaciones.geopistaEditor.getLayerViewPanel(), GeopistaPrintable.FICHA_OCUPACIONES_CONSULTA);
		} catch (Exception ex) {
	...
	private void modificarJButtonActionPerformed()
    {
        ...
        mainOcupaciones.mostrarJInternalFrame(new com.geopista.app.ocupaciones.modificacion.CModificacionLicencias((JFrame)this.desktop, numExpedienteJTField.getText().trim(), false));
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            if (selectedFile != null){
               ...
               /** Comprobamos si existe el directorio. */
                ...
                boolean resultado = CUtilidadesComponentes.GetURLFile(CConstantesComando.anexosLicenciasUrl + solicitudLicencia.getIdSolicitud() + "/" + fileName, tmpFile, "", 0);
                if (!resultado) {
		...
		try {
			...
			if (anexos != null) {
				for (int i = 0; i < anexos.size(); i++) {
					...
					anexosJTableModel.addRow(new String[]{anexo.getFileName(), descTipoAnexo, anexo.getObservacion()});
				}
			}
	...
	public void renombrarComponentes(boolean construir) {
		...
		try {
            ...
            if (construir) {
                ...
                datosSolicitudJTabbedPane.setTitleAt(0, com.geopista.app.licencias.CUtilidadesComponentes.annadirAsterisco(CMainOcupaciones.literales.getString("CConsultaLicenciasForm.expedienteJPanel.TitleTab")));
                datosSolicitudJTabbedPane.setTitleAt(1, com.geopista.app.licencias.CUtilidadesComponentes.annadirAsterisco(CMainOcupaciones.literales.getString("CConsultaLicenciasForm.solicitudJPanel.TitleTab")));
