...
package com.geopista.app.ocupaciones.informes;
...
import com.geopista.app.ocupaciones.CSearchJDialog;
...
import com.geopista.app.ocupaciones.tableModels.CInformesTableModel;
...
public class CGeneracionInformes extends javax.swing.JInternalFrame implements IMultilingue{
	...
	public void cargarPlantillas() {
		try {
        	...
        	AppContext.getApplicationContext().getBlackboard().put(AppContext.idAppType, ConstantesLocalGISPlantillas.PATH_OCUPACION);  
