...
insert into lcg_nodos_capas_campos (clave_capa, clave_grupo, campo_bd, tag_traduccion,tipo_bd, dominio, metodo)
	values ('TP','Info.TP','desinf_1','localgiseiel.tabla.tp.columna.desinf_1',4,'eiel_Método de desinfección','MetodoDesinfeccion1'); 	
insert into lcg_nodos_capas_campos (clave_capa, clave_grupo, campo_bd, tag_traduccion,tipo_bd, dominio, metodo)
	values ('TP','Info.TP','desinf_2','localgiseiel.tabla.tp.columna.desinf_2',4,'eiel_Método de desinfección','MetodoDesinfeccion2'); 	
insert into lcg_nodos_capas_campos (clave_capa, clave_grupo, campo_bd, tag_traduccion,tipo_bd, dominio, metodo)
	values ('TP','Info.TP','desinf_3','localgiseiel.tabla.tp.columna.desinf_3',4,'eiel_Método de desinfección','MetodoDesinfeccion3'); 	
insert into lcg_nodos_capas_campos (clave_capa, clave_grupo, campo_bd, tag_traduccion,tipo_bd, dominio, metodo)
