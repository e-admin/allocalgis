/*
 ...
 SQL para generar los SQL de creación de capas a partir de una instalaciÃ³n existente (Ej. para crear SQL de creaciÃ³n de capas a partir de capas ya creadas en entorno DEV)
