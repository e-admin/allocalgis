...
public class WorkflowEIEL extends InventarioEIEL implements Serializable{
	...
	public boolean isEstadoTemporal() {
		return (estadoValidacion==ConstantesLocalGISEIEL_LCGIII.ESTADO_TEMPORAL);
	}
	
	public boolean isEstadoValido() {
		return (estadoValidacion==ConstantesLocalGISEIEL_LCGIII.ESTADO_VALIDO);
	}

	public boolean isEstadoAutoPublicable() {
		return (estadoValidacion==ConstantesLocalGISEIEL_LCGIII.ESTADO_PUBLICABLE_MOVILIDAD);
	}
	
	public boolean isEstadoPublicable() {
		return (estadoValidacion==ConstantesLocalGISEIEL_LCGIII.ESTADO_PUBLICABLE);
	}
