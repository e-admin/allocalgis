...
public class BuscadorCallejeroPanelBusqueda extends JPanel{
	...
	private void guardarBusqueda(){
		...
		if(appContext.getString(AppContext.BUSCADOR_CALLEJERO_AVANZADO) == null){
			appContext.getUserPreference(AppContext.BUSCADOR_CALLEJERO_AVANZADO,opcionesAvanzadas, true);
		}
		else{
			appContext.setUserPreference(AppContext.BUSCADOR_CALLEJERO_AVANZADO, opcionesAvanzadas);
		}
		if(appContext.getString(AppContext.BUSCADOR_CALLEJERO_LITERAL) == null){
			appContext.getUserPreference(AppContext.BUSCADOR_CALLEJERO_LITERAL,busquedaLiteralText, true);
		}
		else{
			appContext.setUserPreference(AppContext.BUSCADOR_CALLEJERO_LITERAL,busquedaLiteralText);
		}
		
		if(appContext.getString(AppContext.BUSCADOR_CALLEJERO_NOMBREVIA) == null){
			appContext.getUserPreference(AppContext.BUSCADOR_CALLEJERO_NOMBREVIA,nombreviaTextField.getText(), true);
		}
		else{
			appContext.setUserPreference(AppContext.BUSCADOR_CALLEJERO_NOMBREVIA,nombreviaTextField.getText());
		}
		
		if(appContext.getString(AppContext.BUSCADOR_CALLEJERO_NUMERO) == null){
			appContext.getUserPreference(AppContext.BUSCADOR_CALLEJERO_NUMERO,numeroTextField.getText(), true);
		}
		else{
			appContext.setUserPreference(AppContext.BUSCADOR_CALLEJERO_NUMERO,numeroTextField.getText());
		}
		
		if(appContext.getString(AppContext.BUSCADOR_CALLEJERO_CAPA_NOMBREVIA) == null){
			appContext.getUserPreference(AppContext.BUSCADOR_CALLEJERO_CAPA_NOMBREVIA,(String)capaNombreViaJCBox.getSelectedItem(), true);
		}
		else{
			appContext.setUserPreference(AppContext.BUSCADOR_CALLEJERO_CAPA_NOMBREVIA,(String)capaNombreViaJCBox.getSelectedItem());
		}
		
		if(appContext.getString(AppContext.BUSCADOR_CALLEJERO_CAPA_NUMERO) == null){
			appContext.getUserPreference(AppContext.BUSCADOR_CALLEJERO_CAPA_NUMERO,(String)capaNumeroJCBox.getSelectedItem(), true);
		}
		else{
			appContext.setUserPreference(AppContext.BUSCADOR_CALLEJERO_CAPA_NUMERO, (String)capaNumeroJCBox.getSelectedItem());
		}
		
		if(appContext.getString(AppContext.BUSCADOR_CALLEJERO_ATRIBUTO_NOMBREVIA) == null){
			appContext.getUserPreference(AppContext.BUSCADOR_CALLEJERO_ATRIBUTO_NOMBREVIA,(String)atributosNombreViaJCBox.getSelectedItem(), true);
		}
		else{
			appContext.setUserPreference(AppContext.BUSCADOR_CALLEJERO_ATRIBUTO_NOMBREVIA,(String)atributosNombreViaJCBox.getSelectedItem());
		}
		
		if(appContext.getString(AppContext.BUSCADOR_CALLEJERO_ATRIBUTO_NUMERO) == null){
			appContext.getUserPreference(AppContext.BUSCADOR_CALLEJERO_ATRIBUTO_NUMERO,(String)atributosNumeroJCBox.getSelectedItem(), true);
		}
		else{
			appContext.setUserPreference(AppContext.BUSCADOR_CALLEJERO_ATRIBUTO_NUMERO,(String)atributosNumeroJCBox.getSelectedItem());
		}
		
		if(appContext.getString(AppContext.BUSCADOR_CALLEJERO_RELACION_NUMERO) == null){
			appContext.getUserPreference(AppContext.BUSCADOR_CALLEJERO_RELACION_NUMERO,(String)relacionNumeroJCBox.getSelectedItem(), true);
		}
		else{
			appContext.setUserPreference(AppContext.BUSCADOR_CALLEJERO_RELACION_NUMERO,(String)relacionNumeroJCBox.getSelectedItem());
		}
		
		if(appContext.getString(AppContext.BUSCADOR_CALLEJERO_RELACION_NOMBREVIA) == null){
			appContext.getUserPreference(AppContext.BUSCADOR_CALLEJERO_RELACION_NOMBREVIA,(String)relacionNombreViaJCBox.getSelectedItem(), true);
		}
		else{
			appContext.setUserPreference(AppContext.BUSCADOR_CALLEJERO_RELACION_NOMBREVIA,(String)relacionNombreViaJCBox.getSelectedItem());
		}
	...
	private void cargarBusqueda(){
		...
		String opcionesAvanzadas = appContext.getString(AppContext.BUSCADOR_CALLEJERO_AVANZADO);
		String busquedaLiteralText = appContext.getString(AppContext.BUSCADOR_CALLEJERO_LITERAL);
		String nombrevia = appContext.getString(AppContext.BUSCADOR_CALLEJERO_NOMBREVIA);
		String numero = appContext.getString(AppContext.BUSCADOR_CALLEJERO_NUMERO);
		
		String capaNombreVia = appContext.getString(AppContext.BUSCADOR_CALLEJERO_CAPA_NOMBREVIA);
		String capaNumero = appContext.getString(AppContext.BUSCADOR_CALLEJERO_CAPA_NUMERO);
		String atributoNombreVia = appContext.getString(AppContext.BUSCADOR_CALLEJERO_ATRIBUTO_NOMBREVIA);
		String atributoNumero = appContext.getString(AppContext.BUSCADOR_CALLEJERO_ATRIBUTO_NUMERO);
		String relacionNumero = appContext.getString(AppContext.BUSCADOR_CALLEJERO_RELACION_NUMERO);
		String relacionNombrevia = appContext.getString(AppContext.BUSCADOR_CALLEJERO_RELACION_NOMBREVIA);
