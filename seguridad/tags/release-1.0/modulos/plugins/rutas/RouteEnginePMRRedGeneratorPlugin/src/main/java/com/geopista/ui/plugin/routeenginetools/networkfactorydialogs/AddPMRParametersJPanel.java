...
/*		ButtonGroup buttonGroup1 = new ButtonGroup();
	...
	public void saveParameters(){
		...
		pmrProperties.setMinWidth(Double.parseDouble(jTextAnchuraAcera.getText()));
		...
		pmrProperties.setObstacleHeight(Double.parseDouble(this.jTextObstacleHeight.getText()));
