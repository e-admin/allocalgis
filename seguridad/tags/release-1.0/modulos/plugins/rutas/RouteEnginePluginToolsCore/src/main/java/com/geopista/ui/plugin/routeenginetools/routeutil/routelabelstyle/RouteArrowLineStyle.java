...
public class RouteArrowLineStyle extends LineStringSegmentStyle{
    ...
    public void paintLineString(LineString lineString, IViewport viewport,
...
//    	}
    ...
    public void paint(Coordinate p0, Coordinate p1, IViewport viewport,
    		Graphics2D graphics) throws Exception {
//    	paint(viewport.toViewPoint(new Point2D.Double(p0.x, p0.y)),
//    			viewport.toViewPoint(new Point2D.Double(p1.x, p1.y)), viewport,
//    			graphics);
    ...
    public void paint(Feature feature,Graphics2D g,IViewport viewport){
    	if (feature.getSchema().hasAttribute("trafficRegulation") && 
    			feature.getSchema().hasAttribute("TrafficRegulationPainted") ){
    		...
    		try{
    			int i = (Integer) feature.getAttribute("TrafficRegulationPainted");
    			if (i==1){
    				painted = true;
    			} else{
    				painted = false;
    		...
    		if (painted){
    			...
    			String regulation = "";
    			try{
    				if (feature.getAttribute("trafficRegulation") instanceof String){
    					regulation = (String) feature.getAttribute("trafficRegulation");
    				} else if (feature.getAttribute("trafficRegulation") instanceof StreetTrafficRegulation){
    					regulation = ((StreetTrafficRegulation) feature.getAttribute("trafficRegulation")).toString();
    				}
...
//        graphics.drawImage(this.imageIcon.getImage(),imageFin(p1, p0, this.finLength, this.finAngle), new image() );
	...
	public void paintDirect(Coordinate p0, Coordinate p1, GeopistaLayer layer) throws NoninvertibleTransformException {
			IViewport viewport = this.myViewport;
...
//            AffineTransform.getRotateInstance(theta);
    ...
    public static class Direct extends RouteArrowLineStyle {
        public Direct(IViewport viewport, Graphics2D graphics2d) {        	
            super(
    ...
    public static class Inverse extends RouteArrowLineStyle {
        public Inverse(IViewport viewport, Graphics2D graphics2d) {
            super(
    ...
    public static class BiDirect extends RouteArrowLineStyle {
        public BiDirect(IViewport viewport, Graphics2D graphics2d) {
            super(
