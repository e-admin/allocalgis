...
public class PredefinedCoordinateSystems {
	private static PrecisionModel precisionModelGeographic = getGeometryFactory(100000000).getPrecisionModel();
	private static PrecisionModel precisionModelUTM = getGeometryFactory(100).getPrecisionModel();
