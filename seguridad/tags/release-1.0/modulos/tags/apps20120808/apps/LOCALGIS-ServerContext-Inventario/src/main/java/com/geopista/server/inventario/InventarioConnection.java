...
//	                    hab.setValorAmor(rs.getDouble("total_amortizado"));
	                    if(rs.getLong("ID_CA")!=0 && rs.getLong("id_cuenta_amortizacion")!= rs.getLong("ID_CA")){
	                    	  hab.setValorAmorAnio(rs.getDouble("total_amortizado_anio")+calcularTotalAmortizadoPorAnio(hab.getFechaAdquisicion(),anio, hab.getCoste(), hab.getCuentaAmortizacion(), LCGIII_DatosAmortizacionConst.POR_AÑOS));
	                    	 ...
	                    	 hab.setValorAmorAnio(calcularTotalAmortizado(formatoDeFecha.parse("31/12/"+Integer.toString(anio)),hab.getFechaAdquisicion(), hab.getCoste(), hab.getCuentaAmortizacion(), LCGIII_DatosAmortizacionConst.POR_AÑOS));
