...
public class JPanelUsuarios extends javax.swing.JPanel {
	...
	private void initComponents(ResourceBundle messages) {// GEN-BEGIN:initComponents
		...
		jPanelListaUsuarios.add(jButtonUsuEliminar,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 500, 85,
						-1));
		...
		jPanelListaUsuarios.add(jButtonEditar,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 500, 75,
						-1));
		...
		jPanelListaUsuarios.add(jButtonVerPermisos,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 500, -1,
						-1));

		listaUsuariosJScrollPane.setViewportView(jTableUsuarios);

		jPanelListaUsuarios.add(listaUsuariosJScrollPane,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 350,
						470));
		...
		jPanelListaUsuarios.add(jButtonUsuAnadir,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 500, 75,
						-1));
		...
		jPanelEditarUsuario.add(jLabelNombreUsuario,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 15, -1,
						-1));
		...
		jPanelEditarUsuario.add(jLabelACLUsuario,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 255, 190,
						-1));
		...
		jPanelEditarUsuario.add(jComboBoxACLs,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 255, 200,
						-1));
		...
		jPanelEditarUsuario.add(jButtonPermitir,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 288, 125,
						-1));
		...
		jPanelEditarUsuario.add(jButtonDenegar,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 288,
						125, -1));
		...
		jPanelEditarUsuario.add(jButtonLimpiar,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 288,
						120, -1));
		...
		jPanelEditarUsuario.add(jButtonCancelar,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(135, 500,
						110, -1));
		...
		jPanelEditarUsuario.add(jButtonUsuAceptar,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(255, 500,
						110, -1));
		...
		jPanelEditarUsuario.add(jLabelPermisos,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 300, -1,
						-1));
		...
		jPanelEditarUsuario.add(jScrollPaneUsuPer,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 315, 450,
						180));
	...
	public void aceptarActionPerformed() {
		try {
			...
			if (this.jTextFieldUsuNombre.getText().toUpperCase().equals("SYSSUPERUSER")){
				...
				//Si el usuario validado tiene el identificador de entidad=0 le dejamos que pueda seleccionar
				//la entidad 0 y asignarle entidad 0 a otros usuarios
	...
	private void verPermisos() {
		if (usuarioSelected != null) {
			ShowPermisos permisosDialog = new ShowPermisos(usuarioSelected
					.getId(), listaAcl, framePadre, true, mensajesUsuario);
			Dimension d = Toolkit.getDefaultToolkit().getScreenSize();
