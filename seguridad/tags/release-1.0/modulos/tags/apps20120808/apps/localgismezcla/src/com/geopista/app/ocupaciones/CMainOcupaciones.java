	...
	private boolean configureApp() {
		...
		try {
		    ...
		    try{
                   ...
                   com.geopista.protocol.CConstantesComando.servletLicenciasUrl = app.getString("geopista.conexion.servidorurl")+"ocupaciones/CServletOcupaciones";
                   com.geopista.protocol.CConstantesComando.anexosLicenciasUrl = app.getString("geopista.conexion.servidorurl")+"anexos/ocupacion/";
                   com.geopista.protocol.CConstantesComando.loginLicenciasUrl = app.getString("geopista.conexion.servidorurl")+"ocupaciones";
