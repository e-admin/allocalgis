...
import com.geopista.sql.GEOPISTADriver;
...
public class GeopistaInformeCatastral extends JPanel implements WizardPanel
{
 ...
 //private JPanel pnlVentana = new JPanel();
  ...
  private void jbInit() throws Exception
  {
      ...
      String Where_c = "{parcelas.id}="+ this.parcela + " and  {municipios.id="+ aplicacion.getString("geopista.DefaultCityId") +"}";
      try {
      ...
      while (e.hasMoreElements())
      {
       ...
       DriverManager.registerDriver(new com.geopista.sql.GEOPISTADriver());
        ...
        Class.forName(aplicacion.getString("geopista.conexion.driver"));
