...
public class FeatureCollectionDxfConverter implements DxfConverter {
	 ...
	 * por el nombre de la capa dxf a partir de la que se 
	 * generó. 
	 */
	 ...
	 * de un tipo que no existe en el fichero dxf
	 */
	...
	/* (non-Javadoc)
	 * @see org.agil.dxf.reader.DxfConverter#convert(org.agil.dxf.reader.Dxf3DFACE, org.agil.dxf.reader.DxfFile, java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see org.agil.dxf.reader.DxfConverter#convert(org.agil.dxf.reader.DxfBLOCK, org.agil.dxf.reader.DxfFile, java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see org.agil.dxf.reader.DxfConverter#convert(org.agil.dxf.reader.DxfDIMENSION, org.agil.dxf.reader.DxfFile, java.lang.Object)
	 */
	...
	public void convert(DxfLINE line, DxfFile dxf, Object collector) {
		...
		if(forLayer == null){
			...
			this.featureCollectionToLayerName.put(forLayer, layerName+"-Lineas");
		}
	...
	public void convert(DxfPOINT point, DxfFile dxf, Object collector) {
		...
		if(forLayer == null){
			...
			this.featureCollectionToLayerName.put(forLayer, layerName+"-Puntos");
	...
	/**
	 * Devuelve una geometria JTS a partir de una POLYLINE dxf del tipo NET
	 * @param poly
	 * @return
	 */
	...
	/**
	 * Construye una geometria JTS a partir de una entidad dxf POLYLINE
	 * normal
	 * @param poly
	 * @return
	 */
	...
	/* (non-Javadoc)
	 * @see org.agil.dxf.reader.DxfConverter#convert(org.agil.dxf.reader.DxfSOLID, org.agil.dxf.reader.DxfFile, java.lang.Object)
	 */
	 ...
	 * texto.
	 * @param text entidad dxf del tipo TEXT
	...
	public void convert(DxfTEXT text, DxfFile dxf, Object collector) {
		...
		if(forLayer == null){
			...
			this.featureCollectionToLayerName.put(forLayer, layerName+"-Textos");
		}
	...
	/* (non-Javadoc)
	 * @see org.agil.dxf.reader.DxfConverter#convert(org.agil.dxf.reader.DxfTRACE, org.agil.dxf.reader.DxfFile, java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see org.agil.dxf.reader.DxfConverter#convert(org.agil.dxf.reader.DxfEntitySet, org.agil.dxf.reader.DxfFile, java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see org.agil.dxf.reader.DxfConverter#convert(org.agil.dxf.reader.DxfATTRIB, org.agil.dxf.reader.DxfFile, java.lang.Object)
	 */
