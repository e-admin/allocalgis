...
public class CMainAdministrador extends CMain{
	...
	private boolean configureApp() {
		...
		try {
			...
			try{PropertyConfigurator.configureAndWatch("config" + File.separator + "log4j.ini", 3000);}catch(Exception e){};
	           ...
	           try{
                   Constantes.url = app.getString("geopista.conexion.servidorurl")+"administracion";                   
	...
	*/
    ...
    {
    	// Si el usuario no es un usuario de la entidad 0 se desactiva el menu de entidades:
    	boolean bEntidad;
        ...
        jMenuItemGestionEntidades.setEnabled(bEntidad);
    }
