 ...
 * postgis databases through a WFS.
 *
 * <p>-------------------------------------------------------------------------</p>
 *
 * @author Andreas Poth
...
public final class PostgisDataStore extends AbstractDataStore {
    
    public PostgisDataStore(URL config) throws DataStoreException {
        super( config );
    }
