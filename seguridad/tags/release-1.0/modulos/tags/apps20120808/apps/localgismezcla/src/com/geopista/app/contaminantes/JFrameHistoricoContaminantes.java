...
public class JFrameHistoricoContaminantes extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jComboBoxTipoBusqueda = new ComboBoxEstructuras(com.geopista.app.contaminantes.estructuras.Estructuras.getListaTipoMedioambiental(),null,
        ...
        jComboBoxAccion = new ComboBoxEstructuras(com.geopista.app.contaminantes.estructuras.Estructuras.getListaTipoAccion(),null,
                com.geopista.app.contaminantes.init.Constantes.Locale);
     ...
     private void buscar() {
        try
        {
               ...
               if (jComboBoxTipoBusqueda.getSelectedIndex()!=0)
                ...
                listaHistoricos= new OperacionesContaminantes(com.geopista.app.contaminantes.init.Constantes.url).getHistorico(peticion);
                actualizarModelo();
    ...
    private void anadir()
    {
        ...
        if (dialogApunte.isAceptado())
        {
            ...
            try
            {
                CResultadoOperacion result=new OperacionesContaminantes((com.geopista.app.contaminantes.init.Constantes.url)).gestionarHistorico(historico);
    ...
    private void modificar()
    {
        ...
        if (dialogApunte.isAceptado())
        {
            ...
            try
            {
                CResultadoOperacion result=new OperacionesContaminantes((com.geopista.app.contaminantes.init.Constantes.url)).gestionarHistorico(historicoSelected);
