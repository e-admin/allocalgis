...
class CDescribeFeatureType extends AbstractDescribeFeatureType {
    ...
    public CDescribeFeatureType(OracleDataStore parent, OGCWebServiceRequest request) {
    ...
    protected Document createSchema(String featureType) throws Exception {
        ...
        try {
            ...
            OracleSpatialAccess osa =
            new OracleSpatialAccess( con, connect.getSpatialVersion() );
