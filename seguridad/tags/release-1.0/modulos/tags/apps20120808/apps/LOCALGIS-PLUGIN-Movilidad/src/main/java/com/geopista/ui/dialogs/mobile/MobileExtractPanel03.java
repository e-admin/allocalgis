...
public class MobileExtractPanel03  extends JPanel implements WizardPanel
{
	 ...
	 * @param viewport
	 */
	public static void resizeViewToEnvelope(PlugInContext ctx, Envelope newWrapperEnvelope, Viewport viewport){
		...
		Dimension dimView=ctx.getLayerViewPanel().getSize();
