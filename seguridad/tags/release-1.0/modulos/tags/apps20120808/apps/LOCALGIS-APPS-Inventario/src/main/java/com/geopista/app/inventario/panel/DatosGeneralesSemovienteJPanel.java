...
public class DatosGeneralesSemovienteJPanel extends InventarioPanel{
    ...
    private void initComponents() throws Exception{
        ...
        add(descFrutosJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 310, 20));
        add(valorFrutosJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 335, 110, 20));
        add(cuentaContableJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 375, 110, 20));
        add(destinoJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 395, 110, 20));
        ...
        add(descFrutosJScrollPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 290, 310, 40));
        add(valorFrutosJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 335, 160, 20));
        add(cuentaContableJCBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 355, 290, -1));
        add(cuentaContableJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 375, 20, 20));
        add(cuentaContableJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 375, 310, -1));
        add(destinoJTField, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 395, 310, -1));
