...
public class MainInventario extends CMain {
...
//        saveCatalogo.setVisible(true);
 ...
 private void confDatosValoracionJMenuItemActionPerformed(){
    ...
    private boolean configureApp() {
        try {
             try{
                    com.geopista.protocol.CConstantesComando.servletLicenciasUrl = aplicacion.getString("geopista.conexion.servidorurl")+ WebAppConstants.LICENCIAS_WEBAPP_NAME + ServletConstants.CSERVLETLICENCIAS_SERVLET_NAME;
