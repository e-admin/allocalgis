...
/*
 * TarifasDifuntosJDialog.java
 *
 * Created on 21-jun-2011, 09:21:18
 */
 ...
 * @author yraton
 */
public class TarifasDifuntosJDialog extends javax.swing.JDialog {
    ...
    public TarifasDifuntosJDialog (JFrame desktop, String locale, String operacion,String tipo) throws Exception{
    	super(desktop);
    ...
    /** Creates new form TarifasJDialog */
    public TarifasDifuntosJDialog(JFrame desktop, String locale) throws Exception{
        super(desktop);
        this.desktop= desktop;
        this.locale= locale;
        inicializar();
...
//        listaTarifasTabla = new ArrayList<TarifaBean>();
        ...
        vDomainTipoCalculo = Estructuras.getListaCombosServiciosSorted(locale);
        ...
        tipoCalculoJLabel.setText("Tipo Servicio");
...
//      }
    ...
    public int getPatronCalculo() {
		return patronCalculo;
	}

	public void setPatronCalculo(int patronCalculo) {
