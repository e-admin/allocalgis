...
public class ExpedientePanelTree extends JPanel  {
        ...
        {  
        	...
        	if (!fc.isDelete()){
        		...
        		if (!fc.isDelete()){
        			...
        			if(nodoFinca.children()==DefaultMutableTreeNode.EMPTY_ENUMERATION || nodoFinca.getAllowsChildren()){
    ...
    public BienInmuebleJuridico fillObjectBienInmueble(DefaultMutableTreeNode nodoBI)
    {
        ...
        if (nodoBI.getUserObject() instanceof BienInmuebleJuridico
                && nodoBI.children()==DefaultMutableTreeNode.EMPTY_ENUMERATION || nodoBI.getAllowsChildren())
        {              
            EdicionOperations oper = new EdicionOperations();
