...
public class ImportarFINSalida extends JPanel implements WizardPanel
{
    ...
    /**
     * Nombre de la etiqueta raíz del xml que se espera importar
     */
    private static final String TIPO_FICHERO = "finsalida";
    
    public static final int DIM_X=700;
    public static final int DIM_Y=450;
    
    public ImportarFINSalida()
    {   
        try
        {     
                ...
                new Thread(new Runnable()
                    ...
                    public void run()
                    {
                        try
                        {
                            ...
                            panel.getJComboBoxDatosImportar().addItem(I18N.get("Importacion","importar.asistente.finsalida.tipo"));
    ...
    {        
        ...
        String lastFolder=AppContext.getApplicationContext().getUserPreference(ImportarUtils_LCGIII.LAST_IMPORT_DIRECTORY, null, false);
        ...
        AppContext.getApplicationContext().setUserPreference(ImportarUtils_LCGIII.LAST_IMPORT_DIRECTORY, fc.getCurrentDirectory().getAbsolutePath());
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION)
        {
                    ...
                    new Thread(new Runnable()
                        ...
                        {                            
                            try
                            {
                                ...
                                mensajeValidacion = ImportarUtils.validateLowSAXdocumentWithXSD(fc.getSelectedFile().getPath(), TIPO_FICHERO);
            ...
            if (mensajeValidacion.trim().length()==0){
              ...
              .append(ImportarUtils_LCGIII.HTML_FIN_PARRAFO);  
            	...
            	strBuf.append(ImportarUtils_LCGIII.HTML_ROJO).append(mensajeValidacion).append(ImportarUtils_LCGIII.HTML_FIN_PARRAFO);
            }
            jEditorPaneErrores.setText(strBuf.toString());
