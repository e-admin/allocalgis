...
public class FxccPanel extends JPanel implements FeatureExtendedPanel{
    ...
    public FxccPanel()
    {
        ...
        ResourceBundle bundle = ResourceBundle.getBundle("com.geopista.ui.plugin.infcatfisicoeconomico.languages.InfCatastralFisicoEconomicoPlugIni18n",loc,this.getClass().getClassLoader());
    ...
    throws Exception {
    	...
    	InputStream fileDXF = ImportarUtils_LCGIII.parseStringToIS(file);
    	...
    	fileDXF = ImportarUtils_LCGIII.parseStringToIS(file);
    ...
    private String chooseCategory(DataSourceQuery dataSourceQuery) {
    	...
    	if (dataSourceQuery != null && dataSourceQuery.toString()!=null){
    		if (dataSourceQuery.toString().toUpperCase().startsWith("PG")){
    			return I18N.get("InfCatastralFisicoEconomicoPlugIn","infCatastralFisicoEconomico.fxcc.panel.CategoriaPG");
    		}
...
//    			return I18N.get("Expedientes","fxcc.panel.CategoriaPS");
    			if (dataSourceQuery.toString().toUpperCase().length()>=4){
    				...
    				return I18N.get("InfCatastralFisicoEconomicoPlugIn","infCatastralFisicoEconomico.fxcc.panel.CategoriaPS");
    			}
    		}
    ...
    public void initDXF() {
        ...
        progressDialog.report(I18N.get("InfCatastralFisicoEconomicoPlugIn","infCatastralFisicoEconomico.fxcc.panel.ComprobandoFicheroDXF"));
    				...
    				public void run()
    				{
    					...
    					{   
    						...
    						if(textFxcc!=null){
    							...
    							Document docFxcc = builder.build(ImportarUtils_LCGIII.parseStringToIS(textFxcc));
    							...
    							if(dxf!=null){
    								...
    								progressDialog.report(I18N.get("InfCatastralFisicoEconomicoPlugIn","infCatastralFisicoEconomico.fxcc.panel.CargandoFicheroDXF"));
    ...
    public JButton getJButtonNuevoDXF()
    {
    	if (jButtonNuevoDXF  == null)
    	{
    		...
    		jButtonNuevoDXF.setText(I18N.get("InfCatastralFisicoEconomicoPlugIn", "infCatastralFisicoEconomico.fxcc.panel.boton.nuevodxf"));
