...
public class ImportarPadronMunicipal extends JPanel implements WizardPanel
{
    ...
    public void exitingToRight() throws Exception
    {
        ...
        blackboard.put(ImportarUtils_LCGIII.FILE_TYPE, jComboBoxFileType.getSelectedItem().toString());  
                            ...
                            try
                            {
                                ...
                                {   
                                    ...
                                    if(file.length()%LONGITUD_REGISTRO == 0)
                                        blackboard.put(ImportarUtils_LCGIII.FILE_TXT_MULTILINE, false);  
                                    
                                    //varias lineas
                                    else
                                    {
                                        blackboard.put(ImportarUtils_LCGIII.FILE_TXT_MULTILINE, true);
                                ...
                                else
                                {
                                    ...
                                    if (ImportarUtils.validateXMLwithXSD(fc.getSelectedFile().getPath(), TIPO_FICHERO))
