...
public class GUIUtil {
    ...
    Window w=SwingUtilities.windowForComponent(componentToMove);
    centre(componentToMove,w);
    ...
    public static JFileChooser createJFileXMLChooserWithOverwritePrompting() {
        return new FileXMLChooserWithOverwritePrompting();
    }
    ...
    public static class FileXMLChooserWithOverwritePrompting extends JFileChooser {
        public void approveSelection() {
            if (selectedFiles(this).length != 1) {
                return;
            }
    ...
    /** 
     * Highlights a given component with a given color.  Great for
     * GridBagLayout debugging.
     *
     */
