...
public class LoginDBDialog extends javax.swing.JDialog {
    ...
    public void preInitGUI(){
        rememberPassword= !("".equals(AppContext.getApplicationContext().getUserPreference("LAST_PASS",null,false)));
    }
    
    /** Add your post-init code in here     */
    public void postInitGUI(){
        //lastUserName=AppContext.getApplicationContext().getUserPreference("LAST_LOGIN",lastUserName,false); //$NON-NLS-1$
        //lastPassword=AppContext.getApplicationContext().getUserPreference("LAST_PASS",lastPassword,false); //$NON-NLS-1$
        setLogin("");
        setPassword("");
