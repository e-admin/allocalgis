...
public class Depuradoras2Dialog extends JDialog
{
    ...
    public Depuradoras2Dialog(Depuradora2EIEL elemento, boolean isEditable)
    {
        ...
        getDepuradoras2Panel().getJComboBoxProvincia().setEnabled(false);
        getDepuradoras2Panel().getJComboBoxMunicipio().setEnabled(false);
    ...
    private void onTabbedPageChange(ChangeEvent e) {
        ...
        if (sel == 1){
        	this.getDepositosNucleosPanel().tabbedChanged(getDepuradoras2Panel().getDepuradora2Data());
        }
	}
