package com.localgis.webservices.civilwork.model.dao.oracle;
...
import com.localgis.webservices.civilwork.model.dao.oracle.warnings.OracleLocalGISNotesDAO;
...
public class OracleDAOFactory extends DAOFactory
{
    ...
    public DataSource getDataSource() throws NamingException 
    {
        ...
        return (DataSource)envContext.lookup("oracle");
    }
	...
	public ILocalGISNotesDAO getLocalGISNotesDAO() {
		...
		return new OracleLocalGISNotesDAO();
	}
