        ...
        try{
            ...
            switch (query.getAction()){
            	...
            	case Const.ACTION_GET_PLAZA:
            		Long id = (Long) params.get(Const.KEY_IDELEMENTOCEMENTERIO);
            		geoConn.returnPlaza(oos,id , userSesion);
        		break;
            	...
            	case Const.ACTION_GET_CEMENTERIO:
            		id = (Long) params.get(Const.KEY_IDELEMENTOCEMENTERIO);
            		geoConn.returnCementerio(oos, id.intValue() , userSesion);
        		break;
