...
//				CConstantesComando.loginLicenciasUrl = AppContext.getApplicationContext().getString(SSOConstants.SSO_SERVER_URL);
	...
	private boolean configureApp() {
		...
		try {
            ...
            try{
                   ...
                   com.geopista.protocol.CConstantesComando.servletLicenciasUrl = app.getString("geopista.conexion.servidorurl") + WebAppConstants.LICENCIAS_WEBAPP_NAME + ServletConstants.CSERVLETLICENCIAS_SERVLET_NAME;
                   com.geopista.protocol.CConstantesComando.anexosLicenciasUrl = app.getString("geopista.conexion.servidorurl")+"anexos/licencias/";
                   com.geopista.protocol.CConstantesComando.loginLicenciasUrl = app.getString("geopista.conexion.servidorurl") + WebAppConstants.LICENCIAS_WEBAPP_NAME;
	...
	public boolean applySecurityPolicy(GeopistaAcl acl, GeopistaPrincipal principal) {
		...
		try {
			...
			CConstantesLicencias.principal = principal;
