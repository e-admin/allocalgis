...
public class CModificacionLicencias extends JInternalFrameLicencias implements IMultilingue {
        ...
        CUtilidadesComponentes.showPersonaDialog(desktop,CMainLicencias.literales);
         if ((CConstantesLicencias.persona != null) && (CConstantesLicencias.persona.getDniCif() != null)) {
            if ((CConstantesLicencias.persona != null) && (CConstantesLicencias.persona.getDniCif() != null)) {
                ...
                DNIRepresentanteTField.setText(CConstantesLicencias.persona.getDniCif());
                ...
                faxRepresentanteTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getFax());
                telefonoRepresentanteTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getTelefono());
                movilRepresentanteTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getMovil());
                ...
                numeroViaRepresentanteTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getNumeroVia());
                ...
                try{
                    cPostalRepresentanteTField.setNumber(new Integer(CConstantesLicencias.persona.getDatosNotificacion().getCpostal()));
                        ...
                        */
                        if ((CConstantesLicencias.representante != null) || (_DNI_CIF_Representante.trim().length() > 0)){
                            if (CConstantesLicencias.representante != null){
                                /** caso 1 */
                               //System.out.println("************** 1.- Se ha asignado un representante de BD ID="+CConstantesLicencias.representante.getIdPersona());
                        ...
                        if ((CConstantesLicencias.representante != null) || (_DNI_CIF_Representante.trim().length() > 0)){
                            if (CConstantesLicencias.representante != null){
                                /** caso 1 */
                                //System.out.println("************** 4.- Se ha asignado un representante de BD ID="+CConstantesLicencias.representante.getIdPersona());
                               representante.setIdPersona(CConstantesLicencias.representante.getIdPersona());
                            }else{
                                /** caso 2 */
	...
	private void buscarDNIPromotorJButtonActionPerformed() {//GEN-FIRST:event_buscarDNIPromotorJButtonActionPerformed
		...
		if ((CConstantesLicencias.persona != null) && (CConstantesLicencias.persona.getDniCif() != null)) {
            DNIPromotorTField.setText(CConstantesLicencias.persona.getDniCif());
            ...
            faxPromotorTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getFax());
            telefonoPromotorTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getTelefono());
            movilPromotorTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getMovil());
            ...
            numeroViaPromotorTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getNumeroVia());
            ...
            try{
                cPostalPromotorTField.setNumber(new Integer(CConstantesLicencias.persona.getDatosNotificacion().getCpostal()));
	...
	private void buscarDNIPropietarioJButtonActionPerformed() {//GEN-FIRST:event_buscarDNIPropietarioJButtonActionPerformed
		...
		if ((CConstantesLicencias.persona != null) && (CConstantesLicencias.persona.getDniCif() != null)) {
                DNIPropietarioTField.setText(CConstantesLicencias.persona.getDniCif());
                ...
                faxPropietarioTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getFax());
                telefonoPropietarioTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getTelefono());
                movilPropietarioTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getMovil());
                ...
                numeroViaPropietarioTField.setText(CConstantesLicencias.persona.getDatosNotificacion().getNumeroVia());
                ...
                try{
                    cPostalPropietarioTField.setNumber(new Integer(CConstantesLicencias.persona.getDatosNotificacion().getCpostal()));
