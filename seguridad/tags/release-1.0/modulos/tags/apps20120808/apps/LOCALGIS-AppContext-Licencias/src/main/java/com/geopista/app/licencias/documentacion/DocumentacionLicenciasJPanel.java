                ...
                if (!f.isAbsolute()){
                    ...
                    if (returnVal == JFileChooser.APPROVE_OPTION) {
                       ...
                       /** Comprobamos si existe el directorio. */
                        ...
                        boolean resultado = CUtilidadesComponentes.GetURLFile(CConstantesComando.anexosLicenciasUrl + _solicitud.getIdSolicitud() + "/" + "alegacion" + "/" + alegacion.getIdAlegacion() + "/" + fileName, tmpFile, "", 0);
                        if (!resultado) {
                ...
                if (returnVal == JFileChooser.APPROVE_OPTION) {
                    ...
                    if (selectedFile != null){
                       ...
                       /** Comprobamos si existe el directorio. */
                        ...
                        boolean resultado= CUtilidadesComponentes.GetURLFile(CConstantesComando.anexosLicenciasUrl + _solicitud.getIdSolicitud() + "/" + fileName, tmpFile, "", 0);
                        if (!resultado) {
                            mostrarMensaje(literales.getString("DocumentacionLicenciasJPanel.mensaje2"));
                            this.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
                            return;
    ...
    private void mejoras() {//GEN-FIRST:event_mejorasJTabbedPaneStateChanged
        ...
        if (tab != null){
            if ((tab.isFirst()) && (enMejoraDatos())){
                ...
                if (anexo != null) {
                    /** boton eliminar */
                    if (!getOperacion().equalsIgnoreCase("CONULTA")){
