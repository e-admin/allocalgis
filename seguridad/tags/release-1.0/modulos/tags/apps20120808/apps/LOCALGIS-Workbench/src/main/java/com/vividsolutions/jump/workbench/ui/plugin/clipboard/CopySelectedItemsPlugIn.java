...
public class CopySelectedItemsPlugIn extends AbstractPlugIn {
    ...
    public boolean execute(PlugInContext context) throws Exception {
        Toolkit.getDefaultToolkit().getSystemClipboard().setContents(new CollectionOfFeaturesTransferable(
        		...
        		context.getLayerViewPanel().getSelectionManager().createFeaturesFromSelectedItems()), new DummyClipboardOwner());
        return true;
    }        
    ...
    public void initialize(PlugInContext context) throws Exception {
        ...
        featureInstaller.addPopupMenuItem(popupMenu,
                ...
                CopySelectedItemsPlugIn.createEnableCheck(context.getWorkbenchContext()));
                //null);
