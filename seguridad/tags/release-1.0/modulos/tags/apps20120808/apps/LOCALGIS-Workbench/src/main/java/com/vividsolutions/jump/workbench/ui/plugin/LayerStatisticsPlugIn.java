...
public class LayerStatisticsPlugIn extends AbstractPlugIn {
    ...
    public boolean execute(PlugInContext context) throws Exception {
        ...
        out.addHeader(1, aplicacion.getI18nString("plugin.layerstatics.estadisticas"));
        ...
        for (int i = 0; i < selectedLayers.length; i++) {
            ...
            out.addHeader(2, aplicacion.getI18nString("plugin.layerstatics.nombre") +" "+ layer.getName());

            Envelope layerEnv = layer.getFeatureCollectionWrapper().getEnvelope();
            out.addField(aplicacion.getI18nString("plugin.layerstatics.bordes"), layerEnv.toString());
            totalEnv.expandToInclude(layerEnv);
            output(ls, out);
        }

        if (selectedLayers.length > 1) {
            out.addHeader(2, aplicacion.getI18nString("plugin.layerstatics.resumen"));
            out.addField(aplicacion.getI18nString("plugin.layerstatics.bordes"), totalEnv.toString());
    ...
    public void output(LayerStatistics ls, HTMLFrame out) {
        //=========  Output  ===============
        out.addField(aplicacion.getI18nString("plugin.layerstatics.numentidades"), ls.featureCount + "");

        out.append("<table border='1'>");
        out.append(
            "<tr><td bgcolor=#CCCCCC>&nbsp;</td><td  bgcolor=#CCCCCC align='center'> "+aplicacion.getI18nString("plugin.layerstatics.minimo")+" </td><td  bgcolor=#CCCCCC align='center'> "+aplicacion.getI18nString("plugin.layerstatics.maximo")+" </td><td  bgcolor=#CCCCCC align='center'> "+aplicacion.getI18nString("plugin.layerstatics.media")+" </td><td  bgcolor=#CCCCCC align='center'> "+aplicacion.getI18nString("plugin.layerstatics.total")+" </td></tr>");
        out.append("<tr><td bgcolor=#CCCCCC> "+aplicacion.getI18nString("plugin.layerstatics.puntos")+" </td><td align='right'>" +
            ls.minCoord + "</td><td align='right'>" + ls.maxCoord +
            "</td><td align='right'>" + ls.avgCoord() +
            "</td><td align='right'>" + ls.totalCoord + "</td></tr>");
        out.append("<tr><td bgcolor=#CCCCCC> "+aplicacion.getI18nString("plugin.layerstatics.huecos")+" </td><td align='right'>" +
            ls.minHoles + "</td><td align='right'>" + ls.maxHoles +
            "</td><td align='right'>" + ls.avgHoles() +
            "</td><td align='right'>" + ls.totalHoles + "</td></tr>");
        out.append(
            "<tr><td bgcolor=#CCCCCC> "+ aplicacion.getI18nString("plugin.layerstatics.componentes")+" </td><td align='right'>" +
            ls.minComp + "</td><td align='right'>" + ls.maxComp +
            "</td><td align='right'>" + ls.avgComp() +
            "</td><td align='right'>" + ls.totalComp + "</td></tr>");
        out.append("<tr><td bgcolor=#CCCCCC> "+aplicacion.getI18nString("plugin.layerstatics.area")+" </td><td align='right'>" +
            ls.minArea + "</td><td align='right'>" + ls.maxArea +
            "</td><td align='right'>" + ls.avgArea() +
            "</td><td align='right'>" + ls.totalArea + "</td></tr>");
        out.append("<tr><td bgcolor=#CCCCCC> "+aplicacion.getI18nString("plugin.layerstatics.longitud")+" </td><td align='right'>" +
