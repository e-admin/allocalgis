 ...
 *
 * Created on 24 de septiembre de 2004, 16:29
 */
...
import com.geopista.style.filtereditor.ui.impl.Filter2String;
 ...
 * @author enxenio s.l.
 */
public class InsertUpdateFilterPanel extends AbstractPanel implements ActionListener {
	...
	public void configure(Request request) {
		...
		if (_filterTree.getRoot() instanceof Operator) {
			filterTxt.setText(Filter2String.createStringFromOperation((Operator)_filterTree.getRoot()));	
		}
    ...
    public InsertUpdateFilterPanel() {
        initComponents();
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        actionPanel.add(filterTxt, gridBagConstraints);
