...
public class MapLayerWizardPanel extends JPanel implements com.geopista.ui.wizard.WizardPanel {
    /**
	 * 
	 */
    ...
    public final static String NO_COMMON_SRS_MESSAGE = AppContext.getApplicationContext().getI18nString("TheChosenLayersDoNotHaveACommonEPSGCoordinateReferenceSystem");
    ...
    public String getInstructions() {
        ...
        return AppContext.getApplicationContext().getI18nString("PleaseChooseTheWMSLayersThatShouldAppearOnTheImage");
    }

    public void exitingToRight() throws WorkbenchException {
    	if(dataMap.get(LAYERS_KEY)!=null)
    	dataMap.remove(LAYERS_KEY);
    ...
    public String getTitle() {
        return AppContext.getApplicationContext().getI18nString("ChooseWMSLayers");
    }
    ...
    public String getNextID() {
        return LayerStylesWizardPanel.class.getName();
    }
