...
public class ParallelItemsPlugIn extends AbstractPlugIn
{
    private boolean selectParallelItemsButtonAdded = false;
    ...
    {
        if (!selectParallelItemsButtonAdded)
        {                        
            toolbox.add(new ParallelItemsTool(null));
            toolbox.finishAddingComponents();
            toolbox.validate();
            selectParallelItemsButtonAdded = true;
        }
    }
}
