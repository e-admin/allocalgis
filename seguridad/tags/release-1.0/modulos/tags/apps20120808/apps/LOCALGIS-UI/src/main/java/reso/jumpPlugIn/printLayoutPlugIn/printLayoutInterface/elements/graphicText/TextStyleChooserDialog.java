...
public class TextStyleChooserDialog extends JDialog {
	...
	private JLabel apercuLabel = new JLabel();
private String currentText=null;
	...
	private class OkCancelActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			if (okCancelPanel.wasOKPressed()) {
				text.setText(apercuLabel.getText());
				text.setVerticalAlignment(apercuLabel.getVerticalAlignment());
				text.setHorizontalAlignment(apercuLabel
						.getHorizontalAlignment());
				text.setFont(apercuLabel.getFont());
				text.setFontColor(apercuLabel.getForeground());
				text.setBorder(apercuLabel.getBorder());
				text.setOpaque(apercuLabel.isOpaque());
				text.setBackgroundColor(apercuLabel.getBackground());
	...
	private void init(GraphicText gt) {
		...
		if (gt.getUnderline()) {
			String ch = gt.getText().replaceAll("<html><u>", "");
			textPanel.yourTextArea.setText(ch.replaceAll("</u></html>", ""));
		} else {
			textPanel.yourTextArea.setText(gt.getText());
		}
		apercuLabel.setText(textPanel.yourTextArea.getText());
		...
		apercuLabel.setVerticalAlignment(gt.getVerticalAlignment());
		apercuLabel.setHorizontalAlignment(gt.getHorizontalAlignment());

		//initialisation de la police
		fontPanel.fontNameComboBox.setSelectedItem(gt.getFont()
				.getFamily());
		fontPanel.fontSizeTextField.setText(new Integer(gt.getFont()
				.getSize()).toString());
		...
		apercuLabel.setFont(new Font(gt.getFont().getName(), gt
				.getFont().getStyle(), gt.getFont().getSize()));

		apercuLabel.setForeground(fontPanel.color.getBackground());
		...
		if (gt.getBorder() instanceof LineBorder) {
			...
			borderPanel.color.setBackground(((LineBorder) gt.getBorder())
					.getLineColor());
		...
		apercuLabel.setPreferredSize(new Dimension(400, 40));
		apercu.setLayout(new GridBagLayout());
		apercu.add(apercuLabel, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
				GridBagConstraints.NORTHWEST, GridBagConstraints.REMAINDER,
	...
	private class TextPanel extends JPanel {
		...
		public TextPanel() {
			...
			yourTextArea.append(apercuLabel.getText());
			yourTextArea.addFocusListener(new FocusListener() {
				public void focusGained(FocusEvent e) {
				}

				public void focusLost(FocusEvent e) {
					apercuLabel.setText(yourTextArea.getText()); 
			...
			public PositionPanel() {
				...
				topLeft.addItemListener(new ItemListener() {
					public void itemStateChanged(ItemEvent e) {
						apercuLabel.setVerticalAlignment(SwingConstants.TOP);
						apercuLabel.setHorizontalAlignment(SwingConstants.LEFT);
					}
				});
				...
				centerLeft.addItemListener(new ItemListener() {
					public void itemStateChanged(ItemEvent e) {
						apercuLabel.setVerticalAlignment(SwingConstants.CENTER);
						apercuLabel.setHorizontalAlignment(SwingConstants.LEFT);
					}
				});
				...
				bottomLeft.addItemListener(new ItemListener() {
					public void itemStateChanged(ItemEvent e) {
						apercuLabel.setVerticalAlignment(SwingConstants.BOTTOM);
						apercuLabel.setHorizontalAlignment(SwingConstants.LEFT);
					}
				});
	...
	private class FontPanel extends JPanel {
		...
		private void initFontNameComboBox() {
			...
			fontNameComboBox.addItemListener(new ItemListener() {
				public void itemStateChanged(ItemEvent e) {
					apercuLabel.setFont(new Font(fontNameComboBox
							.getSelectedItem().toString(), apercuLabel
							.getFont().getStyle(), apercuLabel.getFont()
							.getSize()));
				}
			});
		}
		...
		private void initFontSize() {
			fontSizeTextField.setText(Integer.toString(apercuLabel.getFont()
					.getSize()));
			fontSizeTextField.addFocusListener(new FocusListener() {
				...
				public void focusLost(FocusEvent e) {
					apercuLabel.setFont(new Font(apercuLabel.getFont()
							.getName(), apercuLabel.getFont().getStyle(),
							Integer.valueOf(fontSizeTextField.getText())
									.intValue()));
				}
			});
		}
		...
		private void initFontStyle() {
			boldCheckBox.setFont(new Font(boldCheckBox.getFont().getName(),
					Font.BOLD, boldCheckBox.getFont().getSize()));
			italicCheckBox.setFont(new Font(italicCheckBox.getFont().getName(),
					Font.ITALIC, italicCheckBox.getFont().getSize()));
			fontStyle
					.setBorder(BorderFactory
							.createTitledBorder(I18NPlug.get(PrintLayoutPlugIn.name,"reso.jumpPlugIn.printLayoutPlugIn.printLayoutInterface.elements.options.TextStyleChooserDialog.FontPanel.FontStyle")));
			...
			boldCheckBox.addItemListener(new ItemListener() {
				public void itemStateChanged(ItemEvent e) {
					if (boldCheckBox.isSelected()) {
						apercuLabel.setFont(new Font(apercuLabel.getFont()
								.getName(), apercuLabel.getFont().getStyle()
								+ Font.BOLD, apercuLabel.getFont().getSize()));
					} else {
						apercuLabel.setFont(new Font(apercuLabel.getFont()
								.getName(), apercuLabel.getFont().getStyle()
								- Font.BOLD, apercuLabel.getFont().getSize()));
			...
			underlineCheckBox.addItemListener(new ItemListener() {
				public void itemStateChanged(ItemEvent e) {
					if (underlineCheckBox.isSelected()) {
						apercuLabel.setText("<html><u>" + apercuLabel.getText()
								+ "</u></html>");
						text.setUnderline(true);
					} else {
						String ch = apercuLabel.getText().replaceAll(
								"<html><u>", "");
						apercuLabel.setText(ch.replaceAll("</u></html>", ""));
			...
			italicCheckBox.addItemListener(new ItemListener() {
				public void itemStateChanged(ItemEvent e) {
					if (italicCheckBox.isSelected()) {
						apercuLabel
								.setFont(new Font(apercuLabel.getFont()
										.getName(), apercuLabel.getFont()
										.getStyle()
										+ Font.ITALIC, apercuLabel.getFont()
										.getSize()));
					} else {
						apercuLabel
								.setFont(new Font(apercuLabel.getFont()
			...
			upperCaseCheckBox.addItemListener(new ItemListener() {
				public void itemStateChanged(ItemEvent e) {
					if (upperCaseCheckBox.isSelected()) {
						apercuLabel
								.setText(currentText.toUpperCase());
		...
		private void initFontColor() {
			...
			color.setBackground(apercu.getForeground());
			color.addPropertyChangeListener(new PropertyChangeListener() {
				public void propertyChange(PropertyChangeEvent evt) {
					apercuLabel.setForeground(color.getBackground());
				}
			});
	...
	private class BorderPanel extends JPanel {
		...
		public BorderPanel() {
			...
			color.addPropertyChangeListener(new PropertyChangeListener() {
				public void propertyChange(PropertyChangeEvent evt) {
					apercuLabel.setBorder(BorderFactory.createLineBorder(color
	...
	private class TramePanel extends JPanel {
		...
		public TramePanel() {
			...
			transparent.addItemListener(new ItemListener() {
				public void itemStateChanged(ItemEvent e) {
					apercuLabel.setOpaque(false);
					tramePanel.setEnabled(apercuLabel.isOpaque());
				}
			});
			stylePanel.add(opaque);
			opaque.addItemListener(new ItemListener() {
				public void itemStateChanged(ItemEvent e) {
					apercuLabel.setOpaque(true);
					tramePanel.setEnabled(apercuLabel.isOpaque());
				}
			});
			setLayout(new GridBagLayout());
		...
		private class TrameColorPanel extends JPanel {
			...
			public TrameColorPanel() {
				...
				color.setBorder(BorderFactory
						.createEtchedBorder(EtchedBorder.RAISED));
				color.setPreferredSize(new Dimension(160, 20));
				color.setBackground(apercuLabel.getBackground());
				color.addPropertyChangeListener(new PropertyChangeListener() {
					public void propertyChange(PropertyChangeEvent evt) {
						apercuLabel.setBackground(color.getBackground());
					}
				});
