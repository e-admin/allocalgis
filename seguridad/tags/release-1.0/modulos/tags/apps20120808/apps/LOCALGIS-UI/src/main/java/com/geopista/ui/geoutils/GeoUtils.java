...
package com.geopista.ui.geoutils;

import java.util.BitSet;

import com.geopista.ui.cursortool.rotateselecteditems.MathVector;
...
public class GeoUtils extends java.lang.Object
{
    ...
    {   //rotate inpt about rpt by theta degrees (+ clockwise)
        ...
        //double hip = rpt.distance(inpt);
        //double xout = inpt.x + hip*ct;
        //double yout = inpt.y + hip*st;
