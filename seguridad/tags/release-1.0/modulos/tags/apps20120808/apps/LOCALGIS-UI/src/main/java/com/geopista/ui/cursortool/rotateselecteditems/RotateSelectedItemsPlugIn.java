...
public class RotateSelectedItemsPlugIn extends AbstractPlugIn
{
    private boolean selectRotateSelectedItemsButtonAdded = false;
    ...
    {
        if (!selectRotateSelectedItemsButtonAdded)
        {            
        	toolbox.addToolBar();
            toolbox.add(new RotateSelectedItemsTool(null));
            toolbox.finishAddingComponents();
            toolbox.validate();
            selectRotateSelectedItemsButtonAdded = true;
        }
    }
}
