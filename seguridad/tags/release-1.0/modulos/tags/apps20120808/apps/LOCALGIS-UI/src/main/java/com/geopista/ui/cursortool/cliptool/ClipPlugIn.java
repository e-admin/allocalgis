...
public class ClipPlugIn extends AbstractPlugIn
{
    private boolean selectClipButtonAdded = false;
    ...
    {
        if (!selectClipButtonAdded)
        {            
            toolbox.add(new ClipTool(null));
            toolbox.finishAddingComponents();
            toolbox.validate();
            selectClipButtonAdded = true;
        }
    }
}
