...
import com.geopista.app.ocupaciones.eventos.CConsultaEventos;
import com.geopista.app.ocupaciones.eventos.CUltimosEventos;
import com.geopista.app.ocupaciones.historico.CMantenimientoHistorico;
import com.geopista.app.ocupaciones.informes.CGeneracionInformes;
import com.geopista.app.ocupaciones.notificaciones.CNotificaciones;
import com.geopista.app.ocupaciones.planos.CGeneracionPlanos;
import com.geopista.app.ocupaciones.pendientes.TareasPendientesJInternalFrame;
...
public class CMainOcupaciones extends CMain {
   ...
   public CMainOcupaciones(String tipoOcupacion) {
    ...
    private void cargarMainOcupaciones(){
		...
		try
        {
			...
			if(SSOAuthManager.isSSOActive())
				CConstantesComando.loginLicenciasUrl = AppContext.getApplicationContext().getString(SSOAuthManager.SSO_SERVER_URL);
	...
	private boolean configureApp() {
		...
		try {
		    ...
		    try{
                   ...
                   com.geopista.protocol.CConstantesComando.servletLicenciasUrl = app.getString(UserPreferenceConstants.LOCALGIS_SERVER_URL)+"ocupaciones/CServletOcupaciones";
                   com.geopista.protocol.CConstantesComando.anexosLicenciasUrl = app.getString(UserPreferenceConstants.LOCALGIS_SERVER_URL)+"anexos/ocupacion/";
                   com.geopista.protocol.CConstantesComando.loginLicenciasUrl = app.getString(UserPreferenceConstants.LOCALGIS_SERVER_URL)+"ocupaciones";
                   ...
                   com.geopista.protocol.CConstantesComando.plantillasOcupacionesUrl = app.getString(UserPreferenceConstants.LOCALGIS_SERVER_URL)+"plantillas/ocupacion/";
	...
	private void consultarOcupacionJMenuItemActionPerformed() {
        ...
        com.geopista.app.ocupaciones.consulta.CConsultaLicencias consultarLicencia= new com.geopista.app.ocupaciones.consulta.CConsultaLicencias(this);
	...
	private void crearOcupacionJMenuItemActionPerformed() {//GEN-FIRST:event_crearLicenciaObraMayorJMenuItemActionPerformed
		...
		CConstantesOcupaciones.selectedSubApp = CConstantesOcupaciones.Ocupacion;
		mostrarJInternalFrame(new com.geopista.app.ocupaciones.creacion.CCreacionLicencias(this));
		zoomMapa();
		desktopPane.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
		this.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
	...
	private void modificarOcupacionJMenuItemActionPerformed() {
		...
		CConstantesOcupaciones.selectedSubApp = CConstantesOcupaciones.Ocupacion;
	    mostrarJInternalFrame(new com.geopista.app.ocupaciones.modificacion.CModificacionLicencias(this, null, true));
	    zoomMapa();
		desktopPane.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
		this.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
	...
	private void exitForm(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_exitForm
		try {
            ...
            if (iFrame!=null){
                if (iFrame instanceof com.geopista.app.ocupaciones.modificacion.CModificacionLicencias)
                {
                    ((com.geopista.app.ocupaciones.modificacion.CModificacionLicencias)iFrame).desbloquearExpediente();
                    ((com.geopista.app.ocupaciones.modificacion.CModificacionLicencias)iFrame).borrarFeaturesSinGrabar();
                }
                else if (iFrame instanceof com.geopista.app.ocupaciones.creacion.CCreacionLicencias)
                    ((com.geopista.app.ocupaciones.creacion.CCreacionLicencias)iFrame).borrarFeaturesSinGrabar();
            }
