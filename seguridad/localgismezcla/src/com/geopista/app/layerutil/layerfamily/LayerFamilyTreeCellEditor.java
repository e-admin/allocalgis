        ...
        if (currentLayerFamily !=null){
            ...
            if (EDIT.equals(e.getActionCommand())) {
                ...
                else
                {
                    ...
                    labelFamily.setText(traducciones.get(GestorCapas.DEFAULT_LOCALE).toString());
                }
    ...
    protected String getNameNode(Object value) {
        try
        {
            ...
            if (node.getUserObject() instanceof LayerFamilyTable) 
            {
                ...
                else if (nodeInfo.getHtNombre().get(GestorCapas.DEFAULT_LOCALE)!= null)
                    title = nodeInfo.getHtNombre().get(GestorCapas.DEFAULT_LOCALE).toString();
                
                else if (nodeInfo.getHtDescripcion().get(locale)!=null)
                    title = nodeInfo.getHtDescripcion().get(locale).toString();
                else if (nodeInfo.getHtDescripcion().get(GestorCapas.DEFAULT_LOCALE)!= null)
                    title = nodeInfo.getHtDescripcion().get(GestorCapas.DEFAULT_LOCALE).toString();                 
