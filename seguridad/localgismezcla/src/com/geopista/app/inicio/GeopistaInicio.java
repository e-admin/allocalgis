...
import com.geopista.app.wizard.GenericReportWizard;
import com.geopista.app.wizard.ReportWizard;
...
import com.geopista.app.catastro.dialogs.ReferenciarViasPanel;
...
//		setTitle ("GEOPISTA") ;
	...
	public void login(){
		...
		if (SSOAuthManager.isSSOActive()) {
			com.geopista.app.administrador.init.Constantes.url = AppContext.getApplicationContext().getString(SSOAuthManager.SSO_SERVER_URL);
			CConstantesComando.loginGeopistaInicio = AppContext.getApplicationContext().getString(SSOAuthManager.SSO_SERVER_URL);
		}
              ...
              d.init(new WizardPanel[] {
               ...
               d.setVisible(true);*/
				...
				}else if (description.equals("com.geopista.app.inforeferencia.GeopistaUnirDatosCallesPanel"))
				{
					...
					if (aplicacion.isOnline()){
						WizardComponent d = new WizardComponent(appContext,
								"Inforeferencia: Importar datos del Callejero", null);
						d.init(new WizardPanel[] { 
...
//				PLANEAMIENTO
				...
				else if (e.getDescription().equals("com.geopista.app.planeamiento.GeopistaEditorDominios01Panel"))
				{
					...
					d.init(new WizardPanel[] {
							new GeopistaEditarDominiosPlaneamiento()});
					showAppPanel(d);
				}
				...
				else if (e.getDescription().equals("com.geopista.app.planeamiento.GeopistaInformeParcelasAfectadasPanel"))
				{
					...
					if (aplicacion.isOnline()){
						...
						d.init(new WizardPanel[] {
								new GeopistaInformeParcelasAfectadasPanel()});
						showAppPanel(d);
					}else{
						JOptionPane.showMessageDialog(this,aplicacion.getI18nString("mensaje.no.conectado.a.la.base.datos"));
