 ...
 * Time: 19:13:33
 */
public class SaveInspector  extends LoggerHttpServlet {
       private org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(SaveInspector.class);
               ...
               try
               {
                    ...
                    else
                    {
                        ...
                        if (inspector.getId()!=null)
                            resultado=COperacionesContaminantes.actualizarInspector(inspector);
                        else
                            resultado=COperacionesContaminantes.crearInspector(inspector, sSesion.getIdMunicipio());
                    }
               }catch(Exception e)
               {
