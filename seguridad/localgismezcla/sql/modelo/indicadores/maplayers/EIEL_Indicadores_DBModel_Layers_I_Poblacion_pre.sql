...
-------- ### MAPA DE Poblacion ####
INSERT INTO DICTIONARY(ID_VOCABLO,LOCALE,TRADUCCION) VALUES (NEXTVAL('seq_dictionary'),'es_ES','EIEL_Indicadores I_I Poblacion');
INSERT INTO DICTIONARY(ID_VOCABLO,LOCALE,TRADUCCION) VALUES (CURRVAL('seq_dictionary'),'ca_ES','EIEL_Indicadores I_I Poblacion');
INSERT INTO DICTIONARY(ID_VOCABLO,LOCALE,TRADUCCION) VALUES (CURRVAL('seq_dictionary'),'gl_ES','EIEL_Indicadores I_I Poblacion');
INSERT INTO DICTIONARY(ID_VOCABLO,LOCALE,TRADUCCION) VALUES (CURRVAL('seq_dictionary'),'va_ES','EIEL_Indicadores I_I Poblacion');
INSERT INTO DICTIONARY(ID_VOCABLO,LOCALE,TRADUCCION) VALUES (CURRVAL('seq_dictionary'),'eu_ES','EIEL_Indicadores I_I Poblacion');

INSERT INTO MAPS(ID_MAP,ID_NAME,XML,ID_ENTIDAD) VALUES(999,CURRVAL('seq_dictionary'),'<?xml version="1.0" encoding="UTF-8"?>
<mapDescriptor><description></description><mapUnits></mapUnits><mapScale></mapScale><mapProjection>UTM 29N ED50</mapProjection><mapName>EIEL Indicadores_I_I Poblacion</mapName></mapDescriptor>
',0);

select * from maps order by id_map desc limit 4
delete from maps where id_map=999

delete from dictionary where id_vocablo in (229015)
select * from dictionary where id_vocablo in (229016,228994)
-- Estilos por defecto
...
select * from styles order by id_style desc limit 5
...
select * from layers where name='EIEL_Indicadores_I_Poblacion'
select * from layerfamilies_layers_relations where id_layer=12295
select * from maps_layerfamilies_relations where id_layerfamily=446
select * from queries where id_layer=12295
...
select * from  tables where name='eiel_indicadores_d_poblacion';
delete from tables where name='eiel_indicadores_d_poblacion';

delete from tables where id_table=10343
select * from columns where id_table=10343
delete from COLUMNS_DOMAINS where id_column in (select id from columns where id_table=10342);
delete  from columns where id_table=10343;

select * from layers where name='EIEL_Indicadores_I_Poblacion'
select * from attributes where id_layer=12300
delete from attributes where id_layer=12300
...
--select * from attributes where id_layer=12298
--delete from  attributes  where id_layer=12298 and position=11
