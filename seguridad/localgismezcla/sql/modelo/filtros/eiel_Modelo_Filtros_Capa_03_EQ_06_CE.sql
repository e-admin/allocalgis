...
insert into lcg_nodos_capas_campos (clave_capa, clave_grupo, campo_bd, tag_traduccion,tipo_bd, dominio, metodo)
	values ('CE','Info.CE','acceso','localgiseiel.tabla.ce.columna.acceso_ce',0,'eiel_Estado del acceso','Acceso'); 	
insert into lcg_nodos_capas_campos (clave_capa, clave_grupo, campo_bd, tag_traduccion,tipo_bd, dominio, metodo)
	values ('CE','Info.CE','capilla','localgiseiel.tabla.ce.columna.capilla',0,'eiel_Capilla','Capilla'); 
insert into lcg_nodos_capas_campos (clave_capa, clave_grupo, campo_bd, tag_traduccion,tipo_bd, dominio, metodo)
	values ('CE','Info.CE','ampliacion','localgiseiel.tabla.ce.columna.ampliacion_ce',0,'eiel_Posibilidad de ampliación','Ampliacion'); 	
insert into lcg_nodos_capas_campos (clave_capa, clave_grupo, campo_bd, tag_traduccion,tipo_bd, dominio, metodo)
...
insert into lcg_nodos_capas_campos (clave_capa, clave_grupo, campo_bd, tag_traduccion,tipo_bd, dominio, metodo)
	values ('CE','Info.CE','crematorio','localgiseiel.tabla.ce.columna.crematorio_ce',0,'eiel_Existencia de crematorio','Crematorio'); 	
insert into lcg_nodos_capas_campos (clave_capa, clave_grupo, campo_bd, tag_traduccion,tipo_bd, dominio, metodo)
